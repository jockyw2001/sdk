...
static MI_S32 MI_WARP_IOCTL_CreateChannel(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    s32Ret = MI_WARP_IMPL_CreateChannel(stCreateChnInfo.devId, stCreateChnInfo.chnId);
...
static MI_S32 MI_WARP_IOCTL_EnableInputPort(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    s32Ret = MI_WARP_IMPL_EnableInputPort(devId, chnId);
...
static MI_S32 MI_WARP_IOCTL_DisableInputPort(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    //DBG_INFO("<%s> Dev: %d, Chn: %d.\n", __func__, devId, chnId);
    s32Ret = MI_WARP_IMPL_DisableInputPort(devId, chnId);
...
static MI_S32 MI_WARP_IOCTL_EnableOutputPort(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    //DBG_INFO("<%s> Dev: %d, Chn: %d.\n", __func__, devId, chnId);
    s32Ret = MI_WARP_IMPL_EnableOutputPort(devId, chnId);
...
static MI_S32 MI_WARP_IOCTL_DisableOutputPort(MI_DEVICE_Context_t *env, void *ptr)
{
    ...
    AUTO_LOCK(env, mutex);
    //DBG_INFO("<%s> Dev: %d, Chn: %d.\n", __func__, devId, chnId);
    s32Ret = MI_WARP_IMPL_DisableOutputPort(devId, chnId);

    return s32Ret;
}
static MI_S32 MI_WARP_IOCTL_SetTable(MI_DEVICE_Context_t *env, void *ptr)
{
    MI_S32 s32Ret;
    MI_WARP_SetTable_t *pstSetTable = (MI_WARP_SetTable_t *)ptr;
    MI_WARP_DEV devId = pstSetTable->devId;
    MI_WARP_CHN chnId = pstSetTable->chnId;
    MI_WARP_TableType_e eTableType = pstSetTable->eTableType;
    void * pTableAddr = pstSetTable->pTableAddr;
    MI_U32 u32TableSize = pstSetTable->u32TableSize;
    AUTO_LOCK(env, mutex);
    //DBG_INFO("<%s>\n", __func__);
    s32Ret = MI_WARP_IMPL_SetTable(devId, chnId, eTableType, pTableAddr, u32TableSize);
...
static MI_DEVICE_WrapperFunction_t ioctl_table[E_MI_WARP_CMD_MAX] = {
    ...
    [E_MI_WARP_SETTABLE] = MI_WARP_IOCTL_SetTable,
};
