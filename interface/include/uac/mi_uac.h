...
MI_S32 MI_UAC_GetCapturePortAttr(MI_UAC_DEV DevId,
               MI_UAC_PORT PortId,
               MI_UAC_InputPortAttr_t *pstInputPortAttr);

MI_S32 MI_UAC_GetPlaybackPortAttr(MI_UAC_DEV DevId,
               MI_UAC_PORT PortId,
               MI_UAC_OutputPortAttr_t *pstOutputPortAttr);

MI_S32 MI_UAC_SendFrame(MI_UAC_CHN UacChn,
               MI_UAC_Frame_t *pstData,
               MI_S32 s32MilliSec);
