...
typedef enum
{
    MI_PANEL_AUO_21_1920x1080_60Hz = 0,
    MI_PANEL_LG_37_1920x1080_60Hz,
    MI_PANEL_INX_10_1280x800_60Hz,
    MI_PANEL_MAX
}MI_PANEL_INDEX_e;
...
typedef enum
{
    E_MI_PNL_LINK_TTL,                              ///< TTL  type
    E_MI_PNL_LINK_LVDS,                             ///< LVDS type
    E_MI_PNL_LINK_RSDS,                             ///< RSDS type
    E_MI_PNL_LINK_MINILVDS,                         ///< TCON
    E_MI_PNL_LINK_ANALOG_MINILVDS,                  ///< Analog TCON
    E_MI_PNL_LINK_DIGITAL_MINILVDS,                 ///< Digital TCON
    E_MI_PNL_LINK_MFC,                              ///< Ursa (TTL output to Ursa)
    E_MI_PNL_LINK_DAC_I,                        ///< DAC output
    E_MI_PNL_LINK_DAC_P,                       ///< DAC output
    E_MI_PNL_LINK_PDPLVDS,                    ///< For PDP(Vsync use Manually MODE)
    E_MI_PNL_LINK_EXT,                              ///< EXT LPLL TYPE
    E_MI_PNL_LINK_MIPI_DSI,                         ///< Mipi DSI
}MI_PANEL_LinkType_e;
...
typedef struct
{
    const char pPanelName[48];          ///<  PanelName
    MI_U8             u8Dither;         ///<  PANEL_DITHER, keep the setting
    MI_PANEL_LinkType_e eLinkType;        ///<  PANEL_LINK
