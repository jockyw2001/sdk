...
static test_vpe_Config stTest008 = {
    .inputFile  = TEST_VPE_CHNN_FILE(008, 0, 1920x1080),
...
int main(int argc, const char *argv[])
{
    ...
    VpeChannel = 0;
    VpePort = 0;
    test_vpe_CreatChannel(VpeChannel, VpePort, &stTest008.stCropWin, &stTest008.stOutPort[0].stPortWin,E_MI_SYS_PIXEL_FRAME_YUV422_YUYV,E_MI_SYS_PIXEL_FRAME_YUV422_YUYV);
