...
int main(int argc, const char *argv[])
{
    ...
    stCanvas.u16X = stTest006.stOutPort[0].stPortWin.u16X;
    stCanvas.u16Y = stTest006.stOutPort[0].stPortWin.u16Width;
    stCanvas.u16Width = stTest006.stOutPort[0].stPortWin.u16Width;
    stCanvas.u16Height= stTest006.stOutPort[0].stPortWin.u16Height;

    stDispWin.u16X = stTest006.stOutPort[0].stPortWin.u16X;
    stDispWin.u16Y = stTest006.stOutPort[0].stPortWin.u16Y;
    stDispWin.u16Width = 1920;//stTest006..stOutPort[0].stPortWin.u16Width;
    stDispWin.u16Height= 1080;//stTest006..stOutPort[0].stPortWin.u16Height;
    ...
    do {
        ...
        if(MI_SUCCESS  == MI_SYS_ChnInputPortGetBuf(&stVpeChnInputPort0,&stBufConf,&stBufInfo,&hHandle , 0))
        {
            ...
            if (test_vpe_GetOneFrame(stTest006.src_fd, stTest006.src_offset, stBufInfo.stFrameData.pVirAddr[0], frame_size) == 1)
            {
