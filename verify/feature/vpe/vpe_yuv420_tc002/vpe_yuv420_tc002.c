...
static test_vpe_Config stTest002[] = {
    {
        ...
        .stOutPort  = {
            [0] = {
                .outputFile = TEST_VPE_PORT_OUT_FILE(002, 0, 0, 480x270),
                .bEnable    = TRUE,
                .stPortWin  = {0, 0, 480, 270},
            },
        },
    },
    #if 1
    {
        ...
        .stOutPort  = {
            [1] = {
                .outputFile = TEST_VPE_PORT_OUT_FILE(002, 1, 0, 480x270),
                .bEnable    = TRUE,
                .stPortWin  = {0, 0, 480, 270},
            },
        },
    },
    {
        ...
        .stOutPort  = {
            [2] = {
                .outputFile = TEST_VPE_PORT_OUT_FILE(002, 2, 0, 480x270),
                .bEnable    = TRUE,
                .stPortWin  = {0, 0, 480, 270},
            },
        },
    },
    {
        ...
        .stOutPort  = {
            [0] = {
                .outputFile = TEST_VPE_PORT_OUT_FILE(002, 3, 0, 480x270),
                .bEnable    = TRUE,
                .stPortWin  = {0, 0, 480, 270},
            },
        },
...
int main(int argc, const char *argv[])
{
    ...
    for (i = 0; i < sizeof(stTest002)/sizeof(stTest002[0]); i++)
    {
        ...
        for (j = 0; j < 4; j++)
        {
            ...
            {
                sprintf(dest_file, "%s/port%d_%s", pbaseDir, j, stTest002[i].stOutPort[j].outputFile);
    ...
    for (i = 0; i < sizeof(stTest002)/sizeof(stTest002[0]); i++)
    {
        for (j = 0; j < 4; j++)
        {
            if (stTest002[i].stOutPort[j].bEnable == TRUE)
            {
                test_vpe_CreatChannel(i, j, &stTest002[i].stCropWin, &stTest002[i].stOutPort[j].stPortWin,E_MI_SYS_PIXEL_FRAME_YUV_SEMIPLANAR_420,E_MI_SYS_PIXEL_FRAME_YUV422_YUYV);
