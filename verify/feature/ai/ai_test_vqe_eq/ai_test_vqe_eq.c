...
{
    printf("\n");
    printf("Please enter: feature_ai -c xxx -n yyy -e zzz -g aaa -d bbb\n");
...
int main(int argc, char *argv[])
{
    ...
    MI_AUDIO_HpfFreq_e eHpfFreq = E_MI_AUDIO_HPF_FREQ_80;
    ...
    while ((s32Opt = getopt(argc, argv, "c:n:f:e:g:d:")) != -1)
    {
            switch(s32Opt)
            {
                case 'c':
