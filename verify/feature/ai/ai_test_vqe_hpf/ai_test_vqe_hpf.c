...
{
    printf("\n");
    printf("Please enter: feature_ai -c xxx -n yyy -f zzz -h aaa -d bbb \n");
    printf("xxx: channel number \n");
    printf("yyy: test total frame cnt \n");
    printf("zzz : sample rate of AI device \n");
    printf("aaa:  Cut Frequency of HPF \n");
...
int main(int argc, char *argv[])
{
    ...
    while ((s32Opt = getopt(argc, argv, "c:n:f:h:d:")) != -1)
    {
            switch(s32Opt)
            {
                case 'c':
