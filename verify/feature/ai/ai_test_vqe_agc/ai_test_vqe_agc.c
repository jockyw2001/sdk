...
{
    printf("\n");
    printf("Please enter: feature_ai -c xxx -n yyy -f zzz -g aaa -s bbb -d ccc\n");
    printf("xxx: channel number \n");
    printf("yyy: test total frame cnt \n");
    printf("zzz : sample rate of AI device \n");
    printf("aaa: target gain of agc [-80, 0]\n");
    printf("bbb: noiseflow of agc [-65, -20]\n");
    printf("ccc: AI device ID \n");
}
...
int main(int argc, char *argv[])
{
    ...
    while ((s32Opt = getopt(argc, argv, "c:n:f:g:s:d:")) != -1)
    {
            switch(s32Opt)
            {
                case 'c':
