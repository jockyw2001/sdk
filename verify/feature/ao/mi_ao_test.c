...
static void _mi_ao_test_help()
{
    printf("\n");
    printf("Please enter: feature_ao -i xxx -o yyy -r zzz -d aaa\n");
    printf("xxx: input file path \n");
    printf("yyy: output file path \n");
    printf("zzz: output sample rate \n");
...
int main(int argc, char *argv[])
{
    ...
    while ((s32Opt = getopt(argc, argv, "i:o:r:ve:d:")) != -1)
    {
            switch(s32Opt)
            {
                case 'i':
