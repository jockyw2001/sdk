...
MI_VIF_DevAttr_t DEV_ATTR_DIGITAL_CAM =
{
...
MI_S32 ST_Vif_CreateDev(MI_VIF_DEV VifDev, VIF_AD_WORK_MODE_E e_WorkMode)
{
    ...
    else if (e_WorkMode == SAMPLE_VI_MODE_DIGITAL_CAM_1_1080P_REALTIME)
    {
        memcpy(&stDevAttr, &DEV_ATTR_DIGITAL_CAM, sizeof(MI_VIF_DevAttr_t));
        stDevAttr.eWorkMode = E_MI_VIF_WORK_MODE_RGB_REALTIME;
    }
