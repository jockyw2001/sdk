...
ST_CaseDesc_t g_stVifCaseDesc[] =
{
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 14,
            .szDesc = "AD0-2x1080P Double Edge 2Mux",
            .u32WndNum = 6,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 26,
            .szDesc = "4Chx1080P Video Capture, 5xH26X VENC + 4x1080P H264 VDEC",
            .u32WndNum = 4,
            .bNeedVdisp = TRUE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 27,
            .szDesc = "4Chx1080P Video Capture, 5xH26X VENC",
            .u32WndNum = 4,
            .bNeedVdisp = TRUE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
...
#define DISK0_PATH_PREFIX "/home/"
#define DISK1_PATH_PREFIX "/tmp/"
...
void *ST_VencGetEsBufferProc(void *args)
{
    ...
    while (1)
    {
        ...
        if(MI_SUCCESS == (s32Ret = MI_SYS_ChnOutputPortGetBuf(&stVencChnInputPort, &stBufInfo, &hHandle)))
        {
            ...
            if (pArgs->stVencAttr[0].eType == E_MI_VENC_MODTYPE_H264E)
            {
                u8NaluCode = stStream.pstPack[0].stDataType.eH264EType;
                if(u8NaluCode != E_MI_VENC_H264E_NALU_SPS && u8NaluCode != E_MI_VENC_H264E_NALU_PSLICE)
                {
                    ST_WARN("Invalid type ch%d %d %X\n", pArgs->stVencAttr[0].vencChn, u8NaluCode, u8NaluCode);
                }
            ...
            {
                u8NaluCode = stStream.pstPack[0].stDataType.eH265EType;
...
MI_S32 ST_VifToDisp(MI_S32 s32CaseIndex)
{
    ...
    *************************************************/
    ...
    for (i = 0; i < s32CapChnNum; i++)
    {
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_CHN)
        {
            ...
            //ExecFunc(MI_SYS_SetChnOutputPortDepth(&stVpeChnOutputPort, 0, 30), 0);
    ...
    *************************************************/
    ...
    {
        if (SUPPORT_DIVP_DI && (288 == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight) &&
            (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_CHN))
        {
