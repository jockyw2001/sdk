...
#define MOUSE_DEV_NAME   "/dev/mice"
...
int ST_FBVdecInit(ST_DispoutTiming_e enDispTiming)
{
    ...
    stVdecChnAttr.u32PicWidth   = stVdispOutRect.u16PicW;
    stVdecChnAttr.u32PicHeight  = stVdispOutRect.u16PicH;
    ...
    stDivpChnAttr.stCropRect.u16Width   = stVdispOutRect.u16PicW;
    stDivpChnAttr.stCropRect.u16Height  = stVdispOutRect.u16PicH;
    stDivpChnAttr.u32MaxWidth           = stVdispOutRect.u16PicW;
    stDivpChnAttr.u32MaxHeight          = stVdispOutRect.u16PicH;
    ...
    stOutputPortAttr.u32Width           = stVdispOutRect.u16PicW;
    stOutputPortAttr.u32Height          = stVdispOutRect.u16PicH;
...
MI_S32 main(MI_S32 argc, MI_U8 **argv)
{
    ...
    while (1)
    {
        ...
        switch (ch)
        {
            ...
            case '2':
            {
                enDispTimingCur = E_ST_TIMING_3840x2160_30;
            }
            break;
        }
