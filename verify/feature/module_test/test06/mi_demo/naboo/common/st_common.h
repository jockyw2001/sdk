...
{
    E_ST_VIF_CHN = 0x01,
    E_ST_VIF_SUB_CHN = 0x02,
    E_ST_VDEC_CHN = 0x04,
    E_ST_VIF_VENC_CHN = 0x08,
    E_ST_VIF_RGN_CHN = 0x10,
    E_ST_VDEC_RGN_CHN = 0x20,
    E_ST_VDF_CHN = 0x40,
    E_ST_VDISP_CHN = 0x80,
    E_ST_CHN_TYPE_MAX,
} ST_VideoChnType_e;
...
typedef struct
{
    ...
    // sub size is 2/w, h/2
    MI_S32 s32FrmRateSub;         // sub frame rate
    MI_VENC_ModType_e eSubType;    // sub encode type
