...
MI_S32 ST_Disp_DevInit(MI_DISP_DEV dispDev, MI_DISP_LAYER DispLayer, MI_DISP_OutputTiming_e eTiming)
{
    ...
    switch (eTiming)
    {
        ...
        case E_MI_DISP_OUTPUT_2560x1440_30:
            stDispDevInfo.stLayerAttr.stVidLayerSize.u16Width = 2560;
            stDispDevInfo.stLayerAttr.stVidLayerSize.u16Height = 1440;
            stDispDevInfo.stLayerAttr.stVidLayerDispWin.u16X = 0;
            stDispDevInfo.stLayerAttr.stVidLayerDispWin.u16Y = 0;
            stDispDevInfo.stLayerAttr.stVidLayerDispWin.u16Width = 2560;
            stDispDevInfo.stLayerAttr.stVidLayerDispWin.u16Height = 1440;
            break;
