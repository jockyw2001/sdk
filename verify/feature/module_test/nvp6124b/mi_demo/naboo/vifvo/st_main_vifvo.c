...
#define FR_VPE  15
#define FR_VENC 13
#define VENC_GET_STREAM_WRITE (1)
...
#define SUB_VENC_W 704
#define SUB_VENC_H 576
...
{
    {
        ...
        {
            .u32CaseIndex = 0,
            .szDesc = "(8X)-1080P(Main+Sub) Video Capture 8xPreview",
            .u32WndNum = 8,
            .u32VifNum = 8,
            .bNeedVdisp = TRUE,
        },
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 1,
            .szDesc = "(1+7) 1080P(Main+Sub) Video Capture 8xPreview",
            .u32WndNum = 8,
            .u32VifNum = 8,
            .bNeedVdisp = TRUE,
        },
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 2,
            .szDesc = "(1X Window) 1080P(Main+Sub) Video Capture 8xPreview",
            .u32WndNum = 8,
            .u32VifNum = 8,
            .bNeedVdisp = TRUE,
        },
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 3,
            .szDesc = "(8X Vdec Disp) + (8X)1080P(Main+Sub) Video Capture && Venc",
            .u32WndNum = 8,
            .u32VifNum = 8,
            .bNeedVdisp = TRUE,
        },
        ...
        {
            {
                .eVideoChnType = E_ST_VIF_CHN | E_ST_VIF_SUB_CHN| E_ST_VDEC_CHN,
                .uChnArg =
                {
                    .stVifChnArg =
                    {
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 4,
            .szDesc = "(8X)-1080P, Main-1080P H265, Sub-D1 H264",
            .u32WndNum = 8,
            .u32VifNum = 8,
            .bNeedVdisp = TRUE,
        },
        ...
        {
            {
                ...
                .uChnArg =
                {
                    .stVifChnArg =
                    {
                        ...
                        .s32FrmRateSub = E_MI_VIF_FRAMERATE_FULL,
                        .eSubType = E_MI_VENC_MODTYPE_H264E,
                    },
                    .stVdecChnArg =
                    {
                        .u32Chn = 0,
...
void *ST_VencGetEsBufferProc(void *args)
{
    ...
    while (1)
    {
        ...
        if (MI_SUCCESS == s32Ret)
        {
            ...
            ///@bug the following log would be observed. The more channels allocated the more lines are seen.
            ///[MI ERR ]: mi_sys_alloc_chunk[278]: fail
            ///[MI ERR ]: mi_sys_mma_allocator_alloc[249]:  fail
...
MI_S32 ST_CreateVencChannel(MI_S32 s32VencChn, MI_S32 s32VencType, MI_U16 u16Width, MI_U16 u16Height, MI_S32 s32FrameRate)
{
    ...
    s32Ret = MI_SYS_SetChnOutputPortDepth(&stVencChnOutputPort, 8, 8);
    if (MI_SUCCESS != s32Ret)
    {
...
MI_S32 ST_VifToDisp(MI_S32 s32CaseIndex)
{
    ...
    ST_Rect_t stDispWndRect1080P[16] = {0};
    MI_S32 s32AdId[4];
    ...
    s32CapChnNum = pstCaseDesc[s32CaseIndex].stDesc.u32VifNum;
    ...
    switch (s32CaseIndex)
    {
        ...
        case 4:
        {
            for (i = 0; i < u32WndNum; i++)
            {
                ...
                stDispWndRect1080P[i].s32X    = ALIGN_BACK((1920 / u32Square) * (i % u32Square), 2);
                stDispWndRect1080P[i].s32Y    = ALIGN_BACK((1080 / u32Square) * (i / u32Square), 2);
                stDispWndRect1080P[i].u16PicW = ALIGN_BACK((1920 / u32Square), 2);
                stDispWndRect1080P[i].u16PicH = ALIGN_BACK((1080 / u32Square), 2);
            }
            break;
        }
        case 1:
    ...
    for (i = 0; i < s32CapChnNum; i++) //init vif channel
    {
        ...
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_SUB_CHN)
        {
            ...
            stVifPortInfoInfo.u32RectWidth =
                pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapWidth / 2;
            stVifPortInfoInfo.u32RectHeight =
                pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight / 2;
            stVifPortInfoInfo.u32DestWidth =
                pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapWidth / 2;
            stVifPortInfoInfo.u32DestHeight =
                pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight / 2;
            stVifPortInfoInfo.u32FrameRate = pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.s32FrmRateSub;

            STCHECKRESULT(ST_Vif_CreatePort(stVifChnCfg[i].u8ViChn, 1, &stVifPortInfoInfo));
            ST_DBG("============vif channel(%d) port(1) x(%d)-y(%d)-w(%d)-h(%d)..\n", i, stVifPortInfoInfo.u32RectX,
                stVifPortInfoInfo.u32RectY, stVifPortInfoInfo.u32RectWidth, stVifPortInfoInfo.u32RectHeight);
        }
#endif
    ...
    *************************************************/
    ...
    MI_DIVP_CHN divpChn = 0;
    MI_U32 u32SubWidth = SUB_VENC_W, u32SubHeight = SUB_VENC_H;
    ...
    for (i = 0; i < s32DispChnNum; i++)
    {
        ...
        stVpeChannelInfo.u16VpeCropW = pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapWidth / 2;
        if (SUPPORT_DIVP_DI && (288 == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight))
        {
            u16VpeInHeight = pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16CapHeight * 2  / 2;
        }
        else
        {
        ...
        ExecFunc(MI_SYS_SetChnOutputPortDepth(&stVpeChnOutputPort, 1, 8), 0);
        ...
        stVpeChnOutputPort.u32DevId = 0;
        stVpeChnOutputPort.u32ChnId = vpeChn;
        stVpeChnOutputPort.u32PortId = MAIN_VENC_PORT;
        ExecFunc(MI_SYS_SetChnOutputPortDepth(&stVpeChnOutputPort, 1, 8), 0);
        ...
        if (E_MI_VENC_MODTYPE_H264E == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.eType)
        {
            stPortInfo.u16OutputWidth = ALIGN_N(SUB_VENC_W, VENC_H264_ALIGN_W);
            stPortInfo.u16OutputHeight = ALIGN_N(SUB_VENC_H, VENC_H264_ALIGN_H);
        }
        else if (E_MI_VENC_MODTYPE_H265E == pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.eType)
        {
            stPortInfo.u16OutputWidth = ALIGN_N(SUB_VENC_W, VENC_H265_ALIGN_W);
            stPortInfo.u16OutputHeight = ALIGN_N(SUB_VENC_H, VENC_H265_ALIGN_H);
        }
        else
        {
            stPortInfo.u16OutputWidth = ALIGN_N(SUB_VENC_W, 32);
            stPortInfo.u16OutputHeight = ALIGN_N(SUB_VENC_H, 32);
        }

        STCHECKRESULT(ST_Vpe_CreatePort(SUB_VENC_PORT, &stPortInfo)); //default support port2 --->>> venc
        ...
        ExecFunc(MI_SYS_SetChnOutputPortDepth(&stVpeChnOutputPort, 1, 8), 0);
        if (((1 == s32CaseIndex) || (2 == s32CaseIndex)) && (0 == i))
        {
            stPortInfo.ePixelFormat = E_MI_SYS_PIXEL_FRAME_YUV_MST_420;//E_MI_SYS_PIXEL_FRAME_YUV422_YUYV;
            stPortInfo.u16OutputWidth = stDispWndRect[i].u16PicW;
            stPortInfo.u16OutputHeight = stDispWndRect[i].u16PicH;
        ...
        {
            stPortInfo.ePixelFormat = E_MI_SYS_PIXEL_FRAME_YUV_SEMIPLANAR_420;//E_MI_SYS_PIXEL_FRAME_YUV422_YUYV;
            stPortInfo.u16OutputWidth = stDispWndRect1080P[i].u16PicW;
            stPortInfo.u16OutputHeight = stDispWndRect1080P[i].u16PicH;
            ...
            stVpeChnOutputPort.u32DevId = 0;
            stVpeChnOutputPort.u32ChnId = vpeChn;
            stVpeChnOutputPort.u32PortId = VDISP_PORT;
            ExecFunc(MI_SYS_SetChnOutputPortDepth(&stVpeChnOutputPort, 1, 8), 0);
        }
    ...
    *************************************************/
    ...
    if (pstCaseDesc[s32CaseIndex].stDesc.bNeedVdisp)
    {
        ...
        {
            vdispPort = i;
            stRect.s32X     = ALIGN_BACK(stDispWndRect1080P[i].s32X, 16);
            stRect.s32Y     = ALIGN_BACK(stDispWndRect1080P[i].s32Y, 2);
            stRect.u16PicW  = ALIGN_BACK(stDispWndRect1080P[i].u16PicW, 16);
            stRect.u16PicH  = ALIGN_BACK(stDispWndRect1080P[i].u16PicH, 2);
    ...
    {
        {
            ...
            //if (s32CapChnNum == 1)
            //    stBindInfo.stSrcChnPort.u32ChnId = stVifChnCfg[0].u8ViChn;
            //else
                stBindInfo.stSrcChnPort.u32ChnId = stVifChnCfg[i].u8ViChn;
            ...
            stBindInfo.u32SrcFrmrate = FR_VIF;
            stBindInfo.u32DstFrmrate = FR_VPE;
            STCHECKRESULT(ST_Sys_Bind(&stBindInfo));
        }
        //preview
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_SUB_CHN)
        {
            ...
            //else
                stBindInfo.stSrcChnPort.u32ChnId = stVifChnCfg[i].u8ViChn;
            stBindInfo.stSrcChnPort.u32PortId = 1; //Sub stream
    ...
    *************************************************/
    if (bVdecFlag == 0)
    {
        for (i = 0; i < s32DispChnNum; i++)
        {
            ...
            stBindInfo.stSrcChnPort.u32ChnId = i;
            stBindInfo.stSrcChnPort.u32PortId = DISP_PORT;
            if (((1 == s32CaseIndex) || (2 == s32CaseIndex)) && (0 == i)) //case 2 == 1xWindow disp
            {
                stBindInfo.stSrcChnPort.u32ChnId = i + VPE_SUB_CHN_START;
            }
            if ((2 == s32CaseIndex) && (i > 0))
            {
                continue;
            }
            stBindInfo.stDstChnPort.eModId = E_MI_MODULE_ID_DISP;
    ...
    for (i = 0; i < u32VencNum; i++)
    {
        ...
        stBindInfo.u32SrcFrmrate = FR_VPE;
        stBindInfo.u32DstFrmrate = FR_VENC;
        if (((1 == s32CaseIndex) || ((2 == s32CaseIndex))) && (0 == i))
        {
    ...
    for (i = 0; i < s32CapChnNum; i++) //init vif channel
    {
        ...
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VIF_SUB_CHN)
        {
            STCHECKRESULT(ST_Vif_StartPort(stVifChnCfg[i].u8ViChn, 1));
        }
    }
