...
int vif_dev_clkmode_config()
{
    /* RIU mapping*/
    MmapHandle* riu_base = devMemMMap(0x1F000000, 0x2B0000);
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x02) = 0x9550;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x03) = 0x00A2;
...
int vif_i2c_init()
{
    ...
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x0)  |= 0x00;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x06) |= 0x05;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1033, 0x30) |= 0x444;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x2B) |= 0xFFF0;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x37) |= 0xFF00;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1033, 0x30) |= 0x444;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x02) |= 0x8D50;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x03) |= 0x0061;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x28) |= 0x3FFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x2E) |= 0x3FFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x34) |= 0x3FFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1026, 0x3A) |= 0x3FFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1135, 0x09) |= 0xFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1135, 0x0A) |= 0xFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1134, 0x09) |= 0xFF;
    *(unsigned short*)REG_ADDR(riu_base->virt_addr, 0x1134, 0x0A) |= 0xFF;
