...
int vif_dh9931_Init(int VifDev , int channel, int pclk, int edge)
{
    ...
    else if(pid == 0)
    {
        ...
        if (VifDev == 0)
        {
            vif_i2c_write(0x60 + 2 * VifDev, 0x0802, 0x34, I2C_FMT_A16D8);
        }
        else if (VifDev == 1)
        {
            vif_i2c_write(0x60 + 2 * VifDev, 0x0802, 0x28, I2C_FMT_A16D8);
        }
        else if (VifDev == 2)
        {
            vif_i2c_write(0x60 + 2 * VifDev, 0x0802, 0x32, I2C_FMT_A16D8);
            //0x16~0x29 is ok, get middle value 0x23
        }
        else
            vif_i2c_write(0x60 + 2 * VifDev, 0x0802, 0x36, I2C_FMT_A16D8);
