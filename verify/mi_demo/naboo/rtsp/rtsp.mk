...
LIBS +=  -ladda -lmi_divp -lmi_vdisp -lmi_vif -lmi_vpe -lmi_venc -lmi_disp -lmi_hdmi -lliveMedia -lgroupsock -lBasicUsageEnvironment -lUsageEnvironment

SUBDIRS += ./rtsp/src

ST_DEP := common hdmi disp vpe vif vdisp fb mess warp tem