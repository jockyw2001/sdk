...
#define OD_START_PORT 8
    ...
    #define RGN_OSD_START       32
    #define RGN_OSD_WIDTH       200
    #define RGN_OSD_HEIGHT      200
    #define RGN_OSD_LOAD_FILE   0
    #define RGN_OSD_MAX_NUM     32
    #define SUPPORT_RGN_OSD_TIME    1
#endif
...
RGN_Thread_Args_t g_stRgnThreadArgs[RGN_OSD_MAX_NUM];
pthread_t g_updateosdpt;
MI_BOOL g_updateOsdFlag = FALSE;
...
ST_CaseDesc_t g_stVifCaseDesc[] =
{
    ...
    },
    {
        ...
        .stSubDesc =
        {
            ...
            {
                .u32CaseIndex = 2,
                .szDesc = "split 1 channel",
                .u32WndNum = 1,
            },
            {
                .u32CaseIndex = 3,
                .szDesc = "split 4 channel",
                .u32WndNum = 4,
            },
            {
                .u32CaseIndex = 4,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 5,
            .szDesc = "4ChxD1-AD0~3 Video Capture + VdispVenc",
            .u32WndNum = 4,
            .bNeedVdisp = FALSE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 11,
            .szDesc = "AD0-2x720P Double Edge Video Capture",
            .u32WndNum = 2,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 12,
            .szDesc = "AD0-2x720P 2Mux SingleUp Video Capture",
            .u32WndNum = 8,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 13,
            .szDesc = "AD0-AD3 16xD1 1Mux Video Capture",
            .u32WndNum = 16,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 14,
            .szDesc = "8x1080P 15Fps Double Edge 2Mux + VdispVenc",
            .u32WndNum = 8,
            .bNeedVdisp = FALSE,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        ...
        {
            {
                ...
                .uChnArg =
                {
                    .stVifChnArg =
                    {
                        ...
                        .u16CapWidth = 1920,
                        .u16CapHeight = 1080,
                        .s32FrmRate = E_MI_VIF_FRAMERATE_HALF,
                        .eType = E_MI_VENC_MODTYPE_H265E,
                    }
                }
            },
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 16,
            .szDesc = "AD0-1x1080P Video Capture 1xPreview+6xH264",
            .u32WndNum = 1,
            .u32VencNum = 6,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 17,
            .szDesc = "AD0-1x1080P Video Capture 1xPreview+6xH265",
            .u32WndNum = 1,
            .u32VencNum = 6,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 18,
            .szDesc = "AD0-1x1080P Video Capture 1xPreview+3xH264+3xH265",
            .u32WndNum = 1,
            .u32VencNum = 6,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 20,
            .szDesc = "AD0-1x4K15 Video Capture",
            .u32WndNum = 1,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 21,
            .szDesc = "AD0-2x1080P 1120 double Video Capture",
            .u32WndNum = 1,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 22,
            .szDesc = "Homologous output AD0-2x1080P Double Edge 2Mux",
            .u32WndNum = 6,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 23,
            .szDesc = "4Chx1080P Video Capture, 4xH264 VENC + 4x1080P H264 VDEC",
            .u32WndNum = 4,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
        ...
        {
            {
                .eVideoChnType = E_ST_VIF_CHN | E_ST_VDEC_CHN,
                .uChnArg =
                {
                    .stVifChnArg =
                    {
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 24,
            .szDesc = "AD0-1x1080P Video Capture 1xPreview + 1xVDF",
            .u32WndNum = 1,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 9,
        ...
        {
            {
                .eVideoChnType = E_ST_VIF_CHN | E_ST_VDF_CHN,
                .uChnArg =
                {
                    .stVifChnArg =
                    {
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 25,
            .szDesc = "4Chx1080P Video Capture + VDF",
            .u32WndNum = 4,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
    ...
    },
    {
        ...
        {
            .u32CaseIndex = 26,
            .szDesc = "AD0-8x1080P Double Edge 2Mux + VDF",
            .u32WndNum = 8,
        },
        .eDispoutTiming = E_ST_TIMING_1080P_60,
        .u32SubCaseNum = 3,
            ...
            if (stTestInfo.stChnInfo[i].s32VideoFormat != ad_status.iVideoFormat)
            {
                switch (ad_status.iVideoFormat)
                {
                    ...
                    case AD_VIDEO_IN_HD_1080P_30HZ:
                        ...
                        stPortInfo.s32FrameRate = E_MI_VIF_FRAMERATE_FULL;
                        stPortInfo.ePixFormat = E_MI_SYS_PIXEL_FRAME_YUV_SEMIPLANAR_420;
...
void *ST_UpdateOsdProc(void *args)
{
    ...
    maxWidth = 0;
    maxHeight = 0;
    for (i = 0; i < RGN_OSD_MAX_NUM; i ++)
    {
        if (g_stRgnThreadArgs[i].hHandle == MI_RGN_HANDLE_NULL)
        {
            continue;
        }

        s32Ret = MI_RGN_GetCanvasInfo(g_stRgnThreadArgs[i].hHandle, &g_stRgnThreadArgs[i].stCanvasInfo);
        if (MI_RGN_OK != s32Ret)
        {
            ST_ERR("MI_RGN_GetCanvasInfo error, %X, handle:%d\n", s32Ret, g_stRgnThreadArgs[i].hHandle);
        }

        maxWidth = MAX(maxWidth, g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Width);
        maxHeight = MAX(maxHeight, g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Height);
    }
    ...
    while (g_updateOsdFlag)
    {
        ...
        if (0 == select(0, NULL, NULL, NULL, &tv))
        {
            ...
            for (i = 0; i < RGN_OSD_MAX_NUM; i ++)
            {
                ...
                //
                minWidth = MIN(stBitMapData.width, g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Width);
                minHeight = MIN(stBitMapData.height, g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Height);

#if 0
                ST_DBG("minWidth:%d,minHeight:%d, %dx%d, %dx%d\n", minWidth, minHeight,
                    stBitMapData.width, stBitMapData.height,
                    g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Width, g_stRgnThreadArgs[i].stCanvasInfo.stSize.u32Height);
#endif
                for (j = 0; j < minHeight; j ++)
                {
                    memcpy((MI_U8 *)(g_stRgnThreadArgs[i].stCanvasInfo.virtAddr + j * g_stRgnThreadArgs[i].stCanvasInfo.u32Stride),
                        stBitMapData.pBuf + j * stBitMapData.width * 2, stBitMapData.width * 2);
                }

                s32Ret = MI_RGN_UpdateCanvas(g_stRgnThreadArgs[i].hHandle);
                if (MI_RGN_OK != s32Ret)
                {
...
void *ST_VencGetEsBufferProc(void *args)
{
    ...
    while (pArgs->bRunFlag)
    {
        ...
        MI_VENC_CloseFd(pArgs->stVencAttr[0].vencChn);

        printf("get es thread exit, venc:%d\n", pArgs->stVencAttr[0].vencChn);
    ...
    MI_S32 ST_SubExit()
    {
        ...
        *************************************************/
...
#if SUPPORT_RGN_OSD_TIME
        g_updateOsdFlag = FALSE;
        // wait thread exit
        sleep(1);
#endif
        ...
        for (i = 0; i < u32ShowWndNum; i++)
        {
            ...
            s32Ret = MI_RGN_DetachFromChn(hHandle, &stChnPort);
            if (MI_RGN_OK != s32Ret)
            {
...
#if USE_DISP_VGA
    STCHECKRESULT(ST_Disp_DeInit(ST_DISP_DEV1, ST_DISP_LAYER1, u32CurWndNum));
#endif
    ...
    for (i = 0; i < u32CurWndNum; i++)
    {
        ...
        ExecFunc(MI_DISP_GetInputPortAttr(ST_DISP_LAYER0, i, &stInputPortAttr), MI_SUCCESS);
        stInputPortAttr.stDispWin.u16X      = ALIGN_BACK((u16CurDispWidth / u32Square) * (i % u32Square), 2);
        stInputPortAttr.stDispWin.u16Y      = ALIGN_BACK((u16CurDispHeight / u32Square) * (i / u32Square), 2);
        stInputPortAttr.stDispWin.u16Width  = ALIGN_BACK(u16CurDispWidth / u32Square, 2);
        stInputPortAttr.stDispWin.u16Height = ALIGN_BACK(u16CurDispHeight / u32Square, 2);
...
MI_S32 ST_CreateVencChannel(MI_S32 s32VencChn, MI_S32 s32VencType, MI_U16 u16Width, MI_U16 u16Height, MI_S32 s32FrameRate)
{
    ...
    s32Ret = MI_SYS_SetChnOutputPortDepth(&stVencChnOutputPort, 35, 38);
    if (MI_SUCCESS != s32Ret)
    {
...
MI_S32 ST_VifToDisp(MI_S32 s32CaseIndex)
{
    ...
    else if (888 == u32WndNum) //irrgular split
    {
    ...
    *************************************************/
    ...
    for (i = 0; i < RGN_OSD_MAX_NUM; i ++)
    {
        g_stRgnThreadArgs[i].hHandle = MI_RGN_HANDLE_NULL;
        memset(&g_stRgnThreadArgs[i].stCanvasInfo, 0, sizeof(MI_RGN_CanvasInfo_t));
    }
    ...
    */
    switch (s32CaseIndex)
    {
        ...
        case 24:
            ...
            stTestInfo.stChnInfo[0].s32VideoFormat = AD_VIDEO_IN_HD_1080P_25HZ;
            break;
        case 1:
            g_s32AdId[1] = 1;
            stVifChnCfg[0].u8ViDev = 0;
        ...
        case 15: //960H NTSC *4
            for (i = 0; i < 4; i++)
            {
                g_s32AdId[i] = 1;//AD0 -4XD1
                stVifChnCfg[i].u8ViDev = 0;
                stVifChnCfg[i].u8ViChn = 4 * i;
            }
        ...
        case 6:
            ...
            s32AdWorkMode = SAMPLE_VI_MODE_1_D1;
            break;
        case 7://1xMode 1*720P
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            s32AdWorkMode = SAMPLE_VI_MODE_1_720P;
            stTestInfo.stChnInfo[0].s32VideoFormat = AD_VIDEO_IN_HD_720P_25HZ;
            break;
        case 8://2xMode 2*720P
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            stVifChnCfg[1].u8ViDev = 0;
            stVifChnCfg[1].u8ViChn = 2;
            s32AdWorkMode = SAMPLE_VI_MODE_2_720P;
            break;
        case 9:
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            ...
            stVifChnCfg[1].u8ViDev = 0;
            stVifChnCfg[1].u8ViChn = 2;
            s32AdWorkMode = SAMPLE_VI_MODE_2_D1;
            break;
        case 11://2xMode Double 2*720P
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            stVifChnCfg[1].u8ViDev = 0;
            stVifChnCfg[1].u8ViChn = 2;
            s32AdWorkMode = SAMPLE_VI_MODE_2X_DOUBLE_720P;
            break;
        case 12://2xMode Singleup 8*720P
            for (i = 0; i < 4; i++)
            {
                g_s32AdId[i] = 1;
            }
        ...
        case 19:
            ...
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            s32AdWorkMode = SAMPLE_VI_MODE_2X_DOUBLE_4M;
            break;
        case 20:
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            s32AdWorkMode = SAMPLE_VI_MODE_2X_DOUBLE_4K15;
            break;
        case 21:
            g_s32AdId[0] = 1;
            stVifChnCfg[0].u8ViDev = 0;
            stVifChnCfg[0].u8ViChn = 0;
            s32AdWorkMode = SAMPLE_VI_MODE_1120_2X_DOUBLE_1080P;
            break;
        default:
    ...
    for (i = 0; i < s32CapChnNum; i++) //init vif channel
    {
        ...
        stVifPortInfoInfo.s32FrameRate = pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.s32FrmRate;
        ...
        stVifPortInfoInfo.ePixFormat = E_MI_SYS_PIXEL_FRAME_YUV_SEMIPLANAR_420;
    ...
    *************************************************/
    ...
    for (i = 0; i < s32CapChnNum; i++)
    {
        ...
        stVpeChannelInfo.eFormat = E_MI_SYS_PIXEL_FRAME_YUV422_YUYV;
        stVpeChannelInfo.eRunningMode = E_MI_VPE_RUNNING_MODE_FRAMEBUF_DVR_MODE;
...
#ifdef SUPPORT_VIDEO_PREVIEW
        stPortInfo.ePixelFormat = E_MI_SYS_PIXEL_FRAME_YUV_MST_420;//E_MI_SYS_PIXEL_FRAME_YUV422_YUYV;
        ...
        if (pstCaseDesc[s32CaseIndex].stDesc.bNeedVdisp)
        {
            ...
            ST_DBG("vpe %d:%d for vdisp, width:%d,height:%d\n",  stPortInfo.DepVpeChannel, VDISP_PORT,
                   stPortInfo.u16OutputWidth,
                   stPortInfo.u16OutputHeight);
            STCHECKRESULT(ST_Vpe_CreatePort(VDISP_PORT, &stPortInfo)); //default support port0 --->>> vdisp
        }
    ...
    *************************************************/
    ...
    {
#if USE_DISP_VGA
        printf("Homologous output not support layer1 bind dev1\n");
#endif
        STCHECKRESULT(ST_Disp_DevInit(ST_DISP_DEV0, ST_DISP_LAYER1, eDispoutTiming)); //Dispout timing
        MI_DISP_PubAttr_t stPubAttr1;
        memset(&stPubAttr1, 0, sizeof(stPubAttr1));
        stPubAttr1.u32BgColor = YUYV_BLACK;
        stPubAttr1.eIntfSync = eDispoutTiming;
        stPubAttr1.eIntfType = E_MI_DISP_INTF_VGA;
        ExecFunc(MI_DISP_SetPubAttr(ST_DISP_DEV1, &stPubAttr1), MI_SUCCESS);
        ...
        stDispChnInfo1.InputPortNum = 1;

        stDispChnInfo1.stInputPortAttr[0].u32Port = 0;
        stDispChnInfo1.stInputPortAttr[0].stAttr.stDispWin.u16X = 700;
        stDispChnInfo1.stInputPortAttr[0].stAttr.stDispWin.u16Y = 200;
        stDispChnInfo1.stInputPortAttr[0].stAttr.stDispWin.u16Width = stDispWndRect[5].u16PicW;
        stDispChnInfo1.stInputPortAttr[0].stAttr.stDispWin.u16Height = stDispWndRect[5].u16PicH;

        STCHECKRESULT(ST_Disp_ChnInit(ST_DISP_DEV1, &stDispChnInfo1));
    }
    ...
    for (i = 0; i < s32CapChnNum; i++)
    {
        if (pstCaseDesc[s32CaseIndex].stCaseArgs[i].eVideoChnType & E_ST_VDF_CHN)
        {
            ...
            for (j = 0; j < pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16MdNum; j ++)
            {
                ...
                stVdfAttr.unAttr.stMdAttr.u8MdBufCnt  = 4;
            ...
            for (j = 0; j < pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.u16OdNum; j ++)
            {
                ...
                stVdfAttr.unAttr.stOdAttr.u8OdBufCnt  = 4;
                stVdfAttr.unAttr.stOdAttr.u8VDFIntvl  = 0;
                ...
                stVdfAttr.unAttr.stOdAttr.stOdStaticParamsIn.roi_od.pnt[1].x =
                    pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.stOdArea[j].s32X +
                    pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.stOdArea[j].u16PicW - 1;//g_width - 1;
                ...
                stVdfAttr.unAttr.stOdAttr.stOdStaticParamsIn.roi_od.pnt[2].y =
                    ...
                    pstCaseDesc[s32CaseIndex].stCaseArgs[i].uChnArg.stVifChnArg.stOdArea[j].u16PicH - 1;//g_height - 1;
    ...
    *************************************************/
    ...
    fd = open("osd.bmp", O_RDONLY);
    fstat(fd, &st);
    pBitMapAddr = (unsigned char *)mmap(NULL, (size_t)st.st_size,
    ...
    for (i = 0; i < s32DispChnNum; i ++)
    {
        ...
        if (MI_RGN_OK != s32Ret)
        {
            ST_ERR("MI_RGN_GetCanvasInfo error, %X\n", s32Ret);
            return 1;
        }

        for (dd = 0; dd < RGN_OSD_HEIGHT; dd ++)
        {
            memcpy((MI_U8 *)(stCanvasInfo.virtAddr + dd * stCanvasInfo.u32Stride),
                pBitMapAddr + dd * RGN_OSD_WIDTH * 2, RGN_OSD_WIDTH * 2);
        }

        s32Ret = MI_RGN_UpdateCanvas(hHandle);
        if (MI_RGN_OK != s32Ret)
        {
            ST_ERR("MI_RGN_UpdateCanvas error, %X\n", s32Ret);
            return 1;
        }
#endif
        stChnPort.eModId = E_MI_RGN_MODID_VPE;
        ...
        memset(&stChnPortParam, 0, sizeof(MI_RGN_ChnPortParam_t));
        stChnPortParam.bShow = TRUE;
        stChnPortParam.stPoint.u32X = stDispWndRect[i].u16PicW - RGN_OSD_WIDTH - 10;
        ...
        g_stRgnThreadArgs[i].hHandle = hHandle;
#endif
...
#if RGN_OSD_LOAD_FILE
    if (pBitMapAddr)
        munmap(pBitMapAddr, (size_t)st.st_size);
...
#if SUPPORT_RGN_OSD_TIME
    g_updateOsdFlag = TRUE;
    pthread_create(&g_updateosdpt, NULL, ST_UpdateOsdProc, NULL);
#endif
    ...
    *************************************************/
    ...
    if(s32CaseIndex == 22)
    {
        stBindInfo.stSrcChnPort.eModId = E_MI_MODULE_ID_VPE;
        stBindInfo.stSrcChnPort.u32DevId = 0;
        stBindInfo.stSrcChnPort.u32ChnId = 5;
        stBindInfo.stSrcChnPort.u32PortId = DISP_PORT;
        stBindInfo.stDstChnPort.eModId = E_MI_MODULE_ID_DISP;
        stBindInfo.stDstChnPort.u32DevId = 0;
