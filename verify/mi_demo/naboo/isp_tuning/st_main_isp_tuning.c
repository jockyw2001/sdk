...
#ifdef SUPPORT_CDNN
static MI_S32 UVC_EnableCeva(ST_CEVA_CDNN_PortInfo_t *pstCvPortInfo, ST_CEVA_CDNN_ResolutionMap_t *pstCvMap)
{
    ...
    STCHECKRESULT(ST_CEVA_CDNN_Init());
    STCHECKRESULT(ST_CEVA_CDNN_RegisterChn(pstCvPortInfo, pstCvMap));
    STCHECKRESULT(ST_CEVA_CDNN_Start());
    return MI_SUCCESS;
}
static MI_S32 UVC_DisableCeva(void)
{
    ...
    STCHECKRESULT(ST_CEVA_CDNN_Stop());
    STCHECKRESULT(ST_CEVA_CDNN_UnRegisterChn(stChnPort));
    STCHECKRESULT(ST_CEVA_CDNN_Deinit());
...
{
    ST_VPE_PortInfo_t stPortInfo;
    ST_CEVA_CDNN_PortInfo_t stCvPortInfo;
