...
typedef enum {
    UVC_CONTROL_SELECTOR = 1,
    UVC_STREAMING_SELECTOR,
} Selector_Type_e;

typedef struct UVC_Control_s {
    Selector_Type_e stype;
...
static const struct uvc_frame_info uvc_frames_mjpeg[] = {
    ...
    { 3840,2160, { 333333,  400000, 1000000, 0 }, },
    { 0, 0, { 0, }, },
};
...
typedef struct ST_UVC_USERPTR_BufOpts_s {
    MI_S32  (* UVC_DevFillBuffer)(void *uvc,ST_UVC_BufInfo_t *bufInfo,int *handle);
    MI_S32  (* UVC_FinishBuffer)   (int handle);
} ST_UVC_USERPTR_BufOpts_t;

typedef struct ST_UVC_MMAP_BufOpts_s {
    MI_S32  (* UVC_DevFillBuffer)(void *uvc,ST_UVC_BufInfo_t *bufInfo);
