...
//
////////////////////////////////////////////////////////////////////////////////
#ifndef _MI_RGN_INTERNAL_H_
#define _MI_RGN_INTERNAL_H_
...
typedef enum
{
    E_MI_RGN_VPE_PORT0 = 0,
    E_MI_RGN_VPE_PORT1,
    E_MI_RGN_VPE_PORT2,
    E_MI_RGN_VPE_PORT3,
    E_MI_RGN_DIVP_PORT0,
    E_MI_RGN_PORT_MAXNUM
}mi_rgn_PortId_e;
...
typedef struct mi_rgn_VpeCmdInfo_s
{
	MI_U32 u32chnID;
	mi_rgn_CmdPortAttr_t stVpePort[MI_RGN_VPE_PORT_MAXNUM];
}mi_rgn_VpeCmdInfo_t;

typedef struct mi_rgn_DivpCmdInfo_s
{
	MI_U32 u32chnID;
	mi_rgn_CmdPortAttr_t stDivpPort[MI_RGN_VPE_PORT_MAXNUM];
}mi_rgn_DivpCmdInfo_t;
