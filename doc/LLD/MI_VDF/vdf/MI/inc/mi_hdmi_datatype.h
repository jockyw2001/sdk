...
typedef enum
{
    ...
    E_MI_HDMI_PICTURE_SCALING_MAX
 } MI_HDMI_PictureScaling_e;

typedef enum
{
    E_MI_HDMI_COLORSPACE_NO_DATA = 0,
    E_MI_HDMI_COLORSPACE_ITU601,
    E_MI_HDMI_COLORSPACE_ITU709,
    E_MI_HDMI_COLORSPACE_EXTENDED,
    E_MI_HDMI_COLORSPACE_XVYCC_601,
    E_MI_HDMI_COLORSPACE_XVYCC_709,
    E_MI_HDMI_COLORSPACE_MAX
...
typedef enum
{
    ...
    E_MI_HDMI_RGB_QUANTIZATION_MAX
