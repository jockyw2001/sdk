...
MI_S32 MI_DISP_GetVideoLayerCompressAttr(MI_DISP_LAYER DispLayer, MI_DISP_CompressAttr_t *pstCompressAttr);
...
MI_S32 MI_DISP_FrameFlip (MI_PHY phyAddr, MI_U32 u32Width, MI_U32 u32Height);
