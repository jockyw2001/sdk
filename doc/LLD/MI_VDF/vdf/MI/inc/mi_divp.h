...
/// @return MI_DIVP_OK: succeed in creating a channel.
...
/// @return MI_DIVP_OK: succeed in deatroying a DIVP channel.
...
/// @param[in] DivpChn: DIVP channel ID.
/// @param[in] pstAttr: Attribute of DIVP channel.
/// @return MI_DIVP_OK: succeed in setting attribute of DIVP channel.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
///             MI_DIVP_ERR_INVALID_PARAM: Invalid input patamter.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
...
/// @param[in] DivpChn: DIVP channel ID.
/// @param[in] pstAttr: Attribute of DIVP channel.
/// @return MI_DIVP_OK: succeed in getting attribute of DIVP channel.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
...
/// @param[in] DivpChn: DIVP channel ID.
/// @return MI_DIVP_OK: succeed in starting a DIVP channel.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
...
/// @param[in] DivpChn: DIVP channel ID.
/// @return MI_DIVP_OK: succeed in stopping a DIVP channel.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
...
/// @return MI_DIVP_OK: succeed in setting attribute of DIVP channel output port.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
///             MI_DIVP_ERR_INVALID_PARAM: Invalid input patamter.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
...
/// @return MI_DIVP_OK: succeed in getting attribute of DIVP channel output port.
...
//------------------------------------------------------------------------------
/// @brief set OSD and cover switch.
/// @param[in] DivpChn: DIVP channel ID.
/// @param[in] pu32OverlayMask: OSD and cover switch.bit 0~15 is OSD switch and bit 16~31
///    is cover switch.
/// @return MI_DIVP_OK: succeed in setting OSD and cover switch.
///             MI_DIVP_ERR_FAILED: Fail to set OSD and cover switch.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
//------------------------------------------------------------------------------
MI_S32 MI_DIVP_SetChnOverlay(MI_DIVP_CHN DivpChn, MI_S32 u32OverlayMask);

//------------------------------------------------------------------------------
/// @brief get OSD and cover switch status.
/// @param[in] DivpChn: DIVP channel ID.
/// @param[out] pu32OverlayMask: OSD and cover switch.bit 0~15 is OSD switch and bit 16~31
///    is cover switch.
/// @return MI_DIVP_OK: succeed in getting OSD and cover switch status.
///             MI_DIVP_ERR_FAILED: Fail to get OSD and cover switch status.
///             MI_DIVP_ERR_INVALID_CHNID: Invalid channel ID.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
//------------------------------------------------------------------------------
MI_S32 MI_DIVP_GetChnOverlay(MI_DIVP_CHN DivpChn, MI_S32* pu32OverlayMask);
