...
MI_S32 MI_SYS_SetChnMMAConf (MI_SYS_ModuleId_e eModId, MI_U8 u32DevId, MI_U32 u32ChnId, MI_U8 *pu8MMAHeapName);

MI_S32 MI_SYS_GetChnMMAConf (MI_SYS_ModuleId_e eModId,  MI_U8 u32DevId, MI_U32 u32ChnId, void  *data, MI_U32 u32Length);

MI_S32 MI_SYS_ChnInputPortGetBuf (MI_SYS_ChnPort_t *pstChnPort ,MI_SYS_BufConf_t *pstBufConf, MI_SYS_BufInfo_t *pstBufInfo , MI_SYS_BUF_HANDLE *bufHandle);
...
MI_S32 MI_SYS_InsertOutputBuftoInputBuf (MI_VB_POOL_HANDLE hPoolHanel , MI_SYS_ChnPort_t *pstChnPort);
...
MI_S32 MI_VB_ConfDevPubPools(MI_SYS_ModuleId_e  eModule, MI_U32 u32DevId, MI_VB_PoolListConf_t  stPoolListConf);

MI_S32 MI_VB_ReleaseDevPubPools(MI_SYS_ModuleId_e  eModule, MI_U32 u32DevId);

MI_S32 MI_VB_ConfGlobalPools(MI_VB_PoolListConf_t  stPoolListConf);

MI_S32 MI_VB_ReleaseGlobalPools(void);

MI_S32 MI_SYS_MMA_Alloc(MI_U8 *pstMMAHeapName, MI_U32 u32BlkSize ,MI_PHY *phyAddr);

MI_S32 MI_SYS_MMA_Free(MI_PHY  phyAddr);
MI_S32 MI_SYS_Mmap(MI_U64 phyAddr, MI_U32 u32Size , void **ppVirtualAddress);

MI_S32 MI_SYS_Munmap(void *pVirtualAddress, MI_U32 u32Size);
MI_S32 MI_SYS_FlushCache(void *pVirtualAddress, MI_U32 u32Length);
