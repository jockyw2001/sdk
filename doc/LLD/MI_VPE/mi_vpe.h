...
{
    MI_SYS_WindowRect_t *pstRegion;            // region attribute
...
MI_S32 MI_VPE_SetPortOverlay(MI_VPE_CHANNEL VpeCh,MI_VPE_PORT VpePort, MI_U32 u32OverlayMask);
MI_S32 MI_VPE_GetPortOverlay(MI_VPE_CHANNEL VpeCh,MI_VPE_PORT VpePort, MI_U32 *pu32OverlayMask);
