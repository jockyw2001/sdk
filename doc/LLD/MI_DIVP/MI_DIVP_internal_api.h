...
/// @return MI_DIVP_OK: succeed in initing DIVP device.
///             MI_DIVP_ERR_FAILED: Fail to init DIVP module.
///             MI_DIVP_ERR_INVALID_DEVID: invalid device ID.
//------------------------------------------------------------------------------
...
/// @param[in] eDevId: DIVP device ID
/// @return MI_DIVP_OK: succeed in DeIniting DIVP module.
...
//------------------------------------------------------------------------------
/// @brief capture a picture at display VOP
/// @param[in] pstCapInfo: cpatured frame infomation.
/// @param[in] pfCallback: call back from display.
/// @return MI_DIVP_OK: succeed in capturing a picture.
///             MI_DIVP_ERR_INVALID_PARAM: invalid input patamter.
///             MI_DIVP_ERR_NULL_PTR: NULL poiter error.
///             MI_DIVP_ERR_FAILED: Fail to capture a picture.
