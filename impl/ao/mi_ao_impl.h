...
#ifndef _MI_AO_IMPL_H_
#define _MI_AO_IMPL_H_
...
MI_S32 _MI_AO_Init(void);
MI_S32 _MI_AO_DeInit(void);
...
//MI_S32 MI_AO_IMPL_SendFrame(MI_AUDIO_DEV AoDevId, MI_AO_CHN AoChn, MI_AUDIO_Frame_t *pstData, MI_S32 s32MilliSec);
...
//MI_S32 MI_AO_IMPL_GetVqeAttr(MI_AUDIO_DEV AoDevId, MI_AO_CHN AoChn, MI_AO_VqeConfig_t *pstVqeConfig);
