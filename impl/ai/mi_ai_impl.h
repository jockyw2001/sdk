...
#ifndef _MI_AI_IMPL_H_
#define _MI_AI_IMPL_H_
...
MI_S32 _MI_AI_Init(void);
MI_S32 _MI_AI_DeInit(void);
MI_S32 _MI_AI_ReadDataThread(void* data);
...
//MI_S32 MI_AI_IMPL_GetFrame(MI_AUDIO_DEV AiDevId, MI_AI_CHN AiChn, MI_AUDIO_Frame_t*pstFrm, MI_AUDIO_AecFrame_t *pstAecFrm , MI_S32 s32MilliSec);
//MI_S32 MI_AI_IMPL_ReleaseFrame(MI_AUDIO_DEV AiDevId, MI_AI_CHN AiChn, MI_AUDIO_Frame_t *pstFrm, MI_AUDIO_AecFrame_t *pstAecFrm);
...
//MI_S32 MI_AI_IMPL_GetVqeAttr(MI_AUDIO_DEV AiDevId, MI_AI_CHN AiChn,  MI_AI_VqeConfig_t *pstVqeConfig);
...
//MI_S32 MI_AI_IMPL_SaveFile(MI_AUDIO_DEV AiDevId, MI_AI_CHN AiChn,MI_AUDIO_SaveFileInfo_t *pstSaveFileInfo);
//MI_S32 MI_AI_IMPL_SetVqeVolume(MI_AUDIO_DEV AiDevId, MI_AI_CHN AiChn, MI_S32 s32VolumeDb);

#endif //_MI_AI_IMPL_H_