...
typedef enum
{
    E_MHAL_DIVP_ATTR_TNR = 0, //reserve
    E_MHAL_DIVP_ATTR_DI, //reference MHAL_DIVP_DiType_e
    E_MHAL_DIVP_ATTR_ROTATE, //reference MHAL_DIVP_Rotate_e
    E_MHAL_DIVP_ATTR_CROP, //reference MHAL_DIVP_Window_t
    E_MHAL_DIVP_ATTR_MIRROR, //MHAL_DIVP_Mirror_t
...
typedef enum
{
    E_MHAL_DIVP_PIXEL_FORMAT_YUV422_YUYV,//(0)
...
typedef enum
{
    E_MHAL_DIVP_ROTATE_NONE, //Rotate 0 degrees
...
typedef enum
{
    ...
    E_MHAL_DIVP_SCAN_MODE_INTERLACE,
...
typedef struct
{
    ...
    MS_BOOL b2P_Enable;//  Enable/Disable Average 2P to 1P mode
