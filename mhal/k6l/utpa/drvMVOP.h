...
typedef enum
{
    ...
    E_MVOP_CMD_SET_XC_H_DOWN_SCALE,             ///<0x11B Set XC Is Hsize dowb scaling.
#endif
    ...
    E_MVOP_CMD_SET_10B_8B_DITHER,               ///<0x11E Set mvop 10 bits to 8 bits dither mode.
    E_MVOP_CMD_SET_HANDSHAKE_MODE,              ///<0x11F TV chip support handshake mode after muji and monet.
    E_MVOP_CMD_SET_FRC_OUTPUT,                  ///<0x120 Reset MVOP output timing.
#endif
#if defined(UFO_PUBLIC_HEADER_500)
    E_MVOP_CMD_SET_MVOP_2P,                     ////<0x11C Set mvop 2p mode, for macan ve sw patch:2580x1440.
#endif
    ...
    E_MVOP_CMD_SET_INTERLACE_FIELD_MODE,        ////<0x124
...
#if defined(UFO_PUBLIC_HEADER_212)
    E_MVOP_CMD_GET_4K2K2PMODE,                  ///< 0x40F Get mvop 4k2k 2p mode or not.
    E_MVOP_CMD_GET_ISMVOPSENDDATA,              ///< 0x410 Get if mvop hw is sending data or not. (check 1st frame to xc)
#endif
