...
static VDEC_EX_User_Cmd _VDEC_MapUserCmd(VDEC_User_Cmd eUserCmd)
{
    ...
    switch (eUserCmd)
    {
        ...
        case VDEC_USER_CMD_AVC_NEW_SLOW_MOTION          : eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_NEW_SLOW_MOTION; break;
        case VDEC_USER_CMD_AUTO_EXHAUST_ES_MODE         : eEXUserCmd = E_VDEC_EX_USER_CMD_AUTO_EXHAUST_ES_MODE; break;
        ...
        case VDEC_USER_CMD_RETURN_INVALID_AFD           : eEXUserCmd = E_VDEC_EX_USER_CMD_RETURN_INVALID_AFD; break;
        case VDEC_USER_CMD_USE_CPB_REMOVAL_DEALY        : eEXUserCmd = E_VDEC_EX_USER_CMD_USE_CPB_REMOVAL_DEALY; break;
        case VDEC_USER_CMD_SET_DV_XC_SHM_ADDR           : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DV_XC_SHM_ADDR ;break;
        case VDEC_USER_CMD_SET_ENABLE_HDR               : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_ENABLE_HDR ;break;
        ...
        case VDEC_USER_CMD_GET_PRE_PAS_U64PTS           : eEXUserCmd = E_VDEC_EX_USER_CMD_GET_PRE_PAS_U64PTS; break;
