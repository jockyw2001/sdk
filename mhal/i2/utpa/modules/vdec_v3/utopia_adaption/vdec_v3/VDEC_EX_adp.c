...
typedef struct DLL_PACKED
{
    VDEC_FRAMEBuff* pVDEC_FRAMEBuff;
} VDEC_EX_PtrFRAMEBuff;
...
typedef struct DLL_PACKED
{
    VDEC_EX_BufferInfo* pVDEC_EX_BufferInfo;
} VDEC_EX_PtrBufferInfo;

#ifdef STELLAR
//E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_SLOT
typedef struct DLL_PACKED
{
    VDEC_EX_FBSlot* pVDEC_EX_FB_Slot;
}VDEC_EX_PtrFB_Slot;
#endif

//E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_HW_CAPS
typedef struct DLL_PACKED
{
    VDEC_HwCap* pVDEC_EX_HwCap;
} VDEC_EX_PtrHW_CAP;

//E_VDEC_EX_V2_USER_CMD_SET_PLAYBACK_INTERVAL
typedef struct DLL_PACKED
{
    VDEC_EX_Playback_Interval* pVDEC_EX_Playback_Interval;
} VDEC_EX_PtrPLAYBACK_INTERVAL;
...
UADP_SDT_NAMEn_DEF(VDEC_EX_EXTEND_DISP_INFO,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_EXTEND_DISP_INFO,3);
//E_VDEC_EX_V2_USER_CMD_GET_PVRSEAMLESS_INFO
UADP_SDT_NAMEn_DEF(VDEC_EX_PVRSEAMLESS_INFO,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_PVRSEAMLESS_INFO,3);
...
UADP_SDT_NAMEn_DEF(VDEC_EX_FBMEMUSAGE_PARAM,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_FB_MEMORY_USAGE_SIZE,3);
 // E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE
UADP_SDT_NAMEn_DEF(VDEC_EX_FB_MEM_USAGE_STRUCT,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_FB_MEMORY_USAGE,3);
//E_VDEC_EX_V2_USER_CMD_GET_HDR_INFO
UADP_SDT_NAMEn_DEF(VDEC_EX_HDR_INFO_STRUCT,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_HDR_INFO,3);
//E_VDEC_EX_V2_USER_CMD_GET_VDEC_CAPABILITY
UADP_SDT_NAMEn_DEF(EN_VDEC_EX_CAPABILITY_STRUCT,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_VDEC_CAPABILITY,3);
...
UADP_SDT_NAMEn_DEF(VDEC_EX_FRAME_INFO_V7,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_FRAME_INFO_V7,3);
#endif

//E_VDEC_EX_V2_USER_CMD_GET_CLLI_SEI
UADP_SDT_NAMEn_DEF(VDEC_EX_CLLI_SEI,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_CLLI_SEI,3);
...
UADP_SDT_NAMEn_DEF(VDEC_EX_VUI_DISP,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_VUI_DISP,3);

#ifdef VDEC_CAP_SYSTEM_PREGET_API
#ifdef VDEC_CAP_DV_OTT_API
UADP_SDT_NAMEn_DEF(VDEC_EX_DV_INFO,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PREGET_DV_INFO,3);
#endif
#endif
...
UADP_SDT_NAMEn_DEF(VDEC_EX_DBG_SET_CMD,4);

//E_VDEC_EX_V2_USER_CMD_DBG_GET_DATA
UADP_SDT_NAMEn_DEF(VDEC_EX_DBG_GET_DATA,4);

//E_VDEC_EX_V2_USER_CMD_DBG_SET_DATA
UADP_SDT_NAMEn_DEF(VDEC_EX_DBG_SET_DATA,4);

//E_VDEC_EX_V2_USER_CMD_SET_FRAMEBUFF2
UADP_SDT_NAMEn_DEF(VDEC_EX_FRAMEBUFF,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PTR_FRAMEBUFF,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_SET_FRAMEBUFF2,3);

//E_VDEC_EX_V2_USER_CMD_SET_PLAYBACK_INTERVAL
UADP_SDT_NAMEn_DEF(VDEC_EX_PLAYBACK_INTERVAL,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PTR_PLAYBACK_INTERVAL,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_SET_PLAYBACK_INTERVAL,3);

//E_VDEC_EX_V2_USER_CMD_SET_DV_XC_SHM_ADDR:
UADP_SDT_NAMEn_DEF(VDEC_EX_XC_SHM_ADDR,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_SET_DV_XC_SHM_ADDR,3);
...
//E_VDEC_EX_V2_USER_CMD_SET_BUFFER_INFO
UADP_SDT_NAMEn_DEF(VDEC_EX_BUFFER_INFO2,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PTR_SET_BUFFER_INFO,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_SET_BUFFER_INFO,3);
...
#ifdef STELLAR
//E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_SLOT
UADP_SDT_NAMEn_DEF(VDEC_EX_FB_SLOT,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PTR_FB_SLOT,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_FB_SLOT,3);
#endif

//E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_HW_CAPS
UADP_SDT_NAMEn_DEF(VDEC_EX_HW_CAP,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_PTR_HW_CAP,1);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_HW_CAP,3);

//E_VDEC_EX_V2_USER_CMD_GET_CODEC_CAP
UADP_SDT_NAMEn_DEF(VDEC_EX_CODEC_CAP_INFO,0);
UADP_SDT_NAMEn_DEF(VDEC_EX_GET_CODEC_CAP,3);
...
MS_U32 VDEC_EX_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SDT_NAME0(VDEC_EX_FBMEMUSAGE_PARAM,VDEC_EX_FbMemUsage_Param);
    UADP_SDT_NAME0(VDEC_EX_FB_MEM_USAGE_STRUCT,VDEC_EX_FB_MEM_USAGE);
    UADP_SDT_NAME0(VDEC_EX_HDR_INFO_STRUCT,VDEC_EX_HDR_INFO);
    UADP_SDT_NAME0(EN_VDEC_EX_CAPABILITY_STRUCT,EN_VDEC_EX_CAPABILITY);
...
//    UADP_SDT_NAME0(VDEC_EX_ERR_TOLERANCE,VDEC_EX_Err_Tolerance);
    ...
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V7
        UADP_SDT_NAME0(VDEC_EX_FRAME_INFO_V7,VDEC_EX_FrameInfoExt_v7);
    #endif
//    UADP_SDT_NAME0(VDEC_EX_FRAME_INFO_EXT,VDEC_EX_FrameInfoExt_v6);
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V6
    ...
    UADP_SDT_NAME0(VDEC_EX_CLLI_SEI,VDEC_EX_ContentLightLevelInfo_SEI);
    UADP_SDT_NAME0(VDEC_EX_DCV_SEI,VDEC_EX_DisplayColourVolume_SEI);
#ifdef VDEC_CAP_SYSTEM_PREGET_API
#ifdef VDEC_CAP_DV_OTT_API
    UADP_SDT_NAME0(VDEC_EX_DV_INFO,VDEC_EX_DV_Info);
#endif
#endif
    ...
    //E_VDEC_EX_V2_USER_CMD_GET_EXTEND_DISP_INFO
    UADP_SDT_NAME0(VDEC_EX_EXTEND_DISP_INFO,VDEC_EX_ExtendDispInfo);
    UADP_SDT_NAME3(VDEC_EX_GET_EXTEND_DISP_INFO,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_EXTEND_DISP_INFO);
    //E_VDEC_EX_V2_USER_CMD_GET_PVRSEAMLESS_INFO
    UADP_SDT_NAME0(VDEC_EX_PVRSEAMLESS_INFO,VDEC_EX_PVR_Seamless_Info);
    UADP_SDT_NAME3(VDEC_EX_GET_PVRSEAMLESS_INFO,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PVRSEAMLESS_INFO);
    //E_VDEC_EX_V2_USER_CMD_GET_DEC_FRAME_INFO
    ...
    // E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE_SIZE
    UADP_SDT_NAME3(VDEC_EX_FB_MEMORY_USAGE_SIZE,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FBMEMUSAGE_PARAM);
    // E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE
    UADP_SDT_NAME3(VDEC_EX_FB_MEMORY_USAGE,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FB_MEM_USAGE_STRUCT);
    //E_VDEC_EX_V2_USER_CMD_GET_HDR_INFO
    UADP_SDT_NAME3(VDEC_EX_GET_HDR_INFO,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],VDEC_EX_HDR_INFO_STRUCT);
    // E_VDEC_EX_V2_USER_CMD_GET_VDEC_CAPABILITY
    UADP_SDT_NAME3(VDEC_EX_GET_VDEC_CAPABILITY,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N,StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N ,param[0],EN_VDEC_EX_CAPABILITY_STRUCT);
    //E_VDEC_EX_V2_USER_CMD_GET_CC_INFO
    ...
    //E_VDEC_EX_V2_USER_CMD_FRC_OUTPUT
//    UADP_SDT_NAME3(VDEC_EX_FRC_OUTPUT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRC_OUTPUT_PARAM);
    UADP_SDT_NAME0(VDEC_EX_FRC_OUTPUT_PARAM,VDEC_EX_FRC_OutputParam);
...
//    UADP_SDT_NAME3(VDEC_EX_SET_ERROR_TOLERANCE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_ERR_TOLERANCE);
    ...
    //E_VDEC_EX_V2_USER_CMD_GET_NEXT_DISP_FRAME_INFO_EXT:
    //UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_EXT,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_EXT);
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V7
        UADP_SDT_NAME3(VDEC_EX_GET_FRAME_INFO_V7,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAME_INFO_V7);
    #endif
    #ifdef VDEC_CAP_FRAME_INFO_EXT_V6
    ...
    //E_VDEC_EX_V2_USER_CMD_GET_CLLI_SEI
    UADP_SDT_NAME3(VDEC_EX_GET_CLLI_SEI,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CLLI_SEI);
    //E_VDEC_EX_V2_USER_CMD_GET_DCV_SEI
    ...
    //E_VDEC_EX_V2_USER_CMD_GET_VUI_DISP_INFO
    UADP_SDT_NAME0(VDEC_EX_VUI_DISP,VDEC_EX_AVC_VUI_DISP_INFO);
    UADP_SDT_NAME3(VDEC_EX_GET_VUI_DISP,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_VUI_DISP);
#ifdef VDEC_CAP_SYSTEM_PREGET_API
#ifdef VDEC_CAP_DV_OTT_API
    //E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_PROFILE:
    //E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_LEVEL:
    UADP_SDT_NAME3(VDEC_EX_PREGET_DV_INFO,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_DV_INFO);
#endif
#endif
    //E_VDEC_EX_V2_USER_CMD_PREGETSTATUS
    ...
    //E_VDEC_EX_V2_USER_CMD_DBG_SET_CMD
    UADP_SDT_NAME4(VDEC_EX_DBG_SET_CMD,VDEC_EX_V2_IO_Param_2,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_MS_U32,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_DBG_GET_DATA
    UADP_SDT_NAME4(VDEC_EX_DBG_GET_DATA,VDEC_EX_V2_IO_Param_2,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_AT, param[0],VDEC_EX_MS_VIRT,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_DBG_SET_DATA
    UADP_SDT_NAME4(VDEC_EX_DBG_SET_DATA,VDEC_EX_V2_IO_Param_2,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_AT, param[0],VDEC_EX_MS_VIRT,UADP_SDT_P2N ,param[1],VDEC_EX_MS_U32);

    //E_VDEC_EX_V2_USER_CMD_SET_FRAMEBUFF2
    UADP_SDT_NAME0(VDEC_EX_FRAMEBUFF,VDEC_FRAMEBuff);
    //UADP_SDT_NAME3(VDEC_EX_SET_FRAMEBUFF2,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_FRAMEBUFF);
    UADP_SDT_NAME1(VDEC_EX_PTR_FRAMEBUFF,VDEC_EX_PtrFRAMEBuff,UADP_SDT_P2N ,pVDEC_FRAMEBuff,VDEC_EX_FRAMEBUFF);
    UADP_SDT_NAME3(VDEC_EX_SET_FRAMEBUFF2,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_FRAMEBUFF);

    //E_VDEC_EX_V2_USER_CMD_SET_PLAYBACK_INTERVAL
    UADP_SDT_NAME0(VDEC_EX_PLAYBACK_INTERVAL,VDEC_EX_Playback_Interval);
    UADP_SDT_NAME1(VDEC_EX_PTR_PLAYBACK_INTERVAL,VDEC_EX_PtrPLAYBACK_INTERVAL,UADP_SDT_P2N ,pVDEC_EX_Playback_Interval,VDEC_EX_PLAYBACK_INTERVAL);
    UADP_SDT_NAME3(VDEC_EX_SET_PLAYBACK_INTERVAL,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_PLAYBACK_INTERVAL);

    //E_VDEC_EX_V2_USER_CMD_SET_DV_XC_SHM_ADDR:
    UADP_SDT_NAME1(VDEC_EX_XC_SHM_ADDR,VDEC_EX_PtrXcShmAddr,UADP_SDT_P2N ,pXCShmAddr,VDEC_EX_MS_PHY);
    UADP_SDT_NAME3(VDEC_EX_SET_DV_XC_SHM_ADDR,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_XC_SHM_ADDR);
    ...
    //E_VDEC_EX_V2_USER_CMD_SET_BUFFER_INFO
    UADP_SDT_NAME0(VDEC_EX_BUFFER_INFO2,VDEC_EX_BufferInfo);
    UADP_SDT_NAME1(VDEC_EX_PTR_SET_BUFFER_INFO,VDEC_EX_PtrBufferInfo,UADP_SDT_P2N ,pVDEC_EX_BufferInfo,VDEC_EX_BUFFER_INFO2);
    UADP_SDT_NAME3(VDEC_EX_SET_BUFFER_INFO,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_PTR_SET_BUFFER_INFO);
    ...
    #ifdef STELLAR
    //E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_SLOT
    UADP_SDT_NAME0(VDEC_EX_FB_SLOT,VDEC_EX_FBSlot);
    UADP_SDT_NAME1(VDEC_EX_PTR_FB_SLOT,VDEC_EX_PtrFB_Slot,UADP_SDT_P2N ,pVDEC_EX_FB_Slot,VDEC_EX_FB_SLOT);
    UADP_SDT_NAME3(VDEC_EX_GET_FB_SLOT,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PTR_FB_SLOT);
    #endif

    //E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_HW_CAPS
    UADP_SDT_NAME0(VDEC_EX_HW_CAP,VDEC_HwCap);
    UADP_SDT_NAME1(VDEC_EX_PTR_HW_CAP,VDEC_EX_PtrHW_CAP,UADP_SDT_P2N ,pVDEC_EX_HwCap,VDEC_EX_HW_CAP);
    UADP_SDT_NAME3(VDEC_EX_GET_HW_CAP,VDEC_EX_V2_IO_Param_1, UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID, UADP_SDT_P2N, pRet,VDEC_EX_MS_U32, UADP_SDT_P2N, param[0],VDEC_EX_PTR_HW_CAP);

    //E_VDEC_EX_V2_USER_CMD_GET_CODEC_CAP
    UADP_SDT_NAME0(VDEC_EX_CODEC_CAP_INFO,VDEC_EX_CODEC_CAP_INFO);
    UADP_SDT_NAME3(VDEC_EX_GET_CODEC_CAP,VDEC_EX_V2_IO_Param_1,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_CODEC_CAP_INFO);
    ...
    switch(u32Cmd)
    {
        ...
        case E_VDEC_EX_V2_CMD_SET_CONTROL:
            ...
            switch(kernel_IO_Param->eUserCmd)
            {
                ...
                case E_VDEC_EX_V2_USER_CMD_DBG_DUMP_STATUS:
                ...
                case E_VDEC_EX_V2_USER_CMD_SUPPORT_MULTI_ULTRA_RES:
                ...
                case E_VDEC_EX_V2_USER_CMD_FORCE_PROGRESSIVE_MODE:
                ...
                case E_VDEC_EX_V2_USER_CMD_SET_DISP_WIN_ID:
                ...
                case E_VDEC_EX_V2_USER_CMD_SET_DV_XC_SHM_ADDR:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_SET_DV_XC_SHM_ADDR, spt_VDEC_EX_SET_DV_XC_SHM_ADDR,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_SET_DYNAMIC_DISP_PATH:
                    ...
                    break;
                case E_VDEC_EX_V2_USER_CMD_DBG_SET_CMD:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_DBG_SET_CMD, spt_VDEC_EX_DBG_SET_CMD,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_DBG_SET_DATA:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_DBG_SET_DATA, spt_VDEC_EX_DBG_SET_DATA,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_SET_PLAYBACK_INTERVAL:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_SET_PLAYBACK_INTERVAL, spt_VDEC_EX_SET_PLAYBACK_INTERVAL,buffer_arg,sizeof(buffer_arg));
                    break;
        ...
        case E_VDEC_EX_V2_CMD_GET_CONTROL:
            ...
            switch(kernel_IO_Param->eUserCmd)
            {
                ...
                case E_VDEC_EX_V2_USER_CMD_DBG_GET_PROG_CNT:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_IO_U32, spt_VDEC_EX_IO_U32,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_GET_CLLI_SEI:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_CLLI_SEI, spt_VDEC_EX_GET_CLLI_SEI,buffer_arg,sizeof(buffer_arg));
                    break;
                ...
                case E_VDEC_EX_V2_USER_CMD_GET_VUI_DISP_INFO:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_VUI_DISP, spt_VDEC_EX_GET_VUI_DISP,buffer_arg,sizeof(buffer_arg));
                    break;
#ifdef VDEC_CAP_SYSTEM_PREGET_API
#ifdef VDEC_CAP_DV_OTT_API
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_PROFILE:
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_DV_SUPPORT_LEVEL:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_PREGET_DV_INFO, spt_VDEC_EX_PREGET_DV_INFO,buffer_arg,sizeof(buffer_arg));
                    break;
#endif
#endif
                ...
                case E_VDEC_EX_V2_USER_CMD_GET_EXT_DISP_INFO:
                    ...
                    break;
                case E_VDEC_EX_V2_USER_CMD_GET_EXTEND_DISP_INFO:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_EXTEND_DISP_INFO, spt_VDEC_EX_GET_EXTEND_DISP_INFO,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_GET_PVRSEAMLESS_INFO:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_PVRSEAMLESS_INFO, spt_VDEC_EX_GET_PVRSEAMLESS_INFO,buffer_arg,sizeof(buffer_arg));
                    break;
                ...
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE_SIZE:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_FB_MEMORY_USAGE_SIZE, spt_VDEC_EX_FB_MEMORY_USAGE_SIZE,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_FB_MEMORY_USAGE, spt_VDEC_EX_FB_MEMORY_USAGE,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_GET_HDR_INFO:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_HDR_INFO, spt_VDEC_EX_GET_HDR_INFO,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_GET_VDEC_CAPABILITY:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_VDEC_CAPABILITY, spt_VDEC_EX_GET_VDEC_CAPABILITY,buffer_arg,sizeof(buffer_arg));
                    break;
                ...
                case E_VDEC_EX_V2_USER_CMD_GET_FILE_END_PATTERN:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_IO_BOOL, spt_VDEC_EX_IO_BOOL,buffer_arg,sizeof(buffer_arg));
                    break;
                ...
                case E_VDEC_EX_V2_USER_CMD_GET_NEXT_DISP_FRAME_INFO_EXT:
                    //u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_FRAME_INFO_EXT, spt_VDEC_EX_GET_FRAME_INFO_EXT,buffer_arg,sizeof(buffer_arg));
                    {
                        ...
                        #ifdef VDEC_CAP_FRAME_INFO_EXT_V7
                        if(version.u32version == 7)
                        {
                            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_FRAME_INFO_V7, spt_VDEC_EX_GET_FRAME_INFO_V7,buffer_arg,sizeof(buffer_arg));
                            break;
                        }
                        #endif
                        #ifdef VDEC_CAP_FRAME_INFO_EXT_V6
                ...
                case E_VDEC_EX_V2_USER_CMD_GET_BUFFER_INFO:
                    ...
                    break;
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_HW_CAPS:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_HW_CAP, spt_VDEC_EX_GET_HW_CAP,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_DBG_GET_DATA:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_DBG_GET_DATA, spt_VDEC_EX_DBG_GET_DATA,buffer_arg,sizeof(buffer_arg));
                    break;
                #ifdef STELLAR
                case E_VDEC_EX_V2_USER_CMD_SYSTEM_PREGET_FB_SLOT:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_FB_SLOT, spt_VDEC_EX_GET_FB_SLOT,buffer_arg,sizeof(buffer_arg));
                    break;
                #endif
                case E_VDEC_EX_V2_USER_CMD_GET_CODEC_CAP:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_GET_CODEC_CAP, spt_VDEC_EX_GET_CODEC_CAP,buffer_arg,sizeof(buffer_arg));
                    break;
                default:
                    break;
            }
        ...
        case E_VDEC_EX_V2_CMD_PRE_SET_CONTROL:
            ...
            switch(kernel_IO_Param->eUserCmd)
            {
                ...
                case E_VDEC_EX_V2_USER_CMD_DRIVER_MCU_MODE:
                case E_VDEC_EX_V2_USER_CMD_HDR10_UPDATE_PERFRAME:
                case E_VDEC_EX_V2_USER_CMD_SET_HDR_DYNAMIC:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_IO_BOOL, spt_VDEC_EX_IO_BOOL,buffer_arg,sizeof(buffer_arg));
                    break;
                ...
                case E_VDEC_EX_V2_USER_CMD_SET_CUSTOMER_MODE:
                ...
                case E_VDEC_EX_V2_USER_CMD_SET_BUFFER_INFO:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_SET_BUFFER_INFO, spt_VDEC_EX_SET_BUFFER_INFO,buffer_arg,sizeof(buffer_arg));
                    break;
                #ifdef STELLAR
                case E_VDEC_EX_V2_USER_CMD_SET_FRAMEBUFFER:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_SET_FRAMEBUFF2, spt_VDEC_EX_SET_FRAMEBUFF2,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_VDEC_EX_V2_USER_CMD_RELEASE_FB_SLOT:
                case E_VDEC_EX_V2_USER_CMD_SHOW_FB_USAGE:
                    u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VDEC_EX_IO_U32, spt_VDEC_EX_IO_U32,buffer_arg,sizeof(buffer_arg));
                    break;
                #endif
                default:
