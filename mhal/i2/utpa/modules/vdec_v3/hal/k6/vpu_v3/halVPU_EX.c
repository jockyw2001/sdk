...
static MS_BOOL _VPU_EX_InitAll(VPU_EX_NDecInitPara *pInitPara)
{
    ...
    VPU_EX_ClockSpeed eClkSpeed = E_VPU_EX_CLOCK_480MHZ;
...
#endif
{
    ...
    if (E_VPU_EX_DECODER_MVD == pTaskInfo->eDecType)
    {
            ...
            *((unsigned int*)(pTemp4->u8Reserved)) = u32StartOffset;
            ...
            CMD_QUEUE *pTemp2 = (CMD_QUEUE *)MsOS_PA2KSEG1(MsOS_VA2PA(pInitPara->pFWCodeCfg->u32DstAddr) + VCOMMANDQ_INFO_START + u8Offset*VPU_FW_MEM_OFFSET);
...
MS_BOOL HAL_VPU_EX_CPUSetting(MS_PHY u32StAddr)
{
    ...
    MS_U16 r2_miu_sel = (_VPU_Read2Byte(VPU_REG_R2_MI_SEL_BASE) & 0xfff);
#endif
