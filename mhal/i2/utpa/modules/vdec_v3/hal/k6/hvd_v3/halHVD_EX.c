...
static void _HVD_EX_Context_Init_HAL(void)
{
    ...
    pHVDHalContext->u32VPUClockType = 480;
...
static void _HVD_EX_SetBufferAddr(MS_U32 u32Id)
{
    ...
    MS_BOOL bIsEVD = _HAL_EX_IS_EVD(pCtrl->InitParams.u32ModeFlag);
