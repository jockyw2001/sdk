...
MS_BOOL MDrv_MVD_Set_Playback_Interval(MS_U32 u32Id, MS_U32 u32StartPts, MS_U32 u32EndPts)
{
    ...
    HAL_MVD_Set_Playback_Interval(u8HalIdx, _MS_TO_90K(u32StartPts), _MS_TO_90K(u32EndPts));
    return TRUE;
}
...
E_MVD_Result MDrv_MVD_SetSpeed(MS_U32 u32Id, MVD_SpeedType eSpeedType, MS_U8 u8Multiple)
{
    ...
    if((eSpeedType == E_MVD_SPEED_FAST && u8Multiple == 2 && pMVDDrvContext->bTrickPlay2xAVSync[u8DrvIdx] == TRUE) == FALSE && E_MVD_SPEED_DEFAULT != eSpeedType)
    {
    ...
    {
        if ((E_MVD_SPEED_DEFAULT == eSpeedType) || (eSpeedType == E_MVD_SPEED_FAST && u8Multiple == 2 && pMVDDrvContext->bTrickPlay2xAVSync[u8DrvIdx] == TRUE))
        {
            if (pstCtrlCfg->ePreSpeedType != E_MVD_SPEED_DEFAULT)
            {
