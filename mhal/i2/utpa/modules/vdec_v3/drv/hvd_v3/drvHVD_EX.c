...
static HVD_EX_Result _HVD_MapRetEx(HVD_Return eHvd_Ret)
{
    ...
    switch(eHvd_Ret)
    {
        ...
        case E_HVD_RETURN_CMA_ERROR         : eRes = E_HVD_EX_RET_CMA_ERROR;break;
        default: break;
    }
    return eRes;
}
...
#endif
{
    ...
    if (u32UartCtrl & E_HVD_UART_CTRL_INFO)
    {
        ...
        HVD_EX_MSG_DBG("MSOS API check: 1st:%tu 2nd:%tu delay:%u dif:%tu\n",
    ...
    VPRINTF("[NDec][0x%tx][%d] bShareBBU %d, eStream %d \n", (ptrdiff_t)u32Id, u8DrvId, bShareBBU, eStream);
#endif
...
HVD_EX_Result MDrv_HVD_EX_GenPattern(MS_U32 u32Id, HVD_EX_PatternType eType, MS_VIRT u32VAddr, MS_U32 * pu32Size)
{
    ...
    if (eType == E_HVD_EX_PATTERN_FLUSH)   // flush pattern
    {
        ...
        {
            HVD_EX_MSG_ERR("Flush Pattern must have at least %u bytes, input:%u\n"
    ...
    else if (eType == E_HVD_EX_PATTERN_FILEEND)    // dummy pattern
    {
        ...
        if (*pu32Size < u32MinPatternSize)
        {
            HVD_EX_MSG_ERR("Dummy Pattern must have at least %u bytes, input:%u\n"
                          ,(ptrdiff_t)u32MinPatternSize,(ptrdiff_t)(*pu32Size));
            *pu32Size = u32MinPatternSize;
            eRet = E_HVD_EX_RET_OUTOF_MEMORY;
            _DRV_HVD_EX_RET(u8DrvId, eRet);
...
{
#if (defined(CHIP_EDISON) || defined(CHIP_EINSTEIN) || defined(CHIP_EINSTEIN3)) || defined(CHIP_NAPOLI) || defined(CHIP_MONACO) || defined(CHIP_MUJI) || defined(CHIP_CLIPPERS) || defined(CHIP_MONET) || defined(CHIP_MANHATTAN) || defined(CHIP_MESSI) || defined(CHIP_MASERATI) || defined(CHIP_MAXIM) || defined(CHIP_K6) || defined(CHIP_K6LITE) || defined(CHIP_K7U) || defined(CHIP_M7621)
...
#define SIZE_3K 0xC00
    ...
    #if defined(CHIP_MONACO) || defined(CHIP_MUJI) || defined(CHIP_MONET) || defined(CHIP_MANHATTAN) || defined(CHIP_MESSI) || defined(CHIP_MASERATI) || defined(CHIP_K6) || defined(CHIP_K6LITE) || defined(CHIP_K7U)
