...
MS_BOOL MDrv_AUDIO_SetCommAudioInfo( Audio_COMM_infoType infoType, MS_VIRT param1, MS_VIRT param2 )
{
    ...
    if (infoType == Audio_Comm_infoType_ADEC1_setAudioDecoder)
    {
        ...
        {
            case Audio_DEC_AC4:         MDrv_AUDIO_SetSystem(MSAPI_AUD_DVB_AC4);         break;
            case Audio_DEC_MPEG_H:      MDrv_AUDIO_SetSystem(MSAPI_AUD_DVB_MPEG_H);      break;
            case Audio_DEC_PCM:
    ...
    else if (infoType == Audio_Comm_infoType_ADEC2_setAudioDecoder)
    {
        switch((MMA_AudioType)param1)
        {
            case Audio_DEC_AC4:         MDrv_AUDIO_SetSystem(MSAPI_AUD_DVB2_AC4);       break;
            case Audio_DEC_MPEG_H:      MDrv_AUDIO_SetSystem(MSAPI_AUD_DVB2_MPEG_H);    break;
            case Audio_DEC_PCM:
