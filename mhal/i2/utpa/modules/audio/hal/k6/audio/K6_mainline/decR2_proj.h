...
***********************************************************/
    ...
    #define SYS_DEC1_STOP_DECODE_PCM_LEVEL              (960-64)*48                         //(1536-64)*DEC_OUTPUT_1MS_48K_SIZE      //(1024-64)*DEC_OUTPUT_1MS_48K_SIZE      // 1024ms (should small than "SYS_DEC_STOP_DECODE_PCM_LEVEL")
    ...
    #define SYS_MD_NOSIGNAL_THRESHOLD                   256
    ...
    #define SYS_DEC_SYNTHESIZER_CHANGE_MAX_LIMIT            0x300000
    #define SYS_DEC_SYNTHESIZER_CHANGE_INCREASE_LIMIT       0x10000
...
***********************************************************/
    ...
    #define PARSER_SUPPORT_4STC             1
	#define PASDROP_ENABLE                  1
...
#define STREAMING_LOW_LATENCY_LIMITER   0
...
***********************************************************/
    ...
    #define D_PREFETCH_NUM              0       // k6 has this feature, 0: disable D_PREFETCH, 1 ~ 4: on
    #define R2_SPRA_DCU_PREFETCH        (118)   //118 for DCU prefetch, 119 for ICU prefetch

    /* I_PREFETCH */
    #define I_PREFETCH_NUM              0
...
/******************* MCU <--> DEC-R2 *******************/
    /* MCU -> DEC-R2 */
        ...
        #define R2_CHECK_OTP_HW_LOCK_ADDR       1     // 0: 112E_9E is locked,  1: 112E_92 is locked
        #if (R2_CHECK_OTP_HW_LOCK_ADDR == 1)
        #define MBOX_BYTE_STATUS_SELECT            MBOX_M2D_0392
        #define MBOX_BYTE_STATUS_SPEED             MBOX_M2D_0392+1
        #else
...
/* dec R2 <--> snd R2 */
    ...
    /* SND-DSP -> snd R2 */
      ...
      //#define MBOX_S2D_REG_HDMI_IN_FREQ           MBOX_S2D_IO_B
        ...
        #define MBOX_S2D_DSPWORD_IP_AUTH2           MBOX_S2D_IO_C
