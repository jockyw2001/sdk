...
***********************************************************/
    ...
    #define D_CACHE_MEM_SIZE            16384
    #define D_CACHE_LINE_SIZE           16
    #define D_CACHE_LINE_NUM            (16384/16)
    #define PRINT_OUT_NUM               (4096*4)
...
***********************************************************/
    ...
    /* MISC */
        ...
        #define MPEG_ENC2_BASE         (OFFSET_R2_TO_COMM_DDR+ OFFSET_MP3_ENC2_DRAM_BASE)
...
***********************************************************/
    ...
    #define ASND_PRE_INPUT_PCM_CH           14           //(RAW DMX + 5.1)
    #define ASND_PRE_DMX_L_CH               0
    #define ASND_PRE_DMX_R_CH               1
    #define ASND_PRE_SE_L_CH                8
    #define ASND_PRE_SE_R_CH                9

    #define DOWNMIX_2_CH_ORDER              ASND_PRE_SE_L_CH
    #define MULTI_5P1_CH_ORDER              2
    #define ENC_2_CH_ORDER                  ASND_PRE_SE_L_CH
    #define ECHO_CH_ORDER                   10
    #define ENC_2_CH_ORDER2               12

    /* post sound process */
    #define ASND_POST_PROCESS_BUF_UNIT  256
    #define ASND_POST_INPUT_PCM_CH          8
    #define ASND_POST_SE_L_CH           4
    #define ASND_POST_SE_R_CH           5

    /* outpcm dmx data level limit R2->DSP */
    #define OUTPCM_DMX_LEVEL_UPPER_LIMIT    (ASND_PRE_PROCESS_BUF_UNIT*2*2)*6 // PRE_PROCESS_BUF_UNIT(5.3) * 6 = 32 ms
...
/******************* MCU <--> SND-R2 *******************/
    /* MCU -> SND-R2 */
        ...
        #define SNDR2_MBOX_BYTE_DTS_VIRTUALX_SEL      MBOX_M2A_2E94
        #define SNDR2_MBOX_BYTE_SRS_SEL               MBOX_M2A_2E94
        #define SNDR2_MBOX_BYTE_DV258_SEL             MBOX_M2A_2E92
        ...
        #define SNDR2_MBOX_BYTE_TRANSCODE_SEL              (MBOX_M2A_2E94+1)
            ...
            #define MP3_ENCODE_START_BIT             1
            #define MP3_ENCODE_MUTE_BIT              4
            #define MP3_ENCODE2_ENABLE_BIT         2
            #define MP3_ENCODE2_START_BIT           3
            #define MP3_ENCODE2_MUTE_BIT            5
...
/* SND-R2 --> DEC-R2  */
    #define MBOX_SNDR2_DECR2_ENC_ON_CHIP      MBOX_SER2_A2D_IO_0
        #define DDENC_SUPPORT_BIT           _BIT_0_
        #define DTSENC_SUPPORT_BIT          _BIT_1_
        #define DDPENC_SUPPORT_BIT          _BIT_2_

    /* SND-DSP -> SND-R2 */
        //// R2 decoder ////
        #define MBOX_S2A_DSPWORD_SPEAKER_CH_VOLUME  MBOX_S2A_IO_A
        #define MBOX_S2A_DSPWORD_IP_AUTH2        MBOX_S2A_IO_D
    ...
    /* SND-R2 -> SND DSP */
        ...
        #define MBOX_A2S_DSPWORD_SOUND_PROCESS_CTRL     MBOX_A2S_IO_F
           #define MBOX_PRE_SOUND_PROCESS_DISABLE_BIT	    _BIT_0_
           #define MBOX_POST_SOUND_PROCESS_DISABLE_BIT	    _BIT_1_
