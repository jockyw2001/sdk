...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: HAL_SOUND_GetMute() @@VVV
/// @brief \b Function \b Description: This routine is used to get audio u8Path S/W mute.
/// @param <IN>        \b u8Path    : for audio u8Path0 ~ u8Path6
/// @param <OUT>       \b NONE    :
/// @param <RET>        \b bEnable    :     TRUE --Mute
///                                                    FALSE--Unmute
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
MS_BOOL HAL_SOUND_GetMute(MS_U8 u8Path)
{
    MS_BOOL bEnable = FALSE;

    AUDIO_PRINT(AUDIO_DEBUG_LEVEL_DEBUG, "HAL_SOUND_GetMute = %x\n", (MS_U8)u8Path );

    switch (u8Path)
    {
        case AUDIO_T3_PATH_AUOUT0:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_AUOUT0_VOLUME) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_AUOUT1:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_AUOUT1_VOLUME) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_AUOUT2:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_AUOUT2_VOLUME) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_AUOUT3:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_AUOUT3_VOLUME) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_I2S:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_I2S_VOLUME) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_SPDIF:
        {
            if ((HAL_AUDIO_ReadByte(REG_SOUND_SPDIF_VOL_FRAC+1) & 0x80) &&
                (HAL_AUDIO_ReadByte(REG_M2D_MAILBOX_SPDIF_CTRL) & 0x01))
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_MIXER_MAIN:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_CH5_MIX_VOL_INT) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_MIXER_SECONDARY:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_CH6_MIX_VOL_INT) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_MIXER_DMA_IN:
        {
            if (HAL_AUDIO_ReadByte(REG_SOUND_CH8_MIX_VOL_INT) & 0x80)
            {
                bEnable = TRUE;
            }
            break;
        ...
        case AUDIO_T3_PATH_PCM_CAPTURE1:
        {
            ...
            if((u32Value & 0x00008000) == 0x00008000)
            {
                bEnable = TRUE;
            }
            break;
...
/// @param <IN>        \b u8Path    : for audio CH1~CH6
/// @param <OUT>       \b NONE    :
/// @param <RET>       \b MS_U16    : volume value
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
MS_U16 HAL_SOUND_GetAbsoluteVolume(MS_U8 u8Path)
{
    MS_U8 u8u8Vol1 = 0;
    MS_U8 u8u8Vol2 = 0;
    MS_U16 u16Vol = 0;
    ...
    switch (u8Path)
    {
        case AUDIO_T3_PATH_AUOUT0:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT0_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT0_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }

        case AUDIO_T3_PATH_AUOUT1:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT1_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT1_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_AUOUT2:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT2_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT2_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_AUOUT3:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT3_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_AUOUT3_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_I2S:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_I2S_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_I2S_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_SPDIF:
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_SPDIF_VOLUME) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_SPDIF_VOL_FRAC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_MIXER_MAIN:  //CH5
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_CH5_MIX_VOL_INT) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_CH5_MIX_VOL_FRC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_MIXER_SECONDARY: //CH6
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_CH6_MIX_VOL_INT) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_CH6_MIX_VOL_FRC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_MIXER_DMA_IN: //CH8
        {
            u8u8Vol1 = HAL_AUDIO_ReadByte(REG_SOUND_CH8_MIX_VOL_INT) & 0x7F;
            u8u8Vol2 = HAL_AUDIO_ReadByte(REG_SOUND_CH8_MIX_VOL_FRC) >> 5;
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
        ...
        case AUDIO_T3_PATH_PCM_CAPTURE1:
        {
            ...
            u8u8Vol1 = (MS_U8)((u32Value & 0x007F00) >> 8);
            u8u8Vol2 = (MS_U8)((u32Value & 0x0000E0) >> 5);
            u16Vol = ((MS_U16)u8u8Vol1 << 8) + u8u8Vol2;
            break;
        }
...
void HAL_SOUND_SetBalance(MS_U8 u8Balance)
{
    ...
    if (u8Balance > 100)
    {
        AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s : balance value should be less than 100 \n",__FUNCTION__);
        return;
    }
...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function \b Name: HAL_SOUND_GetBalance()    @@VVV
/// @brief \b Function \b Description: This routine is used to get Balance u8Value.
/// @param <IN>       \b NONE    :
/// @param <OUT>       \b MS_U16    :
/// @param <RET>       \b NONE    :
/// @param <GLOBAL>    \b NONE    :
////////////////////////////////////////////////////////////////////////////////
MS_U16 HAL_SOUND_GetBalance(void)
{
    MS_U8 u8Balance = 0;
    MS_U8 u8ValueL = 0;
    MS_U8 u8ValueR = 0;
    ...
    u8ValueL =  (MS_U8)HAL_SOUND_GetBalance_L();
    u8ValueR =  (MS_U8)HAL_SOUND_GetBalance_R();

    if ((u8ValueL == 0x00) && (u8ValueR == 0x00))
    {
        u8Balance = 50;
    }
    else if((u8ValueL == 0x00) && (u8ValueR != 0x00))
    {
        for (u8Index = 0; u8Index <= 50; u8Index++)
        {
            if (u8ValueR ==  BalanceTab[u8Index])
            {
                break;
            }
        }
        ...
        if (u8Index <= 50)
        {
            u8Balance = 50 - u8Index;
        }
        else
        {
            AUDIO_PRINT(AUDIO_DEBUG_LEVEL_ERROR, "%s : Can't find mapping balance value \n",__FUNCTION__);
        }
    }
    else if ((u8ValueL != 0x00) && (u8ValueR == 0x00))
    {
        for (u8Index = 0; u8Index <= 50; u8Index++)
        {
            if (u8ValueL ==  BalanceTab[u8Index])
            {
                break;
            }
        }
...
MS_U16 HAL_SOUND_GetBass(void)
{
    ...
    u8value = HAL_AUDIO_ReadByte(REG_SOUND_BASS);

    s8value = (MS_S8)(u8value);
    u16Bass = (MS_U16)(((s8value * 50) / 48) + 50);

    if ((u16Bass > 0) && (u16Bass < 50))
    {
        u16Bass = u16Bass - 1;
    }

    if ((u16Bass > 50) && (u16Bass < 100))
    {
        u16Bass = u16Bass + 1;
    }
...
MS_U16 HAL_SOUND_GetTreble(void)
{
    ...
    u8value = HAL_AUDIO_ReadByte(REG_SOUND_TREBLE);

    s8value = (MS_S8)(u8value);
    u16Treble = (MS_U16)(((s8value * 50) / 48) + 50);

    if ((u16Treble > 0) && (u16Treble < 50))
    {
        u16Treble = u16Treble - 1;
    }

    if ((u16Treble > 50) && (u16Treble < 100))
    {
        u16Treble = u16Treble + 1;
    }
...
MS_U16 HAL_SOUND_GetEq(MS_U8 u8Band)
{
    ...
    u8value = HAL_AUDIO_ReadByte(REG_SOUND_EQ1 + (u8Band * 2));

    s8value = (MS_S8)(u8value);
    u16value = (MS_U16)(((s8value * 50) / 48) + 50);

    if ((u16value > 0) && (u16value < 50))
    {
        u16value = u16value - 1;
    }

    if ((u16value > 50) && (u16value < 100))
    {
        u16value = u16value + 1;
    }
...
MS_BOOL HAL_SND_SetParam(Sound_SET_PARAM_Type Type, MS_U16 param1, MS_U16 param2)
{
    ...
    switch(Type)
    {
        ...
        case Sound_SET_PARAM_InternalDelay_Ch4:
        {
            ...
            {
                printf("Warning! Invalid value (%u), delay time should be less than %u ms. \r\n", param1, MULTI_CH_INPUT_DLY_UPPER_BOUND);
                param1 = MULTI_CH_INPUT_DLY_UPPER_BOUND;
            }

            HAL_MAD2_Write_DSP_Xbox(DSP2XboxAddr_multiChInputDelay, param1);
            status = TRUE;
        ...
        case Sound_SET_PARAM_InternalDelay_Ch5:
        {
            ...
            HAL_MAD2_Write_DSP_Xbox(DSP2XboxAddr_ch5InputDelay, param1);
            status = TRUE;
        ...
        case Sound_SET_PARAM_InternalDelay_Ch6:
        {
            ...
            HAL_MAD2_Write_DSP_Xbox(DSP2XboxAddr_ch6InputDelay, param1);
            status = TRUE;
...
MS_U16 HAL_SND_GetParam( Sound_GET_PARAM_Type Type, MS_U16 param1)
{
    ...
    switch(Type)
    {
        ...
        case Sound_GET_PARAM_HPF_Status:
            tmp =  HAL_SOUND_GetHPF_Status();
            break;
        ...
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_Xbox(DSP2XboxAddr_multiChInputDelay);
            break;
        }

        case Sound_GET_PARAM_InternalDelay_Ch5:
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_Xbox(DSP2XboxAddr_ch5InputDelay);
            break;
        }

        case Sound_GET_PARAM_InternalDelay_Ch6:
        {
            tmp = (MS_U16)HAL_MAD2_Read_DSP_Xbox(DSP2XboxAddr_ch6InputDelay);
            break;
        }
