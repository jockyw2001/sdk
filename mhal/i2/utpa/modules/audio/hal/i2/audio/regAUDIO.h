...
#include "K6_mainline_ac4_mpegh/audio_comm2.h"
#include "K6_mainline_ac4_mpegh/decR2_proj.h"
#else
#include "K6_mainline/audio_comm2.h"
#include "K6_mainline/decR2_proj.h"
#endif
...
#define REG_AUDIO_NEW_MODE_CFG                   0x2C48
...
//---------------------------------------------------------------------------
// AUDIO 0x163C BANK Register
// AUDIO DFS Register
//-------------------------------------------------------------------------
#define REG_DSP_DFS_REG                          0x163C60
#define REG_R2_DFS_REG                           0x163C62

//---------------------------------------------------------------------------
// AUDIO 0x163B BANK Register
// AUDIO HDMI Status Register
//-------------------------------------------------------------------------
#define REG_HDMI_STATUS_REG0                          0x163B00
#define REG_HDMI_STATUS_REG1                          0x163B02
#define REG_HDMI_STATUS_REG2                          0x163B04
#define REG_HDMI_STATUS_REG3                          0x163B06
#define REG_HDMI_STATUS_REG4                          0x163B08
#define REG_HDMI_STATUS_REG5                          0x163B0A
#define REG_HDMI_STATUS_REG6                          0x163B0C
#define REG_HDMI_STATUS_REG7                          0x163B0E
#define REG_HDMI_STATUS_REG8                          0x163B10
#define REG_HDMI_STATUS_REG9                          0x163B12
#define REG_HDMI_STATUS_REG10                         0x163B14
#define REG_HDMI_STATUS_REG11                         0x163B16
#define REG_HDMI_STATUS_REG12                         0x163B18  //[5:4] 00:valid status, 01:user status, 10: channel status
...
#define REG_SOUND_HDMI_TX_VOLUME                 M2S_MBOX_HDMI_VOL+1
...
#define REG_SOUND_HDMI_TX_VOL_FRAC               M2S_MBOX_HDMI_VOL
...
#define REG_AUDIO_STATUS_HDMI_LOCK               D2M_MBOX_HDMI_NPCM_LOCK
...
#define REG_DSP_XBOX_FLAG_CTRL                   0x2D30
#define REG_DSP_XBOX_FLAG_INFO                   0x2DEE

//---------------------------------------------------------------------------
// Audio SND-DSP XBOX REGISTER
//---------------------------------------------------------------------------
#define REG_DSP_XBOX_ADDRESS                     0x2E30
#define REG_DSP_XBOX_WR_DATA_H                   0x2E32
#define REG_DSP_XBOX_WR_DATA_L                   0x2E34
#define REG_DSP_XBOX_MISC                        0x2E36
#define REG_DSP_XBOX_RD_DATA_H                   0x2E38
#define REG_DSP_XBOX_RD_DATA_L                   0x2E3A
...
#define REG_AUDIO_PTS_H                          DSP1PmAddr_audio_PTS_H
#define REG_AUDIO_PTS_L                          DSP1PmAddr_audio_PTS_L
#define REG_PtsStcDelta_H                        DSP1PmAddr_audio_Td_H
#define REG_PtsStcDelta_L                        DSP1PmAddr_audio_Td_L
#define REG_DEC_SampleRate                       DSP1PmAddr_smpRate
#define REG_DEC_SoundMode                        DSP1PmAddr_soundMode
#define REG_MHEG5_SIZE                           DSP1PmAddr_reqMHEG5_size
#define REG_ErrorCount                           DSP1PmAddr_decErrorCnt
#define REG_AC3_AVdelay                          DSP1PmAddr_ac3_avDelay
#define REG_AAC_AVdelay                          DSP1PmAddr_aac_avDelay
#define REG_MPG_AVdelay                          DSP1PmAddr_mpg_avDelay
...
#define REG_DEC2_AUDIO_IPAUTH                    DSP2XboxAddr_ipSecurity
#define REG_DEC2_AUDIO_IPAUTH2                   DSP2XboxAddr_ipSecurity2
...
//---------------------------------------------------------------------------
// DEC-R2/SND_R2 register base
//---------------------------------------------------------------------------
#define REG_SDR_SWITCH_CTRL                      0x163C44       // [0]: 0x1129 SDR BASE, 0, SDR1; 1, SDR2
                                                                // [1]: 0x1630 SDR BASE, 0, SDR1; 1, SDR2
// R2_0 base
#define REG_R2_0_CTRL_BASE                       0x112900
#define REG_R2_0_MAILBOX_BASE                    0x112E00
#define REG_R2_0_CTRL_BANK_SW_BIT_MASK           0x01

// R2_1 base
#define REG_R2_1_CTRL_BASE                       0x163000
#define REG_R2_1_MAILBOX_BASE                    0x160300
#define REG_R2_1_CTRL_BANK_SW_BIT_MASK           0x02

// DEC-R2 base
#define REG_DECR2_DDR_BASE                       (HAL_AUDIO_GetDspMadBaseAddr(2))           // DEC-R2 DDR base
#define REG_DECR2_CTRL_BASE                      (REG_R2_0_CTRL_BASE)
#define REG_DECR2_MAILBOX_BASE                   (REG_R2_0_MAILBOX_BASE)
#define REG_DECR2_CTRL_BANK_SW_BIT_MASK          (REG_R2_0_CTRL_BANK_SW_BIT_MASK)

// SND_R2 base
#define REG_SNDR2_DDR_BASE                       (HAL_AUDIO_GetDspMadBaseAddr(2)+ADEC__R2_DDR_SIZE)             //SND_R2 base
#define REG_SNDR2_CTRL_BASE                      (REG_R2_1_CTRL_BASE)
#define REG_SNDR2_MAILBOX_BASE                   (REG_R2_1_MAILBOX_BASE)
#define REG_SNDR2_CTRL_BANK_SW_BIT_MASK          (REG_R2_1_CTRL_BANK_SW_BIT_MASK)

//---------------------------------------------------------------------------
// Audio DEC-R2 REGISTER SETTING
//---------------------------------------------------------------------------
// DEC_R2 control Bank
#define REG_DECR2_CTRL                           (REG_DECR2_CTRL_BASE + 0x80)

//SDR1
#define REG_DECR2_ICMEM_BASE_LO                  (REG_DECR2_CTRL_BASE + 0x82)
#define REG_DECR2_ICMEM_BASE_HI                  (REG_DECR2_CTRL_BASE + 0x84)

//SDR2
#define REG_DECR2_ICMEM2_BASE_LO                 (REG_DECR2_CTRL_BASE + 0x8C)
#define REG_DECR2_ICMEM2_BASE_HI                 (REG_DECR2_CTRL_BASE + 0x8E)

#define REG_DECR2_DCMEM_BASE_LO                  (REG_DECR2_CTRL_BASE + 0x86)
#define REG_DECR2_DCMEM_BASE_HI                  (REG_DECR2_CTRL_BASE + 0x88)

#define REG_DECR2_DQMEM_BASE_LO                  (REG_DECR2_CTRL_BASE + 0x9A)
#define REG_DECR2_DQMEM_BASE_HI                  (REG_DECR2_CTRL_BASE + 0x9C)
#define REG_DECR2_DQMEM_SIZE_MASK_LO             (REG_DECR2_CTRL_BASE + 0x9E)
#define REG_DECR2_DQMEM_SIZE_MASK_HI             (REG_DECR2_CTRL_BASE + 0xA0)

#define REG_DECR2_IO0_MAPPING_BASE_HI            (REG_DECR2_CTRL_BASE + 0xA8)
#define REG_DECR2_IO1_MAPPING_BASE_HI            (REG_DECR2_CTRL_BASE + 0xAA)
#define REG_DECR2_IO2_MAPPING_BASE_HI            (REG_DECR2_CTRL_BASE + 0xAC)
#define REG_DECR2_IO3_MAPPING_BASE_HI            (REG_DECR2_CTRL_BASE + 0xAE)
#define REG_DECR2_MEM_CTRL                       (REG_DECR2_CTRL_BASE + 0xB0)
#define REG_DECR2_RESET_CTRL                     (REG_DECR2_CTRL_BASE + 0x80)
#define REG_DECR2_SWITCH_CTRL                    (REG_DECR2_CTRL_BASE + 0xD6)

// DEC_R2 mailbox Bank
#define REG_DECR2_PARAM_TYPE                     (REG_DECR2_MAILBOX_BASE + 0x80)
#define REG_DECR2_ID_SELECT                      (REG_DECR2_MAILBOX_BASE + 0x82)
#define REG_DECR2_PARAM_VAL1                     (REG_DECR2_MAILBOX_BASE + 0x84)
#define REG_DECR2_PARAM_VAL2                     (REG_DECR2_MAILBOX_BASE + 0x86)
#define REG_DECR2_CMD_TOKEN                      (REG_DECR2_MAILBOX_BASE + 0xA3)
#define REG_DECR2_INFO1                          (REG_DECR2_MAILBOX_BASE + 0xA4)
#define REG_DECR2_INFO2                          (REG_DECR2_MAILBOX_BASE + 0xA6)

#define REG_DECR2_SYSTEM_START                   (REG_DECR2_MAILBOX_BASE + 0x9C)
#define REG_DECR2_ACK1                           (REG_DECR2_MAILBOX_BASE + 0xAE)
#define REG_DECR2_BOOTCODE_DONE_ACK              (REG_DECR2_MAILBOX_BASE + 0xB0)
#define REG_DECR2_DSPRELOAD_DONE_ACK             (REG_DECR2_MAILBOX_BASE + 0xB0)
#define REG_DECR2_MAIN_COUNTER                   (REG_DECR2_MAILBOX_BASE + 0xB2)
#define REG_DECR2_TIMER_COUNTER                  (REG_DECR2_MAILBOX_BASE + 0xB3)
#define REG_DECR2_VERSION                        (REG_DECR2_MAILBOX_BASE + 0xAA)

#define REG_R2_ASNDDSP_TYPE                      (REG_DECR2_MAILBOX_BASE + 0x94)
#define REG_R2_HDMI_NONPCM_PATH                  (REG_DECR2_MAILBOX_BASE + 0x96)
#define REG_R2_DECODE1_TYPE                      (REG_DECR2_MAILBOX_BASE + 0x98)
#define REG_R2_DECODE2_TYPE                      (REG_DECR2_MAILBOX_BASE + 0x9A)
#define REG_R2_DECODE3_TYPE                      (REG_DECR2_MAILBOX_BASE + 0x9C)
#define REG_R2_DECODE1_CMD                       (REG_DECR2_MAILBOX_BASE + 0x98 + 0x1)
#define REG_R2_DECODE2_CMD                       (REG_DECR2_MAILBOX_BASE + 0x9A + 0x1)
#define REG_R2_DECODE3_CMD                       (REG_DECR2_MAILBOX_BASE + 0x9C + 0x1)

//---------------------------------------------------------------------------
// Audio SND-R2 REGISTER SETTING
//---------------------------------------------------------------------------
// SND_R2 control Bank
#define REG_SNDR2_CTRL                           (REG_SNDR2_CTRL_BASE + 0x80)

//SDR1
#define REG_SNDR2_ICMEM_BASE_LO                  (REG_SNDR2_CTRL_BASE + 0x82)
#define REG_SNDR2_ICMEM_BASE_HI                  (REG_SNDR2_CTRL_BASE + 0x84)

//SDR2
#define REG_SNDR2_ICMEM2_BASE_LO                 (REG_SNDR2_CTRL_BASE + 0x8C)
#define REG_SNDR2_ICMEM2_BASE_HI                 (REG_SNDR2_CTRL_BASE + 0x8E)

#define REG_SNDR2_DCMEM_BASE_LO                  (REG_SNDR2_CTRL_BASE + 0x86)
#define REG_SNDR2_DCMEM_BASE_HI                  (REG_SNDR2_CTRL_BASE + 0x88)

#define REG_SNDR2_DQMEM_BASE_LO                  (REG_SNDR2_CTRL_BASE + 0x9A)
#define REG_SNDR2_DQMEM_BASE_HI                  (REG_SNDR2_CTRL_BASE + 0x9C)
#define REG_SNDR2_DQMEM_SIZE_MASK_LO             (REG_SNDR2_CTRL_BASE + 0x9E)
#define REG_SNDR2_DQMEM_SIZE_MASK_HI             (REG_SNDR2_CTRL_BASE + 0xA0)

#define REG_SNDR2_IO0_MAPPING_BASE_HI            (REG_SNDR2_CTRL_BASE + 0xA8)
#define REG_SNDR2_IO1_MAPPING_BASE_HI            (REG_SNDR2_CTRL_BASE + 0xAA)
#define REG_SNDR2_IO2_MAPPING_BASE_HI            (REG_SNDR2_CTRL_BASE + 0xAC)
#define REG_SNDR2_IO3_MAPPING_BASE_HI            (REG_SNDR2_CTRL_BASE + 0xAE)
#define REG_SNDR2_MEM_CTRL                       (REG_SNDR2_CTRL_BASE + 0xB0)
#define REG_SNDR2_RESET_CTRL                     (REG_SNDR2_CTRL_BASE + 0x80)
#define REG_SNDR2_SWITCH_CTRL                    (REG_SNDR2_CTRL_BASE + 0xD6)

// SND_R2 mailbox Bank
#define REG_SNDR2_PARAM_TYPE                     (REG_SNDR2_MAILBOX_BASE + 0x80)
#define REG_SNDR2_ID_SELECT                      (REG_SNDR2_MAILBOX_BASE + 0x82)
#define REG_SNDR2_PARAM_VAL1                     (REG_SNDR2_MAILBOX_BASE + 0x84)
#define REG_SNDR2_PARAM_VAL2                     (REG_SNDR2_MAILBOX_BASE + 0x86)
#define REG_SNDR2_CMD_TOKEN                      (REG_SNDR2_MAILBOX_BASE + 0xA3)
#define REG_SNDR2_INFO1                          (REG_SNDR2_MAILBOX_BASE + 0xA4)
#define REG_SNDR2_INFO2                          (REG_SNDR2_MAILBOX_BASE + 0xA6)


#define REG_SNDR2_MBOX_BYTE_DAP_SEL              (REG_SNDR2_MAILBOX_BASE+0x93)
#define REG_SNDR2_MBOX_MAIN_SEL                  (REG_SNDR2_MAILBOX_BASE+0x96)
#define REG_SNDR2_MULTI_CHANNEL_VOLUME           (REG_SNDR2_MAILBOX_BASE+0x98)

#define REG_SNDR2_SYSTEM_START                   (REG_SNDR2_MAILBOX_BASE + 0x9C)
#define REG_SNDR2_ADVSND_SEL                     (REG_SNDR2_MAILBOX_BASE + 0x8E)
#define REG_SNDR2_MBOX_BYTE_SRS_SEL              (REG_SNDR2_MAILBOX_BASE + 0x94)
#define REG_SNDR2_MBOX_BYTE_TRANSCODE_SEL        (REG_SNDR2_MAILBOX_BASE + 0x95)
#define REG_SNDR2_ACK1                           (REG_SNDR2_MAILBOX_BASE + 0xAE)
#define REG_SNDR2_BOOTCODE_DONE_ACK              (REG_SNDR2_MAILBOX_BASE + 0xB0)
#define REG_SNDR2_MAIN_COUNTER                   (REG_SNDR2_MAILBOX_BASE + 0xB2)
#define REG_SNDR2_TIMER_COUNTER                  (REG_SNDR2_MAILBOX_BASE + 0xB3)
#define REG_SNDR2_VERSION                        (REG_SNDR2_MAILBOX_BASE + 0xAA)
...
//---------------------------------------------------------------------------
// Audio HDMI RX REGISTER SETTING
//---------------------------------------------------------------------------
#define SYNTH_HDMI_N_F_Status                    0x160256
