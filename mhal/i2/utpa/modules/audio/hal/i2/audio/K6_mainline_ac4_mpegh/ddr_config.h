...
*************************************************/
    /* DSP DDR size */
        ...
        /* ASND-DSP DDR */
            ...
            #define MULTI_CH_INPUT_DLY_DRAM_SIZE           0x36000      // 6ch (256 ms), can be adjusted by request    //216KB, multiple of (MULTI_CH_INPUT_DELAY_DMA_LINESIZE*BYTES_IN_MIU_LINE)

            /* CH5 input delay */
            #define OFFSET_CH5_INPUT_DLY_DRAM_BASE         0x02F0000
            #define CH5_INPUT_DLY_DRAM_SIZE                0x12000                                                      //72KB, multiple of (DELAY_DMA_LINESIZE*BYTES_IN_MIU_LINE)
        ...
        /* Common DDR */
            ...
            #define OFFSET_MCU_R2_DMA1_READER_DRAM_BASE    0x031D100
            #define MCU_R2_DMA1_READER_DRAM_SIZE           0x50000                                                     //320KB

            #define OFFSET_MCU_R2_DMA2_READER_DRAM_BASE    0x036D100
