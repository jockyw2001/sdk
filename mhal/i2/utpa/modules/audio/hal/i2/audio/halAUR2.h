...
typedef enum
{
    asnd_dsp_type_dummy,
    asnd_dsp_type_dde=1,
    asnd_dsp_type_MS10dde=2,
    asnd_dsp_type_dtst=3,
    asnd_dsp_type_fmtx=4,
    asnd_dsp_type_btscencode=5,
    asnd_dsp_type_reserved,
} asnd_dsp_type;
...
typedef enum
{
    ...
    adec_capa_amrnb = 1<< adec_type_amrnb,
    adec_capa_amrwb = 1<< adec_type_amrwb,
    adec_capa_ac4 = 1<< adec_type_ac4,
    adec_capa_mpegH = 1<< adec_type_mpegH,
...
typedef enum
{
    ...
    AUR2_CommParam_ADEC_ProcessUntil_PTS = 0x100,
    AUR2_CommParam_ADEC_ProcessUntil_Immediate,
    AUR2_CommParam_ADEC_ProcessUntil_Cancel,
    AUR2_CommParam_ADEC_ProcessFrom_PTS,
    AUR2_CommParam_ADEC_ProcessFrom_Immediate,
    AUR2_CommParam_ADEC_ProcessFrom_Cancel,
...
typedef enum
{
    ...
    R2_SHM_INFO_DEC_OUT_L,
    R2_SHM_INFO_DEC_OUT_R,

    R2_SHM_INFO_ES_LEVEL,
    R2_SHM_INFO_PCM_LEVEL,
    R2_SHM_INFO_PCM_DMX_LEVEL,
    R2_SHM_INFO_ES_RD_PTR,
    R2_SHM_INFO_PCM_WR_PTR,
    R2_SHM_INFO_MM_FILE_REQ_SIZE,
    ...
    R2_SHM_INFO_PCMISR_EMPTY_CNT,
    R2_SHM_INFO_ELAPSED_PCM_CNT,
    ...
    /* TVOS2.0 DTV */
    R2_SHM_INFO_TVOS2_PCM_WRPT,
    R2_SHM_INFO_TVOS2_CPTS,
    R2_SHM_INFO_TVOS2_PCM_FRAMESIZE,
    R2_SHM_INFO_TVOS2_PCM_CH,

    R2_SHM_INFO_PARSER_INFO,
    ...
    R2_SHM_INFO_CHUNK_PTS_H,
    R2_SHM_INFO_CHUNK_PTS_L,

    R2_SHM_INFO_MP3_ENCODER_WRITE_PTR,
    R2_SHM_INFO_MP3_ENCODER_THRESHOLD,
    R2_SHM_INFO_MP3_ENCODER_FRAME_SIZE,
    R2_SHM_INFO_MP3_ENCODER_AVAILABLE_SIZE,
    R2_SHM_INFO_MP3_ENCODER_FRAME_COUNT,
    R2_SHM_INFO_MP3_ENCODER_TIMESTAMP,

    R2_SHM_INFO_AC4_TOC,
    R2_SHM_INFO_DTS_PCM_FRAME_SIZE,

    /* UART INFO */
    R2_SHM_INFO_UART_BUF_BASE,
    R2_SHM_INFO_UART_BUF_SIZE,
    R2_SHM_INFO_UART_BUF_WPTR,
} R2_SHM_INFO_TYPE;
...
typedef enum
{
    ...
    R2_SHM_PARAM_DOLBY_DDP_AD_SUBSTREAM,
    ...
    /* TVOS2.0 DTV */
    R2_SHM_PARAM_TVOS2_PCM_RDPTR,
    R2_SHM_PARAM_TVOS2_DTV_SYNCTYPE,

    R2_SHM_PARAM_MULTI_CHANNEL,
    R2_SHM_PARAM_DAP_EN,
    R2_SHM_PARAM_SPEAKER_EN,
	R2_SHM_PARAM_DDP_ENCODE_EN,
	R2_SHM_PARAM_MMTS_KEEP_33bit_PTS_FLAG,
    R2_SHM_PARAM_CHUNK_PTS_RD_FLAG,

    R2_SHM_PARAM_MP3_ENCODER_READ_PTR,
    R2_SHM_PARAM_PCMR_SOUND_MODE,
    R2_SHM_PARAM_AC4_1ST_PREF_LANG,
    R2_SHM_PARAM_AC4_2ND_PREF_LANG,
    R2_SHM_PARAM_AC4_DE_GAIN,
    R2_SHM_PARAM_AC4_MD_PRESENT_INDEX,
    R2_SHM_PARAM_AC4_AD_PRESENT_INDEX,
