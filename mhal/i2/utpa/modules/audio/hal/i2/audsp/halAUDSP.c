...
#include "halADVAUDIO.h"
    ...
    #include "../audio/K6_mainline_ac4_mpegh/r2_shm_comm.h"
    #include "../audio/K6_mainline_ac4_mpegh/decR2_shm.h"
    #include "../audio/K6_mainline_ac4_mpegh/ddr_config.h"
    #if ASND_R2_SUPPORT
	    #include "../audio/K6_mainline_ac4_mpegh/sndR2_shm.h"
    #endif

#else
    #include "../audio/K6_mainline/r2_shm_comm.h"
    #include "../audio/K6_mainline/decR2_shm.h"
    #include "../audio/K6_mainline/ddr_config.h"
    #if ASND_R2_SUPPORT
	    #include "../audio/K6_mainline/sndR2_shm.h"
    #endif
#endif
    ...
    #ifndef CONFIG_AUDIO_CODEC_AC4_MPEGH_DISABLE
        #include "dspcode_s/K6_mainline_ac4_mpegh/aucode_mboot_r2.c"
    #else
	    #include "dspcode_s/K6_mainline/aucode_mboot_r2.c"
    #endif
#else
    #ifndef CONFIG_AUDIO_CODEC_AC4_MPEGH_DISABLE
        #include "dspcode_s/K6_mainline_ac4_mpegh/aucode_adec_r2.c"
    #else
        #include "dspcode_s/K6_mainline/aucode_adec_r2.c"
    #endif

#if ASND_R2_SUPPORT
    #ifndef CONFIG_AUDIO_CODEC_AC4_MPEGH_DISABLE
        #include "dspcode_s/K6_mainline_ac4_mpegh/aucode_asnd_r2.c"
    #else
	    #include "dspcode_s/K6_mainline/aucode_asnd_r2.c"
    #endif
#endif
#endif
