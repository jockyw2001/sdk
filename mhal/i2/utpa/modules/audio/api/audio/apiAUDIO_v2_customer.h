...
typedef enum
{
    ...
    API_AUDIO_CUSTOMER_PCM_CAPTURE_INPUT_CH4        = 14, //<--MAX is here!!!
    ...
    API_AUDIO_CUSTOMER_PCM_CAPTURE_INPUT_MAX        = API_AUDIO_CUSTOMER_PCM_CAPTURE_INPUT_CH4 + 1,
...
typedef enum
{
    ...
    API_AUDIO_CUSTOMER_ADEC_PARAM_AC3P_1PID_AD_ENABLE           = 37, //<--MAX is here!!!
...
typedef enum
{
    ...
    API_AUDIO_CUSTOMIZED_PATCH_INFO_SPDIF_NPCM_BUF_WPTR         = 24, //<--MAX is here!!!
    ...
    API_AUDIO_CUSTOMIZED_PATCH_INFO_DEC_ES1_BUF_WPTR            = 19,
    ...
    //---MAX---
    API_AUDIO_CUSTOMIZED_PATCH_INFO_MAX = API_AUDIO_CUSTOMIZED_PATCH_INFO_SPDIF_NPCM_BUF_WPTR + 1,
...
{                                                   // |
    int Enable;                                     // |    [0 ~ 1] * 1000          1             * 1000
    int Threshold_dB;                               // |                            -30           * 1000
    int LevelRange_dB;                              // |                            20            * 1000
    int MinGain_dB[2];                              // |                            {0,0}         * 1000
    int MaxGain_dB[2];                              // |                            {0,0}         * 1000
    int Frequency_Hz[2];                            // |                            {2500,5500}   * 1000
    int Q[2];                                       // |                            {0.707,0.707} * 1000
    int AttackTime_ms;                              // |                            500           * 1000
    int ReleaseTime_ms;                             // |                            500           * 1000
...
{                                                   // |
    int Enable;                                     // |    [0 ~ 1]      * 1000     1                         * 1000
    int GlobalMakeUpGain_dB;                        // |                            0                         * 1000
                                                    // |
...
{                                                   // |
    ...
    int Angle_deg[2];                               // |    [10 ~ 90] * 1000        {50,310} * 1000
                                                    // |
...
{                                                   // |
    int Eq_Enable;                                  // |                            1     * 1000
    int Compressor_Enable;                          // |                            1     * 1000
                                                    // |
    ...
    int MakeupGain_dB;                              // |    [-20 ~ 20]  * 1000      -3    * 1000
                                                    // |
    int HighPass_Enable;                            // |                            1     * 1000
    int HighPassFc_Hz;                              // |    [10 ~ 1000] * 1000      50    * 1000
    int HighPassDecay_dB;                           // |                            -24   * 1000
                                                    // |
    int PeakFilter1_Enable;                         // |                            1     * 1000
    ...
    int Peakfilter2Q;                               // |    [0.5 ~ 20]  * 1000      0.707 * 1000
                                                    // |
    int Bwe_Enable;                                 // |                            1     * 1000
    int Bwe_PostNLDLowPassShapingFilterFc_Hz;       // |                            520   * 1000
    int Bwe_OrigGain_dB;                            // |                            0     * 1000
    int Bwe_NLDGain_dB;                             // |                            6     * 1000
    int Bwe_AttackRemoverTime_ms;                   // |                            100   * 1000
    int Bwe_AttackRemoverShortTermTime_ms;          // |                            0     * 1000
    int Bwe_GainSmooAttackTime_ms;                  // |                            5     * 1000
    int Bwe_GainSmooReleaseTime_ms;                 // |                            15    * 1000
    int Bwe_HarmonicDecay_dB;                       // |                            -10   * 1000
    int Bwe_H1Level_dB;                             // |                            -80   * 1000
    int Bwe_H2Level_dB;                             // |                            6     * 1000
    int Bwe_Compressor_Enable;                      // |                            1     * 1000
    int Bwe_PostNLDHighPass_Enable;                 // |                            0     * 1000
    int Bwe_PostNLDLowPassShapingFilter_Enable;     // |                            0     * 1000
                                                    // |
    int LevelEstimatorBass_Enable;                  // |                            1     * 1000
    int LevelEstimatorBass_Threshold_dB;            // |                            -30   * 1000
    int LevelEstimatorBass_LevelRange_dB;           // |                            20    * 1000
    int LevelEstimatorBass_MinGain_dB;              // |                            0     * 1000
    int LevelEstimatorBass_MaxGain_dB;              // |                            15    * 1000
    int LevelEstimatorBass_AttackTime_ms;           // |                            500   * 1000
    int LevelEstimatorBass_ReleaseTime_ms;          // |                            500   * 1000
    int LevelEqualizer_Q;                           // |                            1     * 1000
    int LevelEqualizer_Fc_Hz;                       // |                            110   * 1000
...
typedef enum
{
    ...
    kTSX_HorizEffct_Mild,     /**< Mild Horizontal plane effect control    */
                                                            ...
                                                            // VirtualX control params:
                                                            // Structure containing VirtualXLib1 specific control params.
...
{                                                           // |
    ...
    int                       nReferenceLevel;              // |    0x4000000(-24 dB)   0xCCCCD   ~ 0x4000000 (normalized:7.8e-4(-62 dB) ~ 0.0625(-24 dB))      Control for virtualxLib1 reference level( Read-only )
                                                            ...
                                                            // TruSrndX control params:
                                                            // Structure containing TruSrndX specific control params.
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Default             Range                                                                   Description
...
{                                                           // |
    ...
    dtsVirtualXLib1SubCompApiCtrl_t defApiControls;         // |    Definition controls.     Refer #dtsVirtualXLib1SubCompApiCtrl_t
                                                            ...
                                                            // MBHL common configuration structure
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Default             Range                                                                   Description
...
{                                                           // |
    ...
    int nMbhlProcessDiscrad;                                // |    0x0                         0 ~ 1                                                           Control to discard MBHL processing completely including application of bypass gain
                                                            ...
                                                            // MBHL compressor configuration structure
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Default             Range                                                                   Description
...
{                                                           // |
    ...
    int nMbhlCompGainReduction[3];                          // |    0x8000000(1.0)      0x83126F  ~ 0x7EC8B400(normalized: 0.064 ~ 15.848)                      Realtime compressor gain
                                                            ...
                                                            // MBHL limiter configuration structure
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Default             Range                                                                   Description
...
{                                                           // |
    ...
    int nMbhlGainReduction;                                 // |    0x40000000(1.0)     0x4189378 ~ 0x40000000(normalized: 0.064 ~ 1.0)                         Realtime final limiter gain reduction
                                                            ...
                                                            // Multi-band Hard Limiter configuration structure
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Description
...
{                                                           // |
    ...
    dtsMbhlLimiterApiCtrl    mbhlLimApiControls;            // |    MBHL limiter controls.      Refer #dtsMbhlLimiterApiCtrl
                                                            ...
                                                            // TBHDX control params:
                                                            // Structure containing TBHDX specific control params.
                                                            //  ____________________________________________________________________________________________________________________________________________________
                                                            // |
                                                            // |    Default             Range                                                                   Description
