...
//-------------------------------------------------------------------------------------------------
    ...
    #define BASEADDR_RIU            0x1F000000UL
#else
    #define BASEADDR_RIU            0xBF000000UL
#endif
...
#define RIU_READ_BYTE(addr)         (READ_BYTE((size_t)(_hal_DMD_VD_MBX.u32DMD_VD_MBX_BaseAddr + (addr))))
#define RIU_READ_2BYTE(addr)        (READ_WORD((size_t)(_hal_DMD_VD_MBX.u32DMD_VD_MBX_BaseAddr + (addr))))
#define RIU_WRITE_BYTE(addr, val)   {WRITE_BYTE((size_t)(_hal_DMD_VD_MBX.u32DMD_VD_MBX_BaseAddr + (addr)), val)}
#define RIU_WRITE_2BYTE(addr, val)  {WRITE_WORD((size_t)(_hal_DMD_VD_MBX.u32DMD_VD_MBX_BaseAddr + (addr)), val)}
