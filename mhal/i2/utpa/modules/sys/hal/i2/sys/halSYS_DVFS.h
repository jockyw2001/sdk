...
#define CONFIG_DVFS_GPU_POWER_I2C_ENABLE        0
...
#define CONFIG_DVFS_POWER_SWI2C_CPU_ID          0x82    //0x80
...
#define CONFIG_DVFS_POWER_SWI2C_CORE_ID         0x80    //0x82
...
#define CONFIG_DVFS_CPU_POWER_MAX               (200)
#define CONFIG_DVFS_CORE_POWER_SHIFT_PRADO      (69 - 2)

#if (CONFIG_DVFS_GPU_POWER_I2C_ENABLE)
#define CONFIG_DVFS_GPU_DYNAMIC_POWER_ADJUST_INIT 0x7637
#define CONFIG_DVFS_GPU_POWER_DEFAULT           98
...
#define CONFIG_DVFS_GPU_POWER_SHIFT_PRADO       (69)
#endif
...
typedef struct
{
    MS_U32  bDvfsGpuInitOk;
    MS_U32  dwPowerChipId;
} MSTAR_DVFS_GPU_INFO;

typedef struct
{
    unsigned int    dwGpuClock;
    unsigned int    dwVoltage;
    unsigned int    dwDataExchangeCount;
} MSTAR_DVFS_GPU_READ_INFO;

typedef struct
{
    unsigned int    dwDataExchangeCount;
    int             dwDataExchangeResult;
} MSTAR_DVFS_GPU_WRITE_INFO;
#endif
