...
MS_U32 DACMdbIoctl(MS_U32 cmd, const void* const pArgs)
{
    ...
    switch(cmd)
    {
        case MDBCMD_CMDLINE:
            ...
            MDrv_DACMdbIoctl_EchoCmd(paraCmdLine);
        ...
        case MDBCMD_GETINFO:
            ...
            MDrv_DACMdbIoctl_Cat(paraGetInfo);
...
void DACRegisterToUtopia(void)
{
    ...
    #ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
    UtopiaModuleRegisterMdbNode("dac", (FUtopiaMdbIoctl)DACMdbIoctl);
    #endif
