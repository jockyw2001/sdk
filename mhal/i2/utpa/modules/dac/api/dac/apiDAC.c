...
MS_BOOL _MApi_DAC_VideoTiming_ReMapping(E_OUTPUT_VIDEO_TIMING_TYPE eApiTiming, EN_OUTPUT_VIDEO_TIMING_TYPE* eDrvTiming)
{
    ...
    else if (eApiTiming == E_RES_1280x720P_24Hz)
    {
        *eDrvTiming = RES_1280x720P_24Hz;
    }
    else if (eApiTiming == E_RES_1280x720P_25Hz)
    {
        *eDrvTiming = RES_1280x720P_25Hz;
    }
    else if (eApiTiming == E_RES_1280x720P_30Hz)
    {
        *eDrvTiming = RES_1280x720P_30Hz;
    }
    ...
    else if (eApiTiming == E_RES_800x600P_60Hz)
    {
        *eDrvTiming = RES_800x600P_60Hz;
    }
    else if (eApiTiming == E_RES_1280x800P_60Hz)
    {
        *eDrvTiming = RES_1280x800P_60Hz;
    }
    else if (eApiTiming == E_RES_1366x768P_60Hz)
    {
        *eDrvTiming = RES_1366x768P_60Hz;
    }
    else if (eApiTiming == E_RES_1680x1050P_60Hz)
    {
        *eDrvTiming = RES_1680x1050P_60Hz;
    }
    else if (eApiTiming == E_RES_1920x1200P_60Hz)
    {
        *eDrvTiming = RES_1920x1200P_60Hz;
    }
    else
    {
        return FALSE;
...
MS_BOOL MApi_DAC_Init_U2(void* pInstance)
{
    ...
    if(pDACResourcePrivate->stapiDAC._stDac_ApiStatus.bDac_Initialized == FALSE)
    {
        MDrv_DAC_Init();
    }
...
void MApi_DAC_DumpTable_U2(void* pInstance, MS_U8 *pDACTable, MS_U8 u8DACtype)
{
    ...
    switch(u8DACtype)
    {
        case E_DAC_DUMP_TABTYPE_INIT:
            u8DrvDACtype = DAC_TABTYPE_INIT;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_GPIO:
            u8DrvDACtype = DAC_TABTYPE_INIT_GPIO;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_SC:
            u8DrvDACtype = DAC_TABTYPE_INIT_SC;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_MOD:
            u8DrvDACtype = DAC_TABTYPE_INIT_MOD;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDGEN:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDGEN;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_8BIT:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_8BIT;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_8BIT_Divider:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_8BIT_Divider;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_10BIT:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_10BIT;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_10BIT_Divider:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_10BIT_Divider;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_12BIT:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_12BIT;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_12BIT_Divider:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_12BIT_Divider;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_16BIT:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_16BIT;
            break;

        case E_DAC_DUMP_TABTYPE_INIT_HDMITX_16BIT_Divider:
            u8DrvDACtype = DAC_TABTYPE_INIT_HDMITX_16BIT_Divider;
            break;

        case E_DAC_DUMP_TABTYPE_Gamma:
            u8DrvDACtype = DAC_TABTYPE_Gamma;
            break;

        case E_DAC_DUMP_TABTYPE_SC1_INIT:
            u8DrvDACtype = DAC_TABTYPE_SC1_INIT;
            break;

        case E_DAC_DUMP_TABTYPE_SC1_INIT_SC:
            u8DrvDACtype = DAC_TABTYPE_SC1_INIT_SC;
            break;

        case E_DAC_DUMP_TABTYPE_DAC_PLL_INIT:
            u8DrvDACtype = DAC_TABTYPE_DAC_PLL_INIT;
            break;

        case E_DAC_DUMP_TABTYPE_FRAMELOCK_SC_INIT:
            u8DrvDACtype = DAC_TABTYPE_FRAMELOCK_SC_INIT;
            break;

        case E_DAC_DUMP_TABTYPE_FRAMELOCK_CLK_INIT:
            u8DrvDACtype = DAC_TABTYPE_FRAMELOCK_CLK_INIT;
            break;

        case E_DAC_DUMP_TABTYPE_PNL_CLK_INIT:
            u8DrvDACtype = DAC_TABTYPE_PNL_CLK_INIT;
            break;
    }

    MDrv_DAC_DumpTable(pDACTable, u8DrvDACtype);

    pDACResourcePrivate->stapiDAC._stDac_DacPowerState.DACTable[u8DrvDACtype] = (MS_VIRT)pDACTable;
    pDACResourcePrivate->stapiDAC._stDac_DacPowerState.u8DACtype[u8DrvDACtype] = 1;

    if((u8DrvDACtype == DAC_TABTYPE_SC1_INIT) || (u8DrvDACtype == DAC_TABTYPE_SC1_INIT_SC))
    {
