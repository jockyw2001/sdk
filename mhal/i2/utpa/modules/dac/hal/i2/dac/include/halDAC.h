...
#define L_BK_PAD_TOP1(x)            BK_REG_L(PAD_TOP1_BASE, x)
#define H_BK_PAD_TOP1(x)            BK_REG_H(PAD_TOP1_BASE, x)
...
#define W1BYTE(u32Addr, u8Val, u8mask)     \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x\n", (unsigned int)(u32Addr),  (unsigned int)(BMASK(u8mask) & 0xFF), (unsigned int)(((u8Val) & 0xFF)));
...
#define W2BYTE(u32Addr, u16Val, u16mask)    \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x\n", (unsigned int)(u32Addr),  (unsigned int)(BMASK(u16mask) & 0xFF), (unsigned int)(((u16Val) & 0xFF))); \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x\n", (unsigned int)(u32Addr+1),  (unsigned int)(BMASK(u16mask & 0xFF00) >> 8), (unsigned int)((((u16Val) & 0xFF00) >> 8)));
...
#define W2BYTE_TAB(u32Addr, u16Val, u16mask)    \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x\n", (unsigned int)(u32Addr),  (unsigned int)((u16mask) & 0xFF), (unsigned int)(((u16Val) & 0xFF))); \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x\n", (unsigned int)(u32Addr+1),  (unsigned int)(((u16mask) & 0xFF00) >> 8), (unsigned int)((((u16Val) & 0xFF00) >> 8)));
...
INTERFACE void Hal_DAC_InitHdmitxTbl(void);

INTERFACE void Hal_DAC_Dump_AtopRegTab(void);
