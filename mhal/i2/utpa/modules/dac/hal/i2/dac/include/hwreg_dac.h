...
#define REG_PAD_TOP_HSYNC_EN       (0x05)
#define REG_PAD_TOP_HSYNC_EN_MSK   (0x40)
#define REG_PAD_TOP_VSYNC_EN       (0x0B)
#define REG_PAD_TOP_VSYNC_EN_MSK   (0x20)
#endif
