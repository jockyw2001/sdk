...
#define DAC_HDDAC_DEFAULT_OUTPUTSWAPSEL   DAC_R_G_B
...
#define PARSING_DAC_TAB_TYPE(x)   ( x ==  DAC_TABTYPE_INIT                      ? "DAC_TABTYPE_INIT"                        : \
                                    x ==  DAC_TABTYPE_INIT_GPIO                 ? "DAC_TABTYPE_INIT_GPIO"                   : \
                                    x ==  DAC_TABTYPE_INIT_SC                   ? "DAC_TABTYPE_INIT_SC"                     : \
                                    x ==  DAC_TABTYPE_INIT_MOD                  ? "DAC_TABTYPE_INIT_MOD"                    : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_8BIT          ? "DAC_TABTYPE_INIT_HDMITX_8BIT"            : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_8BIT_Divider  ? "DAC_TABTYPE_INIT_HDMITX_8BIT_Divider"    : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_10BIT         ? "DAC_TABTYPE_INIT_HDMITX_10BIT"           : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_10BIT_Divider ? "DAC_TABTYPE_INIT_HDMITX_10BIT_Divider"   : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_12BIT         ? "DAC_TABTYPE_INIT_HDMITX_12BIT"           : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_12BIT_Divider ? "DAC_TABTYPE_INIT_HDMITX_12BIT_Divider"   : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_16BIT         ? "DAC_TABTYPE_INIT_HDMITX_16BIT"           : \
                                    x ==  DAC_TABTYPE_INIT_HDMITX_16BIT_Divider ? "DAC_TABTYPE_INIT_HDMITX_16BIT_Divider"   : \
                                    x ==  DAC_TABTYPE_Gamma                     ? "DAC_TABTYPE_Gamma"                       : \
                                    x ==  DAC_TABTYPE_SC1_INIT                  ? "DAC_TABTYPE_SC1_INIT"                    : \
                                    x ==  DAC_TABTYPE_SC1_INIT_SC               ? "DAC_TABTYPE_SC1_INIT_SC"                 : \
                                    x ==  DAC_TABTYPE_DAC_PLL_INIT              ? "DAC_TABTYPE_DAC_PLL_INIT"                : \
                                    x ==  DAC_TABTYPE_INIT_HDGEN                ? "DAC_TABTYPE_INIT_HDGEN"                  : \
                                    x ==  DAC_TABTYPE_FRAMELOCK_CLK_INIT        ? "DAC_TABTYPE_FRAMELOCK_CLK_INIT"          : \
                                    x ==  DAC_TABTYPE_FRAMELOCK_SC_INIT         ? "DAC_TABTYPE_FRAMELOCK_SC_INIT"           : \
                                    x ==  DAC_TABTYPE_PNL_CLK_INIT              ? "DAC_TABTYPE_PNL_CLK_INIT"                : \
                                                                                  "UNKNOWN")

#define PARSING_DAC_TABLE(x)  (  x == DAC_PANEL_480I_60          ? "480I_60        "  : \
                                 x == DAC_PANEL_480P_60          ? "480P_60        "  : \
                                 x == DAC_PANEL_576I_50          ? "576I_50        "  : \
                                 x == DAC_PANEL_576P_50          ? "576P_50        "  : \
                                 x == DAC_PANEL_720P_50          ? "720P_50        "  : \
                                 x == DAC_PANEL_720P_60          ? "720P_60        "  : \
                                 x == DAC_PANEL_1080I_50         ? "1080I_50       "  : \
                                 x == DAC_PANEL_1080I_60         ? "1080I_60       "  : \
                                 x == DAC_PANEL_1080P_50         ? "1080P_50       "  : \
                                 x == DAC_PANEL_1080P_60         ? "1080P_60       "  : \
                                 x == DAC_PANEL_1080P_30         ? "1080P_30       "  : \
                                 x == DAC_PANEL_1080P_25         ? "1080P_25       "  : \
                                 x == DAC_PANEL_1080P_24         ? "1080P_24       "  : \
                                 x == DAC_PANEL_640x480_60       ? "640x480_60     "  : \
                                 x == DAC_PANEL_1920x2205P_24    ? "1920x2205P_24  "  : \
                                 x == DAC_PANEL_1280x1470P_50    ? "1280x1470P_50  "  : \
                                 x == DAC_PANEL_1280x1470P_60    ? "1280x1470P_60  "  : \
                                 x == DAC_PANEL_3840x2160P_24    ? "3840x2160P_24  "  : \
                                 x == DAC_PANEL_3840x2160P_25    ? "3840x2160P_25  "  : \
                                 x == DAC_PANEL_3840x2160P_30    ? "3840x2160P_30  "  : \
                                 x == DAC_PANEL_3840x2160P_50    ? "3840x2160P_50  "  : \
                                 x == DAC_PANEL_3840x2160P_60    ? "3840x2160P_60  "  : \
                                 x == DAC_PANEL_4096x2160P_24    ? "4096x2160P_24  "  : \
                                 x == DAC_PANEL_4096x2160P_25    ? "4096x2160P_25  "  : \
                                 x == DAC_PANEL_4096x2160P_30    ? "4096x2160P_30  "  : \
                                 x == DAC_PANEL_4096x2160P_50    ? "4096x2160P_50  "  : \
                                 x == DAC_PANEL_4096x2160P_60    ? "4096x2160P_60  "  : \
                                 x == DAC_PANEL_3840x2160P420_30 ? "3840x2160P420_3"  : \
                                 x == DAC_PANEL_3840x2160P420_50 ? "3840x2160P420_5"  : \
                                 x == DAC_PANEL_3840x2160P420_60 ? "3840x2160P420_6"  : \
                                 x == DAC_PANEL_4096x2160P420_30 ? "4096x2160P420_3"  : \
                                 x == DAC_PANEL_4096x2160P420_50 ? "4096x2160P420_5"  : \
                                 x == DAC_PANEL_4096x2160P420_60 ? "4096x2160P420_6"  : \
                                 x == DAC_PANEL_800x600P_60      ? "800x600P_60    "  : \
                                 x == DAC_PANEL_1024x768P_60     ? "1024x768P_60   "  : \
                                 x == DAC_PANEL_1280x1024P_60    ? "1280x1024P_60  "  : \
                                 x == DAC_PANEL_1280x800P_60     ? "1280x800P_60   "  : \
                                 x == DAC_PANEL_1366x768P_60     ? "1366x768P_60   "  : \
                                 x == DAC_PANEL_1440x900P_60     ? "1440x900P_60   "  : \
                                 x == DAC_PANEL_1600x1200P_60    ? "1600x1200P_60  "  : \
                                 x == DAC_PANEL_1680x1050P_60    ? "1680x1050P_60  "  : \
                                 x == DAC_PANEL_1920x1200P_60    ? "1920x1200P_60  "  : \
                                                                   "UNKNOWN")
...
#define IS_DAC_TABTYPE_8BIT(x)      ( x == DAC_TABTYPE_INIT_HDMITX_8BIT ||  x == DAC_TABTYPE_INIT_HDMITX_8BIT_Divider)
#define IS_DAC_TABTYPE_10BIT(x)     ( x == DAC_TABTYPE_INIT_HDMITX_10BIT ||  x == DAC_TABTYPE_INIT_HDMITX_10BIT_Divider)
#define IS_DAC_TABTYPE_12BIT(x)     ( x == DAC_TABTYPE_INIT_HDMITX_12BIT ||  x == DAC_TABTYPE_INIT_HDMITX_12BIT_Divider)
#define IS_DAC_TABTYPE_16BIT(x)     ( x == DAC_TABTYPE_INIT_HDMITX_16BIT ||  x == DAC_TABTYPE_INIT_HDMITX_16BIT_Divider)

#define IS_DAC_TABTYPE_DIVIDER(x)   ( x == DAC_TABTYPE_INIT_HDMITX_8BIT_Divider  || \
                                      x == DAC_TABTYPE_INIT_HDMITX_10BIT_Divider || \
                                      x == DAC_TABTYPE_INIT_HDMITX_12BIT_Divider || \
                                      x == DAC_TABTYPE_INIT_HDMITX_16BIT_Divider)
...
static void _Hal_DAC_GetTabSize(MS_U8 *pDacTab, MS_U16 u16tabtype, MS_U32 *pu32DacTabsize)
{
    ...
    case DAC_TABTYPE_DAC_PLL_INIT:
    case DAC_TABTYPE_FRAMELOCK_SC_INIT:
    case DAC_TABTYPE_FRAMELOCK_CLK_INIT:
    case DAC_TABTYPE_PNL_CLK_INIT:
        u8Colslen = 4;
        break;
...
static void _Hal_DAC_DumpDacPllRegTab(MS_U8 u8DacTab[DAC_TAB_MAX_SIZE])
{
    MS_U32 u32tabIdx = 0;
    MS_U16 u16timeout = 0x3FFF;
    MS_U32 u32Addr;
...
void Hal_DAC_Enable(MS_BOOL bEnable, MS_BOOL bIsYPbPr)
{
    ...
    if((bIsYPbPr) && (R1BYTE(BK_DAC(REG_DAC_HD_SEL), 1:0) == DAC_TO_VE_YPBPR))
    {
        //Enable old mode
    ...
    if (bIsYPbPr)
    {
        ...
        W2BYTE(L_BK_CHIPTOP(REG_CKG_HDGEN), (~bEnable), REG_CKG_HDGEN_DISABLE_MASK);
...
void Hal_HDGEN_SetTiming(EN_OUTPUT_VIDEO_TIMING_TYPE enTiming)
{
    ...
    switch(enTiming)
    {
        ...
        case RES_1024x768P_60Hz:
            ...
            break;
        case RES_800x600P_60Hz:
            _geDACPanel_index = DAC_PANEL_800x600P_60;
            break;
        case RES_1280x800P_60Hz:
            _geDACPanel_index = DAC_PANEL_1280x800P_60;
            break;
        case RES_1366x768P_60Hz:
            _geDACPanel_index = DAC_PANEL_1366x768P_60;
            break;
        case RES_1680x1050P_60Hz:
            _geDACPanel_index = DAC_PANEL_1680x1050P_60;
            break;
        case RES_1920x1200P_60Hz:
            _geDACPanel_index = DAC_PANEL_1920x1200P_60;
            break;
        case RES_1280x720P_24Hz:
        case RES_1280x720P_25Hz:
        case RES_1280x720P_30Hz:
        default:
            printf("[%s][%d]Wrong Output Video Timing Type %d!!!\n",__FUNCTION__,__LINE__,enTiming);
            return;
    }

    DAC_DBG(printf("DAC Panel Table Index =%s\n", PARSING_DAC_TABLE(_geDACPanel_index)));
...
void Hal_DAC_Dump_AtopRegTab(void)
{
    MS_DAC_ATOP_INFO *pDacAtopInfo = NULL;
    MS_U16 i, j, u16RegIdx;
    MS_U8 *pData;
    MS_U32 u32Addr;
    MS_U8 u8Value, u8Mask;

    for(i=0; i<MS_DAC_ATOP_TAB_NUM; i++)
    {
        pDacAtopInfo = &stHAL_DAC_HDMITX_ATOP_TBL[i];
        pData = pDacAtopInfo->pData;

        for(u16RegIdx=0; u16RegIdx < pDacAtopInfo->u16RegNum; u16RegIdx++)
        {
            j = u16RegIdx *  (REG_ADDR_SIZE+REG_MASK_SIZE+REG_DATA_SIZE);

            u32Addr  = ((MS_U32)pData[j] << 8) | pData[j+1] | 0x170000;
            u8Mask  =  pData[j+2];
            u8Value = pData[j+3];
            W1BYTE_TAB(u32Addr, u8Value, u8Mask);
...
void Hal_DAC_DumpTable(MS_U8 *pDACTable, MS_U8 u8DACtype)
{
    ...
    DAC_DBG(printf("%s %d DACType= %s\n", __FUNCTION__, __LINE__, PARSING_DAC_TAB_TYPE(u8DACtype)));


    if(u8DACtype == DAC_TABTYPE_INIT_HDMITX_8BIT            ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_8BIT_Divider    ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_10BIT           ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_10BIT_Divider   ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_12BIT           ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_12BIT_Divider   ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_16BIT           ||
       u8DACtype == DAC_TABTYPE_INIT_HDMITX_16BIT_Divider)
    {
        //move to hdmitx to setup ATOP
    }
    else
    {
        ...
        switch(u8DACtype)
        {
            ...
            case DAC_TABTYPE_SC1_INIT_SC:
                ...
                break;
            case DAC_TABTYPE_DAC_PLL_INIT:
                pDACTable = DacTbl.pDacDAC_PLL_INITTab;
                break;
            case DAC_TABTYPE_FRAMELOCK_SC_INIT:
                pDACTable = DacTbl.pDacFRAMELOCK_SC_INITTab;
                break;
            case DAC_TABTYPE_FRAMELOCK_CLK_INIT:
                pDACTable = DacTbl.pDacFRAMELOCK_CLK_INITTab;
                break;
            case DAC_TABTYPE_PNL_CLK_INIT:
                pDACTable = DacTbl.pDacPNL_CLK_INITTab;
                break;
            default:
        ...
        case DAC_TABTYPE_SC1_INIT_SC:
            ...
            break;
        case DAC_TABTYPE_DAC_PLL_INIT:
            _Hal_DAC_DumpDacPllRegTab(u8DacTab);
            break;
        default:
            DAC_DBG(printf( "GetTable:unknown Tab type> \n"));
            break;
...
void Hal_DAC_SetVGAHsyncVsync(MS_BOOL bEnable)
{
    if (bEnable)
    {
        //LPF and upsample
        W2BYTE_TAB(HDGEN_BK_SELECT, 0x3, 0xFF);
        W1BYTE_TAB(BK_HDGEN(0xC0), 0, 0x1);             //enable new upsample low-pass filter

        W2BYTE_TAB(HDGEN_BK_SELECT, 0x1, 0xFF);
        W1BYTE_TAB(BK_HDGEN(0x7C), 0x1, 0x1);           //select source of oversample filter : #1: vga out

        W2BYTE_TAB(HDGEN_BK_SELECT, 0x2, 0xFF);
        W1BYTE_TAB(BK_HDGEN(0x80), BIT(1), BIT(1));           //bypass 422to444 filter

        W1BYTE_TAB(H_BK_PAD_TOP1(REG_PAD_TOP_HSYNC_EN), 0x40, REG_PAD_TOP_HSYNC_EN_MSK);
		W1BYTE_TAB(H_BK_PAD_TOP1(REG_PAD_TOP_VSYNC_EN), 0x20, REG_PAD_TOP_VSYNC_EN_MSK);
    }
    else
    {
        ...
        //LPF and upsample
        W2BYTE_TAB(HDGEN_BK_SELECT, 0x3, 0xFF);
        W1BYTE_TAB(BK_HDGEN(0xC0), 1, 0x1);             //disable new upsample low-pass filter

        W2BYTE_TAB(HDGEN_BK_SELECT, 0x1, 0xFF);
        W1BYTE_TAB(BK_HDGEN(0x7C), 0x0, 0x1);           //select source of oversample filter : #0: hdgen out

        W2BYTE_TAB(HDGEN_BK_SELECT, 0x2, 0xFF);
        W1BYTE_TAB(H_BK_PAD_TOP1(REG_PAD_TOP_HSYNC_EN), 0x00, REG_PAD_TOP_HSYNC_EN_MSK);
		W1BYTE_TAB(H_BK_PAD_TOP1(REG_PAD_TOP_VSYNC_EN), 0x00, REG_PAD_TOP_VSYNC_EN_MSK);
