...
#if PQ_GRULE_NR_ENABLE
extern U8 MST_GRule_NR_IP_Index_SC1_Main[PQ_GRULE_NR_IP_NUM_SC1_Main];
extern U8 MST_GRule_NR_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_NR_NUM_SC1_Main][PQ_GRULE_NR_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_OSD_BW_ENABLE
extern U8 MST_GRule_OSD_BW_IP_Index_SC1_Main[PQ_GRULE_OSD_BW_IP_NUM_SC1_Main];
extern U8 MST_GRule_OSD_BW_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_OSD_BW_NUM_SC1_Main][PQ_GRULE_OSD_BW_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_MPEG_NR_ENABLE
extern U8 MST_GRule_MPEG_NR_IP_Index_SC1_Main[PQ_GRULE_MPEG_NR_IP_NUM_SC1_Main];
extern U8 MST_GRule_MPEG_NR_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_MPEG_NR_NUM_SC1_Main][PQ_GRULE_MPEG_NR_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_FILM_MODE_ENABLE
extern U8 MST_GRule_FILM_MODE_IP_Index_SC1_Main[PQ_GRULE_FILM_MODE_IP_NUM_SC1_Main];
extern U8 MST_GRule_FILM_MODE_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_FILM_MODE_NUM_SC1_Main][PQ_GRULE_FILM_MODE_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern U8 MST_GRule_DYNAMIC_CONTRAST_IP_Index_SC1_Main[PQ_GRULE_DYNAMIC_CONTRAST_IP_NUM_SC1_Main];
extern U8 MST_GRule_DYNAMIC_CONTRAST_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_DYNAMIC_CONTRAST_NUM_SC1_Main][PQ_GRULE_DYNAMIC_CONTRAST_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_DDR_SELECT_ENABLE
extern U8 MST_GRule_DDR_SELECT_IP_Index_SC1_Main[PQ_GRULE_DDR_SELECT_IP_NUM_SC1_Main];
extern U8 MST_GRule_DDR_SELECT_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_DDR_SELECT_NUM_SC1_Main][PQ_GRULE_DDR_SELECT_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_PTP_ENABLE
extern U8 MST_GRule_PTP_IP_Index_SC1_Main[PQ_GRULE_PTP_IP_NUM_SC1_Main];
extern U8 MST_GRule_PTP_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_GRULE_PTP_NUM_SC1_Main][PQ_GRULE_PTP_IP_NUM_SC1_Main];
#endif

#if PQ_GRULE_NR_ENABLE
extern U8 MST_GRule_720_NR_SC1_Main[PQ_GRULE_NR_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_OSD_BW_ENABLE
extern U8 MST_GRule_720_OSD_BW_SC1_Main[PQ_GRULE_OSD_BW_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_MPEG_NR_ENABLE
extern U8 MST_GRule_720_MPEG_NR_SC1_Main[PQ_GRULE_MPEG_NR_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_FILM_MODE_ENABLE
extern U8 MST_GRule_720_FILM_MODE_SC1_Main[PQ_GRULE_FILM_MODE_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_DYNAMIC_CONTRAST_ENABLE
extern U8 MST_GRule_720_DYNAMIC_CONTRAST_SC1_Main[PQ_GRULE_DYNAMIC_CONTRAST_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_DDR_SELECT_ENABLE
extern U8 MST_GRule_720_DDR_SELECT_SC1_Main[PQ_GRULE_DDR_SELECT_LVL_NUM_SC1_Main];
#endif
#if PQ_GRULE_PTP_ENABLE
extern U8 MST_GRule_720_PTP_SC1_Main[PQ_GRULE_PTP_LVL_NUM_SC1_Main];
#endif
