...
#define PQ_CSCRule_IP_NUM_Sub 1
...
extern U8 MST_CSCRule_IP_Index_Sub[PQ_CSCRule_IP_NUM_Sub];
extern U8 MST_CSCRule_Array_Sub[PQ_CSCRule_NUM_Sub][PQ_CSCRule_IP_NUM_Sub];
