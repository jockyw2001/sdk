...
#ifndef _K6_SC1_MAIN_EX_C_
#define _K6_SC1_MAIN_EX_C_

#if PQ_SKIPRULE_ENABLE

U8 MST_SkipRule_IP_SC1_Main_Ex[PQ_IP_NUM_SC1_Main_Ex]=
{
...
// AFEC_no_comm
//****************************************************
U8 MST_AFEC_no_comm_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_AFEC_no_comm_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_AFEC_no_comm_NUMS_SC1_Main_Ex]=
{
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};
...
// HISDNR
//****************************************************
U8 MST_HISDNR_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
...
U8 MST_HISDNR_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_HISDNR_NUMS_SC1_Main_Ex]=
{
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};
...
// SPF_DBK
//****************************************************
U8 MST_SPF_DBK_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
...
U8 MST_SPF_DBK_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_SPF_DBK_NUMS_SC1_Main_Ex]=
{
...
// DMS
//****************************************************
U8 MST_DMS_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_SC1_BK26_10_L), 0x02, 0x02 },
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_DMS_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_DMS_NUMS_SC1_Main_Ex]=
{
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};
...
// DMS_H
//****************************************************
U8 MST_DMS_H_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_SC1_BK26_19_L), 0x0B, 0x00 },
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_DMS_H_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_DMS_H_NUMS_SC1_Main_Ex]=
{
...
// DMS_V
//****************************************************
U8 MST_DMS_V_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_SC1_BK26_19_L), 0x30, 0x00 },
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_DMS_V_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_DMS_V_NUMS_SC1_Main_Ex]=
{
...
// DMS_NMR
//****************************************************
U8 MST_DMS_NMR_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_DMS_NMR_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_DMS_NMR_NUMS_SC1_Main_Ex]=
{
...
// VIP_HNMR_Y_lowY
//****************************************************
U8 MST_VIP_HNMR_Y_lowY_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_HNMR_Y_lowY_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_HNMR_Y_lowY_NUMS_SC1_Main_Ex]=
{
...
// VIP_VNMR_Y_lowY
//****************************************************
U8 MST_VIP_VNMR_Y_lowY_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_VNMR_Y_lowY_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_VNMR_Y_lowY_NUMS_SC1_Main_Ex]=
{
...
// VIP_Peaking_adptive
//****************************************************
U8 MST_VIP_Peaking_adptive_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
...
U8 MST_VIP_Peaking_adptive_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_Peaking_adptive_NUMS_SC1_Main_Ex]=
{
...
//****************************************************
U8 MST_VIP_Peaking_Pcoring_ad_C_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_SC1_BK27_2D_L), 0xFF, 0x88 },//Same mark
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_Peaking_Pcoring_ad_C_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_Peaking_Pcoring_ad_C_NUMS_SC1_Main_Ex]=
{
...
//****************************************************
U8 MST_VIP_Peaking_gain_by_Cedge_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_Peaking_gain_by_Cedge_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_Peaking_gain_by_Cedge_NUMS_SC1_Main_Ex]=
{
...
// VIP_ICC_Target
//****************************************************
U8 MST_VIP_ICC_Target_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_ICC_Target_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_ICC_Target_NUMS_SC1_Main_Ex]=
{
...
// VIP_IBC_weight
//****************************************************
U8 MST_VIP_IBC_weight_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};

U8 MST_VIP_IBC_weight_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_IBC_weight_NUMS_SC1_Main_Ex]=
{
...
// VIP_ACK
//****************************************************
U8 MST_VIP_ACK_COM_SC1_Main_Ex[][4] =
{      // Reg           Mask  Value
...
U8 MST_VIP_ACK_SC1_Main_Ex[][REG_ADDR_SIZE+REG_MASK_SIZE+PQ_IP_VIP_ACK_NUMS_SC1_Main_Ex]=
{
 { PQ_MAP_REG(REG_TABLE_END), 0x00, 0x00 }
};


EN_IPTAB_INFO PQ_IPTAB_INFO_SC1_Main_Ex[]=
{
