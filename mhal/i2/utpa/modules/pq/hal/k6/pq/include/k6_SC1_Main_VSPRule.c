...
U8 MST_VSPRule_IP_Index_SC1_Main[PQ_VSPRule_IP_NUM_SC1_Main]=
{
    PQ_IP_VSP_Y_SC1_Main,
    PQ_IP_VSP_C_SC1_Main,
    PQ_IP_SRAM1_SC1_Main,
};


U8 MST_VSPRule_Array_SC1_Main[PQ_VSPRule_NUM_SC1_Main][PQ_VSPRule_IP_NUM_SC1_Main]=
{
    {//PreV_ScalingDown_Interlace, 0
        PQ_IP_VSP_Y_Bilinear_SC1_Main, PQ_IP_VSP_C_Bilinear_SC1_Main, PQ_IP_NULL,
    },
    {//PreV_ScalingDown_Progressive, 1
        PQ_IP_VSP_Y_Bilinear_SC1_Main, PQ_IP_VSP_C_Bilinear_SC1_Main, PQ_IP_NULL,
    },
    {//ScalingDown_00x_YUV, 2
        PQ_IP_VSP_Y_SRAM_1_4Tap_SC1_Main, PQ_IP_VSP_C_C_SRAM_1_SC1_Main, PQ_IP_SRAM1_InvSinc4Tc4p4Fc50Apass01Astop55_SC1_Main,
    },
    {//ScalingDown_00x_RGB, 3
        PQ_IP_VSP_Y_Bilinear_SC1_Main, PQ_IP_VSP_C_Bilinear_SC1_Main, PQ_IP_SRAM1_InvSinc4Tc4p4Fc50Apass01Astop55_SC1_Main,
    },
