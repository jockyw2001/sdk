...
U8 MST_VSPRule_IP_Index_Main[PQ_VSPRule_IP_NUM_Main]=
{
    PQ_IP_VSP_Y_Main,
    PQ_IP_VSP_C_Main,
    PQ_IP_SRAM1_Main,
...
U8 MST_VSPRule_Array_Main[PQ_VSPRule_NUM_Main][PQ_VSPRule_IP_NUM_Main]=
{
    ...
    {//ScalingDown_00x_YUV, 2
        PQ_IP_VSP_Y_SRAM_1_4Tap_Main, PQ_IP_VSP_C_C_SRAM_1_Main, PQ_IP_SRAM1_InvSinc4Tc4p4Fc75Apass0001Astop40_Main, PQ_IP_C_SRAM1_C121_Main,
    },
    {//ScalingDown_00x_RGB, 3
        PQ_IP_VSP_Y_Bilinear_Main, PQ_IP_VSP_C_Bilinear_Main, PQ_IP_NULL, PQ_IP_NULL,
    },
    ...
    {//ScalingDown_10x_YUV, 22
        PQ_IP_VSP_Y_Bypass_Main, PQ_IP_VSP_C_Bypass_Main, PQ_IP_NULL, PQ_IP_NULL,
    },
