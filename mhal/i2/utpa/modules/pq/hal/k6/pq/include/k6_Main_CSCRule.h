...
#define PQ_CSCRule_IP_NUM_Main 1
...
extern U8 MST_CSCRule_IP_Index_Main[PQ_CSCRule_IP_NUM_Main];
extern U8 MST_CSCRule_Array_Main[PQ_CSCRule_NUM_Main][PQ_CSCRule_IP_NUM_Main];
