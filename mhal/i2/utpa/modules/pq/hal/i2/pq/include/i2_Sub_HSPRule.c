...
U8 MST_HSPRule_IP_Index_Sub[PQ_HSPRule_IP_NUM_Sub]=
{
    PQ_IP_HSP_Y_Sub,
    PQ_IP_HSP_C_Sub,
    PQ_IP_SRAM4_Sub,
...
U8 MST_HSPRule_Array_Sub[PQ_HSPRule_NUM_Sub][PQ_HSPRule_IP_NUM_Sub]=
{
    ...
    {//ScalingDown_00x_YUV, 2
        PQ_IP_HSP_Y_SRAM_4_4Tap_Sub, PQ_IP_HSP_C_C_SRAM_4_Sub, PQ_IP_SRAM4_InvSinc4Tc4p4Fc60Apass0001Astop40_Sub, PQ_IP_C_SRAM4_C121_Sub, 
    },
    {//ScalingDown_00x_RGB, 3
        PQ_IP_HSP_Y_Bilinear_Sub, PQ_IP_HSP_C_Bilinear_Sub, PQ_IP_NULL, PQ_IP_C_SRAM4_C121_Sub, 
    },
    ...
    {//ScalingDown_10x_YUV, 22
        PQ_IP_HSP_Y_Bypass_Sub, PQ_IP_HSP_C_Bypass_Sub, PQ_IP_NULL, PQ_IP_NULL, 
    },
