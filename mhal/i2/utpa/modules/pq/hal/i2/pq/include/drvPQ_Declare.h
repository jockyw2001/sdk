...
#include "i2_Main.h"              // table config parameter
#include "i2_Main_HSDRule.h"      // table config parameter
#include "i2_Main_VSDRule.h"      // table config parameter
#include "i2_Main_HSPRule.h"      // table config parameter
#include "i2_Main_VSPRule.h"      // table config parameter
#include "i2_Main_CSCRule.h"      // table config parameter
#include "i2_Main_GRule.h"        // table config parameter
#include "i2_Main_Ex.h"           // table config parameter

#include "i2_Sub.h"               // table config parameter
#include "i2_Sub_HSDRule.h"       // table config parameter
#include "i2_Sub_VSDRule.h"       // table config parameter
#include "i2_Sub_HSPRule.h"       // table config parameter
#include "i2_Sub_VSPRule.h"       // table config parameter
#include "i2_Sub_CSCRule.h"       // table config parameter
#include "i2_Sub_GRule.h"         // table config parameter
#include "i2_Sub_Ex.h"            // table config parameter

#include "i2_SC1_Main.h"              // table config parameter
#include "i2_SC1_Main_HSDRule.h"      // table config parameter
#include "i2_SC1_Main_VSDRule.h"      // table config parameter
#include "i2_SC1_Main_HSPRule.h"      // table config parameter
#include "i2_SC1_Main_VSPRule.h"      // table config parameter
#include "i2_SC1_Main_CSCRule.h"      // table config parameter
#include "i2_SC1_Main_GRule.h"        // table config parameter
#include "i2_SC1_Main_Ex.h"           // table config parameter

 //for customer Main PQ bin support Grule
#if ENABLE_PQ_CUSTOMER_BIN_MAIN_GRULE
#include "i2_Main_Color.h"       // table config parameter
#include "i2_Main_Color_GRule.h" // table config parameter
#endif

 //for customer Sub PQ bin support Grule
#if ENABLE_PQ_CUSTOMER_BIN_SUB_GRULE
#if PQ_ENABLE_PIP
#include "i2_Sub_Color.h"       // table config parameter
#include "i2_Sub_Color_GRule.h" // table config parameter
#endif
#endif

 //for customer SC1 Main PQ bin support Grule
#if ENABLE_PQ_CUSTOMER_BIN_SC1_MAIN_GRULE
#include "i2_SC1_Main_Color.h"       // table config parameter
#include "i2_SC1_Main_Color_GRule.h" // table config parameter
#endif
