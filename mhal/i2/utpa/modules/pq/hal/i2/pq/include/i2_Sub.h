...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_Sub, //80
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_Sub, //81
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_Sub, //82
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_Sub, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_Sub, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_Sub, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_Sub, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_Sub, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_Sub, //88
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_Sub, //89
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_Sub, //90
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_Sub, //91
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_Sub, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_Sub, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_Sub, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_Sub, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_Sub, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_Sub, //97
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_MPEG2_Sub, //98
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_MPEG2_Sub, //99
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_MPEG2_Sub, //100
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_MPEG2_Sub, //101
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_MPEG2_Sub, //102
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_MPEG2_Sub, //103
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_MPEG2_Sub, //104
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_MPEG2_Sub, //105
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_MPEG2_Sub, //106
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_MPEG2_Sub, //107
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_MPEG2_Sub, //108
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_MPEG2_Sub, //109
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_MPEG2_Sub, //110
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_MPEG2_Sub, //111
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_MPEG2_Sub, //112
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_H264_Sub, //113
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_H264_Sub, //114
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_H264_Sub, //115
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_H264_Sub, //116
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_H264_Sub, //117
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_H264_Sub, //118
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_H264_Sub, //119
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_H264_Sub, //120
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_H264_Sub, //121
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_H264_Sub, //122
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_H264_Sub, //123
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H264_Sub, //124
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H264_Sub, //125
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_H264_Sub, //126
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_H264_Sub, //127
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_H265_Sub, //128
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_Sub, //129
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_Sub, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_Sub, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_Sub, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_Sub, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_Sub, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_4K2K_FS_progressive_Sub, //135
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_Sub, //136
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_Sub, //137
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Sub, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_Photo_Sub, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_Sub, //140
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_non_4K2K_Sub, //141
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_Sub, //142
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_Sub, //143
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_Sub, //144
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_Sub, //145
    #endif
    QM_INPUTTYPE_NUM_Sub, // 146
...
extern U8 MST_SkipRule_IP_Sub[PQ_IP_NUM_Sub];
extern EN_IPTAB_INFO PQ_IPTAB_INFO_Sub[];
extern U8 QMAP_1920_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern U8 QMAP_1366_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
extern U8 QMAP_4K2K_Sub[QM_INPUTTYPE_NUM_Sub][PQ_IP_NUM_Sub];
