...
U8 MST_VSDRule_IP_Index_SC1_Main[PQ_VSDRule_IP_NUM_SC1_Main]=
{
    PQ_IP_VSD_SC1_Main,
    PQ_IP_VSP_PreVBound_SC1_Main,
};


U8 MST_VSDRule_Array_SC1_Main[PQ_VSDRule_NUM_SC1_Main][PQ_VSDRule_IP_NUM_SC1_Main]=
{
    {//PreV_ScalingDown_Interlace, 0
        PQ_IP_VSD_Bilinear_SC1_Main, PQ_IP_VSP_PreVBound_ON_SC1_Main, 
    },
    {//PreV_ScalingDown_Progressive, 1
        PQ_IP_VSD_CB_SC1_Main, PQ_IP_VSP_PreVBound_ON_SC1_Main, 
    },
