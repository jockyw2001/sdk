...
{
    if(bMemFmt422)      return MS_MADI_P_MODE8_NO_MIU;
...
void Hal_PQ_set_sram_peaking_cag_table(void *pInstance,MS_U8 u8sramtype, void *pData)
{
}

MS_U16 MHal_PQ_GetPQDelayAvg(MS_PQ_INPUT_SOURCE_TYPE enInputSource)
{
   return 0;
}