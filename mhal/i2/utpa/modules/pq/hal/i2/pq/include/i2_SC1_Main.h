...
#ifndef _I2_SC1_MAIN_H_
#define _I2_SC1_MAIN_H_

#define PQ_IP_NUM_SC1_Main 182
...
typedef enum
{
    ...
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_24Hz_SC1_Main, //68
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_30Hz_SC1_Main, //69
    #endif
    #if PQ_QM_HMDI
    QM_4K2K_60Hz_SC1_Main, //70
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vup_SC1_Main, //71
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vdown_SC1_Main, //72
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hup_Vno_SC1_Main, //73
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vup_SC1_Main, //74
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vdown_SC1_Main, //75
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hdown_Vno_SC1_Main, //76
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vup_SC1_Main, //77
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vdown_SC1_Main, //78
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_SC1_Main, //79
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_444_PC_Hno_Vno_4K_SC1_Main, //80
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vup_SC1_Main, //81
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vdown_SC1_Main, //82
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hup_Vno_SC1_Main, //83
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vup_SC1_Main, //84
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vdown_SC1_Main, //85
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hdown_Vno_SC1_Main, //86
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vup_SC1_Main, //87
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vdown_SC1_Main, //88
    #endif
    #if PQ_QM_HDMI_PC
    QM_HDMI_422_PC_Hno_Vno_SC1_Main, //89
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vup_SC1_Main, //90
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vdown_SC1_Main, //91
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hup_Vno_SC1_Main, //92
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vup_SC1_Main, //93
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vdown_SC1_Main, //94
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hdown_Vno_SC1_Main, //95
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vup_SC1_Main, //96
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vdown_SC1_Main, //97
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_SC1_Main, //98
    #endif
    #if PQ_QM_PC
    QM_DVI_Dsub_HDMI_RGB_PC_Hno_Vno_4K_SC1_Main, //99
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_MPEG2_SC1_Main, //100
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_MPEG2_SC1_Main, //101
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_MPEG2_SC1_Main, //102
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_MPEG2_SC1_Main, //103
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_MPEG2_SC1_Main, //104
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_MPEG2_SC1_Main, //105
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_MPEG2_SC1_Main, //106
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_MPEG2_SC1_Main, //107
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_MPEG2_SC1_Main, //108
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_MPEG2_SC1_Main, //109
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_MPEG2_SC1_Main, //110
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_MPEG2_SC1_Main, //111
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_MPEG2_SC1_Main, //112
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_MPEG2_SC1_Main, //113
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_MPEG2_SC1_Main, //114
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_352x480_H264_SC1_Main, //115
    #endif
    #if PQ_QM_DTV
    QM_DTV_480i_H264_SC1_Main, //116
    #endif
    #if PQ_QM_DTV
    QM_DTV_576i_H264_SC1_Main, //117
    #endif
    #if PQ_QM_DTV
    QM_DTV_480p_H264_SC1_Main, //118
    #endif
    #if PQ_QM_DTV
    QM_DTV_576p_H264_SC1_Main, //119
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_24hz_H264_SC1_Main, //120
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_50hz_H264_SC1_Main, //121
    #endif
    #if PQ_QM_DTV
    QM_DTV_720p_60hz_H264_SC1_Main, //122
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_50hz_H264_SC1_Main, //123
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080i_60hz_H264_SC1_Main, //124
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_24hz_H264_SC1_Main, //125
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_50hz_H264_SC1_Main, //126
    #endif
    #if PQ_QM_DTV
    QM_DTV_1080p_60hz_H264_SC1_Main, //127
    #endif
    #if PQ_QM_DTV
    QM_DTV_4k2k_H264_SC1_Main, //128
    #endif
    #if PQ_QM_DTV
    QM_DTV_4K2K_60Hz_H264_SC1_Main, //129
    #endif
    #if PQ_QM_DTV
    QM_DTV_4k2k_H265_SC1_Main, //130
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_interlace_SC1_Main, //131
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_SC1_Main, //132
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_SD_progressive_24hz_SC1_Main, //133
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_interlace_SC1_Main, //134
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_SC1_Main, //135
    #endif
    #if PQ_QM_MM_VIDEO
    QM_Multimedia_video_HD_progressive_24hz_SC1_Main, //136
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_SD_progressive_SC1_Main, //137
    #endif
    #if PQ_QM_MM_PHOTO
    QM_Multimedia_photo_HD_progressive_SC1_Main, //138
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_SC1_Main, //139
    #endif
    #if PQ_QM_MM_VIDEO
    QM_MM_4K2K_60Hz_SC1_Main, //140
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_interlace_SC1_Main, //141
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_SD_progressive_SC1_Main, //142
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_interlace_SC1_Main, //143
    #endif
    #if PQ_QM_DTV
    QM_DTV_iFrame_HD_progressive_SC1_Main, //144
    #endif
    #if PQ_QM_3D
    QM_3D_Video_interlace_SC1_Main, //145
    #endif
    #if PQ_QM_3D
    QM_3D_Video_progressive_SC1_Main, //146
    #endif
    QM_INPUTTYPE_NUM_SC1_Main, // 147
...
PQ_IP_MADi_RFBL_2D_SC1_Main,
PQ_IP_MADi_RFBL_25D_SC1_Main,
PQ_IP_MADi_RFBL_3D_SC1_Main,
PQ_IP_MADi_25_14F_6R_MC_SC1_Main,
PQ_IP_MADi_P_MODE_MC_3Frame_SC1_Main,
PQ_IP_MADi_25_4R_I_SC1_Main,
PQ_IP_MADi_25_4R_P_SC1_Main,
PQ_IP_MADi_25_8F_4R_P_SC1_Main,
...
extern U8 MST_SkipRule_IP_SC1_Main[PQ_IP_NUM_SC1_Main];
extern EN_IPTAB_INFO PQ_IPTAB_INFO_SC1_Main[];
extern U8 QMAP_720_SC1_Main[QM_INPUTTYPE_NUM_SC1_Main][PQ_IP_NUM_SC1_Main];
