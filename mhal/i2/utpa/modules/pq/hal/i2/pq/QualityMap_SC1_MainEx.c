...
#define PQTABLE_NAME    SC1_MAINEX              // table config parameter
...
#if 0
#include "i2_SC1_Main_Ex.c"               // table config parameter
#include "i2_SC1_Main_Ex_720.c"          // table config parameter
#endif
