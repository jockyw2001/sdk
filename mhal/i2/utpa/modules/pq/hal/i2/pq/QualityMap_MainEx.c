...
#include "i2_Main_Ex.c"               // table config parameter
#include "i2_Main_Ex_1920.c"          // table config parameter
#include "i2_Main_Ex_1366.c"          // table config parameter
#include "i2_Main_Ex_4K2K.c"          // table config parameter
