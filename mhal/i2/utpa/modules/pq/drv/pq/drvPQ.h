...
/// @return delay time value
//-------------------------------------------------------------------------------------------------
INTERFACE MS_U16 MDrv_PQ_GetVideoDelayTime(SCALER_WIN eWindow,EN_PQ_DelayTime_Type enDelayType,ST_PQ_Delay_Info stdelayinfo);
...
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MDrv_PQ_SetMemoryAddress(MS_PQ_SET_MEMORY_INFO *pstPQ_Set_Memory_Address);
...
/// @return success or not
//-------------------------------------------------------------------------------------------------
INTERFACE MS_BOOL MDrv_PQ_LoadTMOModeGRuleTable(PQ_WIN eWindow, MS_PQ_HDR_GRULE_INDEX  eHDRGRuleLevelIndex, MS_U16 u16Width, MS_U16 u16Height);

//-------------------------------------------------------------------------------------------------
/// Load Panel settings
/// @param  eWindow                       \b IN: TBD
//-------------------------------------------------------------------------------------------------
INTERFACE void MDrv_PQ_LoadTMOSettings(PQ_WIN eWindow);
