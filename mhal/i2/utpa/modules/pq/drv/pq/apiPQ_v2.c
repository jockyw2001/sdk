...
MS_U32 PQOpen(void** ppInstance,MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    psPQInstPri->fpPQ_GetVideoDelayTime                        = MDrv_PQ_GetVideoDelayTime_U2;
    ...
    psPQInstPri->fpPQ_LoadTMOSettings                 = MDrv_PQ_LoadTMOSettings_U2;
    psPQInstPri->fpPQ_SetMemoryAddress                = MDrv_PQ_SetMemoryAddress_U2;
    psPQInstPri->fpPQ_LoadTMOModeGRuleTable           = MDrv_PQ_LoadTMOModeGRuleTable_U2;
#endif
#if (ENABLE_PQ_BIN_CF)
...
//drvPQ_cus.c
    ...
    psPQInstPri->fpPQ_AdaptiveTuningByClient            = MDrv_PQ_AdaptiveTuningByClient_U2;
    ...
    psPQInstPri->fpPQ_IsFieldOrderIncorrect            = MDrv_PQ_IsFieldOrderIncorrect_U2;
//drvPQ.c
...
#ifdef STELLAR
//drvPQ_ex.c
    psPQInstPri->fpPQ_EXCtrl                          = MDrv_PQ_EX_Ctrl_U2;
#endif
...
MS_U32 PQIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        {
            pstPQ_GetVideoDelayTime pPQArgs = (pstPQ_GetVideoDelayTime)pArgs;
               pPQArgs->u16Ret = psPQInstPri->fpPQ_GetVideoDelayTime(pInstance,pPQArgs->eWindow,pPQArgs->enDelayType,pPQArgs->stdelayinfo);
        ...
        {
            pstPQ_LoadTMOSettings pPQArgs = (pstPQ_LoadTMOSettings)pArgs;
            psPQInstPri->fpPQ_LoadTMOSettings(pInstance,pPQArgs->eWindow);

            return UTOPIA_STATUS_SUCCESS;
        }
        case E_PQ_CMD_SET_MEMORY_ADDRESS:
        {
            pstPQ_SetMemoryAddress pPQArgs = (pstPQ_SetMemoryAddress)pArgs;
            pPQArgs->bReturnValue = psPQInstPri->fpPQ_SetMemoryAddress(pInstance,pPQArgs->pstPQ_Set_Memory_Address);

            return UTOPIA_STATUS_SUCCESS;
        }
        case E_PQ_CMD_LOAD_TMO_MODE_GRULE_TABLE:
        {
            pstPQ_LoadTMOModeGRuleTable pPQArgs = (pstPQ_LoadTMOModeGRuleTable)pArgs;
            pPQArgs->bReturnValue = psPQInstPri->fpPQ_LoadTMOModeGRuleTable(pInstance,pPQArgs->eWindow,
                                                                                        pPQArgs->eHDRGRuleLevelIndex,
                                                                                        pPQArgs->u16Width,
                                                                                        pPQArgs->u16Height);
            return UTOPIA_STATUS_SUCCESS;
        }
...
//drvPQ_cus.c
        ...
        case E_PQ_CMD_ADAPTIVE_TUNING_BY_CLIENT:
        {
            pstPQ_AdaptiveTuningByClient pPQArgs = (pstPQ_AdaptiveTuningByClient)pArgs;
               psPQInstPri->fpPQ_AdaptiveTuningByClient(pInstance, pPQArgs->enClient);
            return UTOPIA_STATUS_SUCCESS;
        }

        case E_PQ_CMD_IS_FIELD_ORDER_INCORRECT:
        {
            pstPQ_IsFieldOrderIncorrect pPQArgs = (pstPQ_IsFieldOrderIncorrect)pArgs;
               pPQArgs->u32Ret = psPQInstPri->fpPQ_IsFieldOrderIncorrect(pInstance, pPQArgs->eWindow);
            return UTOPIA_STATUS_SUCCESS;
        }
...
//drvbw.c
        ...
        {
            pstPQ_CMD_EX_CTRL pPQArgs = (pstPQ_CMD_EX_CTRL)pArgs;
            pPQArgs->bReturn = psPQInstPri->fpPQ_EXCtrl(pInstance, pPQArgs->u32Cmd, pPQArgs->pbuf, pPQArgs->u32BufSize);
