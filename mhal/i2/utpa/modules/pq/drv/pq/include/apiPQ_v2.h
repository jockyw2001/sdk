...
typedef enum
{
    ...
    E_PQ_CMD_LOAD_CF_SETTING,
       ...
       E_PQ_CMD_LOAD_TMO_SETTINGS,
       E_PQ_CMD_SET_MEMORY_ADDRESS,
       E_PQ_CMD_LOAD_TMO_MODE_GRULE_TABLE,
//drvPQ_cus.c
...
//drvbw.c
    ...
    E_PQ_CMD_GETCONFIG,
    E_PQ_CMD_ADAPTIVE_TUNING_BY_CLIENT,
    E_PQ_CMD_IS_FIELD_ORDER_INCORRECT,
...
{
    SCALER_WIN eWindow;
    EN_PQ_DelayTime_Type enDelayType;
    ST_PQ_Delay_Info stdelayinfo;
    MS_U16 u16Ret;
} stPQ_GetVideoDelayTime,*pstPQ_GetVideoDelayTime;
typedef struct
{
    PQ_WIN eWindow;
    MS_U8 eXRuleType;
...
typedef struct
{
    PQ_WIN eWindow;
    MS_U32 u32Ret;
} stPQ_IsFieldOrderIncorrect,*pstPQ_IsFieldOrderIncorrect;
//drvPQ_cus.c
typedef struct DLL_PACKED
{
    PQ_WIN eWindow;
} stPQ_LoadTMOSettings,*pstPQ_LoadTMOSettings;

typedef struct DLL_PACKED
{
    MS_PQ_SET_MEMORY_INFO *pstPQ_Set_Memory_Address;
    MS_BOOL bReturnValue;
} stPQ_SetMemoryAddress,*pstPQ_SetMemoryAddress;

typedef struct DLL_PACKED
{
    PQ_WIN eWindow;
    MS_PQ_HDR_GRULE_INDEX  eHDRGRuleLevelIndex;
    MS_U16 u16Width;
    MS_U16 u16Height;
    MS_BOOL bReturnValue;
} stPQ_LoadTMOModeGRuleTable,*pstPQ_LoadTMOModeGRuleTable;
...
typedef struct
{
    PQ_ADAPTIVE_TUNING_CLIENT enClient;
} stPQ_AdaptiveTuningByClient,*pstPQ_AdaptiveTuningByClient;
...
typedef struct
{
    ...
    MS_U32 u32BufSize;
    MS_BOOL bReturn;
}stPQ_CMD_EX_CTRL, *pstPQ_CMD_EX_CTRL;
#endif
