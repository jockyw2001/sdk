...
// PnlType
#define PQ_BIN_PNLTYPE_1920           (0)
#define PQ_BIN_PNLTYPE_1366           (1)
#define PQ_BIN_PNLTYPE_4K2K           (2)
//-------------------------------------------------------------------------------------------------
//  enum
//-------------------------------------------------------------------------------------------------
...
void MDrv_PQBin_LoadTableData(void *pInstance,MS_U16 u16PnlIdx, MS_U16 u16TabIdx, MS_U16 u16PQIPIdx, MS_PQBin_Header_Info *pPQBinHeader, MS_U8 *pTable, MS_U16 u16TableSize);
void MDrv_PQBin_LoadTable(void *pInstance,MS_U16 u16PnlIdx, MS_U16 u16TabIdx, MS_U16 u16PQIPIdx, MS_PQBin_Header_Info *pPQBinHeader,PQ_WIN eWindow);
void MDrv_PQBin_CloneTable(void *pInstance,MS_U16 u16PnlIdx, MS_U16 u16TabIdx, MS_U16 u16PQMainIPIdx, MS_U16 u16PQSubIPIdx, MS_PQBin_Header_Info *pPQBinHeader);
...
void MDrv_PQBin_LoadTableBySrcType(void *pInstance,MS_U16 u16PQSrcType, MS_U16 u16PQIPIdx, MS_U16 u16PQPnlIdx, MS_PQBin_Header_Info *pPQBinHeader, PQ_WIN eWindow);
...
MS_U16 MDrv_PQBin_GetGRule_LevelIndex(void *pInstance,MS_U16 u16PnlIdx, MS_U16 u16GRuleType, MS_U16 u16GRuleLvlIndex, const MS_PQBin_Header_Info* const pPQBinHeader);
MS_U16 MDrv_PQBin_GetGRule_IPIndex(void *pInstance,MS_U16 u16GRuleType, MS_U16 u16GRuleIPIndex, const MS_PQBin_Header_Info* const pPQBinHeader);
MS_U16 MDrv_PQBin_GetGRule_TableIndex(void *pInstance,MS_U16 u16GRuleType, MS_U16 u16PQSrcType, MS_U16 u16PQ_NRIdx, MS_U16 u16GRuleIPIndex, const MS_PQBin_Header_Info* const pPQBinHeader);
...
MS_U16 MDrv_PQBin_GetGRule_LvlNum(void *pInstance,    MS_U16 u16PnlIdx,    MS_U16 u16GRuleType,    const MS_PQBin_Header_Info* const pPQBinHeader);
void MDrv_PQBin_DumpVirtualRegTable(void *pInstance,const MS_PQBin_IP_Table_Info* const pTabInfo);
MS_BOOL MDrv_PQBin_SetVRAddress(void *pInstance,MS_PHYADDR u32VRAddress, MS_PHYADDR u32VRSize);
...
void  MDrv_PQBin_SetPanelID(void *pInstance,MS_U8 u8PnlID);
...
void MDrv_PQBin_CheckTableBySrcType(void *pInstance,MS_U16 u16PQSrcType, MS_U16 u16PQIPIdx, MS_U16 u16PQPnlIdx, MS_PQBin_Header_Info * pPQBinHeader, PQ_WIN eWindow);
