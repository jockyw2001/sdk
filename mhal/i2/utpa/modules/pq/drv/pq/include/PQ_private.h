...
typedef    MS_U16                                (*IOCTL_PQ_GET_VIDEO_DELAY_TIME)                            (void* ,SCALER_WIN , EN_PQ_DelayTime_Type, ST_PQ_Delay_Info);
...
typedef void                                 (*IOCTL_PQ_ADAPTIVE_TUNING_BY_CLIENT)               (void* ,PQ_ADAPTIVE_TUNING_CLIENT );
...
typedef MS_U32                                (*IOCTL_PQ_IS_FIELD_ORDER_INCORRECT)                      (void* ,PQ_WIN );
typedef void                                 (*IOCTL_PQ_LoadTMOSettings)                           (void* ,PQ_WIN );
typedef MS_BOOL                              (*IOCTL_PQ_SetMemoryAddress)                           (void* ,MS_PQ_SET_MEMORY_INFO *);
typedef MS_BOOL                              (*IOCTL_PQ_LoadTMOModeGRuleTable)                     (void* ,PQ_WIN ,MS_PQ_HDR_GRULE_INDEX, MS_U16, MS_U16);

#ifdef STELLAR
//drvPQ_ex.c
typedef MS_BOOL                        (*IOCTL_PQ_EX_CTRL)                                           (void*, MS_U32 ,void *,MS_U32);
#endif
...
typedef struct
{
    ...
    IOCTL_PQ_GET_VIDEO_DELAY_TIME                  fpPQ_GetVideoDelayTime;
    ...
    IOCTL_PQ_LoadTMOSettings                     fpPQ_LoadTMOSettings;
    IOCTL_PQ_SetMemoryAddress                    fpPQ_SetMemoryAddress;
    IOCTL_PQ_LoadTMOModeGRuleTable               fpPQ_LoadTMOModeGRuleTable;
#if (ENABLE_PQ_BIN_CF)
...
//drvPQ_cus.c
    ...
    IOCTL_PQ_ADAPTIVE_TUNING_BY_CLIENT          fpPQ_AdaptiveTuningByClient;
...
//drvbw.c
    ...
    IOCTL_PQ_IS_FIELD_ORDER_INCORRECT            fpPQ_IsFieldOrderIncorrect;

#ifdef STELLAR
    // drvPQ_ex.c
        IOCTL_PQ_EX_CTRL                            fpPQ_EXCtrl;
#endif
...
#define _MODULE_PQ_U1_U2_RELATION \
        ...
        URELATION(fpPQ_GetVideoDelayTime,(IOCTL_PQ_GET_DELAY_TIME)MDrv_PQ_GetVideoDelayTime_U2,MDrv_PQ_GetVideoDelayTime) \
        ...
        URELATION(fpPQ_LoadTMOSettings ,(IOCTL_PQ_LoadTMOSettings)MDrv_PQ_LoadTMOSettings_U2,MDrv_PQ_LoadTMOSettings) \
        URELATION(fpPQ_SetMemoryAddress ,(IOCTL_PQ_SetMemoryAddress)MDrv_PQ_SetMemoryAddress_U2,MDrv_PQ_SetMemoryAddress) \
        URELATION(fpPQ_LoadTMOModeGRuleTable ,(IOCTL_PQ_LoadTMOModeGRuleTable)MDrv_PQ_LoadTMOModeGRuleTable_U2,MDrv_PQ_LoadTMOModeGRuleTable) \
        ...
        URELATION(fpPQ_LoadFilmModeTable,(IOCTL_PQ_LOAD_FILMMODE_TABLE)MDrv_PQ_LoadFilmModeTable_U2,MDrv_PQ_LoadFilmModeTable) \
        URELATION(fpPQ_LoadDynamicContrastTable,(IOCTL_PQ_LOAD_DYNAMIC_CONTRAST_TABLE)MDrv_PQ_LoadDynamicContrastTable_U2,MDrv_PQ_LoadDynamicContrastTable) \
        URELATION(fpPQ_LoadNRTable,(IOCTL_PQ_LOAD_NR_TABLE)MDrv_PQ_LoadNRTable_U2,MDrv_PQ_LoadNRTable) \
        URELATION(fpPQ_LoadMPEGNRTable,(IOCTL_PQ_LOAD_MPEG_NR_TABLE)MDrv_PQ_LoadMPEGNRTable_U2,MDrv_PQ_LoadMPEGNRTable) \
        URELATION(fpPQ_Load_ULTRACLEAR_Table,(IOCTL_PQ_LOAD_ULTRACLEAR_TABLE)MDrv_PQ_Load_ULTRACLEAR_Table_U2,MDrv_PQ_Load_ULTRACLEAR_Table) \
        URELATION(fpPQ_Load_XVYCC_Table,(IOCTL_PQ_LOAD_XVYCC_TABLE)MDrv_PQ_Load_XVYCC_Table_U2,MDrv_PQ_Load_XVYCC_Table) \
        URELATION(fpPQ_Load_HDR_Table,(IOCTL_PQ_LOAD_HDR_TABLE)MDrv_PQ_Load_HDR_Table_U2,MDrv_PQ_Load_HDR_Table) \
...
#ifdef STELLAR \
        URELATION(fpPQ_EXCtrl,(IOCTL_PQ_EX_CTRL)MDrv_PQ_EX_Ctrl_U2,MDrv_PQ_EX_Ctrl) \
#endif \
