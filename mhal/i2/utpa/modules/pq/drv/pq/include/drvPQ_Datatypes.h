...
typedef enum
{
    ...
    MS_MADI_P_MODE_MC_5Frame,
    MS_MADI_25_6F_4R_MC,
    MS_MADI_P_MODE_MC_4Frame_Yonly_Main,
    MS_MADI_25_4R_720i_Main,
    MS_MADI_25_12F_6R_MC,
    MS_MADi_P_MODE_NO_DNR_NO_MOT,
    MS_MADI_NUM,
}MS_MADI_TYPE;
...
{
    /// VGA
    MS_PQ_INPUT_SOURCE_VGA,
    /// TV
    MS_PQ_INPUT_SOURCE_TV,
    /// CVBS
    MS_PQ_INPUT_SOURCE_CVBS,
    /// S-video
    MS_PQ_INPUT_SOURCE_SVIDEO,
    /// Component
    MS_PQ_INPUT_SOURCE_YPBPR,
    /// Scart
    MS_PQ_INPUT_SOURCE_SCART,
    /// HDMI
    MS_PQ_INPUT_SOURCE_HDMI,
    /// DTV
    MS_PQ_INPUT_SOURCE_DTV,
    /// DVI
    MS_PQ_INPUT_SOURCE_DVI,
    // Application source
    /// Storage
    MS_PQ_INPUT_SOURCE_STORAGE,
    /// KTV
    MS_PQ_INPUT_SOURCE_KTV,
    /// JPEG
    MS_PQ_INPUT_SOURCE_JPEG,
    /// The max support number of PQ input source
    MS_PQ_INPUT_SOURCE_NUM,
    /// None
    MS_PQ_INPUT_SOURCE_NONE = MS_PQ_INPUT_SOURCE_NUM,
} MS_PQ_INPUT_SOURCE_TYPE;
