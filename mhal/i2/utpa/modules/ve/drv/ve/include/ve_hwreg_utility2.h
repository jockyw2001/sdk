...
//  Macro and Define
//-------------------------------------------------------------------------------------------------
extern MS_VIRT _VE_RIU_BASE;      // This should be inited before XC library starting.
...
#define MDrv_Write4Byte( u32Reg, u32Val )                                               \
    ...
    REG_DBG("wriu -b 0x%06x 0xFF 0x%02x\n", (unsigned int)(u32Reg),   (unsigned int)((u32Val)  & 0x000000FF)); \
...
#define W2BYTEMSK( u32Reg, u16Val, u16Mask)\
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x \n", (unsigned int)(((u32Reg) & 0xFFFF) ),  (unsigned int)((u16Mask) & 0xFF), (unsigned int)((u16Val) & 0xFF)); \
    REG_DBG("wriu -b 0x%06x 0x%02x 0x%02x \n", (unsigned int)(((u32Reg+1) & 0xFFFF) ), (unsigned int)(((u16Mask) & 0xFF00) >> 8), (unsigned int)(((u16Val) & 0xFF00) >> 8));
