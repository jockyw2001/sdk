...
#define VE_TVS_ISR_SUPPORT      FALSE

//Feature: predownscaling before TVS
#define VE_PRESCALE_SUPPORT     TRUE
...
#define VE_MIU_WIDTH 32 //32bytes,256bits

#define BYTE_PER_WORD           32 //32bytes, 256bits
...
#define CKG_VE_IN_ODCLK         (0 << 2)
#define CKG_VE_IN_EDCLK         (2 << 2)
#define CKG_VE_IN_FCLK          (4 << 2)

#define VE_NTSC_FRAME_SIZE  ((MS_U32)(720ul * 480ul)>>2) // 720*480*16bits/64bits
#define VE_PAL_FRAME_SIZE   ((MS_U32)(720ul * 576ul)>>2) // 720*576*16bits/64bits
...
#define VE_H_PRESCALE_DOWN_RATIO(Input, Output)        ( ((MS_U32)(Input)) * 1048576ul / (Output) + 1 )
#define VE_V_PRESCALE_DOWN_RATIO(Input, Output)        ( ((MS_U32)(Input)-1) * 1048576ul / ((Output)-1) + 1 )
#define VE_V_PRESCALE_DOWN_RATIO_1(Input, Output)      ( ((MS_U32)(Input)) * 1048576ul / ((Output)) )

#define VE_H_POSTSCALE_RATIO(Input, Output)             ( ((MS_U32)(Input)) * 1048576ul / (Output) + 1 )
#define VE_V_POSTSCALE_RATIO(Input, Output)             ( ((MS_U32)(Input)-1) * 1048576ul / ((Output)-1) + 1 )
...
typedef enum
{
    ...
    MS_VE_DCS_CVBS_MIN = MS_VE_DCS_TYPE_MIN,
    MS_VE_DCS_CVBS_NTSC = MS_VE_DCS_CVBS_MIN,
    MS_VE_DCS_CVBS_PAL,
    MS_VE_DCS_CVBS_MAX = MS_VE_DCS_CVBS_PAL,

    MS_VE_DCS_COMPONENT_MIN = 0x10,
    MS_VE_DCS_COMPONENT_480I = MS_VE_DCS_COMPONENT_MIN,
    MS_VE_DCS_COMPONENT_480P,
    MS_VE_DCS_COMPONENT_576I,
    MS_VE_DCS_COMPONENT_576P,
    MS_VE_DCS_COMPONENT_720P_24,
    MS_VE_DCS_COMPONENT_720P_25,
    MS_VE_DCS_COMPONENT_720P_30,
    MS_VE_DCS_COMPONENT_720P_50,
    MS_VE_DCS_COMPONENT_720P_60,
    MS_VE_DCS_COMPONENT_1080I_50,
    MS_VE_DCS_COMPONENT_1080I_60,
    MS_VE_DCS_COMPONENT_1080P_24,
    MS_VE_DCS_COMPONENT_1080P_25,
    MS_VE_DCS_COMPONENT_1080P_30,
    MS_VE_DCS_COMPONENT_1080P_50,
    MS_VE_DCS_COMPONENT_1080P_60,
    MS_VE_DCS_COMPONENT_MAX = MS_VE_DCS_COMPONENT_1080P_60,

    MS_VE_DCS_TYPE_MAX = MS_VE_DCS_COMPONENT_MAX,
} MS_VE_DCS_TYPE;
...
#define Hal_VE_set_v_initfactor(args...)
...
void Hal_VE_set_dolby_verifier_addr(MS_PHY u32Addr);
