...
#ifdef CHIP_I2
extern unsigned long spt_MS_NULL;
#else
extern spt_MS_NULL
#endif
//------------------------------------------------------------------------------
...
MS_U32 TVENCODER_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
		...
		case E_MDRV_CMD_TVE_GetInfo :
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL, spt_TVE_GetInfo,NULL,0);
			break;
        case E_MDRV_CMD_TVE_GetStatues:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL, spt_TVE_GetStatus,NULL,0);
			break;
        case E_MDRV_CMD_TVE_SetDbgLevel:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetDbgLevel, spt_TVE_SetDbgLevel,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SwitchInputSRC:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SwitchInputSRC, spt_TVE_SwitchInputSRC,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetInputSRC:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetInputSRC, spt_TVE_SetInputSRC,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SwitchOutputDest:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SwitchOutputDest,spt_TVE_SwitchOutputDest,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetOutputCtrl:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SwitchOutputDest,spt_TVE_SwitchOutputDest,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetOutputVideoStd:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetOutputVideoStd,spt_TVE_SetOutputVideoStd,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetMemoryBaseAddr:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetMemoryBaseAddr,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_Init:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_Init,spt_TVE_Init,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_Exit:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_Exit,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetWSSData:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetWSSData,spt_TVE_SetWSSData,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_GetWSSData:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_GetWSSData,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetMode:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetMode,spt_TVE_SetMode,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetBlackSceen:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetBlackSceen,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_IsBlackScreenEnabled:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_IsBlackScreenEnabled,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetTtxBuffer:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetTtxBuffer,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_VE_GetTtxReadDoneStatus:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_VE_GetTtxReadDoneStatus,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_EnableCcSw:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_EnableCcSw,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetCcRange:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetCcRange,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SendCcData:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SendCcData,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_set_display_window:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_set_display_window,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetOSD:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetOSD,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_SetRGBIn:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetRGBIn,NULL,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_Get_Output_Video_Std:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_Get_Output_Video_Std,NULL,0);
            break;
        case E_MDRV_CMD_TVE_SetCaptureMode:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetCaptureMode,NULL,NULL,0);
            break;
        case E_MDRV_CMD_TVE_GetDstInfo:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_GetDstInfo,spt_TVE_GetDstInfo,NULL,0);
            break;
        case E_MDRV_CMD_TVE_Set_TestPattern:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_Set_TestPattern,NULL,NULL,0);
            break;
        case E_MDRV_CMD_TVE_DisableRegWrite:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_DisableRegWrite,spt_TVE_DisableRegWrite,NULL,0);
            break;
        case E_MDRV_CMD_TVE_AdjustPositionBase:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_AdjustPositionBase,spt_TVE_AdjustPositionBase,NULL,0);
            break;
        case E_MDRV_CMD_TVE_Set_Customer_Scaling:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_Set_Customer_Scaling,spt_TVE_Set_Customer_Scaling,NULL,0);
            break;
        case E_MDRV_CMD_TVE_InitVECapture:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_InitVECapture,NULL,NULL,0);
            break;
        case E_MDRV_CMD_TVE_EnaVECapture:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_EnaVECapture,spt_TVE_EnaVECapture,NULL,0);
            break;
        case E_MDRV_CMD_TVE_Adjust_FrameStart:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_Adjust_FrameStart,spt_TVE_Adjust_FrameStart,NULL,0);
            break;
        case E_MDRV_CMD_TVE_SetPowerState:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_SetPowerState,spt_TVE_SetPowerState,NULL,0);
            break;
        case E_MDRV_CMD_TVE_ReloadSetting:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_TVE_ReloadSetting,NULL,0);
		    break;
        case E_MDRV_CMD_TVE_GetConfig:
			u32Ret = UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_TVE_GetConfig, spt_TVE_GetConfig,NULL,0);
		    break;
        default:
            break;
