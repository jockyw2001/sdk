...
#define MVOP_MIU_CLIENT_SUB     MIU_CLIENT_MVOP_SUB_R
...
#define HAL_MFDEC_MODULE_CNT     1
#if (HAL_MFDEC_MODULE_CNT >= 2)
#define MVOP_SUPPORT_MFDEC1      1
#else
#define MVOP_SUPPORT_MFDEC1      0
#endif
...
typedef struct
{
    MVOP_DrvMirror enMirror;
    EN_MVOP_Output_3D_TYPE en3D;
    MS_BOOL bHSK;
    MS_BOOL bXCGenTiming;
    MVOP_SetCropPos stCropSt;
...
typedef struct
{
    MS_U32 u32RegYoffset;
    MS_U32 u32RegUVoffset;
    MS_U16 u16RegHsize;
    MS_U16 u16RegVsize;
    MS_U16 u16RegStrip;
    MS_BOOL bReg422;
    MS_BOOL bRegPMode;
    MS_BOOL bRegDramContd;
    MS_BOOL bRegField;
    MS_BOOL bReg422Pack;
    MS_BOOL bRegRGB;
    MS_BOOL bRegRGBType;
...
typedef struct
{
    ...
    MS_BOOL bRegHDup;
    MS_BOOL bReg2P;
    HALMVOPFREQUENCY enRegCLOCK;
    MS_U16 u16RegVsForward;
}MVOP_RegOutputMdb;
...
typedef struct
{
    ...
    MS_U32  u32BITLEN_FB_ADDR;         ///<0:8 bit EL y address, 1:8 bit EL uv address
...
void HAL_MVOP_SetAVS2HardwireMode(void);
...
void HAL_MVOP_SubSetAVS2HardwireMode(void);
