...
#define VOP_CTRL0                               (MVOP_REG_BASE + 0x22)
    #define VOP_HDUP        BIT2
    #define VOP_EXTFLD_EN   BIT6
    #define VOP_FIELD_MD    BIT7
...
#define VOP_DS_IDX                            (MVOP_REG_BASE + 0x2E)
    #define VOP_SW_FD_MASK          BIT1
#define VOP_SW_FDMASK                         (MVOP_REG_BASE + 0x2F)
    #define VOP_FORCE_DS            BIT0
    #define VOP_FDMASK              BIT1
    #define VOP_FORCE_BOB           BIT2
...
#define VOP_MPG_JPG_SWITCH                      (MVOP_REG_BASE + 0x40)
    #define VOP_PRO_SEQ         BIT2
    #define VOP_IMG422          BIT4
    #define VOP_DRAM_RD_MODE    BIT5
    #define VOP_FIELD           BIT6
    #define VOP_422PACK         BIT7
...
#define VOP_DEBUG_2C_H                          (MVOP_REG_BASE + 0x59)
    #define VOP_DC2MVD_FLD_FLAG   BIT5
...
#define VOP_DEBUG_2F_H                          (MVOP_REG_BASE + 0x5F)
    #define VOP_DBG_SEL0         (0 << 5)
    #define VOP_DBG_SEL1         (1 << 5)
    #define VOP_DBG_SEL2         (2 << 5)
    #define VOP_DBG_SEL3         (3 << 5)
    #define VOP_DBG_SEL4         (4 << 5)
    #define VOP_DBG_SEL5         (5 << 5)
    #define VOP_DBG_SEL6         (6 << 5)
...
#define VOP_REG_DDR4_REMAP                      (MVOP_REG_BASE + 0x7D)
    #define VOP_MSB_REMAP         (BIT5)
    #define VOP_LSB_REMAP         (BIT6)
...
#define VOP_REG_FD_MASK_SEL                      (MVOP_REG_BASE + 0x7F)  //BIT 8
        #define VOP_10TO8_EN           BIT1
        #define VOP_10TO8             (BIT2 | BIT3) //10 to 8 mode
        #define VOP_FD_MASK_FROM_VDEC  BIT5
        #define VOP_FRAME_RST         (BIT7)
...
#define VOP_REG_MFDEC_0_L                          (MVOP_REG_BASE + 0xA8)
    ...
    #define VOP_MFDEC_SEL           BIT1
    #define VOP_MF0_BURST           (BIT4 | BIT5)
    #define VOP_MF1_BURST           (BIT6 | BIT7)

#define VOP_REG_MFDEC_2_L                          (MVOP_REG_BASE + 0xAC)
    #define VOP_BIT_MIU_SEL         (BIT2 | BIT3)
    #define VOP_UNCOMP_MODE         (BIT4 | BIT5)
    #define VOP_MF_FROM_WB          BIT6

#define VOP_REG_BITLEN_ADD_L                          (MVOP_REG_BASE + 0xAE)
#define VOP_REG_BITLEN_ADD_H                          (MVOP_REG_BASE + 0xB0)

#define VOP_REG_BW_SAVE                          (MVOP_REG_BASE + 0xC0)
    #define VOP_420_BW_SAVE_EX     BIT0

#define VOP_REG_DUMMY_5D                          (MVOP_REG_BASE + 0xBA)
    #define VOP_SRAM_CLK_AUTO       BIT2
    #define VOP_LSB_422_BW_SAVE     BIT4

#define VOP_REG_MFDEC_BIT_PITCH                  (MVOP_REG_BASE + 0xBD)
...
#define REG_CKG_DC_SRAM                             (CHIP_REG_BASE + 0xAE)
    #define CKG_DC0_SRAM                (BIT3 | BIT2 | BIT1 | BIT0)
    #define CKG_DC1_SRAM                (BIT7 | BIT6 | BIT5 | BIT4)
