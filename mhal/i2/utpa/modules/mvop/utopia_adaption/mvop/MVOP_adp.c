...
//-------------------------------------------------------------------------------------------------
  ...
  UADP_SDT_0_DEF(MVOP_TileFormat);
    ...
    //0x122
    UADP_SDT_0_DEF(stTYPE_MVOP_SETCMD_FORCE_P_MODE_BOOL);
    UADP_SDT_2_DEF(stTYPE_MVOP_SETCMD_FORCE_P_MODE);
    //0x12A
    UADP_SDT_0_DEF(stTYPE_MVOP_SETCMD_MFDEC_ROTATE_BOOL);
    UADP_SDT_2_DEF(stTYPE_MVOP_SETCMD_MFDEC_ROTATE);
...
MS_U32 MVOP_adp_Init(FUtopiaIOctl *pIoctl)
{
    ...
    //0x122
    UADP_SDT_NAME0(stTYPE_MVOP_SETCMD_FORCE_P_MODE_BOOL,MS_BOOL);
    UADP_SDT_NAME2(stTYPE_MVOP_SETCMD_FORCE_P_MODE,stMVOP_SET_COMMAND,UADP_SDT_P2N,stHd,MVOP_Handle,UADP_SDT_P2N,pPara,stTYPE_MVOP_SETCMD_FORCE_P_MODE_BOOL);
    //0x12A
    UADP_SDT_NAME0(stTYPE_MVOP_SETCMD_MFDEC_ROTATE_BOOL,MS_BOOL);
    UADP_SDT_NAME2(stTYPE_MVOP_SETCMD_MFDEC_ROTATE,stMVOP_SET_COMMAND,UADP_SDT_P2N,stHd,MVOP_Handle,UADP_SDT_P2N,pPara,stTYPE_MVOP_SETCMD_MFDEC_ROTATE_BOOL);
...
MS_U32 MVOP_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    char buffer_arg[1];
#ifndef STELLAR
    //printk("\033[1;36m[%s][Debug] %d eCmd = 0x%lx\033[m\n",__FUNCTION__,__LINE__,u32Cmd);
#endif
    switch(u32Cmd)
    {
        // Main MVOP
        ...
        case E_MVOP_CMD_INIT:
                printk("\033[1;36m[%s] E_MVOP_CMD_INIT\033[m\n",__FUNCTION__);
        ...
        case E_MVOP_CMD_SET_COMMAND:
        {
            ...
            switch(ptr.eCmd)
            {
                ...
                case E_MVOP_CMD_SET_FORCE_P_MODE:
                    u32Ret=UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_stTYPE_MVOP_SETCMD_FORCE_P_MODE, spt_stTYPE_MVOP_SETCMD_FORCE_P_MODE,buffer_arg,sizeof(buffer_arg));
                    break;
                case E_MVOP_CMD_SET_MFDEC_ROTATE:
                    u32Ret=UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_stTYPE_MVOP_SETCMD_MFDEC_ROTATE, spt_stTYPE_MVOP_SETCMD_MFDEC_ROTATE,buffer_arg,sizeof(buffer_arg));
                    break;
                default:
                        break;
            }
