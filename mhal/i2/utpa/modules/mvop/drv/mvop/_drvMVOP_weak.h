...
__mvop_if MS_BOOL HAL_MVOP_SetYUVBaseAddMultiView(MVOP_DevID eID, MVOP_BaseAddInput *stBaseAddInfo) __mvop_weak;
...
__mvop_if MS_BOOL HAL_MVOP_IsSupport4k2k2P(void)__mvop_weak;
...
__mvop_if MS_BOOL HAL_MVOP_AutoTimingHDS(MVOP_DevID eID)__mvop_weak;
...
__mvop_if void HAL_MVOP_SetMiuSaveArea(MVOP_DevID eID ,MVOP_MIUReadPrct stMiuSave)__mvop_weak;
__mvop_if void HAL_MVOP_SetbyInputTiming(MVOP_DevID eID, MVOP_VidStat *pstVideoStatus)__mvop_weak;
__mvop_if void HAL_MVOP_SetMFDECRotate(MVOP_DevID eID ,MVOP_MFDECRotate eRotate)__mvop_weak;
__mvop_if void HAL_MVOP_EnableFODtoWB(MVOP_DevID eID, MS_BOOL bEnable)__mvop_weak;
__mvop_if MS_BOOL HAL_MVOP_GetIsBotField(MVOP_DevID eID)__mvop_weak;
__mvop_if void HAL_MVOP_SetForcePMode(MVOP_DevID eID, MS_BOOL bEnable)__mvop_weak;
__mvop_if void HAL_MVOP_SetAVS2HardwireMode(void)__mvop_weak;
//======================================================
// SUB MVOP
...
#endif
__mvop_if void HAL_MVOP_SubSetAVS2HardwireMode(void)__mvop_weak;
//======================================================
