...
#define DMS_VERSION_DIPGOP
#define DMS_DI_RING_BUFFER 6
#define DMS_CAPTUREWIN_RING_BUFFER 3
#define DMS_CAPTURE_INTVL_CYCLE 3
#define INVALID_DI_RING_BUFFER_ID DMS_DI_RING_BUFFER
#define DMS_MAX_WINDOW_NUM 4
#define DMS_DIP_QUEUEDEPTH  8
#define DMS_Invalid_ReadPointer_ID  DMS_DIP_QUEUEDEPTH
#define DMS_Invalid_WritePointer_ID  DMS_DIP_QUEUEDEPTH
#define DMS_MVOP_FRAME_INFO_NUM 6
...
typedef struct
{
    ...
    MS_U8 u8Src2ndBufferV7DataValid;
    MS_U16 u16Src2ndBufferWidth;
    MS_U16 u16Src2ndBufferHeight;
...
typedef struct
{
    ...
    MS_U8 u8ReadPointerOffset;
    MS_U32 u32AccumuleOutputRate;
    MS_U32 bStartCountCapModeFRC;
    MS_U16 u16PreviousWP;
    MS_U32 bStartGetCapture;
    MS_U32 u32FrameCount;
    MS_U16 u16NeedDeletePtr;
...
typedef struct
{
    MS_U32 bCaptureRet;
    MS_U32 bIsEventSent;
    MS_U32 bFirstCapFrame;
} DMS_DIPCAPTURE_IMI_INFO;
...
DRV_DMS_INTERFACE MS_BOOL MDrv_DMS_VDECSupportSecondBuffer(void);
