...
#define DMD_DTMB_CHIP_MAXIM         0x0A
#define DMD_DTMB_CHIP_MOONEY        0x0B
#define DMD_DTMB_CHIP_MAINZ         0x0C

#if defined(CHIP_NIKON)
 #define DMD_DTMB_CHIP_VERSION      DMD_DTMB_CHIP_NIKON
#elif defined(CHIP_NASA)
 ...
 #define DMD_DTMB_CHIP_VERSION      DMD_DTMB_CHIP_MAXIM
#elif defined(CHIP_MOONEY)
 #define DMD_DTMB_CHIP_VERSION      DMD_DTMB_CHIP_MOONEY
#elif defined(CHIP_MAINZ)
 #define DMD_DTMB_CHIP_VERSION      DMD_DTMB_CHIP_MAINZ
#else
 #define DMD_DTMB_CHIP_VERSION      DMD_DTMB_CHIP_NIKON
#endif
...
#define FW_RUN_ON_DRAM_MODE     0 // 0: FW download to SRAM, 1: FW download to DRAM
#define SRAM_OFFSET 0x8000
#if (FW_RUN_ON_DRAM_MODE==1)
extern void *memcpy(void *destination, const void *source, size_t num);
#endif

#if (DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MOONEY || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MAXIM || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MACAN || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MASERATI)
#define USE_ALL_DMD_MERGE_FE    1
#else
#define USE_ALL_DMD_MERGE_FE    0
#endif
...
static MS_BOOL _HAL_INTERN_RESET_DMD_MCU(void)
{
...
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_NIKON--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x103300, 0x14);
   ...
   _HAL_DMD_RIU_WriteByte(0x111f4f, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f4e, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f29, 0x0c);
   _HAL_DMD_RIU_WriteByte(0x111f28, 0x0c);
   //_HAL_DMD_RIU_WriteByte(0x111f28, 0x0c);
   _HAL_DMD_RIU_WriteByte(0x111f2d, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f2c, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f2f, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f2e, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f35, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f34, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f3b, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f3a, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f3d, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f3c, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f43, 0x44);
   _HAL_DMD_RIU_WriteByte(0x111f42, 0x44);
   _HAL_DMD_RIU_WriteByte(0x111f45, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f44, 0xc4);
   _HAL_DMD_RIU_WriteByte(0x111f47, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f46, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f49, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f48, 0x04);
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   ...
   {
        HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_WALTZ--------------\n"));
        ...
        _HAL_DMD_RIU_WriteByte(0x111f49, 0xcc);
        _HAL_DMD_RIU_WriteByte(0x111f48, 0x11);

        _HAL_DMD_RIU_WriteByte(0x111f23, 0x04);
        _HAL_DMD_RIU_WriteByte(0x111f22, 0x14);
        _HAL_DMD_RIU_WriteByte(0x111f73, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f72, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f75, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f74, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f77, 0x0c);
        _HAL_DMD_RIU_WriteByte(0x111f76, 0x0c);

        _HAL_DMD_RIU_WriteByte(0x111f61, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f60, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f63, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f62, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f65, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f64, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f69, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f68, 0x00);

        _HAL_DMD_RIU_WriteByte(0x111f6B, 0x44);
        _HAL_DMD_RIU_WriteByte(0x111f6A, 0x44);
        _HAL_DMD_RIU_WriteByte(0x111f7a, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f7b, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f6D, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f6C, 0xC4);

        _HAL_DMD_RIU_WriteByte(0x111f71, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f70, 0x04);

        _HAL_DMD_RIU_WriteByte(0x111f79, 0x00);
        _HAL_DMD_RIU_WriteByte(0x111f78, 0x00);

        _HAL_DMD_RIU_WriteByte(0x111f51, 0x04);
        _HAL_DMD_RIU_WriteByte(0x111f50, 0x00);

        _HAL_DMD_RIU_WriteByteMask(0x101e39, 0x03, 0x03);
   }
   else
   {
        HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_NASA--------------\n"));
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MADISON--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x111f14, 0x01);
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MONACO--------------\n"));
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MUJI--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x103315, 0x00);
   _HAL_DMD_RIU_WriteByte(0x103314, 0x00);
   _HAL_DMD_RIU_WriteByte(0x103302, 0x01); //MUJI add
   _HAL_DMD_RIU_WriteByte(0x103302, 0x00); //MUJI add
   ...
   _HAL_DMD_RIU_WriteByte(0x111f51, 0x04); //MUJI add
   _HAL_DMD_RIU_WriteByte(0x111f50, 0x00); //MuJI add

   _HAL_DMD_RIU_WriteByte(0x112091, 0x2f); //SRAM power saving
   _HAL_DMD_RIU_WriteByte(0x112090, 0x00); //SRAM power saving
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MONET--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x111f7B, 0x00);  //monet add
   _HAL_DMD_RIU_WriteByte(0x111f7A, 0x00);  //monet add
   ...
   _HAL_DMD_RIU_WriteByte(0x111f79, 0x00);  //moent add
   _HAL_DMD_RIU_WriteByte(0x111f78, 0x00);  //monet add

   _HAL_DMD_RIU_WriteByte(0x111f51, 0x04);
   _HAL_DMD_RIU_WriteByte(0x111f50, 0x00);

   // _HAL_DMD_RIU_WriteByte(0x112091, 0x10); //SRAM power saving
   // _HAL_DMD_RIU_WriteByte(0x112090, 0x00); //SRAM power saving
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MANHATTAN--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x111f49, 0x00);//0xcc?
   _HAL_DMD_RIU_WriteByte(0x111f48, 0x11);
 ...
 //  _HAL_DMD_RIU_WriteByte(0x111f7B, 0x00);  //monet add
   ...
   _HAL_DMD_RIU_WriteByte(0x111f81, 0x88);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f80, 0x88);// manhattan adds

   _HAL_DMD_RIU_WriteByte(0x111f83, 0xc8);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f82, 0x88);// manhattan adds

   _HAL_DMD_RIU_WriteByte(0x111f85, 0x88);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f84, 0x88);// manhattan adds

   _HAL_DMD_RIU_WriteByte(0x111f87, 0x08);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f86, 0x88);// manhattan adds

   _HAL_DMD_RIU_WriteByte(0x111f89, 0x00);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f88, 0x00);// manhattan adds

   _HAL_DMD_RIU_WriteByte(0x111f8b, 0x00);// manhattan adds
   _HAL_DMD_RIU_WriteByte(0x111f8a, 0x00);// manhattan adds
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MESSI--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x111f49, 0x00);//0xcc?
   //_HAL_DMD_RIU_WriteByte(0x111f48, 0x11);
   _HAL_DMD_RIU_WriteByte(0x111f48, 0x00);//MESSI only?
...
#elif (DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MAINZ)
static void _HAL_INTERN_DTMB_InitClk(void)
{
	  MS_U8 u8Val;
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MAINZ--------------\n"));
 ...
 //  _HAL_DMD_RIU_WriteByte(0x111f7B, 0x00);  //monet add
   ...
   u8Val = _HAL_DMD_RIU_ReadByte(0x112758);  //Get efuse value
   _HAL_DMD_RIU_WriteByte(0x11261A, u8Val);  //Write efuse value to mailbox reg for fw
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   ...
   #endif
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MAXIM--------------\n"));

   _HAL_DMD_RIU_WriteByte(0x111707,0xff);// SRAM End Address
   _HAL_DMD_RIU_WriteByte(0x111706,0xff);

   _HAL_DMD_RIU_WriteByte(0x111718,_HAL_DMD_RIU_ReadByte(0x111718)&(~0x04));// DRAM Disable

   _HAL_DMD_RIU_WriteByteMask(0x101e39, 0x00, 0x03);


   _HAL_DMD_RIU_WriteByte(0x1128e5, 0x01);//luffy for ADC Sync Flow
   _HAL_DMD_RIU_WriteByte(0x1128e4, 0x01);//luffy for ADC Sync Flow
   ...
   //_HAL_DMD_RIU_WriteByte(0x103315, 0x00);//luffy for ADC Sync Flow
   //_HAL_DMD_RIU_WriteByte(0x103314, 0x00);//luffy for ADC Sync Flow

   //_HAL_DMD_RIU_WriteByte(0x103321, 0x00);//luffy for ADC Sync Flow//VT :maxim adds
   //_HAL_DMD_RIU_WriteByte(0x103320, 0x00);//luffy for ADC Sync Flow//VT :maxim adds
   ...
   _HAL_DMD_RIU_WriteByte(0x1128e4, 0x00);//luffy for ADC Sync Flow

   _HAL_DMD_RIU_WriteByte(0x111f3b, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f3a, 0x00);

   _HAL_DMD_RIU_WriteByte(0x111f69, 0xCC);
   _HAL_DMD_RIU_WriteByte(0x111f68, 0x11);

   _HAL_DMD_RIU_WriteByte(0x152923, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152922, 0x14);

   _HAL_DMD_RIU_WriteByte(0x111f25, 0x04);
   _HAL_DMD_RIU_WriteByte(0x111f24, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152973, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152972, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152975, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152974, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152977, 0x0c);
   _HAL_DMD_RIU_WriteByte(0x152976, 0x0c);

   _HAL_DMD_RIU_WriteByte(0x152961, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152960, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152963, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152962, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152965, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152964, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152969, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152968, 0x00);

   _HAL_DMD_RIU_WriteByte(0x15296B, 0x44);
   _HAL_DMD_RIU_WriteByte(0x15296A, 0x44);

   _HAL_DMD_RIU_WriteByte(0x15297a, 0x00);

   _HAL_DMD_RIU_WriteByte(0x15296d, 0x00);
   _HAL_DMD_RIU_WriteByte(0x15296c, 0xc4);

   _HAL_DMD_RIU_WriteByte(0x152971, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152970, 0x04);

   _HAL_DMD_RIU_WriteByte(0x152979, 0x00);
   _HAL_DMD_RIU_WriteByte(0x152978, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152951, 0x04);
   _HAL_DMD_RIU_WriteByte(0x152950, 0x00);

   _HAL_DMD_RIU_WriteByte(0x152981, 0x88);
   _HAL_DMD_RIU_WriteByte(0x152980, 0x88);

   _HAL_DMD_RIU_WriteByte(0x152983, 0xc8);
   _HAL_DMD_RIU_WriteByte(0x152982, 0x88);

   _HAL_DMD_RIU_WriteByte(0x152985, 0x88);
   _HAL_DMD_RIU_WriteByte(0x152984, 0x88);

   _HAL_DMD_RIU_WriteByte(0x152987, 0x08);
   _HAL_DMD_RIU_WriteByte(0x152986, 0x8c);

   _HAL_DMD_RIU_WriteByte(0x111f75, 0x81);
   _HAL_DMD_RIU_WriteByte(0x111f74, 0x81);

   _HAL_DMD_RIU_WriteByte(0x111f77, 0x81);
   _HAL_DMD_RIU_WriteByte(0x111f76, 0x88);

   _HAL_DMD_RIU_WriteByte(0x15298d, 0x44);
   _HAL_DMD_RIU_WriteByte(0x15298c, 0x00);

   _HAL_DMD_RIU_WriteByte(0x15298f, 0x88);
   _HAL_DMD_RIU_WriteByte(0x15298e, 0x88);

   _HAL_DMD_RIU_WriteByte(0x152991, 0xc8);
   _HAL_DMD_RIU_WriteByte(0x152990, 0x88);

   _HAL_DMD_RIU_WriteByte(0x152993, 0x11);
   _HAL_DMD_RIU_WriteByte(0x152992, 0x18);

   _HAL_DMD_RIU_WriteByte(0x111f7b, 0x18);
   _HAL_DMD_RIU_WriteByte(0x111f7a, 0x11);

   _HAL_DMD_RIU_WriteByte(0x111f79, 0x11);
   _HAL_DMD_RIU_WriteByte(0x111f78, 0x88);

   _HAL_DMD_RIU_WriteByte(0x111f7d, 0x18);
   _HAL_DMD_RIU_WriteByte(0x111f7c, 0x11);

   _HAL_DMD_RIU_WriteByte(0x111f89, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f88, 0x00);

   _HAL_DMD_RIU_WriteByte(0x111f8b, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111f8a, 0x00);

   _HAL_DMD_RIU_WriteByte(0x111f31, 0x18);

   #if (FW_RUN_ON_DRAM_MODE == 1)
   // Bank number of MCU 2 bank[0x1117] may be chaanged with different ASIC
   _HAL_DMD_RIU_WriteByte(0x111700, 0x00); //set start address reg_sram_start_addr_1
   _HAL_DMD_RIU_WriteByte(0x111701, 0x00); //set start address reg_sram_start_addr_1
   _HAL_DMD_RIU_WriteByte(0x111702, 0x00); //set start address reg_sram_end_addr_1
   _HAL_DMD_RIU_WriteByte(0x111703, 0x00); //set start address reg_sram_end_addr_1
   _HAL_DMD_RIU_WriteByte(0x111704, (SRAM_OFFSET & 0xFF)); //set start address reg_sram_start_addr_0
   _HAL_DMD_RIU_WriteByte(0x111705, (SRAM_OFFSET >> 8)); //set start address reg_sram_start_addr_0
   _HAL_DMD_RIU_WriteByte(0x111706, 0x00); //set stop address  reg_sram_end_addr_0
   _HAL_DMD_RIU_WriteByte(0x111707, 0x80); //set stop address  reg_sram_end_addr_0

   _HAL_DMD_RIU_WriteByte(0x111708, 0x00);
   _HAL_DMD_RIU_WriteByte(0x111709, 0x00);
   _HAL_DMD_RIU_WriteByte(0x11170A, 0x00);
   _HAL_DMD_RIU_WriteByte(0x11170B, 0x00);
   _HAL_DMD_RIU_WriteByte(0x11170C, 0x00);
   _HAL_DMD_RIU_WriteByte(0x11170D, 0x00);
   u16_temp_val = SRAM_OFFSET - 1;
   _HAL_DMD_RIU_WriteByte(0x11170E, (u16_temp_val & 0xFF));
   _HAL_DMD_RIU_WriteByte(0x11170F, (u16_temp_val >> 8));

   _HAL_DMD_RIU_WriteByte(0x111718, 0x04);

    // SDRAM address offset
    u16_temp_val = (MS_U16)(((pRes->sDMD_DTMB_InitData.u32TdiStartAddr * 16) + (3 * 1024 * 1024))>>16);
    _HAL_DMD_RIU_WriteByte(0x11171b,(MS_U8)(u16_temp_val>>8));
    _HAL_DMD_RIU_WriteByte(0x11171a,(MS_U8)u16_temp_val);

   _HAL_DMD_RIU_WriteByte(0x11171C, 0x01);
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MASERATI_MACAN--------------\n"));
...
static void _HAL_INTERN_DTMB_InitClk(void)
{
   HAL_INTERN_DTMB_DBINFO(printf("--------------DMD_DTMB_CHIP_MOONEY--------------\n"));
   ...
   _HAL_DMD_RIU_WriteByte(0x111fe2, 0x11);
...
static MS_BOOL _HAL_INTERN_DTMB_Download(void)
{
    ...
    if (pRes->sDMD_DTMB_PriData.bDownloaded)
    {
        ...
        {
            _HAL_INTERN_RESET_DMD_MCU();// _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x00,  0x01); // reset VD_MCU
    ...
    _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x00, 0x00); // release MCU, madison patch
    ...
    {
        _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x0C, DTMB_table[i]); // write data to VD MCU 51 code sram
    }
    ...
    HAL_INTERN_DTMB_DBINFO(printf(">>> DTMB_FW_DRAM_START_ADDR=0x%lx \n", ((pRes->sDMD_DTMB_InitData.u32TdiStartAddr * 16) + (3 * 1024 * 1024))));
    u32VA_DramCodeAddr = MsOS_PA2KSEG1(((pRes->sDMD_DTMB_InitData.u32TdiStartAddr * 16) + (3 * 1024 * 1024)));
    memcpy((void*)(MS_VIRT)u32VA_DramCodeAddr, &DTMB_table[0], u16Lib_size);
    ...
    u8TmpData = (MS_U8)pRes->sDMD_DTMB_PriData.eLastType;
    HAL_INTERN_DTMB_DBINFO(printf("eLastType=%d\n",pRes->sDMD_DTMB_PriData.eLastType));
    memcpy((void*)(MS_VIRT)(u32VA_DramCodeAddr + u16AddressOffset + 9), &u8TmpData, 1);

    HAL_INTERN_DTMB_DBINFO(printf(">Load DRAM code done...\n"));
    ...
    _HAL_INTERN_RESET_DMD_MCU();// _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x00, 0x01); // reset MCU, madison patch
...
static void _HAL_INTERN_DTMB_FWVERSION(void)
{
    ...
    printf("INTERN_DTMB_FW_VERSION:%x.%x.%x\n", data1, data2, data3);
}
...
static MS_BOOL _HAL_INTERN_DTMB_SetACICoef(void)
{
    ...
    _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x04, (u16AddressOffset&0xFF)); // sram address low byte
    _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x05, (u16AddressOffset>>8));   // sram address high byte
    _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x0C, (MS_U8)pRes->sDMD_DTMB_PriData.eLastType);
    ...
    {
        _HAL_DMD_RIU_WriteByte(DMDMcuBase+0x0C, ACI_table[i]); // write data to VD MCU 51 code sram
    }
...
static MS_BOOL _HAL_INTERN_DTMB_PNP_Lock(void)
{
    ...
    #elif (DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MAXIM || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MACAN || DMD_DTMB_CHIP_VERSION == DMD_DTMB_CHIP_MASERATI)  //USE P2 bank
