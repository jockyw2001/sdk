...
#define DMD_ISDBT_CHIP_MANHATTAN    0x08
#define DMD_ISDBT_CHIP_MULAN        0x09
#define DMD_ISDBT_CHIP_MESSI        0x0A
#define DMD_ISDBT_CHIP_MASERATI     0x0B
#define DMD_ISDBT_CHIP_KIWI         0x0C
#define DMD_ISDBT_CHIP_MACAN        0x0D
#define DMD_ISDBT_CHIP_MUSTANG      0x0E
#define DMD_ISDBT_CHIP_MAXIM        0x0F
...
static void _HAL_INTERN_ISDBT_InitClk(void)
{    
    printf("--------------DMD_ISDBT_CHIP_MANHATTAN--------------\n");
...
static void _HAL_INTERN_ISDBT_InitClk(void)
{    
    printf("--------------DMD_ISDBT_CHIP_MASERATI--------------\n");
