...
MS_U32 ISDBT_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs);

MS_U32 ISDBT_adp_Init(FUtopiaIOctl* pIoctl)
{
    printk("ISDBT_adp_Init\n");
    ...
    *pIoctl= (FUtopiaIOctl)ISDBT_adp_Ioctl;
