...
UADP_STRUCT_POINTER_TABLE spt_DMD_DVBS_VCM_OPT[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_SetDefaultVCM_PARAM[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_SetVCM_PARAM[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_GetVCM_PARAM[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_VCM_INIT_PARAM[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_VCM_CHECK[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_VCM_ENABLED[5];
UADP_STRUCT_POINTER_TABLE spt_DVBS_VCM_MODE[5];
#endif
#ifdef UFO_DEMOD_DVBS_TSCONTROL
UADP_STRUCT_POINTER_TABLE spt_DVBS_TS_Enable_PARAM[5];
#endif
UADP_STRUCT_POINTER_TABLE spt_DVBS_GetBCHEflagWindow_PARAM[5];
       ...
       break;
		...
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_GetTunrSignalLevel_PWR_PARAM,spt_DVBS_GetTunrSignalLevel_PWR_PARAM, buffer_arg, sizeof(buffer_arg));			
	     ...
	     case DMD_DVBS_DRV_CMD_Set_Default_IS_ID:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_Set_Default_IS_ID\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_SetDefaultVCM_PARAM,spt_DVBS_SetDefaultVCM_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;	

	     case DMD_DVBS_DRV_CMD_Set_IS_ID:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_Set_IS_ID\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_SetVCM_PARAM,spt_DVBS_SetVCM_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;	

	     case DMD_DVBS_DRV_CMD_Get_IS_ID_INFO:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_Get_IS_ID_INFO\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_GetVCM_PARAM,spt_DVBS_GetVCM_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;

	     case DMD_DVBS_DRV_CMD_VCM_Init:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_VCM_Init\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_VCM_INIT_PARAM,spt_DVBS_VCM_INIT_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;

	     case DMD_DVBS_DRV_CMD_VCM_Check:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_VCM_Check\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_VCM_CHECK,spt_DVBS_VCM_CHECK, buffer_arg, sizeof(buffer_arg));			
	     break;
	     case DMD_DVBS_DRV_CMD_VCM_Enabled:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_VCM_Enabled\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_VCM_ENABLED,spt_DVBS_VCM_ENABLED, buffer_arg, sizeof(buffer_arg));			
	     break;

	     case DMD_DVBS_DRV_CMD_VCM_Mode:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_VCM_Mode\n");         
		     #endif
		u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_VCM_MODE,spt_DVBS_VCM_MODE, buffer_arg, sizeof(buffer_arg));			
	     break;  
	#endif
	#ifdef UFO_DEMOD_DVBS_TSCONTROL
	     case DMD_DVBS_DRV_CMD_TS_Enable:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_TS_Enable\n");         
		     #endif
		     u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_TS_Enable_PARAM,spt_DVBS_TS_Enable_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;
       #endif
	     case DMD_DVBS_DRV_CMD_GetBCHEflagWindow:
		     #ifdef MS_DEBUG
		     printf("kernal mode DVBSIoctl - DMD_DVBS_DRV_CMD_GetBCHEflagWindow\n");         
		     #endif
		     u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBS_GetBCHEflagWindow_PARAM,spt_DVBS_GetBCHEflagWindow_PARAM, buffer_arg, sizeof(buffer_arg));			
	     break;	   
        default:
        break;
...
#ifdef UFO_SUPPORT_VCM
    UADP_SPT_BGN(&spt_DMD_DVBS_VCM_OPT[0],sizeof(DMD_DVBS_VCM_OPT));
    UADP_SPT_FIN(&spt_DMD_DVBS_VCM_OPT[1]);	
	
    UADP_SPT_BGN(&spt_DVBS_SetDefaultVCM_PARAM[0],sizeof(DVBS_SetDefaultVCM_PARAM));
    UADP_SDT_KIND(&spt_DVBS_SetDefaultVCM_PARAM[1],DVBS_SetDefaultVCM_PARAM,UADP_SDT_P2N,u8IS_ID,spt_DVBS_U8_VAL);
    UADP_SDT_KIND(&spt_DVBS_SetDefaultVCM_PARAM[2],DVBS_SetDefaultVCM_PARAM,UADP_SDT_P2N,u8IS_ID_table,spt_DVBS_U8_VAL);
    UADP_SPT_FIN(&spt_DVBS_SetDefaultVCM_PARAM[3]);		

    UADP_SPT_BGN(&spt_DVBS_SetVCM_PARAM[0],sizeof(DVBS_SetVCM_PARAM));
    UADP_SDT_KIND(&spt_DVBS_SetVCM_PARAM[1],DVBS_SetVCM_PARAM,UADP_SDT_P2N,u8IS_ID,spt_DVBS_U8_VAL);
    UADP_SPT_FIN(&spt_DVBS_SetVCM_PARAM[2]);		

    UADP_SPT_BGN(&spt_DVBS_GetVCM_PARAM[0],sizeof(DVBS_GetVCM_PARAM));
    UADP_SDT_KIND(&spt_DVBS_GetVCM_PARAM[1],DVBS_GetVCM_PARAM,UADP_SDT_P2N,u8IS_ID,spt_DVBS_U8_VAL);
    UADP_SDT_KIND(&spt_DVBS_GetVCM_PARAM[2],DVBS_GetVCM_PARAM,UADP_SDT_P2N,u8IS_ID_table,spt_DVBS_U8_VAL);	
    UADP_SPT_FIN(&spt_DVBS_GetVCM_PARAM[3]);	

    UADP_SPT_BGN(&spt_DVBS_VCM_INIT_PARAM[0],sizeof(DVBS_VCM_INIT_PARAM));
    UADP_SDT_KIND(&spt_DVBS_VCM_INIT_PARAM[1],DVBS_VCM_INIT_PARAM,UADP_SDT_P2N,u8VCM_OPT,spt_DMD_DVBS_VCM_OPT);
    UADP_SDT_KIND(&spt_DVBS_VCM_INIT_PARAM[2],DVBS_VCM_INIT_PARAM,UADP_SDT_P2N,u8IS_ID,spt_DVBS_U8_VAL);	
    UADP_SDT_KIND(&spt_DVBS_VCM_INIT_PARAM[3],DVBS_VCM_INIT_PARAM,UADP_SDT_P2N,u32DVBS2_DJB_START_ADDR,spt_DVBS_U32_VAL);
    UADP_SPT_FIN(&spt_DVBS_VCM_INIT_PARAM[4]);	

    UADP_SPT_BGN(&spt_DVBS_VCM_CHECK[0],sizeof(DVBS_VCM_CHECK));
    UADP_SPT_FIN(&spt_DVBS_VCM_CHECK[1]);   
	
    UADP_SPT_BGN(&spt_DVBS_VCM_ENABLED[0],sizeof(DVBS_VCM_ENABLED));
    UADP_SDT_KIND(&spt_DVBS_VCM_ENABLED[1],DVBS_VCM_ENABLED,UADP_SDT_P2N,u8VCM_ENABLED,spt_DVBS_U8_VAL);
    UADP_SPT_FIN(&spt_DVBS_VCM_ENABLED[2]);		

    UADP_SPT_BGN(&spt_DVBS_VCM_MODE[0],sizeof(DVBS_VCM_MODE));
    UADP_SDT_KIND(&spt_DVBS_VCM_MODE[1],DVBS_VCM_MODE,UADP_SDT_P2N,u8VCM_OPT,spt_DMD_DVBS_VCM_OPT);
    UADP_SPT_FIN(&spt_DVBS_VCM_MODE[2]);		
#endif	
#ifdef UFO_DEMOD_DVBS_TSCONTROL
    UADP_SPT_BGN(&spt_DVBS_TS_Enable_PARAM[0],sizeof(DVBS_TS_Enable_PARAM));
    UADP_SDT_KIND(&spt_DVBS_TS_Enable_PARAM[1],DVBS_TS_Enable_PARAM,UADP_SDT_P2N,TS_Enable,spt_DVBS_BOOL_VAL);
    UADP_SPT_FIN(&spt_DVBS_TS_Enable_PARAM[2]);   
#endif
	
    UADP_SPT_BGN(&spt_DVBS_GetBCHEflagWindow_PARAM[0],sizeof(DVBS_GetBCHEflagWindow_PARAM));
    UADP_SDT_KIND(&spt_DVBS_GetBCHEflagWindow_PARAM[1],DVBS_GetBCHEflagWindow_PARAM,UADP_SDT_P2N,BCH_Eflag_Window,spt_DVBS_U16_VAL);
    UADP_SPT_FIN(&spt_DVBS_GetBCHEflagWindow_PARAM[2]);	
