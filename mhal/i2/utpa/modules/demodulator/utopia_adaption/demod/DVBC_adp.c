...
UADP_STRUCT_POINTER_TABLE spt_DVBC_GetCurrentSymbolRateOffset_PARAM[5];
    ...
    u32Ret = psDVBCInstPri->fpDVBC_GetSNR((PDVBC_GetSNR_PARAM)pArgs->snr_reg);\
       ...
       */
       ...
       case DMD_DVBC_DRV_CMD_GetCurrentSymbolRateOffset:
       	 #ifdef MS_DEBUG
		     printf(KERN_EMERG"kernal mode DVBCIoctl - DMD_DVBC_DRV_CMD_GetCurrentSymbolRateOffset\n");         
			   #endif
		     u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs,spt_DVBC_GetCurrentSymbolRateOffset_PARAM,spt_DVBC_GetCurrentSymbolRateOffset_PARAM, buffer_arg, sizeof(buffer_arg));			
       break;
...
MS_U32 DVBC_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_BGN(&spt_DVBC_GetCurrentSymbolRateOffset_PARAM[0],sizeof(DVBC_GetCurrentSymbolRateOffset_PARAM));
    UADP_SDT_KIND(&spt_DVBC_GetCurrentSymbolRateOffset_PARAM[1],DVBC_GetCurrentSymbolRateOffset_PARAM,UADP_SDT_P2N,pData,spt_DVBC_U32_VAL);
    UADP_SPT_FIN(&spt_DVBC_GetCurrentSymbolRateOffset_PARAM[2]);
