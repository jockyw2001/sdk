...
typedef MS_BOOL                   (*IOCTL_DTMB_DBG_GetModuleInfo)(MS_U8, MS_U64* );
typedef MS_BOOL                   (*IOCTL_DTMB_DBG_EchoCmd)(MS_U8, MS_U64* , MS_U32 u32CmdSize, char* );
#endif
...
typedef struct _DTMB_INSTANT_PRIVATE
{
    ...
    #ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
    IOCTL_DTMB_DBG_GetModuleInfo        fpGetModuleInfo;
    IOCTL_DTMB_DBG_EchoCmd              fpEchoCmd;
    #endif
...
MS_U32 DTMBOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    #ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
    pDtmbPri->fpGetModuleInfo       = _MDrv_DMD_DTMB_DBG_GetModuleInfo;
    pDtmbPri->fpEchoCmd             = _MDrv_DMD_DTMB_DBG_EchoCmd;
    #endif
...
MS_U32 DTMBIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch (u32Cmd)
    {
        ...
        #ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
        case DMD_DTMB_DRV_CMD_MD_DBG_GetModuleInfo:
            DMD_DBG(printf("DTMBIoctl - MDrv_DMD_DTMB_DBG_GetModuleInfo\n"));
            u32Ret = psDTMBInstPri->fpGetModuleInfo(((PDTMB_MDB_PARAM)pArgs)->id, &((PDTMB_MDB_PARAM)pArgs)->u64Data);
        case DMD_DTMB_DRV_CMD_MD_DBG_EchoCmd:
            DMD_DBG(printf("DTMBIoctl - MDrv_DMD_DTMB_DBG_EchoCmd\n"));
            u32Ret = psDTMBInstPri->fpEchoCmd(((PDTMB_MDB_PARAM)pArgs)->id, &((PDTMB_MDB_PARAM)pArgs)->u64Data, ((PDTMB_MDB_PARAM)pArgs)->u32Data, &((PDTMB_MDB_PARAM)pArgs)->chData);
            break;
        #endif
...
#ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
MS_U32 DTMBMdbIoctl(MS_U32 cmd, const void* const pArgs)
{
    ...
    switch(cmd)
    {
        case MDBCMD_CMDLINE:
            ...
            _MDrv_DMD_DTMB_DBG_EchoCmd(0, paraCmdLine->u64ReqHdl, paraCmdLine->u32CmdSize, paraCmdLine->pcCmdLine);
        ...
        case MDBCMD_GETINFO:
            ...
            _MDrv_DMD_DTMB_DBG_GetModuleInfo(0, paraGetInfo->u64ReqHdl);
...
void DTMBRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    #ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
    UtopiaModuleRegisterMdbNode("dtmb", (FUtopiaMdbIoctl)DTMBMdbIoctl);
    #endif
    #if DMD_DTMB_STR_EN
