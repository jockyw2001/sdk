...
/////////
            ...
            switch(u32ParaSize)
            {
                ...
                char *pstr_sub;
                case 4:
                    pstr = strstr(paraCmdLine->pcCmdLine, "help");
                    if(pstr != NULL)
                    {
                        eMdbCmdLine = MIU_MDBCMDLINE_HELP;
                        break;
                    }
                    pstr = strstr(paraCmdLine->pcCmdLine, "MSTV");
                    pstr_sub = strstr(paraCmdLine->pcCmdLine, "miu_protect");
                    if(pstr != NULL && pstr_sub != NULL)
                    {
                        eMdbCmdLine = MIU_MDBCMDLINE_MIU_MSTV_MIU_PROTECT;
                    }
                    break;
                case 8:
                    pstr = strstr(paraCmdLine->pcCmdLine, "miu_mask");
                    if(pstr != NULL)
                    {
                    ...
                    break;
                case 9:
                    pstr = strstr(paraCmdLine->pcCmdLine, "dram_size");
                    if(pstr != NULL)
                    {
                    ...
                    break;
                case 10:
                    pstr = strstr(paraCmdLine->pcCmdLine, "miu_select");
                    if(pstr != NULL)
                    {
                        eMdbCmdLine = MIU_MDBCMDLINE_MIU_SELECT;
                    }
                    pstr = strstr(paraCmdLine->pcCmdLine, "dram_clock");
                    if(pstr != NULL)
                    {
                    ...
                    break;
                case 11:
                    pstr = strstr(paraCmdLine->pcCmdLine, "miu_protect");
                    if(pstr != NULL)
                    {
        ...
        case MDBCMD_GETINFO:
            ...
            MdbPrint(paraGetInfo->u64ReqHdl,"A. MIU protect info\n");
            MdbPrint(paraGetInfo->u64ReqHdl,"B. MIU Select info\n");
            MdbPrint(paraGetInfo->u64ReqHdl,"C. MIU mask info\n");
            MdbPrint(paraGetInfo->u64ReqHdl,"D. MIU size\n\n");
