...
void HAL_MIU_SetExtIOMapBase(MS_VIRT virtBase)
{
...
void HAL_MIU_MaskReq(MS_U8 u8Miu, eMIUClientID eClientID)
{
    ...
    u32Grp = MIU_GET_CLIENT_GROUP(sVal);

    switch (u32Grp)
    {
    case 0:
        u32Reg = REG_MIU_MASK_RQ0L;
        break;
    case 1:
        u32Reg = REG_MIU_MASK_RQ1L;
        break;
    case 2:
        u32Reg = REG_MIU_MASK_RQ2L;
        break;
    case 3:
        u32Reg = REG_MIU_MASK_RQ3L;
        break;
    case 4:
        u32Reg = REG_MIU_MASK_RQ4L;
        break;
    case 5:
        u32Reg = REG_MIU_MASK_RQ5L;
        break;
    case 6:
        u32Reg = REG_MIU_MASK_RQ6L;
        break;
    case 7:
        u32Reg = REG_MIU_MASK_RQ7L;
        break;
    default:
        return;
    }
    if(u32Grp < 4)
        u32RegBase = (u8Miu == E_MIU_0 ? MIU_REG_BASE : MIU1_REG_BASE);
    else if( u32Grp < 6 )
        u32RegBase = (u8Miu == E_MIU_0 ? MIU_ARB_REG_BASE : MIU1_ARB_REG_BASE);
    else if( u32Grp <= 7)
        u32RegBase = (u8Miu == E_MIU_0 ? MIU_ARBB_REG_BASE : MIU1_ARBB_REG_BASE);
    else
        return;
