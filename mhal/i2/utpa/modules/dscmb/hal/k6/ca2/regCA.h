...
#define REG_RSA_BASE                        (0xA1D00UL * 2) //bank: 1A1D
    #define REG_RSA_SEC_RANGE_SET           0x6UL
    #define REG_RSA_SEC_RANGE_ENABLE        0x00010000UL
    #define REG_RSA_SEC_RANGE_MASK          0x0000FFFFUL
    #define REG_RSA_SEC_RANGE_START(_a_)    (REG_RSA_BASE + (0x00 + (_a_)* 2) * 4 ) //0~5
    #define REG_RSA_SEC_RANGE_END(_a_)      (REG_RSA_BASE + (0x01 + (_a_)* 2) * 4 ) //0~5
...
#define REG_ONEWAY_BASE       (0x60F00UL * 2)
    #define REG_ONEWAY_40       (REG_ONEWAY_BASE + 0x40*4)
        #define BDMA2PSRAM_LOCK  0x0004UL
...
#define TA_INITIALIZED                  0x51EC
//define a TA command field
#define TA_CMD_CTRL                     (REG_MBX_BASE + 0x62*4)
#define TA_CMD_SEC_GO                   0x0001UL //ACPU: write 1 to trigger, Sec51 write 0 to finish a command
#define TA_CMD_SEC_STATUS               0x0002UL //ACPU: read only, 0: cmd ok, 1:cmd fail
#define TA_CMD_SEC_TYPE                 0x003CUL
#define TA_CMD_SEC_TYPE_SHT             2UL
    #define TA_CMD_TYPE_LENGTH_LOW          0x00UL // low 8-bit of cmd length
    #define TA_CMD_TYPE_LENGTH_HIGH         0x01UL // high 8-bit of cmd length
    #define TA_CMD_TYPE_TASKP               0x0CUL
    #define TA_CMD_TYPE_ETDC                0x0DUL
    #define TA_CMD_TYPE_START               0x0EUL
#define TA_CMD_SEC_DATA                 0xFF00UL // DATA or Length
#define TA_CMD_SEC_DATA_SHT             8UL
//define TA responses when execution failed (STATUS = 1)
#define TA_CMD_RESP                     0xC0UL
#define TA_CMD_RESP_SHT                 6UL
    #define TA_CMD_RESP_AUTH_CHECK_FAIL 0x01UL
    #define TA_CMD_RESP_TDC_SETUP_FAIL  0x02UL
    #define TA_CMD_RESP_CMD_ERROR       0x03UL
// define TDC setup status
#define TA_CMD_TDC_SETUP_STATUS         TA_CMD_SEC_DATA
#define TA_CMD_TDC_SETUP_STATUS_SHT     TA_CMD_SEC_DATA_SHT
    #define TA_TDC_LUT                  0x01UL
    #define TA_TDC_M                    0x02UL
    #define TA_TDC_BC                   0x04UL
