...
#if defined (MCU_AEON)
#define DSCMB_XIU_ID  0x4UL
#elif defined (MCU_ARM_CA7)
#define DSCMB_XIU_ID  0x2UL
#else //default
#define DSCMB_XIU_ID  0x0UL
#endif

#if defined(DSCMB_SECURE_MODE)
#define DSCMB_XIU_NS  0x0UL
#else
#define DSCMB_XIU_NS  0x1UL
#endif
...
#define REG_CIPHER_ES_SWKEY(_a_)          (REG_DSCMB_CIPHER_BANK(_a_) + 0x0070UL)
#define REG_CIPHER_ES_START(_a_)          (REG_DSCMB_CIPHER_BANK(_a_) + 0x0074UL)
#define REG_CIPHER_ES_STATUS(_a_)         (REG_DSCMB_CIPHER_BANK(_a_) + 0x0075UL)
    #define REG_CIPHER_ES_SET_KEY_DONE	      1UL
    #define REG_CIPHER_ES_KEY_LEN   	      16UL
...
#define REG_TSCE_CTRL                          (REG_DSCMB_TSCE0_BANK + 0x0000UL)
    ...
    #define REG_TSCE_UPP_PATH0_PID_FLT_DISABLE    0x01000000
    #define REG_TSCE_UPP_PATH1_PID_FLT_DISABLE    0x02000000
...
// PVR PID 0 & 1
////////////////////////////////////////////////////////////////////////////////////////////////
#define REG_DSCMB_PVRPID_BANK                   0x50880         //0x1A11
#define REG_DSCMB_PVRPID_CTRL(_a_)                          (REG_DSCMB_PVRPID_BANK + (_a_))
    #define REG_TSCE_PVRPID_PROG0                   0x00
    #define REG_TSCE_PVRPID_PROG1                   0x20
    #define REG_TSCE_PVRPID_PID_MSK               0x000001FFF
    #define REG_TSCE_PVRPID_EN                            0x000002000
...
#define REG_KTE_CMD_CTRL0                    (REG_DSCMB_KTE_BANK + 0x0000UL)
    ...
    #define REG_KTE_TO_SECURE_SLOT            0x00400000UL
...
#define REG_KTE_HW_SEM        (REG_DSCMB_KTE_BANK + 0x0007UL )
    #define REG_KTE_XIU_ID_MSK     (0x0000000FUL)
    #define REG_KTE_XIU_ID_SHT     (0x0UL)
    #define REG_KTE_XIU_NS_MSK     (0x00000010UL)
    #define REG_KTE_XIU_NS_SHT     (0x4UL)

#define REG_KTE_DATA(_a_)         (REG_DSCMB_KTE_BANK + 0x0008UL + (_a_)) /// 0<=a<=4, only for read

#define REG_PIDIDX_CTRL                          (REG_DSCMB_KTE_BANK + 0x0040UL)
    ...
    #define REG_PIDIDX_WMUX_MSK                   0x00000F00UL
        ...
        #define REG_PIDIDX_WMUX_PRV               0x00000700UL
        #define REG_PIDIDX_WMUX_SEC               0x00000800UL
...
/// trouble register
#define REG_PIDIDX_WRITE_DATA                    (REG_DSCMB_KTE_BANK + 0x0041UL) //new position

#define REG_PIDIDX_READ_DATA                     (REG_DSCMB_KTE_BANK + 0x0042UL) //new position
...
#define REG_KTE_LSAD_STAT(_a_)                 (REG_DSCMB_KTE_BANK + 0x0010UL + (_a_) )
#define REG_KTE_LSAD_STAT_0                    (REG_DSCMB_KTE_BANK + 0x0010UL)
#define REG_KTE_LSAD_STAT_1                    (REG_DSCMB_KTE_BANK + 0x0011UL)
#define REG_KTE_LSAD_STAT_2                    (REG_DSCMB_KTE_BANK + 0x0012UL)
#define REG_KTE_LSAD_STAT_3                    (REG_DSCMB_KTE_BANK + 0x0013UL)

// key array status register : LSAS // read only
#define REG_KTE_LSAS_STAT(_a_)                 (REG_DSCMB_KTE_BANK + 0x0014UL + (_a_) )
#define REG_KTE_LSAS_STAT_0                    (REG_DSCMB_KTE_BANK + 0x0014UL)
#define REG_KTE_LSAS_STAT_1                    (REG_DSCMB_KTE_BANK + 0x0015UL)
#define REG_KTE_LSAS_STAT_2                    (REG_DSCMB_KTE_BANK + 0x0016UL)
#define REG_KTE_LSAS_STAT_3                    (REG_DSCMB_KTE_BANK + 0x0017UL)

// key array status register : ESA // read only
#define REG_KTE_ESA_STAT(_a_)                  (REG_DSCMB_KTE_BANK + 0x0018UL + (_a_) )
#define REG_KTE_ESA_STAT_0                     (REG_DSCMB_KTE_BANK + 0x0018UL)
#define REG_KTE_ESA_STAT_1                     (REG_DSCMB_KTE_BANK + 0x0019UL)
#define REG_KTE_ESA_STAT_2                     (REG_DSCMB_KTE_BANK + 0x001aUL)
#define REG_KTE_ESA_STAT_3                     (REG_DSCMB_KTE_BANK + 0x001bUL)

// key array status register : IV // read only
#define REG_KTE_IV_STAT(_a_)                   (REG_DSCMB_KTE_BANK + 0x001cUL + (_a_) )
#define REG_KTE_IV_STAT_0                      (REG_DSCMB_KTE_BANK + 0x001cUL)
#define REG_KTE_IV_STAT_1                      (REG_DSCMB_KTE_BANK + 0x001dUL)
#define REG_KTE_IV_STAT_2                      (REG_DSCMB_KTE_BANK + 0x001eUL)
#define REG_KTE_IV_STAT_3                      (REG_DSCMB_KTE_BANK + 0x001fUL)

// pid slot valid status register
#define REG_PIDIDX_STAT(_a_)                     (REG_DSCMB_KTE_BANK + 0x0020UL + (_a_) )
#define REG_PIDIDX_STAT_0                        (REG_DSCMB_KTE_BANK + 0x0020UL)
#define REG_PIDIDX_STAT_1                        (REG_DSCMB_KTE_BANK + 0x0021UL)
#define REG_PIDIDX_STAT_2                        (REG_DSCMB_KTE_BANK + 0x0022UL)
#define REG_PIDIDX_STAT_3                        (REG_DSCMB_KTE_BANK + 0x0023UL)
#define REG_PIDIDX_STAT_4                        (REG_DSCMB_KTE_BANK + 0x0024UL)
#define REG_PIDIDX_STAT_5                        (REG_DSCMB_KTE_BANK + 0x0025UL)
#define REG_PIDIDX_STAT_6                        (REG_DSCMB_KTE_BANK + 0x0026UL)
#define REG_PIDIDX_STAT_7                        (REG_DSCMB_KTE_BANK + 0x0027UL)

#define REG_KTE_FPGA_RDATA(_a_)                     (REG_DSCMB_KTE_BANK + 0x0070UL + (_a_) ) //_a_ = 0~ 3
...
#define REG_DSCMB_KL_SWRST(_a_)        (REG_DSCMB_KL_BANK + 0x0BUL + ((_a_)*(0x40UL)))
    #define REG_DSCMB_KL_RST           (0x2000UL)

#define REG_DSCMB_KL_HW_SEM(_a_)        (REG_DSCMB_KL_BANK + 0x0BUL + ((_a_)*(0x40UL)))
    #define REG_DSCMB_KL_XIU_ID_MSK     (0x0000000FUL)
    #define REG_DSCMB_KL_XIU_ID_SHT     (0x0UL)
    #define REG_DSCMB_KL_XIU_NS_MSK     (0x00000010UL)
    #define REG_DSCMB_KL_XIU_NS_SHT     (0x4UL)
...
#define REG_DSCMB_KL_KDF_STATUS(_a_)      (REG_DSCMB_KL_BANK + 0x8UL + ((_a_)*(0x40UL)))
    #define REG_DSCMB_KL_KDF_BUSY             (0x00000100UL)
...
#define REG_DSCMB_KL_KEY_BUS(_a_)         (REG_DSCMB_KL_BANK + 0x0DUL +((_a_)*(0x40UL)))
    ...
    #define     DSCMB_KL_KEYBUS_TSIO_SHT       (24UL)
...
#define REG_DSCMB_KL_CTRL(_a_)            (REG_DSCMB_KL_BANK + 0x0FUL +((_a_)*(0x40UL)))
    ...
    #define REG_DSCMB_KL_CTRL_SECURE_EN        (0x400000UL)
