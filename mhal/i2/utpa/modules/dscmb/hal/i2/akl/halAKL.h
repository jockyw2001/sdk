...
#ifndef __HAL_AKL_H__
#define __HAL_AKL_H__

#include "MsCommon.h"
#include "drvAKL.h"

#define HAL_AKL_ENG_LSAD (0UL)
#define HAL_AKL_ENG_ESA  (1UL)
#define HAL_AKL_ENG_LSAS (2UL)

#define HAL_AKL_KEY_CLEAR (0UL)
#define HAL_AKL_KEY_EVEN  (2UL)
#define HAL_AKL_KEY_ODD   (3UL)

#define HAL_AKL_DONE      (1UL)

#define HAL_AKL_INPUT_SIZE  (32UL)
#define HAL_AKL_OUTPUT_SIZE (32UL)
#define HAL_AKL_OPCODE_SIZE (4UL)
#define HAL_AKL_STATUS_SIZE (4UL)

typedef enum
{
    E_HAL_AKL_CERT_CMD_INPUT,
    E_HAL_AKL_CERT_CMD_OUTPUT,
    E_HAL_AKL_CERT_CMD_OPCODE,
    E_HAL_AKL_CERT_CMD_STATUS,
} HAL_AKL_CERT_Cmd;
