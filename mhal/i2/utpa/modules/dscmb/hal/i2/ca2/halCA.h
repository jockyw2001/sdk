...
typedef enum
{
    // check value definition of config to set type, not use config nameing
    E_HAL_CA_OTP_CONFIG_FORBID,  // 0: enable, others: disable
    E_HAL_CA_OTP_CONFIG_ALLOW,   // 0: disable, others:enable
    E_HAL_CA_OTP_CONFIG_DISABLE, // 1: disable , others: enable
    E_HAL_CA_OTP_CONFIG_ENABLE,  // 1: enable, others: disable
}HAL_CA_OTP_CONFIG_TYPE;
...
typedef enum {
    ...
    U_OTP_CAdata_36,
    U_OTP_CAdata_37,
    U_OTP_forbid_SEP2DRAM,
    U_OTP_forbid_SEPQMEM_to_DRAM,
    U_OTP_forbid_CryptoDMA_keyslot_QMEM,
    U_OTP_forbid_SEP2UART,
    U_OTP_IXSC_config1,
    U_OTP_IXSC_config2,
    U_OTP_IXSC_config3,
    U_OTP_IXSC_config4,
    ...
    U_OTP_EncryptImage_ForceEnc,
    U_OTP_SW_Reserved1,
    U_OTP_HASH0_VER_REF,
    U_OTP_HASH1_VER_REF,
    U_OTP_HASH2_VER_REF,
    U_OTP_HASH_TEE0_VER_REF,
    U_OTP_HASH_TEE1_VER_REF,
    U_OTP_HASH_TEE2_VER_REF,
    U_OTP_allow_TEE,
    U_OTP_AUTH_TKB,
    U_OTP_allow_EX_CERT,
    U_OTP_RSA_Reserved_00,
    U_OTP_RSA_Reserved_00_1,
    U_OTP_TEE_RSAext_ID_REF,
    U_OTP_RSA_Reserved_01,
    U_OTP_RSA_0,
    ...
    U_OTP_ena_keep_key_reboot,
    U_OTP_ena_smc_plugin_rst,
    U_OTP_allow_LOGICBIST_HW_Rst,
    U_OTP_allow_PSM_HW_Rst,
    U_OTP_allow_GDU_HW_Rst,
    U_OTP_GDU_Mode,
    U_OTP_GDU_Ratio,
    ...
    U_OTP_ForbidAVtoSec,
    U_OTP_TSP_Reserved2,
    U_OTP_ena_clear_stream_to_PVR,
    U_OTP_ena_clear_stream_to_VQ,
    ...
    U_OTP_ena_DMA_lock,
    U_OTP_ena_SEP_lock,
    U_OTP_allow_MPEG_SUSPEND_lock,
    U_OTP_RSA_Reserved_01_lock,
    U_OTP_ena_ACPU2KT_lock,
    U_OTP_ena_NSK2KT_lock,
    U_OTP_ena_KL2KT_lock,
    U_OTP_ena_SEP2KT_lock,
    ...
    U_OTP_ena_kl0_hostkey_lock,
    U_OTP_ena_kl1_hostkey_lock,
    U_OTP_NDSKeyValid_lock,
    U_OTP_RC_OPTION_lock,
    U_OTP_ena_ACPU2TSIOKT_lock,
    U_OTP_ena_SEP2TSIOKT_lock,
    U_OTP_ena_ES_ALGO_lock,
    U_OTP_Dlock_Reserved2,
    U_OTP_Dlock_Reserved3,
    U_OTP_LockWord_CA_reserved,
    ...
    U_OTP_LockWord_KDF_secret_mask_W,
    U_OTP_LockWord_PWRON_KDF_secret_mask_W,
    U_OTP_LockWord_Secure_Guard_W,
    ...
    U_OTP_LockWord_v_pubOtpUniqueID1_W,
    U_OTP_LockWord_v_pubOtpUniqueID2_W,
    U_OTP_LockWord_v_pubOtpUniqueID3_W,
    U_OTP_LockWord_v_pubOtpUniqueID4_W,
    U_OTP_LockWord_AES_MOD_MASK_W,
    U_OTP_LockWord_ACPU_Property_W,
    U_OTP_LockWord_SEP_Property_W,
    ...
    U_OTP_LockWord_3072_3465_W,
    U_OTP_LockWord_Chip_Extension_ID,
    U_OTP_LockWord_Reserved3,
    U_OTP_LockWord_KDF_secret_mask_R,
    U_OTP_LockWord_PWRON_KDF_secret_mask_R,
    ...
    U_OTP_SEP_SBoot,
    U_OTP_forbid_SCS_Debug,
    U_OTP_xCPU_SBoot,
    U_OTP_CAvendorUsage2,
    U_OTP_SCAN_MODE,
    ...
    U_OTP_DBUG_Reserved4,
    U_OTP_forbid_clk_otp_sel,
    U_OTP_DBUG_Reserved5,
    U_OTP_EJTAG2TEE_MODE,
    U_OTP_I2C2TEE_MODE,
    ...
    U_OTP_PostMskAreaRange0,
    U_OTP_PostMskAreaRange1,
    U_OTP_ACPUasHost,
    U_OTP_BONDING,
    U_OTP_NON_BLANK,
    ...
    U_OTP_SOC_UID_SEL,
    U_OTP_allow_MPEG_SUSPEND,
    U_OTP_CA_EN_Reserved2,
    U_OTP_ena_kl0_hostkey,
    U_OTP_ena_kl1_hostkey,
    ...
    U_OTP_BISS_SUBMODE,
    U_OTP_KT_Reserved0,
    U_OTP_ena_ACPU2TSIOKT,
    U_OTP_ena_SEP2TSIOKT,
    U_OTP_KT_Reserved1,
    U_OTP_ena_ACPU2DMA,
    ...
    U_OTP_ena_CA_DMA_secure_protect_0,
