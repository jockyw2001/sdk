...
UADP_SPT_NAMEnNXT_DEF(ADP_DLC_SET_MEMORY_INFO,0);
UADP_SPT_NAMEnNXT_DEF(DLC_SET_MEMORY_ADDRESS,1);
...
//set table
    ...
    UADP_SPT_NAME0NXT(ADP_DLC_SET_MEMORY_INFO,ST_XC_DLC_SET_MEMORY_INFO);
    UADP_SPT_NAME1NXT(DLC_SET_MEMORY_ADDRESS,stDLC_SetMemoryAddress,pstDLC_Set_Memory_Address,ADP_DLC_SET_MEMORY_INFO);
...
MS_U32 DLC_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_DLC_CMD_SET_MEMORY_ADDRESS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DLC_SET_MEMORY_ADDRESS,spt_DLC_SET_MEMORY_ADDRESS,buffer_arg,sizeof(buffer_arg));
            break;
