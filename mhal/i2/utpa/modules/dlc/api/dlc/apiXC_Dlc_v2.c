...
#endif
#endif
    psDLCInstPri->fpDLC_SetMemoryAddress= MApi_XC_DLC_SetMemoryAddress_U2;
...
MS_U32 DLCIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_DLC_CMD_SET_MEMORY_ADDRESS:
        {
                ...
                pstDLC_SetMemoryAddress pDLCArgs = (pstDLC_SetMemoryAddress)pArgs;
                pDLCArgs->bReturn = psDLCInstPri->fpDLC_SetMemoryAddress(pInstance, pDLCArgs->pstDLC_Set_Memory_Address );
