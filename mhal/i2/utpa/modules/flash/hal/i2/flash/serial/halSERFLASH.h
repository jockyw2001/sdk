...
#define FLASH_IC_S25FL127S      0x0806      // 16M
#define FLASH_IC_S25FL128S      0x0807      // 16M
#define FLASH_IC_S25FL128SS     0x0808      // 16M
#define FLASH_IC_S25FL164K      0x0809      // 8M
...
typedef struct
{
   EN_SPAN_COMMAND eCmdtype;
   ST_RWCMD_CONFIG tRwCmd;
} ST_SPAN_CMD;
...
typedef struct
{
    ...
    MS_BOOL b2XREAD;
    ST_HYBRID_BLOCK *pHybridBlcoks;                    // if spi flash support hybrid block size
} hal_SERFLASH_t;
...
extern MS_BOOL HAL_SERFLASH_DYB_READ(MS_U32 u32Addr, MS_U8 *u8buf);
