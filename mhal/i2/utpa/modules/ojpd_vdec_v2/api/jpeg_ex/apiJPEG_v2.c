...
void JPEG_EXRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    UtopiaModuleSetupSTRFunctionPtr(pModuleJPEG_EX_V2,(FUtopiaSTR)JPEGStr);
    UtopiaModuleSetSTRPrivate(pModuleJPEG_EX_V2, sizeof(JPEG_INSTANCE_PRIVATE));
#endif
...
MS_U32 JPEGOpen(void** ppInstance, MS_U32 u32ModuleVersion, void* pAttribute)
{
    ...
    UtopiaModuleGetSTRPrivate(pModuleJPEG_EX_V2, (void**)&psJPEG_STR_InstPri);
