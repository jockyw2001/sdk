...
#define CLKGEN0_READ_WORD(addr)        READ_WORD(PCMCIA_BASE_ADDRESS + ((addr)<<2))
#define CLKGEN0_WRITE_WORD(addr, val)  WRITE_WORD((PCMCIA_BASE_ADDRESS + ((addr)<<2)), (val))
//-------------------------------------------------------------------------------------------------
//  Local Structures
//-------------------------------------------------------------------------------------------------
...
MS_BOOL HAL_PCMCIA_OptConfig(PCMCIA_MODULE eModule, PCMCIA_OPTION eOpt, MS_U32* pInput, MS_U32* pOutput, MS_BOOL bSet)
{
    return FALSE;
}
