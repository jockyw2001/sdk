...
//set table
    ...
    UADP_SPT_BGN(&spt_AESDMA_ParserEncrypt[0], sizeof(AESDMA_PARSER_CONFIGURATIONS));
    UADP_SPT_FIN(&spt_AESDMA_ParserEncrypt[1]);

    UADP_SPT_BGN(&spt_AESDMA_ParserDecrypt[0], sizeof(AESDMA_PARSER_CONFIGURATIONS));
...
MS_U32 AESDMA_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        case MDrv_CMD_AESDMA_Init :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_INIT,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_SetIV:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_SetIvList,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_Reset:
            u32Ret= UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
            break;
        case MDrv_CMD_AESDMA_SetFileInOut:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_FILE_INOUT, NULL, NULL, 0);
            break;
        case MDrv_CMD_AESDMA_SetKey:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_SetKeyList,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_SelEng:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_SEL_ENG,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_Start:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_INIT, NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_GetStatus:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_GetStatus,spt_AESDMA_GetStatus,NULL,0);
            break;
        ...
        case MDrv_CMD_AESDMA_SetPS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_SET_PS,NULL,NULL,0);
            break;
        ...
        case MDrv_CMD_AESDMA_Notify:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_NOTIFY,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_Rand:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_RAND,NULL,NULL,0);
		    break;
...
//                free(pDatatmp_RSAKey);
                ...
                u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_RSA_CALCULATE,spt_RSA_CALCULATE,NULL,0);
            }
            break;
...
//                free(pDatatmp_RSAOut);
                u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_RSA_OUTPUT,spt_RSA_OUTPUT,NULL,0);
            }
		    break;
        case MDrv_CMD_SHA_Calculate:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_SHA_CALCULATE,spt_SHA_CALCULATE,NULL,0);
            break;
        case MDrv_CMD_AESDMA_Memcpy:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
            break;
        case MDrv_CMD_SHA_CalculateManual:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_SHA_CALCULATE_MANUAL,spt_SHA_CALCULATE_MANUAL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_MASKSCRMB:
            u32Ret= UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
            break;
        case MDrv_CMD_AESDMA_PARSER_SETSCRMBPATTERN:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserSetScrmbPattern,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_BYPASSPID:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserPyPassPid,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_SETPID:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserSetPid,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_ENCRYPT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserEncrypt,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_DECRYPT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserDecrypt,NULL,NULL,0);
            break;
        case MDrv_CMD_AESDMA_PARSER_Start:
            u32Ret= UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
            break;
        case MDrv_CMD_AESDMA_PARSER_SETADDEDSCRMBPATTERN:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_ParserSetAddedScrmbPattern,NULL,NULL,0);
            break;
...
//            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AESDMA_MDrvProcessCipher,NULL,NULL,0);
            break;
