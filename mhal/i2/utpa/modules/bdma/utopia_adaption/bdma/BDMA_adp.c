...
MS_U32 BDMA_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        case MDrv_CMD_BDMA_Init:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_INIT_PARAM, NULL,NULL,0);
            break;
        case MDrv_CMD_BDMA_CopyHnd:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_COPYHND_PARAM, NULL,NULL,0);
            break;
        case MDrv_CMD_BDMA_MemCopy:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_MEMCOPY_PARAM, NULL,NULL,0);
            break;
        case MDrv_CMD_BDMA_Search:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_SEARCH_PARAM_PRIVATE, spt_BDMA_SEARCH_PARAM_PRIVATE,NULL,0);
            break;
        case MDrv_CMD_BDMA_CRC32:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_CRC32_PARAM, spt_BDMA_CRC32_PARAM,NULL,0);
            break;
        case MDrv_CMD_BDMA_Pattern_Fill:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_PATTERN_FILL_PARAM_PRIVATE, spt_BDMA_PATTERN_FILL_PARAM_PRIVATE,NULL,0);
            break;
        case MDrv_CMD_BDMA_FlashCopy2Dram:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_FLASHCOPY2DRAM_PARAM_PRIVATE, NULL, NULL,0);
            break;
		#ifdef MOBF_ENABLE
        case MDrv_CMD_BDMA_MOBFSearch:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_BDMA_MOBFSEARCH_PARAM_PRIVATE, spt_BDMA_MOBFSEARCH_PARAM_PRIVATE, NULL,0);
            break;
		#endif
        case MDrv_CMD_BDMA_GetStatus:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL, spt_BDMA_GETSTATUS_PARAM_PRIVATE, NULL,0);
            break;
