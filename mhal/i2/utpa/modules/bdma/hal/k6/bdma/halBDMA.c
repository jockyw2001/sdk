...
////////////////////////////////////////////////////////////////////////////////
/// @brief \b Function  \b Name: HAL_BDMA_Get_RegAddr
...
/// @param <GLOBAL>     \b None :
////////////////////////////////////////////////////////////////////////////////
MS_PHY HAL_BDMA_Get_RegAddr(MS_PHY phy64RegAddr, MS_U8 u8Ch)
{
    if (E_BDMA_CH1 == u8Ch)
...
static MS_BOOL _HAL_BDMA_Is_Status_On(MS_U8 u8Status, MS_U8 u8Ch)
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_STATUS, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_SRC_ADDR_L, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_DST_ADDR_L, u8Ch);
    return HAL_BDMA_Write4Byte(phy64Reg, phy64RegAddr);
}
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_SRC_SEL, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_DST_SEL, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_CMD0_L, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_CMD1_L, u8Ch);
    return HAL_BDMA_Write4Byte(phy64Reg, u32Cmd);
}
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_SIZE_L, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_MISC, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_DWUM_CNT, u8Ch);
...
{
    MS_PHY phy64Reg = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_CTRL, u8Ch);
...
void HAL_BDMA_Dump_AllReg(void)
{
    ...
    MS_PHY phy64EndAddr = HAL_BDMA_Get_RegAddr(BDMA_REG_CH0_CMD1_H, E_BDMA_CH1);
...
////////////////////////////////////////////////////////////////////////////////
///// @brief \b Function  \b Name: HAL_BDMA_SetClk
///// @brief \b Function  \b Description: Set bdma clk
///// @param <GLOBAL>     \b None :
//////////////////////////////////////////////////////////////////////////////////
MS_BOOL HAL_BDMA_SetClk(void)
{
    MS_U16 clk;
    clk = HAL_BDMA_Read2Byte(CLKGEN_REG_BDMA_CLK);
    clk &= ~(0x1<< DISABLE_CLOCK_BIT);

    clk &= ~(0x3<< SEL_CLOCK_SOURCE_BIT);
    clk |= (0x1<< SEL_CLOCK_SOURCE_BIT);
    return HAL_BDMA_Write2Byte(CLKGEN_REG_BDMA_CLK, clk);
}
