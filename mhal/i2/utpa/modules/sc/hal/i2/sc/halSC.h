...
////////////////////////////
#define RST_TO_ATR_HW_TIMEOUT  41000UL //It is experimental value from conax PT for 39990 clokcs ATR test case

////////////////////////////
// SW extCWT value
////////////////////////////
#define GET_SW_EXTWT_IN_MS(WtInMs, EtuInNs, Di)   WtInMs + ((150 * EtuInNs * Di)/1000000); //It is experimental value from conax PT --> WT + 150*Fi/f
