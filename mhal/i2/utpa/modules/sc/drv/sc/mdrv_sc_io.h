...
/* MS_S32 ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_SET_EVENTS,
             MS_S32 *events);
*/
#define MDRV_SC_SET_EVENTS                      _IOW(SC_IOC_MAGIC, 4U, MS_S32)

/* MS_S32 ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_GET_ATTRIBUTE,
             MS_S32 *events);
*/
#define MDRV_SC_GET_ATTRIBUTE                   _IOR(SC_IOC_MAGIC, 5U, MS_S32)


/* MS_S32 ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_SET_ATTRIBUTE,
             MS_S32 *events);
*/
#define MDRV_SC_SET_ATTRIBUTE                   _IOW(SC_IOC_MAGIC, 6U, MS_S32)


/* int ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_CHECK_RST_TO_ATR,
             MS_S32 *events);
*/
#define MDRV_SC_CHECK_RST_TO_ATR                _IOW(SC_IOC_MAGIC, 7U, MS_S32)
...
/* int ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_GET_CWT_RX_ERROR_INDEX,
             MS_S32 *events);
*/
#define MDRV_SC_GET_CWT_RX_ERROR_INDEX         _IOR(SC_IOC_MAGIC, 9U, MS_S32)


/* int ioctl(MS_S32 fd,
             MS_S32 request == MDRV_SC_RESET_RST_TO_ATR,
             MS_S32 *events);
*/
#define MDRV_SC_RESET_RST_TO_ATR               (int)_IO(SC_IOC_MAGIC, 10U)


#define SC_IOC_MAXNR                            10
