...
/*
 * The number of counter register ticks per microsecond.
 * MSOS_HAL_RTC_USTICK = 12000000 / 1000000
 */
#define MSOS_HAL_RTC_USTICK 12
...
static void _hal_delay_us(MS_U32 usecs)
{
    ...
    delaycount = MSOS_HAL_RTC_USTICK * usecs;
