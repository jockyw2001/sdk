...
void *_MApi_GPD_Init(MS_PHY SrcBuf)
{
    ...
    else
    {
        ...
        u32RegValue = *((volatile MS_U32 *)(BankBaseAddr + GPD_CLK_BASE + GPD_CLK_OFFSET));
        ...
        *((volatile MS_U32 *)(BankBaseAddr + GPD_CLK_BASE + GPD_CLK_OFFSET)) = u32RegValue;
#elif 0
...
void _MApi_GPD_GetMdbInfo(MS_U64* u64ReqHdl)
{
    ...
    if(gGPDMDebug._u32ReadBufferAddr_PA ==0 && gGPDMDebug._u32WriteBufferAddr_PA==0 && gGPDMDebug._u32InternalBufferAddr_PA==0)
    {
        MdbPrint(u64ReqHdl,"Input buffer address PA               : Not Used\n");
        MdbPrint(u64ReqHdl,"Output buffer address PA              : Not Used\n");
        MdbPrint(u64ReqHdl,"Internal buffer address PA            : Not Used\n");
        MdbPrint(u64ReqHdl,"Input buffer address VA               : Not Used\n");
        MdbPrint(u64ReqHdl,"Output buffer address VA              : Not Used\n");
        MdbPrint(u64ReqHdl,"Internal buffer address VA            : Not Used\n");
        MdbPrint(u64ReqHdl,"Input buffer size                     : Not Used\n");
        MdbPrint(u64ReqHdl,"Output buffer size                    : Not Used\n");
        MdbPrint(u64ReqHdl,"Internal buffer size                  : Not Used\n");
        MdbPrint(u64ReqHdl,"Picture resolution                    : Not Used\n");
        MdbPrint(u64ReqHdl,"Output format                         : Not Used\n");
        MdbPrint(u64ReqHdl,"Picture type                          : Not Used\n");
        MdbPrint(u64ReqHdl,"HW decoding time                      : Not Used\n");
    }
    else
    {
