...
#define IOMMU_BIT33                         (0x200000000ULL)
#define IOMMU_FPGA_MAPPING_ADDR             (0x50000)
...
#ifdef GPD_SUPPORT_8G
    MS_U64 u64base;
    #if ENABLE_IOMMU_FPGA_VERIFICATION
    u64base = (((base<<3)-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33)>>3;
    #else
    u64base = base;
    #endif
    GPD_SET_MS_U32REG(reg_zbuf_bas_bit_32_28, (MS_U32)(((MS_U64)u64base) >> 28));
    GPD_SET_MS_U32REG(reg_zbuf_bas, (MS_U32)(u64base & (0x0fffffff)));
#else
...
void drv_gpd_set_cbuf_bas(MS_PHY base)
{
    ...
    u64base = base;
    #endif
    GPD_SET_MS_U32REG(reg_cbuf_bas_bit_32_28, (MS_U32)(((MS_U64)u64base) >> 28));
    GPD_SET_MS_U32REG(reg_cbuf_bas, (MS_U32)(u64base & (0x0fffffff)));
#else
...
{
#ifdef GPD_SUPPORT_8G
    MS_U64 u64Start, u64End;
    #if ENABLE_IOMMU_FPGA_VERIFICATION
    u64Start = (bstart-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33;
    u64End = (bend-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33;
    #else
    u64Start = bstart;
    u64End = bend;
    #endif
    GPD_SET_MS_U32REG(reg_gpd_bstart_bit_35_31, (MS_U32)(((MS_U64)u64Start) >>31));
    GPD_SET_MS_U32REG(reg_gpd_bend_bit_35_31, (MS_U32)(((MS_U64)u64End) >>31));
    GPD_SET_MS_U32REG(reg_gpd_bstart, (MS_U32)(u64Start & (0x7fffffff)));
    GPD_SET_MS_U32REG(reg_gpd_bend, (MS_U32)(u64End & (0x7fffffff)));
#else
...
void drv_gpd_set_istart(MS_U32 istart)
{
    ...
    MS_U64 u64Start;
    #if ENABLE_IOMMU_FPGA_VERIFICATION
    u64Start = (istart-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33;
    #else
    u64Start = istart;
    #endif
    GPD_SET_MS_U32REG(reg_gpd_istart_bit_35_31, (MS_U32)(((MS_U64)u64Start) >>31));
    GPD_SET_MS_U32REG(reg_gpd_istart, (MS_U32)(u64Start & (0x7fffffff)));
#else
...
void drv_gpd_set_access_bound(MS_U32 w_start, MS_U32 w_end, MS_U32 i_start, MS_U32 i_end)
{
    ...
    MS_U64 u64Start, u64End;
    #if ENABLE_IOMMU_FPGA_VERIFICATION
    u64Start = (u32Start-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33;
    u64End = (u32End-IOMMU_FPGA_MAPPING_ADDR) | IOMMU_BIT33;
    #else
    u64Start = u32Start;
    u64End = u32End;
    #endif
    GPD_SET_MS_U32REG(reg_lb_addr_bit_32_28, (MS_U32)((((MS_U64)u64Start)>>3)>>28));
    GPD_SET_MS_U32REG(reg_ub_addr_bit_32_28, (MS_U32)((((MS_U64)u64End)>>3)>>28));
    GPD_SET_MS_U32REG(reg_lb_addr, (MS_U32)((u64Start>>3) & (0x0fffffff)));
    GPD_SET_MS_U32REG(reg_ub_addr, (MS_U32)((u64End>>3) & (0x0fffffff)));
#else
