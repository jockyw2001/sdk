...
//HVD set Display Mode
typedef enum
{
    E_HVD_EX_DISPLAY_MODE_DEFAULT,
    E_HVD_EX_DISPLAY_MODE_MCU,
    E_HVD_EX_DISPLAY_MODE_HARDWIRE,
} HVD_EX_Display_mode;
...
typedef enum
{
    ...
    E_HVD_EX_FEATURE_FORCE_MAIN_PROFILE = 1, //BIT0=1: HEVC Only support Main profile decode
} HVD_EX_Feature;
...
typedef struct
{
    MS_U8 STCSetflag[HVD_MAX_DEC_NUM];
    MS_U32 STCIndex[HVD_MAX_DEC_NUM];
}HVD_EX_STCModCfg;
