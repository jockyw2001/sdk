...
#ifdef VDEC3
__vdec_if E_MVD_Result MDrv_MVD_GetFreeStream(MS_U32 *pu32Id, MVD_DRV_StreamType eStreamType, MS_BOOL bIsNStreamMode) __vdec_weak;
#else
...
__vdec_if void MDrv_HVD_EX_SetDbgLevel(MS_U32 u32Id, HVD_EX_UartLevel elevel) __vdec_weak;
...
__vdec_if MS_U64 MDrv_HVD_EX_GetU64PTS_Pre(MS_U32 u32Id) __vdec_weak;
