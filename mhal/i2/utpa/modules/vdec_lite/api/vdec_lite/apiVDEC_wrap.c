...
//------------------------------------------------------------------------------
/// @brief send command for debug
/// @param u8Cmd command
/// @param u8Cmd command arguement
...
/// @param u32Data data to be write
/// @retval E_VDEC_EX_OK Success
/// @retval E_VDEC_EX_FAIL Failure
/// @retval E_VDEC_EX_RET_NOT_INIT The decoder is not initialized
/// @retval E_VDEC_EX_RET_UNSUPPORTED Not supported for current decoder configuration or codec type
...
static VDEC_EX_User_Cmd _VDEC_MapUserCmd(VDEC_User_Cmd eUserCmd)
{
    ...
    switch (eUserCmd)
    {
        ...
        case VDEC_USER_CMD_DISABLE_PBFRAME_MODE         : eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_PBFRAME_MODE; break;
        case VDEC_USER_CMD_SET_SLOW_SYNC                : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_SLOW_SYNC; break;
        case VDEC_USER_CMD_SET_TRICKPLAY_2X_MODE        : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_TRICKPLAY_2X_MODE; break;
        case VDEC_USER_CMD_FRC_ONLY_SHOW_TOP_FIELD      : eEXUserCmd = E_VDEC_EX_USER_CMD_FRC_ONLY_SHOW_TOP_FIELD; break;
        case VDEC_USER_CMD_DISABLE_ES_FULL_STOP         : eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_ES_FULL_STOP; break;
        case VDEC_USER_CMD_DIRECT_STC_MODE              : eEXUserCmd = E_VDEC_EX_USER_CMD_DIRECT_STC_MODE; break;
        case VDEC_USER_CMD_SET_FRAMEBUFF2               : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_FRAMEBUFF2; break;
        ...
        case VDEC_USER_CMD_PUSI_CONTROL                 : eEXUserCmd = E_VDEC_EX_USER_CMD_PUSI_CONTROL; break;
        case VDEC_USER_CMD_DISABLE_FDMASK               : eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_FDMASK; break;
        ...
        case VDEC_USER_CMD_GET_SEQ_CHANGE_INFO          : eEXUserCmd = E_VDEC_EX_USER_CMD_GET_SEQ_CHANGE_INFO; break;
        case VDEC_USER_CMD_GET_DISP_QUEUE_EMPTY         : eEXUserCmd = E_VDEC_EX_USER_CMD_GET_DISP_QUEUE_EMPTY; break;
        ...
        case VDEC_USER_CMD_CAL_FRAMERATE                : eEXUserCmd = E_VDEC_EX_USER_CMD_CAL_FRAMERATE; break;
        case VDEC_USER_CMD_MFCODEC_MODE                 : eEXUserCmd = E_VDEC_EX_USER_CMD_MFCODEC_MODE; break;
        case VDEC_USER_CMD_VDEC_FEATURE                 : eEXUserCmd = E_VDEC_EX_USER_CMD_VDEC_FEATURE; break;
        case VDEC_USER_CMD_SET_DISPLAY_MODE             : eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DISPLAY_MODE; break;

        //Group5:PreGet Control command===============================
        case VDEC_USER_CMD_SYSTEM_PREGET_CONTROL_BASE          : eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PREGET_CONTROL_BASE ;break;
        case VDEC_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE_SIZE  : eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PREGET_FB_MEMORY_USAGE_SIZE ;break;
