...
UADP_SDT_NAMEn_DEF(VDEC_EX_SET_PLAYBACK_INTERVAL,4);
...
//    UADP_SDT_NAME3(VDEC_EX_SET_ERROR_TOLERANCE,VDEC_EX_V2_IO_Param,UADP_SDT_P2N, StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N, pRet,VDEC_EX_MS_U32,UADP_SDT_P2N, param[0],VDEC_EX_ERR_TOLERANCE);
    ...
    UADP_SDT_NAME3(VDEC_EX_SET_PLAYBACK_INTERVAL,VDEC_EX_V2_IO_Param,UADP_SDT_P2N ,StreamID,VDEC_EX_STREAM_V2_ID,UADP_SDT_P2N ,pRet,VDEC_EX_MS_U32,UADP_SDT_P2N ,param[0],VDEC_EX_PLAYBACK_INTERVAL);
