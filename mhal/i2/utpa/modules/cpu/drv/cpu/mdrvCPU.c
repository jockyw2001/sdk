...
MS_U32 CPUIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        case MDrv_CMD_CPU_InitFront:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_InitFront\n");)
        ...
        case MDrv_CMD_CPU_InitEnd:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_InitEnd\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_Disable:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_Disable\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
	            return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_Enable:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_Enable\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_SetHost:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_SetHost\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_GetInfo:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_GetInfo\n");)
        ...
        case MDrv_CMD_CPU_GetLibVer:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_GetLibVer\n");)
        ...
        case MDrv_CMD_CPU_GetStatus:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_GetStatus\n");)
            // this function won't occupy h/w, so don't need to call UtopiaResourceObtainToInstant
        ...
        case MDrv_CMD_CPU_SetDbgLevel:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_SetDbgLevel\n");)
            // this function won't occupy h/w, so don't need to call UtopiaResourceObtainToInstant
        ...
        case MDrv_CMD_CPU_GetBase:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_GetBase\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
        ...
        case MDrv_CMD_CPU_QueryClock:
            CPU_DEBUGINFO(ULOGD(TAG_CPU, "CPUIoctl - MDrv_CMD_CPU_QueryClock\n");)
            if(UtopiaResourceObtain(pModule, CPU_POOL_ID_CPU0, &pResource) != 0)
            {
                ULOGE(TAG_CPU, "UtopiaResourceObtainToInstant fail\n");
                return UTOPIA_STATUS_ERR_RESOURCE;
