...
MS_U32 UARTMdbIoctl(MS_U32 cmd, const void* const pArgs)
{
    ...
    switch(cmd)
    {
        case MDBCMD_CMDLINE:
            ...
            MdbPrint(paraCmdLine->u64ReqHdl, "---------MStar UART Info---------\n");
        ...
        case MDBCMD_GETINFO:
            ...
            MDrv_UART_Debug_cat(paraGetInfo->u64ReqHdl);
...
#ifdef CONFIG_UTOPIA_PROC_DBG_SUPPORT
    UtopiaModuleRegisterMdbNode("uart", (FUtopiaMdbIoctl)UARTMdbIoctl);
#endif
