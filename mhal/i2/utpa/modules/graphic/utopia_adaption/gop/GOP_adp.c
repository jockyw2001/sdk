...
UADP_SPT_NAMEnNXT_DEF(GOP_PROPERTY_R2Y_COLOR_MATRIX_A0,0);
UADP_SPT_NAMEnNXT_DEF(GOP_PROPERTY_R2Y_COLOR_MATRIX,1);
...
UADP_SPT_NAMEnNXT_DEF(GOP_GWIN_PROPERTY_SETARGB1555ALPHA_bEn,0);
UADP_SPT_NAMEnNXT_DEF(GOP_GWIN_PROPERTY_SETARGB1555ALPHA,1);
...
MS_U32 GOP_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_NAME0NXT(GOP_PROPERTY_R2Y_COLOR_MATRIX_A0,DRV_GOP_R2Y_Matrix);
    UADP_SPT_NAME1NXT(GOP_PROPERTY_R2Y_COLOR_MATRIX,GOP_SET_PROPERTY_PARAM,pSetting,GOP_PROPERTY_R2Y_COLOR_MATRIX_A0);
    ...
    UADP_SPT_NAME0NXT(GOP_GWIN_PROPERTY_SETARGB1555ALPHA_bEn,GOP_GWIN_SETARGB1555ALPHA);
    UADP_SPT_NAME1NXT(GOP_GWIN_PROPERTY_SETARGB1555ALPHA,GOP_GWIN_PROPERTY_PARAM,pSet,GOP_GWIN_PROPERTY_SETARGB1555ALPHA_bEn);
        ...
        case MAPI_CMD_GOP_GET_PROPERTY:
           {
                ...
                switch(ptr.en_pro)
                {
                    ...
                    case E_GOP_R2Y_COLOR_MATRIX:
                        u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_PROPERTY_R2Y_COLOR_MATRIX,spt_GOP_PROPERTY_R2Y_COLOR_MATRIX,buffer_arg,sizeof(buffer_arg));
                        break;
        ...
        case MAPI_CMD_GOP_GWIN_GET_PROPERTY:
            {
                ...
                switch(ptr.en_property)
                {
                    ...
                    case E_GOP_GWIN_SETARGB1555ALPHA:
                        u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GOP_GWIN_PROPERTY_SETARGB1555ALPHA,spt_GOP_GWIN_PROPERTY_SETARGB1555ALPHA,buffer_arg,sizeof(buffer_arg));
                        break;
                    default:
                        break;
                }
