...
#define REG_SC_BK01_05_L                        XC_REG(0x01, 0x05)
#define REG_SC_BK01_1E_L                        XC_REG(0x01, 0x1E)
#define REG_SC_BK01_21_L                        XC_REG(0x01, 0x21)
...
#define REG_SC_BK2F_27_L                        XC_REG(0x2F, 0x27)
#define REG_SC_BK2F_37_L                        XC_REG(0x2F, 0x37)
#define REG_SC_BK2F_38_L                        XC_REG(0x2F, 0x38)
#define REG_SC_BK2F_39_L                        XC_REG(0x2F, 0x39)
#define REG_SC_BK2F_3A_L                        XC_REG(0x2F, 0x3A)
#define REG_SC_BK2F_3B_L                        XC_REG(0x2F, 0x3B)
#define REG_SC_BK2F_3C_L                        XC_REG(0x2F, 0x3C)
...
#define REG_SC_BK7F_11_L                        XC_REG(0x7F, 0x11)

#define REG_SC1_BK00_05_L                       XC_REG(0x80+0x00, 0x05)
#define REG_SC1_BK00_06_L                       XC_REG(0x80+0x00, 0x06)
#define REG_SC1_BK10_23_L                       XC_REG(0x80+0x10, 0x23)
...
#define GOP_SC_IP_MAIN_HSTART                   REG_SC_BK01_05_L
#define GOP_SC_IP_MAIN_INTERLACE                REG_SC_BK01_1E_L
#define GOP_SC_IP_MAIN_USR_INTERLACE            REG_SC_BK01_21_L
...
#define GOP_SC_ALPHAMODE                        REG_SC_BK10_5B_L
#define GOP_SC_GOPENMODE1                       REG_SC_BK10_5B_L
#define GOP_SC_MIRRORCFG                        REG_SC_BK12_03_L
#define GOP_SC_BLEND0_GOP_SWITCH                REG_SC_BK2F_27_L
#define GOP_SC_VOP2BLENDING_L                   REG_SC_BK2F_37_L
#define GOP_SC_VOP2BLENDING_H                   REG_SC_BK2F_38_L
#define GOP_SC_VOP2BLENDING_EX                  REG_SC_BK2F_39_L
#define GOP_SC_VOPVTK                           REG_SC_BK2F_3A_L
#define GOP_SC_VOPVTK_L                         REG_SC_BK2F_3B_L
#define GOP_SC_VOPVTK_H                         REG_SC_BK2F_3C_L
...
#define GOP_SC_MIU_IP_SEL                       REG_SC_BK7F_11_L

#define GOP_SC1_CHANNELSYNC                     REG_SC1_BK00_05_L
#define GOP_SC1_GOPEN                           REG_SC1_BK00_06_L
#define GOP_SC1_VOPNBL                          REG_SC1_BK10_23_L
//----------------------------------------------------------------------------
// MVOP Reg
//----------------------------------------------------------------------------
...
// VE Reg
//----------------------------------------------------------------------------
#define VE_REG(reg)                 (VE_REG_BASE + (reg) * 2)

#define GOP_VE_TVS_CTRL             VE_REG(0x00)
#define GOP_VE_TVS_OSD_EN           VE_REG(0x55)
#define GOP_VE_TVS_OSD_EN_ALPHA_INV VE_REG(0x5f)
#define GOP_VE_TVS_OSD1_EN          VE_REG(0x60)
#define GOP_VE_TVE_SWRST            VE_REG(0x07)
...
#define CKG_GOPG0_OD1CLK        (2 << 2)
#define CKG_GOPG0_DIP           (3 << 2)
#define CKG_GOPG0_IDCLK2        (6 << 2)
#define CKG_GOPG0_IDCLK1        (7 << 2)
...
#define CKG_GOPG1_OD1CLK        (2 << 10)
#define CKG_GOPG1_DIP           (3 << 10)
#define CKG_GOPG1_IDCLK2        (6 << 10)
#define CKG_GOPG1_IDCLK1        (7 << 10)
#define CKG_GOPG1_DISABLE_CLK_MASK    (GOP_BIT8)
#define CKG_GOPG1_MASK          (GOP_BIT12 | GOP_BIT11 | GOP_BIT10)

/* GOP Mixer CLK */
#define CKG_GOPMIXER_CLK        (CKG_REG_BASE+(0x41<<1))
#define CKG_GOPMIXER_ODCLK      (4<<2)
#define CKG_GOPMIXER_VECLK      (6<<2)
#define CKG_GOPMIXER_MASK       (GOP_BIT4|GOP_BIT3 | GOP_BIT2)

/* GOPD CLK */
#define GOP_GOPDCLK             (CKG_REG_BASE+(0x41<<1))
...
#define CKG_GOPD_CLK_MIXERCLK_VE (4 << 10)
#define CKG_GOPD_MASK            (GOP_BIT12 | GOP_BIT11 | GOP_BIT10)

/* GOP2 CLK */
#define GOP_GOP2CLK             (CKG_REG_BASE+(0x42<<1))
#define CKG_GOPG2_DISABLE_CLK   ~(GOP_BIT0)
#define CKG_GOPG2_ODCLK         (0 << 2)
#define CKG_GOPG2_OD1CLK        (2 << 2)
#define CKG_GOPG2_IDCLK1        (7 << 2)
#define CKG_GOPG2_DIP           (3 << 2)
...
#define CKG_GOPG3_ODCLK         (0 << 10)
#define CKG_GOPG3_OD1CLK        (2 << 10)
#define CKG_GOPG3_IDCLK1        (7 << 10)
#define CKG_GOPG3_DIP           (3 << 10)
#define CKG_GOPG3_DISABLE_CLK_MASK    (GOP_BIT8)
#define CKG_GOPG3_MASK          (GOP_BIT12 | GOP_BIT11 | GOP_BIT10)
#define CKG_GOPD_DISABLE_CLK   ~(GOP_BIT8)

/* GOP4 CLK*/
#define GOP_GOP4CLK             (CKG_REG_BASE+(0x44<<1))
#define CKG_GOPG4_DISABLE_CLK_MASK    (GOP_BIT0)
#define CKG_GOPG4_DISABLE_CLK_MASK    (GOP_BIT0)
#define CKG_GOPG4_MASK          (GOP_BIT4 | GOP_BIT3 | GOP_BIT2)

// K6 : GOP0~3 and GOP5, NO GOP4. Mapping E_GOP4 to GOP 5 reg
/* GOP5 CLK*/
#define GOP_GOP5CLK             (CKG_REG_BASE+(0x44<<1))
#define CKG_GOPG5_DISABLE_CLK_MASK    (GOP_BIT8)
#define CKG_GOPG5_ODCLK         (0 << 10)
#define CKG_GOPG5_OD1CLK        (2 << 10)
#define CKG_GOPG5_DIP           (3 << 10)
#define CKG_GOPG5_IDCLK1        (7 << 10)
#define CKG_GOPG5_MASK          (GOP_BIT12 | GOP_BIT11 | GOP_BIT10)

/* SRAM CLK */
#define GOP_SRAMCLK             (CKG_REG_BASE+(0x43<<1))
#define CKG_SRAM0_DISABLE_CLK   (GOP_BIT0)
#define CKG_SRAM1_DISABLE_CLK   (GOP_BIT2)
#define CKG_SRAM0_MASK          (GOP_BIT0|GOP_BIT1)
#define CKG_SRAM1_MASK          (GOP_BIT2|GOP_BIT3)
...
/*AFBC CLK*/
#define GOP_AFBCCLK               (CKG_REG_BASE+(0x5F<<1))
#define CKG_AFBCCLK_DISABLE_CLK   (GOP_BIT0)
#define CKG_AFBCCLK_216           (0 << 2)
#define CKG_AFBCCLK_432           (1 << 2)
#define CKG_AFBCCLK_DISABLE_CLK_MASK    (GOP_BIT0|GOP_BIT1|GOP_BIT2|GOP_BIT3)
...
#define GOP_MIU_CLIENT_GOP0     0x0
#define GOP_MIU_CLIENT_GOP1     0x1
#define GOP_MIU_CLIENT_GOP2     0x2
#define GOP_MIU_CLIENT_GOP3     0x3
#define GOP_MIU_CLIENT_GOP4     0x4

#define GOP5_CLIENT_REG          0x7C
#define GOP5_MIU_GROUP           (MIU0_REG_BASE+(GOP5_CLIENT_REG*2))
#define GOP5_MIU_GROUP1          (MIU_REG_BASE+(GOP5_CLIENT_REG*2))
#define GOP_MIU_CLIENT_GOP5     0x2
...
#define GOP_MUX4_SHIFT                      1<<14

//Priority Setting
#define GOP_REGPRI_MASK                     BMASK(1:0)
#define GWIN0_PRI_SHIFT                     0
#define GWIN0_PRI_MASK                      (GOP_REGPRI_MASK<<GWIN0_PRI_SHIFT)
#define GWIN1_PRI_SHIFT                     4
#define GWIN1_PRI_MASK                      (GOP_REGPRI_MASK<<GWIN1_PRI_SHIFT)
#define GWIN2_PRI_SHIFT                     8
#define GWIN2_PRI_MASK                      (GOP_REGPRI_MASK<<GWIN2_PRI_SHIFT)
#define GWIN3_PRI_SHIFT                     12
#define GWIN3_PRI_MASK                      (GOP_REGPRI_MASK<<GWIN3_PRI_SHIFT)
...
// for gwin color format mask
#define GOP_REG_COLORTYPE_MASK              BMASK(4:0)
#define GOP_REG_COLORTYPE_SHIFT             4
...
#define GOP_AFBC_OFST                         0xE
#define GOP_MIXER_OFST                        0xD
#define GOP_1GS0_OFST                         0x15
#define GOP_1GS1_OFST                         0x19
...
#define GOP_4G_H121                         GOP_REG(GOP_4G_OFST, 0x1B)
...
#define GOP_4G_TRSCLR_TUV_L                 GOP_REG(GOP_4G_OFST, 0x26)
#define GOP_4G_TRSCLR_TUV_H                 GOP_REG(GOP_4G_OFST, 0x27)
#define GOP_4G_YUV_SWAP                     GOP_REG(GOP_4G_OFST, 0x28)
#define GOP_4G_OP_MUX_DBF                   GOP_REG(GOP_4G_OFST, 0x29)
...
#define GOP_4G_VIP_VOP_TIMING_SEL           GOP_4G_MULTI_ALPHA
#define GOP_4G_TWO_LINEBUFFER               GOP_4G_MULTI_ALPHA
...
#define GOP_4G_GOP_INTERNAL_ZORDER          GOP_REG(GOP_4G_OFST, 0x6A)
#define GOP_4G_GOP_INTERNAL_ZORDER_TRIG     GOP_REG(GOP_4G_OFST, 0x6B)
...
#define GOP_MUX_SC1                         __GOP_REG(0x7A)
...
#define GOP_4G_ARGB1555_ALPHA_DEF(id)       GOP_REG(GOP_4G_OFST+1, 0x03 + (0x20*((id)%MAX_GOP1_GWIN)))
...
#define GOP_4G_R2Y_SRGB11                   GOP_REG(GOP_4G_OFST+2, 0x21)
#define GOP_4G_R2Y_SRGB12                   GOP_REG(GOP_4G_OFST+2, 0x22)
#define GOP_4G_R2Y_SRGB13                   GOP_REG(GOP_4G_OFST+2, 0x23)
#define GOP_4G_R2Y_SRGB21                   GOP_REG(GOP_4G_OFST+2, 0x24)
#define GOP_4G_R2Y_SRGB22                   GOP_REG(GOP_4G_OFST+2, 0x25)
#define GOP_4G_R2Y_SRGB23                   GOP_REG(GOP_4G_OFST+2, 0x26)
#define GOP_4G_R2Y_SRGB31                   GOP_REG(GOP_4G_OFST+2, 0x27)
#define GOP_4G_R2Y_SRGB32                   GOP_REG(GOP_4G_OFST+2, 0x28)
#define GOP_4G_R2Y_SRGB33                   GOP_REG(GOP_4G_OFST+2, 0x29)
...
#define GOP_2G_ARGB1555_ALPHA_DEF(id)       GOP_REG(GOP_2G_OFST+1, 0x03 + (0x20*((id)%MAX_GOP1_GWIN)))
...
#define GOP_VE_DATA_MUX                         GOP_REG(GOP_MIXER_OFST, 0x30)
...
#define GOP_MIXER_CTRL                          GOP_REG(GOP_MIXER_OFST, 0x0)

#define GOP_MIXER_EN_GOP_MIX0           (1<<0)
#define GOP_MIXER_EN_GOP_MIX1           (1<<1)
#define GOP_MIXER_GOP_MIX_MODE          (1<<2)
#define GOP_MIXER_HS_POL                    (1<<5)
#define GOP_MIXER_VS_POL                    (1<<6)
#define GOP_MIXER_EN_FLD_FREERUN_MD (1<<7)
#define GOP_MIXER_INV_FIELD_VEOSD           (1<<8)
#define GOP_MIXER_ABL_POL                       (1<<9)
#define GOP_MIXER_EN_MIX                        (1<<15)


#define GOP_MIXER_FHST                          GOP_REG(GOP_MIXER_OFST, 0x1)
#define GOP_MIXER_FVST                          GOP_REG(GOP_MIXER_OFST, 0x2)
#define GOP_MIXER_FHEND                         GOP_REG(GOP_MIXER_OFST, 0x3)
#define GOP_MIXER_FVEND                         GOP_REG(GOP_MIXER_OFST, 0x4)
#define GOP_MIXER_HTT                           GOP_REG(GOP_MIXER_OFST, 0x5)
#define GOP_MIXER_HS_DELAY                      GOP_REG(GOP_MIXER_OFST, 0x6)
#define GOP_MIXER_FLD_DELAY_LINE                GOP_REG(GOP_MIXER_OFST, 0x7)
#define GOP_MIXER_FLD_DE_ADJUST                 GOP_REG(GOP_MIXER_OFST, 0x8)
#define GOP_MIXER_C_FIL_COEF0COEF1              GOP_REG(GOP_MIXER_OFST, 0x9)
#define GOP_MIXER_C_FIL_COEF2COEF3              GOP_REG(GOP_MIXER_OFST, 0xa)
#define GOP_MIXER_VFIL_RATIO                    GOP_REG(GOP_MIXER_OFST, 0xb)
#define GOP_MIXER_MIX_DUMMY                     GOP_REG(GOP_MIXER_OFST, 0xc)
#define GOP_MIXER_DEBUG_H                       GOP_REG(GOP_MIXER_OFST, 0xd)
#define GOP_MIXER_DEBUG_V                       GOP_REG(GOP_MIXER_OFST, 0xe)
#define GOP_MIXER_DEBUG_PIXEL_L                 GOP_REG(GOP_MIXER_OFST, 0xf)
#define GOP_MIXER_DEBUG_PIXEL_H                 GOP_REG(GOP_MIXER_OFST, 0x10)
#define GOP_MIXER_VE                            GOP_REG(GOP_MIXER_OFST, 0x11)
#define GOP_MIXER_FULL_WIN_DE                   GOP_REG(GOP_MIXER_OFST, 0x20)
#define GOP_VE_DATA_MUX                         GOP_REG(GOP_MIXER_OFST, 0x30)

    #define GOP_MIXER_EN_VFIL                   (1<<0)
    #define GOP_MIXER_EN_VFIL_MASK             GOP_BIT0
    #define GOP_MIXER_VS_FLD_ON                 (1<<7)
    #define GOP_MIXER_VS_FLD_ON_MASK           GOP_BIT7
#define GOP_MIXER_REG_DUMMY                     GOP_REG(GOP_MIXER_OFST, 0x20)
...
// GOP AFBC Reg
//----------------------------------------------------------------------------
#define REG_AFBC_CORE_EN(id)                    GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x00+(0x20*id))
#define REG_AFBC_ADDR_L(id)                     GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x01+(0x20*id))
#define REG_AFBC_ADDR_H(id)                     GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x02+(0x20*id))
#define REG_AFBC_FMT(id)                        GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x0C+(0x20*id))
#define REG_AFBC_WIDTH(id)                      GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x0A+(0x20*id))
#define REG_AFBC_HEIGHT(id)                     GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x0B+(0x20*id))
#define REG_AFBC_RESP(id)                       GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x0F+(0x20*id))
#define REG_AFBC_MIU                            GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x43)
#define REG_AFBC_DEBUG(id)                      GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x44+(0x20*id))
#define REG_AFBC_READCNT(id)                    GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x4C+(0x20*id))
#define REG_AFBC_TRIGGER                        GOP_REG(GOP_4G_OFST+GOP_AFBC_OFST, 0x50)
