...
#define GOP4_REG_FORM                           E_GOP_REG_FORM_T81G + E_GOP_PAL_SIZE_NONE
...
#define GOP_FIFO_THRESHOLD                      0xD0UL
#define GOP3_FIFO_THRESHOLD                     0x70UL
...
#define GOP_4K2K30
#define OUTPUT_VAILD_SIZE_PATCH
...
#define VE_MUX_INIT_VALUE                       7UL

//Gwin enable HW bug
#define GOP_AUTO_CLK_GATING_PATCH

#define GOP_ZORDER_PD_PATCH        1
#ifdef GOP_ZORDER_PD_PATCH
#define GOP_ZORDER_LAYER0_MUX_OFFSET            0x8
#endif

#define Mixer_preAlpha_setting   0
...
// Get the Gwin offset id of current GOP
