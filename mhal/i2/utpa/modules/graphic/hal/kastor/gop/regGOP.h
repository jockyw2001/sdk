...
// VE Reg
//----------------------------------------------------------------------------
#define GOP_VE_TVS_CTRL             0x00
#define GOP_VE_TVS_OSD_EN           0x55
#define GOP_VE_TVS_OSD1_EN          0x60
#define GOP_VE_TVE_SWRST            0x07
...
#define CKG_GOPG3_DISABLE_CLK   ~(GOP_BIT8)
...
#define CKG_GOPG5_CLK_ODCLK         (0<<10)
#define CKG_GOPG5_CLK_DC0           (1<<10)
#define CKG_GOPG5_CLK_EXTDI         (2<<10)
#define CKG_GOPG5_CLK_DVI           (3<<10)
#define CKG_GOPG5_CLK_SC1_EDCLK     (4<<10)
#define CKG_GOPG5_CLK_SC1_ODCLK     (5<<10)
#define CKG_GOPG5_CLK_27            (6<<10)
#define CKG_GOPG5_CLK_SUB_DC0       (7<<10)
...
#define GOP5_MIU_GROUP           (MIU0_REG_BASE+(GOP_CLIENT_REG*2))
#define GOP5_MIU_GROUP1          (MIU_REG_BASE+(GOP_CLIENT_REG*2))
