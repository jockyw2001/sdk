...
#define atoi(str) simple_strtoul(((str != NULL) ? str : ""), NULL, 0)
    ...
    #define getGopPid()    pInstantGOP
#else
#define getGopPid() 0UL
#endif
...
/********************************************************************************/
/// Set GWIN alpha argb1555 alpha
/// @param u8win \b IN GWIN id
/// @param bAlphaType \b IN
///   - # TRUE define alpha1
///   - # FALSE define alpha0
/// @param u8Val \b IN alpha blending coefficient (0-7)
/// @return GOP_API_SUCCESS - Success
/********************************************************************************/
E_GOP_API_Result MApi_GOP_GWIN_SetARGB1555_Alpha(MS_U8 u8win, MS_BOOL bAlphaType, MS_U8 u8Val)
{
    GOP_GWIN_PROPERTY_PARAM ioctl_info;
    GOP_GWIN_SETARGB1555ALPHA setAlphaInfo;
    GOP_ENTRY();
    ioctl_info.en_property = E_GOP_GWIN_SETARGB1555ALPHA;
    ioctl_info.GwinId = u8win;
    ioctl_info.pSet = (MS_U32*)&setAlphaInfo;
    ioctl_info.u32Size = sizeof(GOP_GWIN_SETARGB1555ALPHA);

    setAlphaInfo.Val = u8Val;
    setAlphaInfo.bAlphaType = bAlphaType;
...
void MApi_GOP_Exit()
{
    ...
    GOP_INFO("---%s %d: PID[%td], TID[%td] tries to exit\n", __FUNCTION__, __LINE__, (ptrdiff_t)getGopPid(), (ptrdiff_t)MsOS_GetOSThreadID());
    GOP_ENTRY();
#ifdef  MSOS_TYPE_LINUX
    GOP_MISC_PARAM ioctl_info;
    MS_U32  value = 0;
...
/******************************************************************************/
/// API for GOP set color matrix
/// @param MS_U8 u8GOP\b IN: GOP ID
/// @param ST_GOP_R2Y matrix  \b IN: 3x3 matrix
/// @return GOP_API_SUCCESS - Success
/// @return GOP_API_FAIL - Failure
/******************************************************************************/
E_GOP_API_Result MApi_GOP_SetR2YMatrix(MS_U8 u8GOP,ST_GOP_R2Y_Matrix *matrix)
{
    GOP_SET_PROPERTY_PARAM ioctl_info;
    GOP_ENTRY();
    memset(&ioctl_info, 0x0, sizeof(GOP_SET_PROPERTY_PARAM));

    ioctl_info.en_pro   = E_GOP_R2Y_COLOR_MATRIX;
    ioctl_info.gop_idx  = u8GOP;
    ioctl_info.pSetting = (void*)matrix;
    ioctl_info.u32Size  = sizeof(ST_GOP_R2Y_Matrix);
