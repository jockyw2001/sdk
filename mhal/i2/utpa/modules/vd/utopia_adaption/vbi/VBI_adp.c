...
MS_U32 VBI_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MDrv_CMD_VBI_GetInfo:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GETINFO_PARAM,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_GetStatus:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GETSTATUS_PARAM,spt_VBI_GETSTATUS_PARAM,NULL,0);
            break;
        case MDrv_CMD_VBI_SetDbgLevel:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_SETDBGLEVEL_PARAM, NULL, NULL, 0);
            break;
        case MDrv_CMD_VBI_Init:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_INIT_TYPE_PARAM, NULL, NULL, 0);
            break;
        case MDrv_CMD_VBI_RegisterCB:
            //u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_REGISTER_CB,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_RingBuffer_Reset:
            u32Ret= UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
            break;
        case MDrv_CMD_VBI_InitializeTTXSlicer:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_INITIALIZER_TTX_SLICER,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_EnableTTXSlicer:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_ENABLE_TTX_SLICER,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_IsVPS_Ready:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_BOOL,spt_VBI_BOOL,NULL,0);
            break;
        ...
        case MDrv_CMD_VBI_GetWSS_Data:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GET_DATA,spt_VBI_GET_DATA,NULL,0);
            break;
        case MDrv_CMD_VBI_GetVPS_Data:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GET_VPS_DATA,spt_VBI_GET_VPS_DATA,NULL,0);
            break;
        case MDrv_CMD_VBI_GetRawVPS_Data:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_GET_RAW_VPS_DATA,spt_VBI_GET_RAW_VPS_DATA,NULL,0);
            break;
        case MDrv_CMD_VBI_SetVideoStandard:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_SET_VIDEO_STANDARD,NULL,NULL,0);
            break;
        ...
        case MDrv_CMD_VBI_TTX_GetPackets:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_TTX_GET_PACKETS,spt_VBI_TTX_GET_PACKETS,NULL,0);
            break;
        case MDrv_CMD_VBI_TTX_GetPacket:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_TTX_GET_PACKET,spt_VBI_TTX_GET_PACKET,NULL,0);
            break;
        ...
        case MDrv_CMD_VBI_TTX_EnableLine:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_TTX_ENABLE_LINE,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_SyncMemory:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_SYNC_MEMORY,NULL,NULL,0);
            break;

        case MDrv_CMD_VBI_CC_InitSlicer:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_INIT_SLICER,NULL,NULL,0);
            break;

        case MDrv_CMD_VBI_CC_InitYPbYr:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_INIT_YPBYR,NULL,NULL,0);
            break;

        case MDrv_CMD_VBI_CC_SetDataRate:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_SETDATARATE,NULL,NULL,0);
            break;
        ...
        case MDrv_CMD_VBI_CC_GetInfo:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_GETINFO,spt_VBI_CC_GETINFO,NULL,0);
            break;

        case MDrv_CMD_VBI_CC_SetFrameCnt:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_SET_FRAMECNT,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_CC_EnableSlicer:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_ENABLE_TTX_SLICER,NULL,NULL,0);
            break;
        case MDrv_CMD_VBI_CC_EnableLine:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CC_ENABLE_LINE,NULL,NULL,0);
            break;
        ...
        case MDrv_CMD_DMX_TTX_SetFilterID:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DMX_TTX_SET_FILTERID,NULL,NULL,0);
            break;
        ...
        case MDrv_CMD_VBI_Exit:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_VBI_CMD,NULL,NULL,0);
            break;
        case MDrv_CMD_DMX_TTX_Exit:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DMX_TTX_CMD,NULL,NULL,0);
            break;
