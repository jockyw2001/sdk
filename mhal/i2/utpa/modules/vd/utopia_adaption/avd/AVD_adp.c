...
MS_U32 AVD_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MDrv_CMD_AVD_Init :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_INIT,spt_AVD_INIT,NULL,0);
        break;
        case MDrv_CMD_AVD_Exit:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
        break;
        case MDrv_CMD_AVD_ResetMCU:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_AVD_CopyToUser,NULL,0);
        break;
        case MDrv_CMD_AVD_FreezeMCU:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,bAVDEnable,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_Scan_HsyncCheck:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_SCAN_HSYNC_CHECK,spt_DrvAVD_AVD_SCAN_HSYNC_CHECK,NULL,0);
        break;
        case MDrv_CMD_AVD_StartAutoStandardDetection:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
        break;
        case MDrv_CMD_AVD_ForceVideoStandard:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_FORCEVIDEOSTANDARD,spt_DrvAVD_AVD_FORCEVIDEOSTANDARD,NULL,0);
        break;
        case MDrv_CMD_AVD_3DCombSpeedup:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
        break;
        case MDrv_CMD_AVD_LoadDSP :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_LOADDSP,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_BackPorchWindowPositon :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_BACKPORCHWINPOS,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_MBX_ReadByteByVDMbox:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_MBXREADBYTEBYVDMBOX,spt_DrvAVD_AVD_MBXREADBYTEBYVDMBOX,NULL,0);
        break;
        case MDrv_CMD_AVD_SetFlag:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,u32AVDValue,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetRegValue :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETREGVALUE,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetRegFromDSP:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
        break;
        case MDrv_CMD_AVD_SetInput :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETINPUT,spt_AVD_SETINPUT,NULL,0);
        break;
        case MDrv_CMD_AVD_SetVideoStandard :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETVIDEOSTANDARD,spt_AVD_SETVIDEOSTANDARD,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_SetShiftClk :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETSHIFTCLK,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetFreerunPLL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,eVideoFreq,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetFreerunFreq:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,eFreerunfreq,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetFactoryPara :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETFACTORYPARA,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_Set_Htt_UserMD :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,u16AVDValue,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetDbgLevel:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_SETDBGLEVEL,spt_DrvAVD_AVD_SETDBGLEVEL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetPQFineTune:
            u32Ret=UtopiaIoctl(pInstanceTmp,u32Cmd,pArgs);
        break;
        case MDrv_CMD_AVD_Set3dCombSpeed:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SET3DCOMBSPEED,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetStillImageParam:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_Still_Image_Param,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetAFECD4Factory:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,u8AVDValue,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_Set2D3DPatchOnOff:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,bAVDEnable,NULL,NULL,0);
        break;
        case MDrv_CMD_AVD_SetAutoFineGainToFixed:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,u8AVDValue,NULL,0);
        break;
        case MDrv_CMD_AVD_GetFlag:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_AVD_CopyToUser,NULL,0);
        break;
        case MDrv_CMD_AVD_GetRegValue:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_GETREGVALUE,spt_DrvAVD_AVD_GETREGVALUE,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_GetStandardDetection :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_GetStandardDetection,spt_AVD_GetStandardDetection,NULL,0);
        break;
        case MDrv_CMD_AVD_GetLastDetectedStandard :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_AVD_CopyToUser,NULL,0);
        break;
        case MDrv_CMD_AVD_GetCaptureWindow :
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_GETCAPTUREWINDOW,spt_AVD_GETCAPTUREWINDOW,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_GetLibVer:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_GETLIBVER,spt_DrvAVD_AVD_GETLIBVER,NULL,0);
        break;
        case MDrv_CMD_AVD_GetInfo:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_AVD_CopyToUser,NULL,0);
        break;
        case MDrv_CMD_AVD_IsSyncLocked:
            UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,NULL,spt_AVD_CopyToUser,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_SetPowerState:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_DrvAVD_AVD_SETPOWERSTATE,spt_DrvAVD_AVD_SETPOWERSTATE,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_SetBurstWinStart:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETBURSTWINSTART,NULL,NULL,0);
        break;
        ...
        case MDrv_CMD_AVD_SetHsyncSensitivityForDebug:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_AVD_SETHSYNCSENSITIVITYFORDEBUG,NULL,NULL,0);
        break;
        default:
        break;
