...
/**
     ...
     * @return          none
     */
void ms_device_del(struct device_s * ms_gdev)
{
...
void ms_device_unregister(struct device_s * ms_gdev)
{
    ...
    /* calling device registed release function to releaes
     * all device's allocated resouces, now ms_usb_release_intf() is called
     */
