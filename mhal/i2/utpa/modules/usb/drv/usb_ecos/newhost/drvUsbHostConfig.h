...
#define ECOS_USB_HOST_LOCAL_VER "20170828"
...
#define BASE_USBBC0_K7U     BASE_USBBC0_KERES
#define BASE_USBBC0_C2P     BASE_USBBC0_KERES
...
#define BASE_USBBC1_K7U     BASE_USBBC1_KANO
#define BASE_USBBC1_C2P     BASE_USBBC1_KANO
...
#define BASE_UTMI2_K7U      (OS_BASE_ADDR+(0x23E00*2))
#define BASE_UTMI2_C2P      BASE_UTMI2_K6
...
#define BASE_UHC2_K7U       (OS_BASE_ADDR+(0x12700*2))
#define BASE_UHC2_C2P       BASE_UHC2_K6
...
#define BASE_USBC2_K7U      BASE_USBC2_CLIPPERS
#define BASE_USBC2_C2P      BASE_USBC2_K6
...
#define XHCI_PORT0_ADDR         (_MSTAR_PM_BASE+(0x380000<<1)+0x0430)
#define XHCI_PORT1_ADDR         (_MSTAR_PM_BASE+(0x390000<<1)+0x0430)
#define MSTAR_U3TOP_P0_BASE     (OS_BASE_ADDR+(0x40200*2))
#define MSTAR_U3TOP_P1_BASE     (OS_BASE_ADDR+(0x40300*2))
#define MSTAR_U3PHY_P0_A_BASE	(OS_BASE_ADDR+(0x02100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(OS_BASE_ADDR+(0x02000 << 1))
#define MSTAR_U3PHY_P1_A_BASE	(OS_BASE_ADDR+(0x02300 << 1))
#define MSTAR_U3PHY_P1_D_BASE	(OS_BASE_ADDR+(0x02200 << 1))
#define XHC_COMP_PORT0          {0, XHCI_PORT0_ADDR, MSTAR_U3TOP_P0_BASE, MSTAR_U3PHY_P0_A_BASE, MSTAR_U3PHY_P0_D_BASE}
#define XHC_COMP_PORT1          {1, XHCI_PORT1_ADDR, MSTAR_U3TOP_P1_BASE, MSTAR_U3PHY_P1_A_BASE, MSTAR_U3PHY_P1_D_BASE}
#elif defined(CHIP_C2P)
#define XHCI_PORT0_ADDR         (OS_BASE_ADDR+(0xe0000<<1)+0x0430)
#define MSTAR_U3TOP_BASE        (OS_BASE_ADDR+(0x40200*2))
#define MSTAR_U3PHY_P0_A_BASE	(OS_BASE_ADDR+(0x02100 << 1))
#define MSTAR_U3PHY_P0_D_BASE	(OS_BASE_ADDR+(0x02000 << 1))
#define XHC_COMP_PORT0          {0, XHCI_PORT0_ADDR, MSTAR_U3TOP_BASE, MSTAR_U3PHY_P0_A_BASE, MSTAR_U3PHY_P0_D_BASE}
...
#define ENABLE_THIRD_EHC
	...
	(defined(CHIP_K7U) && defined(ENABLE_XHC_COMPANION))
...
#define ENABLE_FIFTH_EHC
	...
	defined(CHIP_K6LITE) || \
	defined(CHIP_K7U) || \
	(defined(CHIP_C2P) && defined(ENABLE_XHC_COMPANION))
...
#if defined(CHIP_U4) || defined(CHIP_K1) || defined(CHIP_K2)
        #define EHSTST_TEST_PACKET_UTMI10    0x0038
#else
