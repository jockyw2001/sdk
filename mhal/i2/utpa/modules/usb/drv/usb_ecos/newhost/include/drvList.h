...
/**
     ...
     * @return            boolean
     */
static __inline__ int ms_is_empty_list(const struct list_head *pList )
{
    if (pList == pList->next)
        return TRUE;
    else
...
/**
     ...
     * @return                     None
     */
static __inline__ void ms_list_join(const struct list_head *pList, struct list_head *pHead)
{
