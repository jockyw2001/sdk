...
void ms_U4_series_usb_init(struct s_ChipUsbHostDef *pChip, MS_U8 u8Hostid)
{
    ...
    ms_usbhost_msg("[USB] constant upll NLib, UTMI base %p, USBC base %p, UHC base %p\n",
        (void *)UTMI_base, (void *)USBC_base, (void *)UHC_base);
    ...
    */
    ...
    if(UTMI_DISCON_LEVEL_2A & (0x0f))
    {
	    usb_writeb((UTMI_DISCON_LEVEL_2A & (0x0f)), (void*)(UTMI_base+0x2a*2));
	    ms_usbhost_msg("[USB] init squelch level 0x%x\n", usb_readb((void*)(UTMI_base+0x2a*2)));
    }
...
{
    diag_printf("Mstar USB initial, %d ports supported\n", NUM_OF_ROOT_HUB);
...
struct s_ChipUsbHostDef chipDESC =
{
    ...
    {EHCFLAG_USBBC_OFF | EHCFLAF_XHC_COMP, BASE_UTMI3_KANO, BASE_UHC3_KANO, BASE_USBC3_KANO, BASE_USBBC3_KANO, E_IRQ_UHC3_KANO, E_IRQ_USBC3_KANO, XHC_COMP_PORT0},
    {EHCFLAG_USBBC_OFF | EHCFLAF_XHC_COMP, BASE_UTMI4, BASE_UHC4, BASE_USBC4, BASE_USBBC4, E_IRQ_UHC4_KANO, E_IRQ_USBC4_KANO, XHC_COMP_PORT1},
    },
...
struct s_ChipUsbHostDef chipDESC =
{
    ...
    5,
    {
    {EHCFLAG_USBBC_OFF, BASE_UTMI0, BASE_UHC0, BASE_USBC0, BASE_USBBC0_K7U, E_IRQ_UHC, E_IRQ_USBC, XHC_COMP_NONE},
    {EHCFLAG_USBBC_OFF, BASE_UTMI1, BASE_UHC1, BASE_USBC1, BASE_USBBC1_K7U, E_IRQ_UHC1, E_IRQ_USBC1, XHC_COMP_NONE},
    {EHCFLAG_USBBC_OFF, BASE_UTMI2_K7U, BASE_UHC2_K7U, BASE_USBC2_K7U, BASE_USBBC2_K7U, E_IRQ_UHC2, E_IRQ_USBC2, XHC_COMP_NONE},
    {EHCFLAG_USBBC_OFF | EHCFLAF_XHC_COMP, BASE_UTMI3_K7U, BASE_UHC3_K7U, BASE_USBC3_K7U, BASE_USBBC3_K7U, E_IRQ_UHC3_K7U, E_IRQ_USBC3_K7U, XHC_COMP_PORT0},
    {EHCFLAG_USBBC_OFF | EHCFLAF_XHC_COMP, BASE_UTMI4, BASE_UHC4, BASE_USBC4, BASE_USBBC4, E_IRQ_UHC4_K7U, E_IRQ_USBC4_K7U, XHC_COMP_PORT1},
    },
    {&gVar4UsbPort0, &gVar4UsbPort1, &gVar4UsbPort2, &gVar4UsbPort3, &gVar4UsbPort4}
#else
    3,
    {
    {EHCFLAG_USBBC_OFF, BASE_UTMI0, BASE_UHC0, BASE_USBC0, BASE_USBBC0_K7U, E_IRQ_UHC, E_IRQ_USBC},
    {EHCFLAG_USBBC_OFF, BASE_UTMI1, BASE_UHC1, BASE_USBC1, BASE_USBBC1_K7U, E_IRQ_UHC1, E_IRQ_USBC1},
    {EHCFLAG_USBBC_OFF, BASE_UTMI2_K7U, BASE_UHC2_K7U, BASE_USBC2_K7U, BASE_USBBC2_K7U, E_IRQ_UHC2, E_IRQ_USBC2},
    },
    {&gVar4UsbPort0, &gVar4UsbPort1, &gVar4UsbPort2}
#endif
};
...
struct s_ChipUsbHostDef chipDESC =
{
    ...
    3,
    {
    {EHCFLAG_USBBC_OFF, BASE_UTMI0, BASE_UHC0, BASE_USBC0, BASE_USBBC0_C2P, E_IRQ_UHC, E_IRQ_USBC, XHC_COMP_NONE},
    {EHCFLAG_USBBC_OFF, BASE_UTMI1, BASE_UHC1, BASE_USBC1, BASE_USBBC1_C2P, E_IRQ_UHC1, E_IRQ_USBC1, XHC_COMP_NONE},
    {EHCFLAG_USBBC_OFF | EHCFLAF_XHC_COMP, BASE_UTMI2_C2P, BASE_UHC2_C2P, BASE_USBC2_C2P, BASE_USBBC2_C2P, E_IRQ_UHC2_C2P, E_IRQ_USBC2_C2P, XHC_COMP_PORT0},
    },
    {&gVar4UsbPort0, &gVar4UsbPort1, &gVar4UsbPort2}
#else
    2,
    {
    {EHCFLAG_USBBC_OFF, BASE_UTMI0, BASE_UHC0, BASE_USBC0, BASE_USBBC0_C2P, E_IRQ_UHC, E_IRQ_USBC},
    {EHCFLAG_USBBC_OFF, BASE_UTMI1, BASE_UHC1, BASE_USBC1, BASE_USBBC1_C2P, E_IRQ_UHC1, E_IRQ_USBC1},
    },
    {&gVar4UsbPort0, &gVar4UsbPort1}
#endif
};
...
struct s_ChipUsbHostDef chipDESC =
{
    ...
    2,
    {
    {EHCFLAG_USBBC_OFF | EHCFLAG_DPDM_SWAP, BASE_UTMI0, BASE_UHC0, BASE_USBC0, BASE_USBBC0_KERES, E_IRQ_UHC, E_IRQ_USBC},
    {EHCFLAG_USBBC_OFF | EHCFLAG_DPDM_SWAP, BASE_UTMI1, BASE_UHC1, BASE_USBC1, BASE_USBBC1_KERES, E_IRQ_UHC1, E_IRQ_USBC1},
    },
    {&gVar4UsbPort0, &gVar4UsbPort1}
};
...
MS_BOOL MDrv_USB_Port_Init(MS_U8 u8Hostid)
{
    ...
    {
#if defined(CHIP_K7U)
	if (u8Hostid == 2 && MDrv_SYS_GetChipRev() == 0x0) {
		diag_printf("[WARN] k7u U0 not support port 2\n");
		return FALSE;
	}
#endif
    ...
    INIT_LIST_HEAD(&pChip->p_roothub[u8Hostid]->hub_event);
