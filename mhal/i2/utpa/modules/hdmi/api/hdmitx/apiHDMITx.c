...
MS_BOOL MApi_HDMITx_GetAksv(MS_U8 *pdata)
{
    ...
    if (UtopiaIoctl(pu32HDMITXInst, E_HDMITX_CMD_GETAKSV, (void*)&HDMITXArgs) != UTOPIA_STATUS_SUCCESS)
    {
...
{
    HDMITx_HDCP1X_COMPARE_RI HDMITXArgs;

    HDMITXArgs.bReturn = FALSE;

    if (UtopiaIoctl(pu32HDMITXInst, E_HDMITX_CMD_HDCP1XCOMPARERI, (void*)&HDMITXArgs) != UTOPIA_STATUS_SUCCESS)
    {
       printf("MApi_HDMITx_GeneralCtrl Obtain HDMITX engine fail @ E_HDMITX_CMD_HDCP1XCOMPARERI\n");
       return FALSE;
    }
    else
    {
...
{
    HDMITX_GET_COLOR_FMT HDMITXArgs;

    HDMITXArgs.enColorFmt = HDMITX_VIDEO_COLOR_RGB444;
    HDMITXArgs.u32Ret= 0;

    if (UtopiaIoctl(pu32HDMITXInst, E_HDMITX_CMD_GET_COLOR_FORMAT, (void*)&HDMITXArgs) != UTOPIA_STATUS_SUCCESS)
    {
       printf("MApi_HDMITx_GeneralCtrl Obtain HDMITX engine fail @ E_HDMITX_CMD_GET_COLOR_FORMAT\n");
       return FALSE;
    }
    else
    {
       pstColorFmt->enColorFmt = HDMITXArgs.enColorFmt;
       return HDMITXArgs.u32Ret;
    }
}
...
{
    HDMITX_GET_COLOR_DEPTH HDMITXArgs;

    HDMITXArgs.enColorDepth = HDMITX_VIDEO_CD_NoID;
    HDMITXArgs.u32Ret= 0;

    if (UtopiaIoctl(pu32HDMITXInst, E_HDMITX_CMD_GET_COLOR_DEPTH, (void*)&HDMITXArgs) != UTOPIA_STATUS_SUCCESS)
    {
       printf("MApi_HDMITx_GeneralCtrl Obtain HDMITX engine fail @ E_HDMITX_CMD_GET_COLOR_DEPTH\n");
       return FALSE;
    }
    else
    {
       pstColorDepth->enColorDepth = HDMITXArgs.enColorDepth;
       return HDMITXArgs.u32Ret;
    }
}
...
{
    HDMITX_CHECK_EDID_QUAN_RANGE HDMITXArgs;

    HDMITXArgs.eTiming = idx;
    HDMITXArgs.eOutColor = outcolor_fmt;
    HDMITXArgs.u8Return = 0;

    if (UtopiaIoctl(pu32HDMITXInst, E_HDMITX_CMD_CHECK_EDID_QUANT_RANGE, (void*)&HDMITXArgs) != UTOPIA_STATUS_SUCCESS)
    {
       printf("MApi_HDMITx_GeneralCtrl Obtain HDMITX engine fail @ E_HDMITX_CMD_CHECK_EDID_QUANT_RANGE\n");
       return FALSE;
    }
    else
    {
