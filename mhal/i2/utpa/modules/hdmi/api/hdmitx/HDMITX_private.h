...
typedef struct
{
    ...
    IOCTL_HDMITX_CMD_HDCP1X_COMPARE_RI                            fpHDMITx_Cmd_Hdcp1x_Compare_Ri;
    IOCTL_HDMITX_CMD_GET_TMDS_STATUS                              fpHDMITx_Cmd_Get_TMDS_Status;
    IOCTL_HDMITX_CMD_GET_COLOR_FORMAT                             fpHDMITx_Cmd_Get_Color_Format;
    IOCTL_HDMITX_CMD_GET_COLOR_DEPTH                              fpHDMITx_Cmd_Get_Color_Depth;
    IOCTL_HDMITX_CMD_CHECK_EDID_QUANANTIZATION_RANGE              fpHDMITx_Cmd_Check_EDID_Quantization_Range;
#if defined(VANCLEEF_MCP) || defined(RAPTORS_MCP)
