...
#define PARSING_ATOP_TAB(x)  (  x == MS_TX_ATOP_ID_8bits_480_60I        ? "8bits_480_60I        "  : \
                                x == MS_TX_ATOP_ID_8bits_480_60P        ? "8bits_480_60P        "  : \
                                x == MS_TX_ATOP_ID_8bits_1080_60I       ? "8bits_1080_60I       "  : \
                                x == MS_TX_ATOP_ID_8bits_720_60P        ? "8bits_720_60P        "  : \
                                x == MS_TX_ATOP_ID_8bits_1080_60P       ? "8bits_1080_60P       "  : \
                                x == MS_TX_ATOP_ID_8bits_4K2K_420_30P   ? "8bits_4K2K_420_30P   "  : \
                                x == MS_TX_ATOP_ID_8bits_4K2K_3D_30P    ? "8bits_4K2K_3D_30P    "  : \
                                x == MS_TX_ATOP_ID_8bits_4K2K_420_60P   ? "8bits_4K2K_420_60P   "  : \
                                x == MS_TX_ATOP_ID_8bits_4K2K_60P       ? "8bits_4K2K_60P       "  : \
                                x == MS_TX_ATOP_ID_10bits_480_60I       ? "10bits_480_60I       "  : \
                                x == MS_TX_ATOP_ID_10bits_480_60P       ? "10bits_480_60P       "  : \
                                x == MS_TX_ATOP_ID_10bits_1080_60I      ? "10bits_1080_60I      "  : \
                                x == MS_TX_ATOP_ID_10bits_720_60P       ? "10bits_720_60P       "  : \
                                x == MS_TX_ATOP_ID_10bits_1080_60P      ? "10bits_1080_60P      "  : \
                                x == MS_TX_ATOP_ID_10bits_4K2K_420_30P  ? "10bits_4K2K_420_30P  "  : \
                                x == MS_TX_ATOP_ID_10bits_4K2K_3D_30P   ? "10bits_4K2K_3D_30P   "  : \
                                x == MS_TX_ATOP_ID_10bits_4K2K_420_60P  ? "10bits_4K2K_420_60P  "  : \
                                x == MS_TX_ATOP_ID_10bits_4K2K_60P_RB   ? "10bits_4K2K_60P_RB   "  : \
                                x == MS_TX_ATOP_ID_12bits_480_60I       ? "12bits_480_60I       "  : \
                                x == MS_TX_ATOP_ID_12bits_480_60P       ? "12bits_480_60P       "  : \
                                x == MS_TX_ATOP_ID_12bits_1080_60I      ? "12bits_1080_60I      "  : \
                                x == MS_TX_ATOP_ID_12bits_720_60P       ? "12bits_720_60P       "  : \
                                x == MS_TX_ATOP_ID_12bits_1080_60P      ? "12bits_1080_60P      "  : \
                                x == MS_TX_ATOP_ID_12bits_4K2K_420_30P  ? "12bits_4K2K_420_30P  "  : \
                                x == MS_TX_ATOP_ID_12bits_4K2K_3D_30P   ? "12bits_4K2K_3D_30P   "  : \
                                x == MS_TX_ATOP_ID_12bits_4K2K_420_60P  ? "12bits_4K2K_420_60P  "  : \
                                x == MS_TX_ATOP_ID_16bits_480_60I       ? "16bits_480_60I       "  : \
                                x == MS_TX_ATOP_ID_16bits_480_60P       ? "16bits_480_60P       "  : \
                                x == MS_TX_ATOP_ID_16bits_1080_60I      ? "16bits_1080_60I      "  : \
                                x == MS_TX_ATOP_ID_16bits_720_60P       ? "16bits_720_60P       "  : \
                                x == MS_TX_ATOP_ID_16bits_1080_60P      ? "16bits_1080_60P      "  : \
                                x == MS_TX_ATOP_ID_16bits_4K2K_420_30P  ? "16bits_4K2K_420_30P  "  : \
                                x == MS_TX_ATOP_ID_16bits_4K2K_3D_30P   ? "16bits_4K2K_3D_30P   "  : \
                                x == MS_TX_ATOP_ID_16bits_4K2K_420_60P  ? "16bits_4K2K_420_60P  "  : \
                                                                          "UNKNOWON")
//-------------------------------------------------------------------------------------------------
//  Local Structures
//-------------------------------------------------------------------------------------------------
...
stHDMITx_ATOP_SETTING HDMITxVideoAtopSetting[HDMITX_COLOR_DEPTH_TYPE_NUM][E_HDMITX_RES_MAX] =
{
    //color depth = 8bit
    {
        {0x03, 0x03, 0x00, 0x03, 0x14, 0x0F, 0x44A3B7},  // 0: 640x480p
...
// 148Mhz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x1745D1},  // 12: 1920x1080p_50Hz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x1745D1},  // 13: 1920x1080p_60Hz
...
// 150MHz
        {0x02, 0x02, 0x00, 0x0C, 0x38, 0x08, 0x155555},  // 27: 1600x1200p_60Hz
// 106.5MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x2075B8},  // 28: 1440x900p_60Hz
// 108MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x200000},  // 29: 1280x1024p_60Hz
// 65MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x352B52},  // 30: 1024x768p_60Hz
// 59.4MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x3A2E8B},  // 31: 1280x720p_24Hz
// 74.25MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x2E8BA2},  // 32: 1280x720p_25Hz
// 74.25MHz
        {0x02, 0x02, 0x00, 0x03, 0x14, 0x0F, 0x2E8BA2},  // 33: 1280x720p_30Hz
    },

    //color depth  = 10 bit
    {
        {0x03, 0x03, 0x01, 0x03, 0x14, 0x0F, 0x36E95F},  // 0: 640x480p
...
// 148Mhz
        ...
        // the following is 4k2k timing list, if not support, default is 3840x2160p@3
...
// 59.4MHz
        {0x02, 0x02, 0x01, 0x03, 0x14, 0x0F, 0x2E8BA2},  // 31: 1280x720p_24Hz
// 74.25MHz
        {0x02, 0x02, 0x01, 0x03, 0x14, 0x0F, 0x253C82},  // 32: 1280x720p_25Hz
// 74.25MHz
        {0x02, 0x02, 0x01, 0x03, 0x14, 0x0F, 0x253C82},  // 33: 1280x720p_30Hz
    },

    //color depth = 12 bit
    {
        {0x03, 0x03, 0x02, 0x03, 0x14, 0x0F, 0x2DC27A},  // 0: 640x480p
...
// 59.4MHz
        {0x02, 0x02, 0x02, 0x03, 0x14, 0x0F, 0x26C9B2},  // 31: 1280x720p_24Hz
// 74.25MHz
        {0x02, 0x02, 0x02, 0x03, 0x14, 0x0F, 0x1F07C1},  // 32: 1280x720p_25Hz
// 74.25MHz
        {0x02, 0x02, 0x02, 0x03, 0x14, 0x0F, 0x1F07C1},  // 33: 1280x720p_30Hz

    },

    //color depth = 16 bit
    {
        {0x02, 0x02, 0x03, 0x03, 0x14, 0x0F, 0x44A3B7},  // 0: 640x480p
...
// 148Mhz
        {0x01, 0x01, 0x03, 0x0C, 0x38, 0x08, 0x1745D1},  // 12: 1920x1080p_50Hz
        {0x01, 0x01, 0x03, 0x0C, 0x38, 0x08, 0x1745D1},  // 13: 1920x1080p_60Hz
...
// 59.4MHz
        {0x01, 0x01, 0x03, 0x03, 0x14, 0x0F, 0x3A2E8B},  // 31: 1280x720p_24Hz
// 74.25MHz
        {0x01, 0x01, 0x03, 0x03, 0x14, 0x0F, 0x2E8BA2},  // 32: 1280x720p_25Hz
// 74.25MHz
        {0x01, 0x01, 0x03, 0x03, 0x14, 0x0F, 0x2E8BA2},  // 33: 1280x720p_30Hz
    },
};
...
void MHal_HDMITx_InitSeq(void)
{
    ...
    //txpll input div 1
    MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_3C, 0x03F3, 0x0029);
    ...
    MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_70, 0x0100, 0x0100); //REG_OV_ICTRL_DRV_MAIN_CLK
...
void MHal_HDMITx_SetTMDSOnOff(MS_BOOL bRB_Swap, MS_BOOL bTMDS)
{
    ...
    if (bTMDS == TRUE)
    {
        if(ub148to165MHz)
        {
            MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_39, 0xFFFF, 0x8000);
        }
        else
        {
            MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_39, 0xFFFF, 0xF000);
...
MS_BOOL MHal_HDMITx_ColorandRange_Transform(MsHDMITX_VIDEO_COLOR_FORMAT incolor, MsHDMITX_VIDEO_COLOR_FORMAT outcolor, MsHDMITX_YCC_QUANT_RANGE inrange, MsHDMITX_YCC_QUANT_RANGE outrange)
{
    ...
    else if(incolor == E_HDMITX_VIDEO_COLOR_RGB444)
    {
        if(inrange == E_HDMITX_YCC_QUANT_LIMIT)//LR
        {
            ...
            { //LR -> FY
                ...
                DBG_HDMITX(printf("Not Support This! Replace by LR -> LY\n"));
    ...
    else if((incolor == E_HDMITX_VIDEO_COLOR_YUV444) || (incolor == E_HDMITX_VIDEO_COLOR_YUV422))
    {
        ...
        else if(inrange == E_HDMITX_YCC_QUANT_FULL)//FY
        {
            ...
            {//FY->LR
                ...
                DBG_HDMITX(printf("Not Support This! Replace by FY -> FR\n"));
    ...
    //if((bReturn == TRUE) && (outcolor == E_HDMITX_VIDEO_COLOR_YUV422))
...
void _MHal_HDMITx_DumpRegTab(MS_U8 *pdata, MS_U16 u16regnum, MS_U16 u16datasize, MS_U8 u8dataoffset)
{
    ...
    for(i=0; i< u16regnum; i++)
    {
        ...
        base = ((MS_U32)pdata[j]) << 8 | 0x170000U;
        addr = pdata[j+1] >> 1;

        if(pdata[j+1] & 0x01)
        {
            mask  = (MS_U16)(pdata[j+2]) << 8;
            value = (MS_U16)(pdata[j+3+u8dataoffset]) << 8;
        }
        else
        {
            mask  = pdata[j+2];
            value = pdata[j+3+u8dataoffset];
        }
...
{
#define IS_CD_8_BIT(x)  (x == E_HDMITX_VIDEO_CD_24Bits || x == E_HDMITX_VIDEO_CD_NoID)
#define IS_CD_10_BIT(x) (x == E_HDMITX_VIDEO_CD_30Bits)
#define IS_CD_12_BIT(x) (x == E_HDMITX_VIDEO_CD_36Bits)
#define IS_CD_16_BIT(x) (x == E_HDMITX_VIDEO_CD_48Bits)

    MS_U16 u16atop_idx, u16misc_idx;
    ...
    switch(video_idx)
    {
        ...
        case E_HDMITX_RES_720x576i:
            u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_480_60I :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_480_60I :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_480_60I :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_480_60I :
                                                 MS_TX_ATOP_ID_NUM;

            u16atop_idx = u16misc_idx;
            break;

        case E_HDMITX_RES_720x480p:
        case E_HDMITX_RES_720x576p:
            u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_480_60P  :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_480_60P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_480_60P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_480_60P :
                                                 MS_TX_ATOP_ID_NUM;

            u16atop_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_720_60P  :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_720_60P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_720_60P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_720_60P :
                                                 MS_TX_ATOP_ID_NUM;
            break;
        ...
        case E_HDMITX_RES_1280x720p_24Hz:
            u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_720_60P  :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_720_60P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_720_60P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_720_60P :
                                                 MS_TX_ATOP_ID_NUM;

            u16atop_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_1080_60P  :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_1080_60P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_1080_60P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_1080_60P :
                                                 MS_TX_ATOP_ID_NUM;
        ...
        case E_HDMITX_RES_1920x1080i_60Hz:
            ...
            u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_1080_60I :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_1080_60I :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_1080_60I :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_1080_60I :
                                                 MS_TX_ATOP_ID_NUM;
        ...
        case E_HDMITX_RES_1920x1080p_60Hz:
            u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_1080_60P :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_1080_60P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_1080_60P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_1080_60P :
                                                 MS_TX_ATOP_ID_NUM;

            u16atop_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_4K2K_3D_30P  :
                          IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_4K2K_3D_30P :
                          IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_4K2K_3D_30P :
                          IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_4K2K_3D_30P :
                                                 MS_TX_ATOP_ID_NUM;
            break;
        ...
        case E_HDMITX_RES_4096x2160p_30Hz:
            if(bIs420)
            {
                u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_4K2K_420_30P :
                              IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_4K2K_420_30P :
                              IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_4K2K_420_30P :
                              IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_4K2K_420_30P :
                                                     MS_TX_ATOP_ID_NUM;
            }
            else
            {
                u16misc_idx = IS_CD_8_BIT(cd_val)  ? MS_TX_ATOP_ID_8bits_4K2K_3D_30P :
                              IS_CD_10_BIT(cd_val) ? MS_TX_ATOP_ID_10bits_4K2K_3D_30P :
                              IS_CD_12_BIT(cd_val) ? MS_TX_ATOP_ID_12bits_4K2K_3D_30P :
                              IS_CD_16_BIT(cd_val) ? MS_TX_ATOP_ID_16bits_4K2K_3D_30P :
                                                     MS_TX_ATOP_ID_NUM;
        ...
        case E_HDMITX_RES_4096x2160p_60Hz:
            if(IS_CD_8_BIT(cd_val))
            {
                u16misc_idx = (bIs420) ? MS_TX_ATOP_ID_8bits_4K2K_420_60P : MS_TX_ATOP_ID_8bits_4K2K_60P;
            }
            else
            {
                u16misc_idx = MS_TX_ATOP_ID_NUM;
            }
            u16atop_idx = u16misc_idx;
            break;
        ...
        case E_HDMITX_RES_1280x1024p_60Hz:
            if(IS_CD_8_BIT(cd_val))
            {
                u16misc_idx = MS_TX_ATOP_ID_8bits_1080_60P;
                u16atop_idx = MS_TX_ATOP_ID_8bits_4K2K_3D_30P;
            }
            else
            {
                u16misc_idx = MS_TX_ATOP_ID_NUM;
                u16atop_idx = MS_TX_ATOP_ID_NUM;
            }
            break;
        ...
        case E_HDMITX_RES_1024x768p_60Hz:
            if(IS_CD_8_BIT(cd_val))
            {
                u16misc_idx = MS_TX_ATOP_ID_8bits_720_60P;
                u16atop_idx = MS_TX_ATOP_ID_8bits_1080_60P;
            }
            else
            {
                u16misc_idx = MS_TX_ATOP_ID_NUM;
    ...
    if(u16misc_idx == MS_TX_ATOP_ID_NUM || u16atop_idx == MS_TX_ATOP_ID_NUM)
    {
    ...
    else
    {
        ...
        DBG_HDMITX(printf("%s %d, Atop=%s, Misc=%s\n", __FUNCTION__, __LINE__, PARSING_ATOP_TAB(u16atop_idx), PARSING_ATOP_TAB(u16misc_idx)));
        for(i=0; i<MS_TX_ATOP_TAB_NUM; i++)
        {
            ptxatopinfo = &stHAL_HDMITX_ATOP_TBL[i];

            if(bCommon)
            {
                bWrite = ptxatopinfo->enIPType == MS_TX_ATOP_IP_COMMON ? TRUE : FALSE;
            }
            else
            {
                bWrite = TRUE;
            ...
            if(bWrite)
            {
                ...
                {
                    if(i <= MS_TX_ATOP_COMMON_TAB_INIT_HDMITX_MISC)
                    {
                        _MHal_HDMITx_DumpRegTab(ptxatopinfo->pData, ptxatopinfo->u16RegNum, MS_TX_ATOP_ID_NUM, u16misc_idx);
                    }
                    else
                    {
                        _MHal_HDMITx_DumpRegTab(ptxatopinfo->pData, ptxatopinfo->u16RegNum, MS_TX_ATOP_ID_NUM, u16atop_idx);
                    }
                }
            }
        }
...
//wilson@kano:TBD
    ...
    bIsDoubleCLK = (idx >= E_HDMITX_RES_3840x2160p_24Hz && idx <= E_HDMITX_RES_4096x2160p_60Hz) ? FALSE : TRUE;
    ...
    if(ub148to165MHz)
    {
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_32, 0x3F00, 0x04 << 8);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_33, 0x3F00, 0x04 << 8);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_33, 0x003F, 0x04);

        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_38, 0x0003, 0);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_39, 0xF000, 0x8000);
    }
    else
    {
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_32, 0x3F00, 0x00 << 8);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_33, 0x3F00, 0x00 << 8);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_33, 0x003F, 0x00);

        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_38, 0x0003, HDMITxVideoAtopSetting[ucCDIdx][idx].MUX_DIVSEL_POST);
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_39, 0xF000, 0xF000);
    }
#endif
    ...
    //video engine fifo reset
    MHal_HDMITx_Mask_Write(HDMITX_VIDEO_REG_BASE, REG_VE_CONFIG_01, 0x0010, 0x0000);
    MHal_HDMITx_Mask_Write(HDMITX_VIDEO_REG_BASE, REG_VE_CONFIG_01, 0x0010, 0x0010);
    ...
    if(bIsDoubleCLK)
    {
        ...
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_11, BIT(0), BIT(0));
        MHal_HDMITx_Mask_Write(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_1B, 0x0184, 0x0184);
    }
    else
    {
        MHal_HDMITx_Mask_Write(HDMITX_PHY_REG_BASE, REG_HDMITxPHY_CONFIG_11, BIT(0), 0);
        MHal_HDMITx_Mask_Write(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_1B, 0x0184, 0x0000);
    }
...
MsHDMITX_VIDEO_COLOR_FORMAT MHal_HDMITx_GetAVIInfo_ColorFmt(void)
{
    ...
    usAVI09 = MHal_HDMITx_Read(HDMITX_REG_BASE, REG_PKT_AVI_1_09);
    usAVI09 &= 0x00E0;
    usAVI09 = usAVI09 >> 5;
...
MsHDMITX_VIDEO_COLORDEPTH_VAL MHal_HDMITx_GetGC_ColorDepth(void)
{
    ...
    usGC04 = MHal_HDMITx_Read(HDMITX_REG_BASE, REG_PKT_GC12_04);
    usGC04 &= 0x000F;
    ...
    switch(usGC04)
    {
        case 0:
        {
            enOutColorDepth = E_HDMITX_VIDEO_CD_NoID;
        }
        break;

        case 4:
        {
            enOutColorDepth = E_HDMITX_VIDEO_CD_24Bits;
        }
        break;

        case 5:
        {
            enOutColorDepth = E_HDMITX_VIDEO_CD_30Bits;
        }
        break;

        case 6:
        {
            enOutColorDepth = E_HDMITX_VIDEO_CD_36Bits;
        }
        break;

        case 7:
        {
            enOutColorDepth = E_HDMITX_VIDEO_CD_48Bits;
        }
        break;
...
{
	MHal_HDMITx_Mask_Write(PAD_TOP_BASE, 0x0006, 0x0700, 0x0000); //reg_i2cm3_mode
	MHal_HDMITx_Mask_Write(PAD_TOP_BASE, 0x0005, 0x2000, 0x2000); //reg_hdmitx_ddc_en BK1026_05[13]
}
