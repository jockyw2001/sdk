...
#define REG(bank, addr)              (*((volatile MS_U16 *)((_gPM_MapBase+(bank<<1U)) + ((addr)<<2U))))
#define PMREG(bank, addr)              (*((volatile MS_U16 *)((_gPM_MapBase+(bank<<1U)) + ((addr)<<2U))))
#define REG8(bank, addr)             (*((volatile MS_U8 *)((_gPM_MapBase+(((MS_U32)bank)<<1U)) + (((MS_U32)addr)<<1U))))
...
#define i2cSetSCL(pin_state)            ( REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) = (REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) & (~BIT0)) | (pin_state << 0) )
#define i2cSetSDA(pin_state)            ( REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) = (REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) & (~BIT4)) | (pin_state << 4) )
#define i2cSCL_PIN_STATUS               ( (REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) & BIT0) >> 0 )
#define i2cSDA_PIN_STATUS               ( (REG(HDMITX_MISC_REG_BASE, REG_MISC_CONFIG_01) & BIT4) >> 4 )
...
#else
void MHal_HDMITx_SetIOMapBase(MS_VIRT u32Base, MS_VIRT u32PMBase)
{
    _gHDMITx_MapBase = u32Base;
    _gPM_MapBase = u32PMBase;
...
MS_BOOL MHal_HDMITx_AdjustDDCFreq(MS_U32 u32Speed_K)
{
    ...
    #if (defined(MSOS_TYPE_LINUX_KERNEL))
    {
        u32CpuSpeedMHz = (MS_U32) ((MS_U32) ((volatile MS_U16*)(_gCoproBase))[0x1EE2]);
