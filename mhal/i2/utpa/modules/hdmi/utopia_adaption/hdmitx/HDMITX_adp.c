...
//MApi_HDMITx_Hdcp1xCompareRi
UADP_SPT_NAMEnNXT_DEF(HDMITx_HDCP1X_COMPARE_RI, 0);

UADP_SPT_NAMEnNXT_DEF(HDMITX_GET_TMDS_STATUS, 0);
...
#undef DEF_HDCP22_RIV_SIZE
    ...
    //MApi_HDMITx_GetFullRxStatus
    UADP_SPT_NAME0NXT(HDMITX_GET_TMDS_STATUS, stHDMITX_GET_TMDS_STATUS);

    //MApi_HDMITx_Hdcp1xCompareRi
    UADP_SPT_NAME0NXT(HDMITx_HDCP1X_COMPARE_RI, stHDMITX_HDCP1X_COMPARE_RI);
...
#undef DEF_HDCP22_KS_SIZE
            ...
            {
                #if EN_HDMITX_ADP_LOG
                printk("E_HDMITX_CMD_HDCP1XCOMPARERI\r\n");
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITx_HDCP1X_COMPARE_RI, spt_HDMITx_HDCP1X_COMPARE_RI, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
            ...
            {
                #if EN_HDMITX_ADP_LOG
                printk("E_HDMITX_CMD_GETTMDSSTATUS\r\n");
                #endif
                ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMITX_GET_TMDS_STATUS, spt_HDMITX_GET_TMDS_STATUS, usbuffer_arg, sizeof(usbuffer_arg));
            }
            break;
    };
