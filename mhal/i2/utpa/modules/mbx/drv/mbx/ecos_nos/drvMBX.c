...
#elif defined(MSOS_TYPE_ECOS) || defined(MSOS_TYPE_UCOS) || defined(MSOS_TYPE_ATOMTHREADS)
    #define DRV_MBX_LockSend()   {\
                                        {\
...
MBX_Result  _MDrv_MBX_RecvMsg(MBX_Class eTargetClass, MBX_Msg *pMsg, MS_U32 u32Flag)
{
    ...
    if(u32Flag == MBX_CHECK_ALL_MSG_CLASS)
    {
        ...
        DRV_MBX_UnLockRecv();
        MBX_DBG_PRINT(MBX_DBG_LEVEL_MSGQ, "[_MDrv_MBX_RecvMsg]RecvMail Fail Result=%d; Flag=%tx \n ", mbxResult, (ptrdiff_t)u32Flag);
        return mbxResult;
    }
    else
    {
...
void _MDrv_MBX_MsgRecvCb(InterruptNum eIntNum)
{
    ...
    switch(eIntNum)
    {
        ...
        case E_INT_FIQ_MIPS_VPE1_TO_AEON:
        ...
        case E_INT_FIQ_8051_TO_MIPS_VPE0:
        case E_INT_FIQ_8051_TO_MIPS_VPE1:
