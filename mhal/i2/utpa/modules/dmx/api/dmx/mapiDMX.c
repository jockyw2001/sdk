...
static MS_BOOL _DMXProbeResourceToUtopia(DMX_INSTANT_PRIVATE *pDmxInstant)
{
    ...
    pDmxInstant->fpDMXCILINKConfig =                    _MApi_DMX_CILINK_Config;
...
MS_U32 DMXIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    DMX_TSO_Cfg*                        pTSOConfigure       = NULL;
    ...
    PDMX_CILINK_CONFIG_PARAM            pstCilinkConfig     = NULL;
    ...
    switch(u32Cmd)
    {
        ...
        case MApi_CMD_DMX_Pvr_SetPktMode:
            ...
            pu32Param = (MS_U32*)pArgs;
            pu32Param[2] = (MS_U32)psDmxInstPri->fpDMXPvrEngSetPktMode((DMX_PVR_ENG)(pu32Param[0]), (DMX_Pvr_PacketMode)(pu32Param[1]));
            break;
        ...
        case MApi_CMD_DMX_TSO_Configure:
            ...
            pTSOConfigure = (DMX_TSO_Cfg*)pArgs;
            pTSOConfigure->u32Res = (MS_U32)psDmxInstPri->fpDMXTsoConfigure(pTSOConfigure);
            break;
        ...
        case MApi_CMD_DMX_PCR_GET_MAP_STC:
            ...
            break;
        case MApi_CMD_DMX_CILINK_CONFIG:
            DMX_MSG(ULOGD("DMX", "DMXIoctl - MApi_CMD_DMX_CILINK_CONFIG\n"));
            pstCilinkConfig = (PDMX_CILINK_CONFIG_PARAM)pArgs;
            pstCilinkConfig->u32Res = (MS_U32)psDmxInstPri->fpDMXCILINKConfig(pstCilinkConfig->eEng, pstCilinkConfig->eCmd, pstCilinkConfig->pData);
            break;
        ...
        case MApi_CMD_DMX_TSIO_Service_PidOpen:
            ...
            pstSerPidOpen->u32Res = (MS_U32)psDmxInstPri->fpDMXTSIOServicePidOpen(pstSerPidOpen->u16Handle, pstSerPidOpen->pstFltCfg);
            break;
        ...
        case MApi_CMD_DMX_TSIO_Service_PidClose:
            ...
            pstSerPidClose->u32Res = (MS_U32)psDmxInstPri->fpDMXTSIOServicePidClose(pstSerPidClose->u16Handle, pstSerPidClose->u32DmxId);
            break;
