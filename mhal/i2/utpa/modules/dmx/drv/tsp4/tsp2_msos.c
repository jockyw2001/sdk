...
#if defined(MSOS_TYPE_ECOS) || defined(MSOS_TYPE_LINUX) || defined(MSOS_TYPE_LINUX_KERNEL) || defined(MSOS_TYPE_UCOS) || defined(MSOS_TYPE_ATOMTHREADS)
...
#endif // defined(MSOS_TYPE_ECOS) || defined(MSOS_TYPE_LINUX) || defined(MSOS_TYPE_UCOS) || defined(MSOS_TYPE_ATOMTHREADS)
