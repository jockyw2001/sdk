...
#define TSP_EVENT_PROC_EXIT             0x40000000
...
typedef enum
{
    ...
    E_TSP_FAIL_INVALID,
    E_TSP_FAIL_NODATA,
    E_TSP_FAIL_TEE_NO_TA,
    E_TSP_FAIL_TEE_NOT_SUPPORTED,
    E_TSP_FAIL_TEE_OS_MODE_NOT_SUPPORTED,
...
#define E_TSP_FLT_USER_SEC_NO_PUSI      0x00000600
#define E_TSP_FLT_USER_SECTION_VER      0x00000700
#define E_TSP_FLT_USER_DSS_130          0x00000800
#define E_TSP_FLT_USER_DSS_130_AUX_PKT  0x00000900
...
typedef enum
{
    E_TSP_PKTMODE_204               =   0x00000000,
    E_TSP_PKTMODE_134               =   0x00000001,     // RVU with timestamp
    E_TSP_PKTMODE_192               =   0x00000002,
    E_TSP_PKTMODE_130               =   0x00000003,     // RVU
    E_TSP_PKTMODE_188               =   0x00000004,
    ...
    E_TSP_PKTMODE_PES               =   0x0000000B,     // PES mode

    E_TSP_PKTMODE_FILEIN_MIN        =   E_TSP_PKTMODE_204,
    E_TSP_PKTMODE_FILEIN_MAX        =   E_TSP_PKTMODE_188,

    E_TSP_PKTMODE_LIVEIN_MIN        =   E_TSP_PKTMODE_130,
...
typedef enum
{
    ...
    E_DRVTSP_PAD_EXT_INPUT6           = 0x6,
    E_DRVTSP_PAD_EXT_INPUT7           = 0x7,
    E_DRVTSP_PAD_DEMOD0               = 0x8,
    E_DRVTSP_PAD_DEMOD1               = 0x9,
    E_DRVTSP_PAD_TSO0                 = 0xA,
    E_DRVTSP_PAD_TSO1                 = 0xB,
    E_DRVTSP_PAD_TSIO0                = 0xC,
    E_DRVTSP_PAD_CILINK1              = 0xD,
    E_DRVTSP_PAD_CILINK2              = 0xE,
    ...
    E_DRVTSP_PAD_EXT_INPUT6_3WIRE     = 0x86,
    E_DRVTSP_PAD_EXT_INPUT7_3WIRE     = 0x87,

    E_DRVTSP_INVALID,
} DrvTSP_PadIn;

#define DrvTSP_PadOut                   MS_U32
#define E_DRVTSP_OUTPAD_MASK            0x000000FFUL
#define E_DRVTSP_OUTPAD_NONE            0x000000FFUL
#define E_DRVTSP_OUTPAD_PAD0            0x00000000UL
#define E_DRVTSP_OUTPAD_PAD1            0x00000001UL
#define E_DRVTSP_OUTPAD_PAD3            0x00000003UL
#define E_DRVTSP_OUTPAD_CILINK1         0x00000004UL
#define E_DRVTSP_OUTPAD_CILINK2         0x00000005UL
...
TSP_Result MDrv_TSP_SetTSIF(DrvTSP_If eTSIF, TSP_TSIFCfg u16Cfg, MS_BOOL bFileIn);
...
TSP_Result MDrv_TSP_SetPacketMode(DrvTSP_If u32TSIf, TSP_PktMode eDrvPktMode);
