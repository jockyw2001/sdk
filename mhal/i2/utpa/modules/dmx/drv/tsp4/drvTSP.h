...
#define DRVTSP_TEE_NO_TA                E_TSP_FAIL_TEE_NO_TA
#define DRVTSP_TEE_NOT_SUPPORTED        E_TSP_FAIL_TEE_NOT_SUPPORTED
#define DRVTSP_REE_FLOW                 E_TSP_FAIL_TEE_OS_MODE_NOT_SUPPORTED
...
#define E_DRVTSP_FLT_TYPE_SECTION_VER      E_TSP_FLT_USER_SECTION_VER
#define E_DRVTSP_FLT_TYPE_SECTION_NO_PUSI  E_TSP_FLT_USER_SEC_NO_PUSI
#define E_DRVTSP_FLT_TYPE_DSS_130          E_TSP_FLT_USER_DSS_130
#define E_DRVTSP_FLT_TYPE_DSS_130_AUX_PKT  E_TSP_FLT_USER_DSS_130_AUX_PKT
