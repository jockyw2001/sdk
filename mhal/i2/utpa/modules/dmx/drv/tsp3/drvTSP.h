...
typedef enum
{
    ...
    E_DRVTSP_PAD_TSO0                 = 0x6,
    E_DRVTSP_PAD_DEMOD                = 0x7,
    E_DRVTSP_PAD_DEMOD0               = 0x7,

    E_DRVTSP_PAD_DEMOD1               = 0x9,
    E_DRVTSP_PAD_TSO1                 = 0xB,
    E_DRVTSP_PAD_TSIO0                = 0xC,
    E_DRVTSP_PAD_EXT_INPUT6           = 0xD,
    E_DRVTSP_PAD_EXT_INPUT7           = 0xE,

    E_DRVTSP_PAD_CILINK1              = 0x10,
    E_DRVTSP_PAD_CILINK2              = 0x11,
...
/// TSP interface
#define E_DRVTSP_IF_TOTAL_NUM           (E_DRVTSP_IF_NUM + (E_DRVTSP_IF_FI_NUM-E_DRVTSP_IF_FI_BASE))
                                        // E_DRVTSP_IF_NUM + E_DRVTSP_IF_FI_NUM
typedef enum
{
    E_DRVTSP_IF_TS0                   = 0x0,        //TSIF0         // index 0
    E_DRVTSP_IF_TS1                   = 0x1,        //TSIF1         // index 1
    E_DRVTSP_IF_TS2                   = 0x2,        //TSIF2         // index 2
    E_DRVTSP_IF_TS3                   = 0x3,        //TSIF3         // index 3
    E_DRVTSP_IF_NUM,

    E_DRVTSP_IF_FI_BASE               = 0x80,       //TSFI (version 3.0 New)
    E_DRVTSP_IF_FI                    = E_DRVTSP_IF_FI_BASE,        // index 4
    E_DRVTSP_IF_FI_NUM,
...
//LIVE PATH enum for _stTspPathState
typedef enum
{
    E_DRVTSP_LIVE0        = 0,
    E_DRVTSP_LIVE_FI      = 1,
...
//FILE PATH enum for _stTspPathState
typedef enum
{
    E_DRVTSP_FILE0 = E_DRVTSP_LIVE_FI,
    E_DRVTSP_FILE1,
    E_DRVTSP_FILE2,
} DrvTSP_FILE_PATH;

//Resource allocate define
typedef enum
{
    E_DRV_TSP_PATH_LIVE,
    E_DRV_TSP_PATH_FILE,
...
//Clock control function define
typedef enum
{
    E_DRV_TSP_PATH,
    E_DRV_TSP_PVR,
    E_DRV_TSP_FUNC_INVALID
} DRV_TSP_FUNC_TYPE;
...
#define TSP_MAX_SIGFLAG_NUM             16UL
