...
#ifndef _DRV_CILINK_H_
#define _DRV_CILINK_H_
...
typedef enum
{
    E_DRVCILINK_CAP_RESOURCE_SIZE              = 0,       // Get the data structure size of private resource (share resource)
    E_DRVCILINK_CAP_NULL,
} DrvCILINK_Cap;
...
typedef enum
{
    DRVCILINK_FAIL                      = 0,
    DRVCILINK_OK                        = 1,
    DRVCILINK_INVALID_PARAM             = 2,
}DrvCILINK_Result;

typedef enum
{
    E_DRVCILINK_CILINK1                 = 0,
    E_DRVCILINK_CILINK2                 = 1,
}DrvCILINK_ENG;
