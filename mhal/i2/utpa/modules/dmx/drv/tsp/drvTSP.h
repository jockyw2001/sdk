...
#define TSP_VERSION                     TSP_VER_1_0
...
#define E_DRVTSP_FLT_TYPE_SECTION_NO_PUSI           0x01000009
...
typedef enum
{
    ...
    E_DRVTSP_PAD_DEMOD0               = E_DRVTSP_PAD_DEMOD,
...
typedef enum
{
    ...
    E_DRVTSP_IF_NUM,
    E_DRVTSP_IF_TS0 = E_DRVTSP_IF_PLAYBACK,
    E_DRVTSP_IF_TS1 = E_DRVTSP_IF_PVR0,
    E_DRVTSP_IF_TS2 = E_DRVTSP_IF_PVR1,
    E_DRVTSP_IF_FI,
} DrvTSP_If;
...
typedef enum
{
    E_DRVTSP_ALP0                       = 0,   //TSIF0
    E_DRVTSP_ALP1                       = 1,   //TSIF_FI
    E_DRVTSP_ALP2                       = 2,   //TSIF1
    E_DRVTSP_ALP3                       = 3,   //TSIF2
...
TSP_Result MDrv_TSP_Resume(MS_PHY u32FWAddr, MS_U32 u32FWSize);
...
TSP_Result MDrv_TSP_Resume_Filter(void);   //@jay need to check 20170821
...
TSP_Result MDrv_TSP_SecFlt_SetBuffer(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY u32StartAddr, MS_U32 u32BufSize);
TSP_Result MDrv_TSP_SecFlt_SetReqCount(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_U32 u32ReqCount);
TSP_Result MDrv_TSP_SecFlt_GetBufStart(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY *pu32BufStart);
TSP_Result MDrv_TSP_SecFlt_GetBufSize(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_U32 *pu32BufSize);
TSP_Result MDrv_TSP_SecFlt_GetReadAddr(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY *pu32ReadAddr);
TSP_Result MDrv_TSP_SecFlt_GetWriteAddr(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY *pu32WriteAddr);

TSP_Result MDrv_TSP_SecFlt_SetReadAddr(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY u32ReadAddr);
...
// PVR API
TSP_Result MDrv_TSP_PVR_SetBuffer(MS_PHY u32BufStart0, MS_PHY u32BufStart1, MS_U32 u32BufSize0, MS_U32 u32BufSize1);
...
TSP_Result MDrv_TSP_PVR_BlockEnable(MS_U8 u8PVRId, MS_BOOL bEnable);        //@jay need to check 20170821
...
// PVR engine API
TSP_Result MDrv_TSP_PVR_Eng_SetBuffer(MS_U8 u8PVRId, MS_PHY u32BufStart0, MS_PHY u32BufStart1, MS_U32 u32BufSize0, MS_U32 u32BufSize1);
TSP_Result MDrv_TSP_PVR_Eng_Start(MS_U8 u8PVRId, DrvTSP_RecMode eRecMode, MS_BOOL bStart);
TSP_Result MDrv_TSP_PVR_Eng_GetWriteAddr(MS_U8 u8PVRId, MS_PHY *pu32WriteAddr);
...
// File API
TSP_Result MDrv_TSP_File_SetAddr(MS_PHY u32StreamAddr);
...
TSP_Result MDrv_TSP_File_GetReadAddr(MS_PHY *pu32ReadAddr);
...
TSP_Result MDrv_TSP_TTX_SecFlt_GetWriteAddr(MS_U32 u32EngId, MS_U32 u32SecFltId, MS_PHY *pu32WriteAddr); // special case for TTX
...
//--VQ , MOBF --------------
TSP_Result MDrv_TSP_SetVQueBuf(MS_PHY u32VQBaseAddr, MS_U32 u32VQBufLen);
...
void       MDrv_TSP_WriteProtect_Enable(MS_BOOL bEnable, MS_PHY* pu32StartAddr, MS_PHY* pu32EndAddr);
void       MDrv_TSP_OrzWriteProtect_Enable(MS_BOOL bEnable, MS_PHY u32StartAddr, MS_PHY u32EndAddr);
...
TSP_Result MDrv_TSP_SetFwDataAddr(MS_PHY u32DataAddr, MS_U32 u32Size);
...
TSP_Result MDrv_TSP_Create_IoSignal(DrvTSP_IoSignal *pstIoSignal);      //@jay need to check 20170821
TSP_Result MDrv_TSP_Close_IoSignal(DrvTSP_IoSignal *pstIoSignal);       //@jay need to check 20170821

//--------- ALP module API, for ATSC 3.0 -----------------------------------
TSP_Result MDrv_TSP_Ree_SendTeeCmd(TSP_REE_TO_TEE_CMD_TYPE cmd_type, void* param, size_t datasize);      //@jay need to check 20170821
TSP_Result MDrv_TSP_ALP_PVR_SetRecordStampClk(DrvTsp_ALP_Eng AlpEng, MS_U32 u32Clk);        //@jay need to check 20170821

//-------- merge stream --------------------------
TSP_Result MDrv_TSP_MStr_SyncByte(DrvTSP_If eIf, MS_U8 u8StrId, MS_U8* pu8SyncByte, MS_BOOL bSet);  //@jay need to check 20170821
