...
TSIO_Result MDrv_TSIO_Service_SetDMAinVC(MS_U16 u16Servicehandle, DRVTSIO_DMAIN_SET *peSet)
{
    ...
    u8Sid = _ptsio_res->_Servic[u16Servicehandle].u8Sid;
    HAL_TSIO_SGDMAIN_PidFltEnable(u8Sid, !peSet->bBypassAll);
...
TSIO_Result MDrv_TSIO_SGDMAIN_PidFlt_Free(MS_U16 u16PidFltId)
{
    ...
    HAL_TSIO_SGDMAIN_Flt_SetBypassTSIO(u16PidFltId, FALSE);
...
/// @note
//-------------------------------------------------------------------------------------------------
TSIO_Result MDrv_TSIO_SGDMAIN_PidFlt_SetBypassTSIO(MS_U16 u16PidFltId, MS_BOOL bBypassTSIO)
{
    TSIO_DBGTRACE();
    _TSIO_ENTRY();
    ...
    if(bBypassTSIO)
    {
        if(HAL_TSIO_SGDMAIN_Flt_SetBypassTSIO(u16PidFltId, bBypassTSIO) != TRUE)
        {
            TSIO_DBGERR("Not support bypass TSIO for TSO pid filter!!\n");
        }
    }
