...
typedef enum
{
    ...
    E_DRVMMFI_MODE_PS_VD3           = 0x2000,
    E_DRVMMFI_MODE_PS_VD4           = 0x4000,

    E_DRVMMFI_MODE_PS_AUE           = 0x0003,
    E_DRVMMFI_MODE_PS_AUF           = 0x0005,

    E_DRVMMFI_MODE_PS_VD5           = 0x0006,
    E_DRVMMFI_MODE_PS_VD6           = 0x0007,
    E_DRVMMFI_MODE_PS_VD7           = 0x0009,
    E_DRVMMFI_MODE_PS_VD8           = 0x000A,
...
typedef enum
{
    ...
    E_DRVMMFI_FLTTYPE_AUDC = 3,
    E_DRVMMFI_FLTTYPE_AUDD = 4,
    E_DRVMMFI_FLTTYPE_AUDE = 5,
    E_DRVMMFI_FLTTYPE_AUDF = 6,
    E_DRVMMFI_FLTTYPE_VD   = 7,
    E_DRVMMFI_FLTTYPE_VD3D = 8,
    E_DRVMMFI_FLTTYPE_VD3  = 9,
    E_DRVMMFI_FLTTYPE_VD4  = 10,
    E_DRVMMFI_FLTTYPE_VD5  = 11,
    E_DRVMMFI_FLTTYPE_VD6  = 12,
    E_DRVMMFI_FLTTYPE_VD7  = 13,
    E_DRVMMFI_FLTTYPE_VD8  = 14,
...
MMFI_Result MDrv_MMFI_EngClk(DrvMMFI_Path epath, MS_BOOL bClkOn);
