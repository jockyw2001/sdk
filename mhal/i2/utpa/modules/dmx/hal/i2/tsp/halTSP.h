...
#define TSP_TSIF4                       0x04    // not support
#define TSP_TSIF5                       0x05    // not support
#define TSP_TSIF6                       0x06    // not support
...
typedef enum _TSP_DST_SEQ
{
    ...
    E_TSP_DST_FIFO_VIDEO5,      //Not support
    E_TSP_DST_FIFO_VIDEO6,      //Not support
    E_TSP_DST_FIFO_VIDEO7,      //Not support
    E_TSP_DST_FIFO_VIDEO8,      //Not support

    E_TSP_DST_FIFO_AUDIO,
    E_TSP_DST_FIFO_AUDIO2,
    E_TSP_DST_FIFO_AUDIO3,
    E_TSP_DST_FIFO_AUDIO4,
    E_TSP_DST_FIFO_AUDIO5,      //Not support
    E_TSP_DST_FIFO_AUDIO6,      //Not support
...
typedef enum _HAL_TSP_TSIF // for HW TSIF
{
    ...
    E_TSP_HAL_TSIF_2            ,
    E_TSP_HAL_TSIF_3            ,
    E_TSP_HAL_TSIF_4            ,   // not support
    E_TSP_HAL_TSIF_5            ,   // not support
    E_TSP_HAL_TSIF_6            ,   // not support
...
typedef enum
{
    ...
    E_TSP_HAL_CAP_VAL_DSCMB_ENG_NUM                 = 1,
...
} TSP_FQ_MUX_OUT_SRC;   // not support
...
typedef enum _TSP_PIDFLT_SRC
{
    ...
    E_TSP_PIDFLT_LIVE2,
    E_TSP_PIDFLT_LIVE3,
    E_TSP_PIDFLT_LIVE4, // not support
    E_TSP_PIDFLT_LIVE5, // not support
    E_TSP_PIDFLT_LIVE6, // not support
    E_TSP_PIDFLT_FILE0,
    E_TSP_PIDFLT_FILE1,
    E_TSP_PIDFLT_FILE2,
    E_TSP_PIDFLT_FILE3,
    E_TSP_PIDFLT_FILE4, // not support
    E_TSP_PIDFLT_FILE5, // not support
    E_TSP_PIDFLT_FILE6, // not support
...
//enable LUT
#define TSP_PIDFLT_OUT_LUT              0x00000000  // K6 not suppor
