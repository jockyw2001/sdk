...
// FQ define
#define FQ_NUM                      4
#define FQ_MUX_START_ID             4   // not support
#define FQ_MUX_PATH_START_ID        0   // not support
...
MS_BOOL HAL_FQ_SetExtRiuBank(MS_VIRT u32BankAddr);
...
void    HAL_FQ_AddrMode(MS_U32 u32FQEng, MS_BOOL bSet, MS_BOOL *pbAddrMode);
...
void    HAL_FQ_MUX_Src(MS_U32 u32FQEng, MS_U32 *pu32Path, MS_BOOL bSet);
void    HAL_FQ_MUX_RushModeEnable(MS_U32 u32FQEng, MS_BOOL bEnable);
void    HAL_FQ_ClkGating(MS_U32 u32FQEng, MS_BOOL bEnable);
