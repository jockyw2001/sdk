...
typedef struct _REG_SecFlt
{
    ...
    #define TSP_SECFLT_USER_MASK                    0x00010007
    #define TSP_SECFLT_USER_SHFT                    0
    #define TSP_SECFLT_USER_NULL                    0x00000000
    #define TSP_SECFLT_USER_SEC                     0x00000001
    #define TSP_SECFLT_USER_PES                     0x00000002
    #define TSP_SECFLT_USER_PKT                     0x00000003
    #define TSP_SECFLT_USER_PCR                     0x00000004
    #define TSP_SECFLT_USER_TTX                     0x00000005
    #define TSP_SECFLT_USER_SEC_WITHOUT_PUSI        0x00000006
    #define TSP_SECFLT_USER_VER                     0x00000007
    #define TSP_SECFLT_USER_DSS_130                 0x00010000
    #define TSP_SECFLT_USER_DSS_130_AUX_PKT         0x00010001
 /*
...
typedef struct _REG_Ctrl
{
    ...
    REG32                           _xbf202d60_64;                      // 0xbf802d60   0x58~0x59

    REG16                           CH_BW_CTRL;                         // 0xbf802d68   0x5a
    #define TSP_CH_BW_WP_LD                         0x0100              // 1=update 0=latch

    REG16                           _xbf202d6C;                         // 0xbf802d6c   0x5b
...
typedef struct _REG_Ctrl2
{
    ...
    REG16    CFG_04;
        #define    CFG_04_TSP_FILEIN_ABORT_ECO_TSIF0                            0x0001    //abort tsif0 DMA
        #define    CFG_04_TSP_FILEIN_ABORT_ECO_TSIF1                            0x0002    //abort tsif1 DMA
        #define    CFG_04_TSP_FILEIN_ABORT_ECO_TSIF2                            0x0004    //abort tsif2 DMA
        #define    CFG_04_TSP_FILEIN_ABORT_ECO_TSIF3                            0x0008    //abort tsif3 DMA
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT0                            0x0100    //fix last_done_z to 1T pulse for new miu arbiter
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT1                            0x0200
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT2                            0x0400
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT3                            0x0800
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT4                            0x1000
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT5                            0x2000
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT6                            0x4000
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT7                            0x8000
        #define    CFG_04_MIU_FIXED_LAST_DONE_Z_ABT_ALL                         0xFF00
    REG16    CFG_05;
    ...
    REG16    CFG_10;
        ...
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT0                                 0x0100    //fix last_done_z trigger by other clients for new miu arbiter
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT1                                 0x0200
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT2                                 0x0400
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT3                                 0x0800
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT4                                 0x1000
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT5                                 0x2000
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT6                                 0x4000
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT7                                 0x8000
        #define    CFG_10_MIU_CHECK_MI2RDY_ABT_ALL                              0xFF00
    REG16    CFG_11;
...
typedef struct _REG_Ctrl3
{
    ...
    REG16   CFG3_18;
        #define CFG3_18_HD_0000_TO_SECTION_RVU                                  0x0001
        #define CFG3_18_HD_1100_TO_SECTION_RVU                                  0x0002
        #define CFG3_18_HD_10X0_11X0_TO_SECTION_RVU                             0x0004
        #define CFG3_18_HD_0000_TO_SECTION_DIRECTV                              0x0100
        #define CFG3_18_HD_1100_TO_SECTION_DIRECTV                              0x0200
        #define CFG3_18_HD_10X0_11X0_TO_SECTION_DIRECTV                         0x0400
    REG16   CFG3_19;
        #define CFG3_19_DIRECTV_PSI_EN0                                         0x0001
        #define CFG3_19_DIRECTV_EN0                                             0x0008
        #define CFG3_19_DIRECTV_PSI_EN1                                         0x0010
        #define CFG3_19_DIRECTV_EN1                                             0x0080
        #define CFG3_19_DIRECTV_PSI_EN2                                         0x0100
        #define CFG3_19_DIRECTV_EN2                                             0x0800
        #define CFG3_19_DIRECTV_PSI_EN3                                         0x1000
        #define CFG3_19_DIRECTV_EN3                                             0x8000
    REG16   CFG3_1A;
        #define CFG3_1A_RVU_DIRECTV_AFTER_CA_ENABLE_PATH0                       0x0100 //U02
        #define CFG3_1A_RVU_DIRECTV_AFTER_CA_ENABLE_PATH1                       0x0200 //U02
        #define CFG3_1A_RVU_DIRECTV_AFTER_CA_ENABLE_PATH2                       0x0400 //U02
        #define CFG3_1A_RVU_DIRECTV_AFTER_CA_ENABLE_PATH3                       0x0800 //U02
        #define CFG3_1A_RVU_DIRECTV_AFTER_CA_ENABLE_MASK                        0x0F00
    REG16   CFG3_1B;
    REG16   CFG3_1C;
        #define CFG3_1C_PATH0_RVU_ALWAYS_PAYLOAD_128                            0x0400 //U02
        #define CFG3_1C_PATH1_RVU_ALWAYS_PAYLOAD_128                            0x0800 //U02
        #define CFG3_1C_PATH2_RVU_ALWAYS_PAYLOAD_128                            0x1000 //U02
        #define CFG3_1C_PATH3_RVU_ALWAYS_PAYLOAD_128                            0x2000 //U02
        #define CFG3_1C_RVU_ALWAYS_PAYLOAD_128_MASK                             0x3C00
    REG16   CFG3_1D;
    REG16   CFG3_1E;                                                                                // 0X1E
...
typedef struct _REG_Ctrl6
{
    ...
    REG16   CFG6_2B;
        ...
        #define TSP_OR_WRITE_FIX_FOR_NEW_MIU_ARBITER_DISABLE                    0x2000
        #define TSP_FIX_FILTER_NULL_PKT                                         0x4000
    REG16   CFG6_2C_REG_MIU_SEL_FILEIN_MM;
        #define REG_MIU_SEL_FILEIN0_MASK                                        0x0003
        #define REG_MIU_SEL_FILEIN0_SHIFT                                       0
        #define REG_MIU_SEL_FILEIN1_MASK                                        0x000C
        #define REG_MIU_SEL_FILEIN1_SHIFT                                       2
        #define REG_MIU_SEL_FILEIN2_MASK                                        0x0030
        #define REG_MIU_SEL_FILEIN2_SHIFT                                       4
        #define REG_MIU_SEL_FILEIN3_MASK                                        0x00C0
        #define REG_MIU_SEL_FILEIN3_SHIFT                                       6
        #define REG_MIU_SEL_MMFI0_MASK                                          0x0300
        #define REG_MIU_SEL_MMFI0_SHIFT                                         8
        #define REG_MIU_SEL_MMFI1_MASK                                          0x0C00
        #define REG_MIU_SEL_MMFI1_SHIFT                                         10
    REG16   CFG6_2D_REG_MIU_SEL_FW;
        #define REG_MIU_SEL_VQ_MASK                                             0x0003
        #define REG_MIU_SEL_VQ_SHIFT                                            0
        #define REG_MIU_SEL_OR_ADDR_MASK                                        0x000C
        #define REG_MIU_SEL_OR_ADDR_SHIFT                                       2
        #define REG_MIU_SEL_SECTION_MASK                                        0x0030
        #define REG_MIU_SEL_SECTION_SHIFT                                       4
        #define REG_MIU_SEL_MERGE_EN_MASK                                       0xFF00
    REG16   CFG6_2E_REG_MIU_PVR_FQ;
        #define REG_MIU_SEL_PVR1_MASK                                           0x0003
        #define REG_MIU_SEL_PVR1_SHIFT                                          0
        #define REG_MIU_SEL_PVR2_MASK                                           0x000C
        #define REG_MIU_SEL_PVR2_SHIFT                                          2
        #define REG_MIU_SEL_PVR3_MASK                                           0x0030
        #define REG_MIU_SEL_PVR3_SHIFT                                          4
        #define REG_MIU_SEL_PVR4_MASK                                           0x00C0
        #define REG_MIU_SEL_PVR4_SHIFT                                          6
        #define REG_MIU_SEL_FIQ0_MASK                                           0x0300
        #define REG_MIU_SEL_FIQ0_SHIFT                                          8
        #define REG_MIU_SEL_FIQ1_MASK                                           0x0C00
        #define REG_MIU_SEL_FIQ1_SHIFT                                          10
        #define REG_MIU_SEL_FIQ2_MASK                                           0x3000
        #define REG_MIU_SEL_FIQ2_SHIFT                                          12
        #define REG_MIU_SEL_FIQ3_MASK                                           0xC000
        #define REG_MIU_SEL_FIQ3_SHIFT                                          14
    REG16   CFG6_2F;
...
typedef struct _REG_Ctrl8_1
{
    ...
    REG16   CFG8_66_6B[0x6C - 0x66];                                            //reserved
    REG16   CFG8_6C;
        #define CFG8_6C_REG_PVR1_PES_DIRECTV_130_MODE                           0x0001
