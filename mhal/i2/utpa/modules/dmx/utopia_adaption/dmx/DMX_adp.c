...
//-------------------------------------------------------------------------------------------------
#ifdef MSOS_TYPE_LINUX_KERNEL
#define CPY_FROM_USER(a,b,c)                                    if(copy_from_user((void*)a,(void*)b,c) != 0) { return UTOPIA_STATUS_FAIL; }
#define CPY_to_USER(a,b,c)                                      if(copy_to_user((void*)a,(void*)b,c) != 0) { return UTOPIA_STATUS_FAIL; }
#else
...
#define CMP_CPY_FROM_USER(a,b,c)                                if(copy_from_user((void*)a, compat_ptr((unsigned long)b), c) != 0)  {  return UTOPIA_STATUS_FAIL; }
#define CMP_CPY_TO_USER(a,b,c)                                  if(copy_to_user(compat_ptr((unsigned long)a), (void*)b, c) != 0) { return UTOPIA_STATUS_FAIL;  }
...
MS_U32 DMX_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
            ...
            if(IS_CMP_TASK())
            {
                ...
                if(pstFltInfoDes->bSet == TRUE)
                {
                    ...
                    else
                    {
                        ...
                        u32NextPtr += LEN_U32_X2;  //patch u32AlignDummy0
                        pinfo->pType2Notify = 0;
                        CMP_CPY_FROM_USER((void*)&(pinfo->pType2Notify), u32NextPtr, LEN_U32_X1);
                        u32NextPtr += LEN_U32_X2;  //patch u32AlignDummy1
        ...
        case MApi_CMD_DMX_TSO_Configure:
            ...
            if(IS_CMP_TASK())
            {
                CMP_CPY_FROM_USER((void*)buffer_arg, ps8AdpSrc, u32data);
                ps8AdpSrc += u32data;
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
            }
            else
            {
                CPY_FROM_USER((void*)buffer_arg, ps8AdpSrc, u32data);
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
            }
        ...
        case MApi_CMD_DMX_FQ_Configure:
            ...
            if(IS_CMP_TASK())
            {
                pstFqCfg->pCfgPara = (void*)buffer_array0;
                CMP_CPY_FROM_USER((void*)buffer_arg, ps8AdpSrc, LEN_U32_X4+LEN_U32_X1+1);
                ps8AdpSrc += LEN_U32_X4 + LEN_U32_X1 + 1;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void*)buffer_array0, u32NextPtr, sizeof(void*));
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CPY_to_USER(u32NextPtr, (void*)(pstFqCfg->pCfgPara),LEN_U32_X1);
                CPY_to_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
            }
            else
            {
                CPY_FROM_USER((void*)buffer_arg, pArgs, sizeof(DMX_FQ_Cfg));
                CPY_FROM_USER((void*)buffer_array0, (void*)pstFqCfg->pCfgPara, LEN_U32_X1);
                pNxtPtr = (void*)pstFqCfg->pCfgPara;
                pstFqCfg->pCfgPara = (void*)buffer_array0;
                u32Ret = UtopiaIoctl(pInstanceTmp, u32Cmd, (void*)buffer_arg);
                CPY_to_USER(pNxtPtr, (void*)buffer_array0, LEN_U32_X1);
                CPY_to_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
            }
            break;
        ...
        case MApi_CMD_DMX_TSIO_Service_SetDMAoutVC:
            ...
            if(IS_CMP_TASK())
            {
                ...
                ps8AdpSrc += 6;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void*)buffer_array0, (void *)u32NextPtr, sizeof(TSIO_DMAOUT_SET));
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
            }
            else
        ...
        case MApi_CMD_DMX_TSIO_Service_SetDMAinVC:
            ...
            if(IS_CMP_TASK())
            {
                ...
                ps8AdpSrc += 6;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void*)buffer_array0, (void *)u32NextPtr, sizeof(TSIO_DMAIN_SET));
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
            }
            else
        ...
        case MApi_CMD_DMX_TSIO_Service_SetLocdecKey:
            ...
            if(IS_CMP_TASK())
            {
                ...
                ps8AdpSrc += 6;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void *)&(pstTsioLocDes->eSet->bEnable), (void *)u32NextPtr, sizeof(MS_BOOL));
                u32NextPtr+=sizeof(MS_BOOL);
                CMP_CPY_FROM_USER((void *)&(pstTsioLocDes->eSet->bEvenkeyenable), (void *)u32NextPtr, sizeof(MS_BOOL));
                u32NextPtr+=3;
                CMP_CPY_FROM_USER(&u32NextPtr1, u32NextPtr, LEN_U32_X1);
                u32NextPtr+=LEN_U32_X1;
                CMP_CPY_FROM_USER((void *)&(pstTsioLocDes->eSet->u16Evenkeylen), (void *)u32NextPtr, sizeof(MS_U16));
                u32NextPtr+=sizeof(MS_U16);
                CMP_CPY_FROM_USER((void *)&(pstTsioLocDes->eSet->bOddkeyenable), (void *)u32NextPtr, sizeof(MS_BOOL));
                u32NextPtr+=2;
                CMP_CPY_FROM_USER(&u32NextPtr2, (void *)u32NextPtr, LEN_U32_X1);
                u32NextPtr+=LEN_U32_X1;
                CMP_CPY_FROM_USER((void *)&(pstTsioLocDes->eSet->u16Oddkeylen), u32NextPtr, sizeof(MS_U16));
                CMP_CPY_FROM_USER((void *)buffer_array1, (void *)u32NextPtr1, pstTsioLocDes->eSet->u16Evenkeylen);
                CMP_CPY_FROM_USER((void *)buffer_array2, (void *)u32NextPtr2, pstTsioLocDes->eSet->u16Oddkeylen);
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
            }
            else
        ...
        case MApi_CMD_DMX_TSIO_Service_PidOpen:
            ...
            if(IS_CMP_TASK())
            {
                pstTsioPidDes->pstFltCfg = (TSIO_FLT_CFG *)buffer_array0;
                pstTsioPidDes->pstFltCfg->pu32DmxId = (MS_U32 *)buffer_array1;
                CMP_CPY_FROM_USER((void*)buffer_arg, ps8AdpSrc, 6);
                ps8AdpSrc += 6;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void *)&(pstTsioPidDes->pstFltCfg->eFltSrc), (void *)u32NextPtr, sizeof(TSIO_FLT_SRC));
                u32NextPtr+=sizeof(TSIO_FLT_SRC);
                CMP_CPY_FROM_USER((void *)&(pstTsioPidDes->pstFltCfg->u16Pid), (void *)u32NextPtr, sizeof(MS_U16));
                u32NextPtr+=sizeof(MS_U16);
                CMP_CPY_FROM_USER(&u32NextPtr1, (void *)u32NextPtr, LEN_U32_X1);
                u32NextPtr+=LEN_U32_X1;
                CMP_CPY_FROM_USER((void *)&(pstTsioPidDes->pstFltCfg->bBypassTSIO), u32NextPtr, sizeof(MS_BOOL));
                CMP_CPY_FROM_USER((void *)buffer_array1, (void *)u32NextPtr1, pstTsioPidDes->pstFltCfg->pu32DmxId);
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1); // copy return value
                CMP_CPY_TO_USER((void *)u32NextPtr, (void*)buffer_array1, sizeof(MS_U32)); // copy filter id
            }
            else
            {
                CPY_FROM_USER((void*)buffer_arg, pArgs, sizeof(DMX_TSIO_Service_PidOpen_PARAM));
                CPY_FROM_USER((void*)buffer_array0, (void*)pstTsioPidDes->pstFltCfg, sizeof(TSIO_FLT_CFG));
                pstTsioPidDes->pstFltCfg = (TSIO_FLT_CFG*)buffer_array0;
                CPY_FROM_USER((void*)buffer_array1, (void*)pstTsioPidDes->pstFltCfg->pu32DmxId, sizeof(MS_U32));
                pNxtPtr = (void *)pstTsioPidDes->pstFltCfg->pu32DmxId;
                pstTsioPidDes->pstFltCfg->pu32DmxId = (MS_U32*)buffer_array1;
                u32Ret = UtopiaIoctl(pInstanceTmp, u32Cmd, (void*)buffer_arg);
                CPY_to_USER(pArgs, (void*)buffer_arg, LEN_U32_X1); // copy return value
                CPY_to_USER((void *)pNxtPtr, (void*)buffer_array1, sizeof(MS_U32)); // copy filter id
            }
            break;
        ...
        case MApi_CMD_DMX_TSIO_Service_Alloc:
            ...
            if(IS_CMP_TASK())
            {
                ...
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
                CMP_CPY_TO_USER((void *)u32NextPtr, (void*)buffer_array0, sizeof(MS_U16));
            }
            else
            {
                ...
                u32Ret = UtopiaIoctl(pInstanceTmp, u32Cmd, (void*)buffer_arg);
                CPY_to_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
                CPY_to_USER((void *)pNxtPtr, (void*)buffer_array0, sizeof(MS_U16));
            }
            break;
        ...
        case MApi_CMD_DMX_TSIO_CC:
            ...
            if(IS_CMP_TASK())
            {
                ...
                {
                    CMP_CPY_TO_USER((void *)u32NextPtr2, (void*)buffer_array1, *pstTsioCcDes->Parm->pOutLen);
                    CMP_CPY_TO_USER((void *)u32NextPtr3, (void*)buffer_array4, sizeof(MS_U16));
                }
            }
            else
            {
                ...
                {
                    pNxtPtr = (void *)pstTsioCcDes->Parm->pOut;
                    pstTsioCcDes->Parm->pOut = (MS_U8 *)buffer_array1;
                }

                if (pstTsioCcDes->Parm->pOutLen != NULL)
                {
                    pNxtPtr1 = (void *)pstTsioCcDes->Parm->pOutLen;
                    pstTsioCcDes->Parm->pOutLen = (MS_U8 *)buffer_array4;
                }
                if(pstTsioCcDes->pResult != NULL)
                {
                    pNxtPtrOut = (void *)pstTsioCcDes->pResult;
                    pstTsioCcDes->pResult = (TSIO_CC_RESULT *)buffer_array3;
                }
                u32Ret = UtopiaIoctl(pInstanceTmp, u32Cmd, (void*)buffer_arg);
                //CPY_to_USER(pArgs, (void*)buffer_arg, sizeof(DMX_TSIO_CC_PARAM));
                CPY_to_USER(pArgs, (void*)buffer_arg, sizeof(LEN_U32_X1));
                CPY_to_USER((void *)pNxtPtr, (void*)buffer_array1, pstTsioCcDes->Parm->pOutLen); // copy output data
                CPY_to_USER((void *)pNxtPtr1, (void*)buffer_array4, sizeof(MS_U16)); // copy output length
                CPY_to_USER((void *)pNxtPtrOut, (void*)buffer_array3, sizeof(TSIO_CC_RESULT)); // copy command result
            }
            break;
        ...
        case MApi_CMD_DMX_TSIO_GetInfo:
            ...
            if(IS_CMP_TASK())
            {
                ...
                ps8AdpSrc += LEN_U32_X3;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void*)buffer_array0, (void *)u32NextPtr, sizeof(MS_U32));
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void*)buffer_arg, LEN_U32_X1);
                CMP_CPY_TO_USER((void*)u32NextPtr, (void*)buffer_array0, sizeof(MS_U32));
            }
            else
            {
        ...
        case MApi_CMD_DMX_TSIO_Service_DMAout_WriteGet:
            ...
            if(IS_CMP_TASK())
            {
                ...
                ps8AdpSrc += 6;
                CMP_CPY_FROM_USER(&u32NextPtr, ps8AdpSrc, LEN_U32_X1);
                CMP_CPY_FROM_USER((void*)buffer_array0, (void *)u32NextPtr, sizeof(MS_PHY*));
                u32Ret = UtopiaIoctl(pInstanceTmp,u32Cmd,(void*)buffer_arg);
                CMP_CPY_TO_USER(pArgs, (void *)buffer_arg, LEN_U32_X1);
                CMP_CPY_TO_USER((void *)u32NextPtr, (void *)buffer_array0, sizeof(MS_PHY*));
            }
            else
            {
