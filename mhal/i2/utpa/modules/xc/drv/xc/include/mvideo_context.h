...
#ifdef MSOS_TYPE_LINUX_KERNEL
INTERFACE void* MDrv_XC_Get_PID_Instance(int device_id);
#define g_pDevice0Instance (MDrv_XC_Get_PID_Instance(0))
#define g_pDevice1Instance  (MDrv_XC_Get_PID_Instance(1))
#else
...
#ifndef UNUSED     //fix compile warnings
#define UNUSED(x) ((x)=(x))
#endif

#ifndef CAST_ALIGN  //fix compile warnings
#define CAST_ALIGN(type)  (type *)(void *)
#endif
...
#endif
{
    ...
    MS_U32   u32H_PostScalingIniFactor;
    MS_U32   u32V_PostScalingIniFactor;
    MS_BOOL  bIsHScalingUp;
    MS_BOOL  bIsVScalingUp;
...
#endif
{
    ...
    MS_U16 u16OSDLayer;             ///<for MDrv_XC_SetOSDLayer/MDrv_XC_GetOSDLayer
...
#else
typedef struct __attribute__((aligned(4))) s_Data_Path
#endif
{
...
#else
typedef struct __attribute__((aligned(4))) s_Mux_InputSource_Attr
#endif
{
...
#define IS_OUTPUT_1280_800(width, height)  (((width) == XC_1280_800_H_SIZE) && ((height) == XC_1280_800_V_SIZE))
...
#ifdef MSOS_TYPE_LINUX_KERNEL
INTERFACE void*  utopia_get_xc_instance(int device_id);
INTERFACE void utopia_create_xc_instance_table(void* pInstance, MS_U32 u32DeviceID );
INTERFACE MS_BOOL utopia_delete_xc_instance_table(void* pInstance);
#endif
