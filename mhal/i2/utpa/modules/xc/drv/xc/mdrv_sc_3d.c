...
MS_BOOL MDrv_SC_3D_FormatValidation(void *pInstance, XC_InternalStatus *pSrcInfo, SCALER_WIN eWindow)
{
    ...
    if (IS_INPUT_PIXEL_ALTERNATIVE(eWindow) || IS_INPUT_CHECK_BOARD(eWindow))
    {
        ...
        else if(!IsSrcTypeVga(gSrcInfo[eWindow].enInputSourceType))
        {
            bRet = FALSE;
...
#else
    UNUSED(pSrcInfo);
    UNUSED(pu16V_SizeAfterPreScaling);
    UNUSED(pu16DNROffset);
    UNUSED(pu16Ratio);
    UNUSED(eWindow);
#endif
}
...
#else
    UNUSED(pSrcInfo);
    UNUSED(pu32FRCM_RPixelOffset);
    UNUSED(pu16FRCM_ROffset);
    UNUSED(pu16FRCM_ROffset3D);
    UNUSED(bLeftSide);
    UNUSED(eWindow);
#endif
}
...
MS_BOOL MDrv_SC_3D_IsSupportFBL3D(void)
{
#ifndef DISABLE_3D_FUNCTION
...
static void _MDrv_SC_3D_2DTo3D_BGColorDetection_U9(void* pInstance)
{
    ...
    MS_U32 u32ScalingRatio = DISPLAY_DD_H*DISPLAY_DD_V*1000/FHD_W/FHD_H;
    UNUSED(CbTpMaxinBncnt);
    UNUSED(CrTpMaxinBncnt);
    UNUSED(YBnMaxcnt);
    UNUSED(YTpMaxcnt);
    UNUSED(CrMaxcnt);
    UNUSED(CbMaxcnt);
...
static void MainObjectDetection_U9(void)//only for bule sky pattern (Golf pattern)
{
    ...
    UNUSED(tmpColorIdx[0]);     //just for fixing compile warning, meaningless here
...
static void _MDrv_SC_3D_2DTo3D_TrendDetection(void *pInstance)
{
    ...
    */
    ...
    MS_S32 VerTrendCplx_Range_Wei=0;

    MS_S32 times,timesH=0,timesV;
    UNUSED(timesH);
    UNUSED(VerTrendCplx_Range_Wei);
    UNUSED(VerTrendDiff_Max_Wei);
...
#if(HW_2DTO3D_VER >= 4)
    else if(IS_INPUT_NORMAL_2D_HW(eWindow) && IS_OUTPUT_SIDE_BY_SIDE_HALF_HW())
    {
        bRet = (SC_R2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK62_06_L, BIT(15)) == BIT(15));
        bRet ^= (IsHMirrorMode(eWindow) || (MDrv_ReadRegBit(REG_MVOP_MIRROR, (BIT(0)|BIT(1))) == (BIT(0)|BIT(1))));
    }
#endif
#endif
...
#endif //end of DISABLE_3D_FUNCTION
//-------------------------------------------------------------------------------------------------
...
#ifndef DISABLE_3D_FUNCTION
#if (HW_2DTO3D_SUPPORT == FALSE)
    printf("===Attention! hw auto detect mode is not supported by this chip!=== %s() %d\n",__FUNCTION__,__LINE__);
#else
    XC_INSTANCE_PRIVATE *psXCInstPri = NULL;
    UtopiaInstanceGetPrivate(pInstance, (void**)&psXCInstPri);
...
#else
    UNUSED(pSrcInfo);
    UNUSED(pu16VactVideo);
    UNUSED(pu16VactSpace);
    UNUSED(bPreVscalingEna);
#endif
...
#ifdef SUPPORT_Scaling_Sub1_Mode
                //H post-scaling Phase
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_01_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor>>00), 0xFFFF);
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_02_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor>>16), 0xFFFF);
                //H post-scaling Sub1 Mode
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_08_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsHScalingUp == TRUE ? BIT(9) : 0), BIT(9));
                //V post-scaling Phase
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_03_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor>>00), 0xFFFF);
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_04_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor>>16), 0xFFFF);
                //V post-scaling Sub1 Mode
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_0A_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsVScalingUp == TRUE ? BIT(9) : 0), BIT(9));
#endif
            }
            else // SUB_WINDOW
            {
...
#ifdef SUPPORT_Scaling_Sub1_Mode
                //H post-scaling Phase
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_21_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor>>00), 0xFFFF);
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_22_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor>>16), 0xFFFF);
                //H post-scaling Sub1 Mode
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_28_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsHScalingUp == TRUE ? BIT(9) : 0), BIT(9));
                //V post-scaling Phase
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_23_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor>>00), 0xFFFF);
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_24_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor>>16), 0xFFFF);
                //V post-scaling Sub1 Mode
                MDrv_XC_MLoad_WriteCmd(pInstance, REG_SC_BK23_2A_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsVScalingUp == TRUE ? BIT(9) : 0), BIT(9));
#endif
            }
            MDrv_XC_MLoad_Fire(pInstance, TRUE);
            _MLOAD_RETURN(pInstance);
...
#ifdef SUPPORT_Scaling_Sub1_Mode
                SC_W4BYTE(psXCInstPri->u32DeviceID, REG_SC_BK23_01_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor);   // H pre-scaling Phase
                SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK23_08_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsHScalingUp == TRUE ? BIT(9) : 0), BIT(9)); //H post-scaling Sub1 Mode
                SC_W4BYTE(psXCInstPri->u32DeviceID, REG_SC_BK23_03_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor);   // V pre-scaling Phase
                SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK23_0A_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsVScalingUp == TRUE ? BIT(9) : 0), BIT(9)); //V post-scaling Sub1 Mode
#endif
            }
            else // SUB_WINDOW
            {
...
#ifdef SUPPORT_Scaling_Sub1_Mode
                SC_W4BYTE(psXCInstPri->u32DeviceID, REG_SC_BK23_21_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32H_PostScalingIniFactor);   // H pre-scaling Phase
                SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK23_28_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsHScalingUp == TRUE ? BIT(9) : 0), BIT(9)); //H post-scaling Sub1 Mode
                SC_W4BYTE(psXCInstPri->u32DeviceID, REG_SC_BK23_23_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u32V_PostScalingIniFactor);   // V pre-scaling Phase
                SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK23_2A_L, (pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.bIsVScalingUp == TRUE ? BIT(9) : 0), BIT(9)); //V post-scaling Sub1 Mode
#endif
            }
            _XC_RETURN(pInstance);
        }
...
static void _Mdrv_Set_3D_Display_Window(void *pInstance, MS_U16 u16H_Start, MS_U16 u16H_End,
    MS_U16 u16V_Start, MS_U16 u16V_End, SCALER_WIN eWindow)
{
    XC_INSTANCE_PRIVATE *psXCInstPri = NULL;
    UtopiaInstanceGetPrivate(pInstance, (void**)&psXCInstPri);
    XC_RESOURCE_PRIVATE* pXCResourcePrivate = NULL;
    ...
    if(SUB_WINDOW != eWindow)
    {
        ...
        if(MDrv_XC_Is_SupportSWDS(pInstance, eWindow))
        {
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK10_08_L,u16H_Start, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK10_09_L, u16H_End, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK10_0A_L, u16V_Start, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK10_0B_L, u16V_End, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
#if (FRC_INSIDE && (HW_DESIGN_4K2K_VER == 6))
            if (pXCResourcePrivate->stdrvXC_MVideo_Context.g_bFSCEnabled)
            {
                MHal_SWDS_AddTGENMdeStartEndX(pInstance, u16H_Start, u16H_End, eWindow);
                MHal_SWDS_AddTGENMdeStartEndY(pInstance, u16V_Start, u16V_End, eWindow);
            }
#endif
        }
        else
#endif
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK10_08_L, u16H_Start, VOP_DISPLAY_HSTART_MASK);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK10_09_L, u16H_End, VOP_DISPLAY_HEND_MASK);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK10_0A_L, u16V_Start, VOP_DISPLAY_VSTART_MASK);//Main window display window
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK10_0B_L, u16V_End, VOP_DISPLAY_VEND_MASK);
        }
    }
    else
    {
        ...
        if(MDrv_XC_Is_SupportSWDS(pInstance, eWindow))
        {
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK0F_07_L, u16H_Start, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK0F_08_L, u16H_End, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK0F_09_L, u16V_Start, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);//sub window display window
            Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK0F_0A_L, u16V_End, DS_OP,DS_XC,&PSTXC_DS_CMDCNT);
#if (FRC_INSIDE && (HW_DESIGN_4K2K_VER == 6))
            if (pXCResourcePrivate->stdrvXC_MVideo_Context.g_bFSCEnabled)
            {
                MHal_SWDS_AddTGENMdeStartEndX(pInstance, u16H_Start, u16H_End, eWindow);
...
#endif
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK0F_07_L, u16H_Start, VOP_DISPLAY_HSTART_MASK);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK0F_08_L, u16H_End, VOP_DISPLAY_HEND_MASK);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK0F_09_L, u16V_Start, VOP_DISPLAY_VSTART_MASK);
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK0F_0A_L, u16V_End, VOP_DISPLAY_VEND_MASK);
        }
    }
}

static void _Mdrv_Set_3D_SBS_Out_Display_Window(void *pInstance, XC_InternalStatus *pSrcInfo, SCALER_WIN eWindow)
{
    XC_INSTANCE_PRIVATE *psXCInstPri = NULL;
    UtopiaInstanceGetPrivate(pInstance, (void**)&psXCInstPri);
    XC_RESOURCE_PRIVATE* pXCResourcePrivate = NULL;
    ...
    MS_U16 u16H_Start_Main = 0, u16H_End_Main = 0, u16V_Start_Main = 0, u16V_End_Main = 0;
    MS_U16 u16H_Start_Sub = 0, u16H_End_Sub = 0, u16V_Start_Sub = 0, u16V_End_Sub = 0;

    MS_U16 u16H_Start_L = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisStart;
    MS_U16 u16H_End_L = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisStart + pSrcInfo->stDispWin.width/2-1;
    MS_U16 u16V_Start_L = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart;
    MS_U16 u16V_End_L = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd;

    MS_U16 u16H_Start_R = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisStart + pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Width/2;
    ...
    MS_U16 u16H_End_R = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisEnd;
    MS_U16 u16V_Start_R = u16V_Start_L;
    MS_U16 u16V_End_R = u16V_End_L;

    //H mirror: L=>Sub window, R=>main window.
    if(IsHMirrorMode(eWindow))
    {
        u16H_Start_Main = u16H_Start_R;
        u16H_End_Main = u16H_End_R;
        u16V_Start_Main = u16V_Start_R;
        u16V_End_Main = u16V_End_R;

        u16H_Start_Sub = u16H_Start_L;
        u16H_End_Sub = u16H_End_L;
        u16V_Start_Sub = u16V_Start_L;
        u16V_End_Sub = u16V_End_L;
    }
    else //nomal case: L=>main window, R=>Sub window.
    {
        u16H_Start_Main = u16H_Start_L;
        u16H_End_Main = u16H_End_L;
        u16V_Start_Main = u16V_Start_L;
        u16V_End_Main = u16V_End_L;

        u16H_Start_Sub = u16H_Start_R;
        u16H_End_Sub = u16H_End_R;
        u16V_Start_Sub = u16V_Start_R;
        u16V_End_Sub = u16V_End_R;
    }

    _Mdrv_Set_3D_Display_Window(pInstance, u16H_Start_Main, u16H_End_Main, u16V_Start_Main, u16V_End_Main, eWindow);
    _Mdrv_Set_3D_Display_Window(pInstance, u16H_Start_Sub, u16H_End_Sub, u16V_Start_Sub, u16V_End_Sub, SUB_WINDOW);
}

static void _Mdrv_Set_3D_TB_Out_Display_Window(void *pInstance, XC_InternalStatus *pSrcInfo, SCALER_WIN eWindow)
{
    XC_INSTANCE_PRIVATE *psXCInstPri = NULL;
    UtopiaInstanceGetPrivate(pInstance, (void**)&psXCInstPri);
    XC_RESOURCE_PRIVATE* pXCResourcePrivate = NULL;
    ...
    MS_U16 u16H_Start_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisStart;
    MS_U16 u16H_End_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16H_DisEnd;
    MS_U16 u16V_Start_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart;
    MS_U16 u16V_End_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart + pSrcInfo->stDispWin.height/2-1;

    MS_U16 u16H_Start_B = u16H_Start_T;
    MS_U16 u16H_End_B = u16H_End_T;
    MS_U16 u16V_Start_B = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart + pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height/2;
    ...
    MS_U16 u16V_End_B = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd;
#if (FRC_INSIDE && (HW_DESIGN_4K2K_VER == 6))
    ...
    {
        u16V_Start_Sub = u16V_Start_T;
        u16V_End_Sub = u16V_End_T + pSrcInfo->stDispWin.height/2;
        u16V_Start_Main = u16V_Start_B + pSrcInfo->stDispWin.height/2;
        u16V_End_Main = u16V_End_B + pSrcInfo->stDispWin.height;
    }
    else
#endif
#if (FRC_INSIDE && (HW_DESIGN_4K2K_VER == 6))
    if(MHal_FRC_IsEnableFRC3D(pInstance, MAIN_WINDOW))
    {
        ...
        {
            u16V_Start_T = pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16VStart +  u16VDispwinOffset*2;
            u16V_End_T = u16V_End_T + pSrcInfo->stDispWin.height/2-1;
            u16V_Start_B = u16V_Start_B + pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height;
            u16V_End_B = u16V_End_B + pSrcInfo->stDispWin.height/2 -1;
        }
        else if(IS_OUTPUT_4K2K_60HZ_PANEL())
        {
            if(pXCResourcePrivate->stdrvXC_3D._bLAToTB)
            {
                if(IsVMirrorMode(eWindow))
                {
                    u16V_Start_B = pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16VStart +  u16VDispwinOffset*2;
                    u16V_End_B = u16V_Start_B + pSrcInfo->stDispWin.height -1;
                    if (u16V_End_B == (pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16VStart+pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height - 1))
                    {
                        u16V_End_B += 1; //"+1" is hw bug
                    }
                }
                else
                {
                    u16V_Start_T = pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16VStart +  u16VDispwinOffset*2;
                    u16V_End_T = u16V_Start_T + pSrcInfo->stDispWin.height -1;
                    if (u16V_End_T == (pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16VStart+pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height - 1))
                    {
                        u16V_End_T += 1; //"+1" is hw bug
                    }
                }
            }
        }
    ...
    //V mirror: Top(L)=>Sub window, Bottom(R)=>main window.
    if(IsVMirrorMode(eWindow))
    {
        u16H_Start_Main = u16H_Start_B;
        u16H_End_Main = u16H_End_B;
        u16V_Start_Main = u16V_Start_B;
        u16V_End_Main = u16V_End_B;

        u16H_Start_Sub = u16H_Start_T;
        u16H_End_Sub = u16H_End_T;
        u16V_Start_Sub = u16V_Start_T;
        u16V_End_Sub = u16V_End_T;
    }
    else //nomal case: L=>main window, R=>Sub window.
    {
        u16H_Start_Main = u16H_Start_T;
        u16H_End_Main = u16H_End_T;
        u16V_Start_Main = u16V_Start_T;
        u16V_End_Main = u16V_End_T;

        u16H_Start_Sub = u16H_Start_B;
        u16H_End_Sub = u16H_End_B;
        u16V_Start_Sub = u16V_Start_B;
        u16V_End_Sub = u16V_End_B;
    }
...
static void _Mdrv_Set_3D_FP_Out_Display_Window(void *pInstance, XC_InternalStatus *pSrcInfo, SCALER_WIN eWindow)
{
    XC_INSTANCE_PRIVATE *psXCInstPri = NULL;
    UtopiaInstanceGetPrivate(pInstance, (void**)&psXCInstPri);
    XC_RESOURCE_PRIVATE* pXCResourcePrivate = NULL;
    ...
    MS_U16 u16H_Start_B = u16H_Start_T;
    MS_U16 u16H_End_B = u16H_End_T;
    MS_U16 u16V_Start_B = 0;
    MS_U16 u16V_End_B = 0;

    if(pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height ==DOUBLEHD_1080X2P_VSIZE)
    {
        u16V_End_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart + DOUBLEHD_1080X2P_FRAME_VSIZE - 1;
        u16V_Start_B = u16V_End_T + DOUBLEHD_1080X2P_GARBAGE_VSIZE;
        pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart
                                                                    + DOUBLEHD_1080X2P_VSIZE -1;
        u16V_End_B = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd;
    }
    else if(pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.u16Height ==DOUBLEHD_720X2P_VSIZE)
    {
        u16V_End_T = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart + DOUBLEHD_720X2P_FRAME_VSIZE - 1;
        u16V_Start_B = u16V_End_T + DOUBLEHD_720X2P_GARBAGE_VSIZE;
        pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisStart
                                                                     + DOUBLEHD_720X2P_VSIZE -1;
        u16V_End_B = pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16V_DisEnd;
    }
                           ...
                           SCALER_WIN eWindow)
{
       ...
       && ((eInputMode != pXCResourcePrivate->stdrvXC_3D.ePreInputMode) || (eOutputMode != pXCResourcePrivate->stdrvXC_3D.ePreOutputMode)))
    {
        ...
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK68_70_L, 0x0, BIT(1));//FE_OP watch stgen's parameter. select original tgen
        }
        if(_bCopyMainOPBase)
        {
    ...
    if(b3Dstate)
    {
           ...
           )
        {
            ...
            if (IsVMirrorMode(eWindow) || IsHMirrorMode(eWindow))
            {
...
/////------------------
    ...
    else if(IS_INPUT_SIDE_BY_SIDE_HALF(eWindow) || IS_INPUT_SIDE_BY_SIDE_HALF_INTERLACE(eWindow))
    {
        ...
        if(IsEnableDualMode(eWindow))
        {
            ...
            if(MDrv_XC_Is_SupportSWDS(pInstance, eWindow))
            {
                ...
                if (IsHMirrorMode(eWindow) == TRUE)
                {
                    Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK12_16_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset/2 + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
                    Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK12_56_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset/2 + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
                    Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_16_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNROffset, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
                    Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_56_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNROffset, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
...
#endif
            {
                ...
                if (IsHMirrorMode(eWindow) == TRUE)
                {
                    SC_W2BYTEMSK(0, REG_SC_BK12_16_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset/2 + 1) & ~0x1, 0x1FFF);  //F2_1 OPM offset
                    SC_W2BYTEMSK(0, REG_SC_BK12_56_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset/2 + 1) & ~0x1, 0x1FFF);  //F2_1 OPM offset

                    SC_W2BYTEMSK(0, REG_SC_BK52_16_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNROffset, 0x1FFF);  //F2_1 OPM offset
                    SC_W2BYTEMSK(0, REG_SC_BK52_56_L, pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNROffset, 0x1FFF);  //F2_1 OPM offset
                }
                else
                {
    ...
    else if(IS_INPUT_CHECK_BOARD(eWindow))
    {
        ...
        if(IsEnableDualMode(eWindow))
        {
            ...
            if(MDrv_XC_Is_SupportSWDS(pInstance, eWindow))
            {
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_0E_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset), DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 IPM offset
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_0F_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNRFetch), DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 IPM fetch number
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_16_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMOffset/2 + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_17_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM fetch number
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_56_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMOffset/2 + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM offset
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK52_57_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + 1) & ~0x1, DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2_1 OPM fetch number
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK11_28_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNRFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNRFetch), DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2 IPM total fetch
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK11_29_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16OPMFetch), DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2 OPM total fetch
                Hal_SC_WriteSWDSCommand(pInstance, MAIN_WINDOW, REG_SC_BK11_69_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16OPMFetch), DS_IP,DS_XC,&PSTXC_DS_CMDCNT);  //F2 OPM total fetch
            ...
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_0E_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNROffset), 0x1FFF);  //F2_1 IPM offset
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_0F_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNRFetch), 0x1FFF);  //F2_1 IPM fetch number
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_16_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMOffset/2 + 1) & ~0x1, 0x1FFF);  //F2_1 OPM offset
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_17_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + 1) & ~0x1, 0x0FFF);  //F2_1 OPM fetch number
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_56_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMOffset/2 + 1) & ~0x1, 0x1FFF);  //F2_1 OPM offset
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK52_57_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + 1) & ~0x1, 0x0FFF);  //F2_1 OPM fetch number
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK11_28_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualDNRFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DNRFetch), 0x1FFF);  //F2 IPM total fetch
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK11_29_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16OPMFetch), 0x1FFF);  //F2 OPM total fetch
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK11_69_L, (MS_U16)(pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16DualOPMFetch + pXCResourcePrivate->stdrvXC_MVideo_Context.stDBreg.u16OPMFetch), 0x1FFF);  //F2 OPM total fetch
    ...
    else if(IS_OUTPUT_TOP_BOTTOM() || IS_OUTPUT_TOP_BOTTOM_HW())
    {
        ...
        _Mdrv_Set_3D_TB_Out_Display_Window(pInstance, pSrcInfo, eWindow);
        //not for Maserati 120Hz
        MS_U8 u8LPLL_Type =(MS_U8)pXCResourcePrivate->stdrvXC_MVideo_Context.g_XC_InitData.stPanelInfo.eLPLL_Type;
        if(!IsVBY1_16LANE(u8LPLL_Type))
        {
            //if FRC 3D enable and output 3D type is LA or FA, hide sub window.
            if((pXCResourcePrivate->stdrvXC_3D._bFAToTB ||pXCResourcePrivate->stdrvXC_3D._bLAToTB)
                && pXCResourcePrivate->stdrvXC_3D._bFRC3DEnabled )
            {
                SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK68_70_L, BIT(1), BIT(1));//FE_OP watch stgen's parameter.
            }
        }
        //only for direct TV test
    ...
    else if(IS_OUTPUT_SIDE_BY_SIDE_HALF() || IS_OUTPUT_SIDE_BY_SIDE_HALF_HW())
    {
        ...
        _Mdrv_Set_3D_SBS_Out_Display_Window(pInstance, pSrcInfo, eWindow);
    ...
    else if (IS_OUTPUT_FRAME_PACKING())
    {
        ...
        _Mdrv_Set_3D_FP_Out_Display_Window(pInstance, pSrcInfo,eWindow);
    ...
    else if(IS_OUTPUT_SIDE_BY_SIDE_HALF_HW())
    {
        ...
        if (IsHMirrorMode(eWindow) || (MDrv_ReadRegBit(REG_MVOP_MIRROR, (BIT(0)|BIT(1))) == (BIT(0)|BIT(1))))
        {
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK62_06_L, BIT(15), BIT(15)); //sign bit:bit15
            SC_W2BYTEMSK(psXCInstPri->u32DeviceID, REG_SC_BK62_0E_L, 0x0000, BIT(15));   //sign bit:bit15
        }
