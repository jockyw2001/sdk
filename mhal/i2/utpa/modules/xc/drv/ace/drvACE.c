...
MS_BOOL MDrv_XC_ACE_Set_IHC_SRAM(void* pInstance, MS_U16 *pBuf, MS_U16 u16ByteSize)
{
    ...
    MS_U16* SRAM1_IHC = (MS_U16*) malloc(sizeof(MS_U16)*MAX_SRAM_SIZE);
    MS_U16* SRAM2_IHC = (MS_U16*) malloc(sizeof(MS_U16)*MAX_SRAM_SIZE);
    MS_U16* SRAM3_IHC = (MS_U16*) malloc(sizeof(MS_U16)*MAX_SRAM_SIZE);
    MS_U16* SRAM4_IHC = (MS_U16*) malloc(sizeof(MS_U16)*MAX_SRAM_SIZE);

    if(SRAM1_IHC == NULL || SRAM2_IHC == NULL || SRAM3_IHC == NULL || SRAM4_IHC ==NULL)
    {
        if(SRAM1_IHC != NULL)
        {
            free(SRAM1_IHC);
        ...
        printf("SRAM_IHC malloc fail\n");
        return FALSE;
    }

    memset(SRAM1_IHC, 0, sizeof(MS_U16)*MAX_SRAM_SIZE);
    memset(SRAM2_IHC, 0, sizeof(MS_U16)*MAX_SRAM_SIZE);
    memset(SRAM3_IHC, 0, sizeof(MS_U16)*MAX_SRAM_SIZE);
    memset(SRAM4_IHC, 0, sizeof(MS_U16)*MAX_SRAM_SIZE);
    ...
    Hal_ACE_Set_IHC_SRAM(pInstance, SRAM1_IHC, 0, cont1);
    Hal_ACE_Set_IHC_SRAM(pInstance, SRAM2_IHC, 1, cont2);
    Hal_ACE_Set_IHC_SRAM(pInstance, SRAM3_IHC, 2, cont3);
    Hal_ACE_Set_IHC_SRAM(pInstance, SRAM4_IHC, 3, cont4);
