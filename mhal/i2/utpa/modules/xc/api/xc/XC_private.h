...
typedef void                             (*IOCTL_XC_SETFRAMECOLOR)                           (void*, MS_U32, MS_BOOL);
...
typedef MS_BOOL                          (*IOCTL_XC_POLLEVENT)                               (void*);
typedef MS_BOOL                          (*IOCTL_XC_CANCEL_POLLEVENT)                        (void*);
...
typedef E_APIXC_ReturnValue              (*IOCTL_XC_GETPIXELSHIFT)                           (void*, MS_S8*, MS_S8*);
...
typedef E_APIXC_ReturnValue              (*IOCTL_XC_SET_VTRACK_ALLPAYLOADDATA)               (void*, XC_VTRACK_PAYLOAD*);
typedef E_APIXC_ReturnValue              (*IOCTL_XC_SET_VTRACK_VTRACKKEY)                    (void*, MS_U64);
...
typedef MS_U8                            (*IOCTL_XC_GETSWDSINDEX)                            (void*, SCALER_WIN);
...
typedef void                             (*IOCTL_XC_GETDSINFO)                               (void*,XC_GET_DS_INFO*, MS_U32, SCALER_WIN);
typedef MS_U16                           (*IOCTL_XC_GET_DS_VERSION)                          (void*);
...
#endif
{
    ...
    //Please use u16DynamicScalingIndexDepth_Ext instead of u8DynamicScalingIndexDepth for new chip
    MS_U16 u16DynamicScalingIndexDepth_Ext;
#endif
...
#if(!SUPPORT_HDMI20)
    MS_HDMI_EXTEND_PACKET_RECEIVE_t stHdmiExtendPacketReceive;
#endif
...
#endif
{
    ...
    IOCTL_XC_POLLEVENT                              fpXC_PollEvent;
    IOCTL_XC_CANCEL_POLLEVENT                       fpXC_Cancel_PollEvent;
    ...
    IOCTL_XC_GETPIXELSHIFT                          fpXC_GetPixelShift;
    ...
    IOCTL_XC_SET_VTRACK_ALLPAYLOADDATA              fpXC_Vtrack_SetAllPayloadData;
    IOCTL_XC_SET_VTRACK_VTRACKKEY                   fpXC_Vtrack_SetVtrackKey;
    ...
    IOCTL_XC_GETDSINFO                              fpXC_GetDSInfo;
    IOCTL_XC_GET_DS_VERSION                         fpXC_Get_DS_Version;
