...
typedef APIPNL_Result                       (*IOCTL_PNL_OVERDRIVER_SETTING)                    (void*, MS_PNL_OD_SETTING*, MS_U32);
...
typedef APIPNL_Result                       (*IOCTL_PNL_SETFILEPATH)                            (void*, E_PNL_FILE_PATH,char*);
...
typedef struct __attribute__((packed))
{
    ...
    IOCTL_PNL_OVERDRIVER_SETTING                fpPNL_OverDriver_Setting;
    ...
    IOCTL_PNL_SETFILEPATH                       fpPNL_Set_FILE_Path;
    // Device ID
    MS_U32 u32DeviceID;
...
#define OverDriverTblSize 1089
#define PNL_FILE_PATH_LENGTH 50
typedef struct __attribute__((packed))
{
    ...
    // MApi_PNL_OD
    MS_U16 _u16ODTbl[OverDriverTblSize];
    MS_PHY _u32OD_MSB_Addr;
    MS_PHY _u32OD_LSB_Addr;
    MS_U32 _u32ODInitDataLen;
    MS_U32 _ODTbl_Size;
    MS_BOOL _bOD_En;

    //PNL file path
    char _pm_PNL_CUSTOMER_PATH[PNL_FILE_PATH_LENGTH];
} ST_APIPNL;
