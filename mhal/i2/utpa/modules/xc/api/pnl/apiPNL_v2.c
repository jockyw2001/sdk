...
void PNLRegisterToUtopia(FUtopiaOpen ModuleType)
{
    ...
    else
    {
        ...
        memset(pPNLResourcePrivate->stapiPNL._u16ODTbl, 0 ,sizeof(MS_U16)*OverDriverTblSize);
        pPNLResourcePrivate->stapiPNL._u32OD_MSB_Addr = 0;
        pPNLResourcePrivate->stapiPNL._u32OD_LSB_Addr = 0;
        pPNLResourcePrivate->stapiPNL._u32ODInitDataLen = 0;
        pPNLResourcePrivate->stapiPNL._ODTbl_Size = 0;
        pPNLResourcePrivate->stapiPNL._bOD_En = FALSE;
        memset(pPNLResourcePrivate->stapiPNL._pm_PNL_CUSTOMER_PATH,0,sizeof(char)*PNL_FILE_PATH_LENGTH);
...
MS_U32 PNLOpen(void** ppInstance, const void* const pAttribute)
{
    ...
    psPNLInstPri->fpPNL_OverDriver_Setting     = MApi_PNL_OverDriver_Setting_U2;
    ...
    psPNLInstPri->fpPNL_Set_FILE_Path          = MApi_PNL_SetFilePath_U2;
...
MS_U32 PNLIoctl(void* pInstance, MS_U32 u32Cmd, void* pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case E_PNL_CMD_OVERDRIVER_SETTING:
        {
            pstPNL_OverDriver_Setting pPNLArgs = (pstPNL_OverDriver_Setting)pArgs;
            pPNLArgs->eResult = psPNLInstPri->fpPNL_OverDriver_Setting(pInstance, pPNLArgs->pPNL_ODSetting, pPNLArgs->u32ODInitDataLen);
            return UTOPIA_STATUS_SUCCESS;
        }
        ...
        case E_PNL_CMD_SETFILEPATH:
        {
            pstPNL_Set_File_Path pPNLArgs = (pstPNL_Set_File_Path)pArgs;
            pPNLArgs->eResult = psPNLInstPri->fpPNL_Set_FILE_Path(pInstance,pPNLArgs->enPNLFilePath,pPNLArgs->pPNLFilePath);
            return UTOPIA_STATUS_SUCCESS;
        }
        default:
