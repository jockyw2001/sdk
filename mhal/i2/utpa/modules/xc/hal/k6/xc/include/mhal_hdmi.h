...
#define INPUT_PORT_DVI_END              INPUT_PORT_DVI0
...
INTERFACE void Hal_HDMI_StablePolling(MS_U8 ucMHLSupportPath, MS_U32 *ulPacketStatus, stHDMI_POLLING_INFO *stHDMIPollingInfo);
...
INTERFACE void Hal_HDMI_DataRtermControl(E_MUX_INPUTPORT enInputPortType, MS_BOOL bDataRtermEnable);
