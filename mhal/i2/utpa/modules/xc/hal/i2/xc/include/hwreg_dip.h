...
#define MFDEC_BYPASS_MODE                   (BIT(9))
#define MFDEC_RIU_MODE                      (BIT(12))
#define MFDEC_RIU1_MODE                     (BIT(13))
#define REG_MFDEC_ENA_MASK                  (MFDEC_RIU1_MODE|MFDEC_RIU_MODE|MFDEC_BYPASS_MODE|MFDEC_UNCOMP_MODE|MFDEC_HVD_MODE|MFDEC_VP9_MODE|MFDEC_VMIRROR|MFDEC_HMIRROR|MFDEC_ENABLE)
...
#define MFDEC_Y_START                       (BMASK(7:0))
