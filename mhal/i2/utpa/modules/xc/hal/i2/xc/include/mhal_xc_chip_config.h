...
#define SC1_SCALER_LINE_BUFFER_MAX  (1920UL)
...
#define FETCH_PIXEL_ALIGNMENT  OFFSET_PIXEL_ALIGNMENT
...
#else
#define SUPPORT_KERNEL_MLOAD                0 // I2_UTPA_KAPI_XC
#endif

#define SUPPORT_KERNEL_DS                   0 // I2_UTPA_KAPI_XC
...
#define GOP_ZORDER_SYNCPD_PATCH             1
...
#define XC_1280_800_H_SIZE 1280
#define XC_1280_800_V_SIZE 800
...
#define REG_MVOP_CROP_H_START   (REG_MVOP_BASE    + 0x40)
#define REG_MVOP_CROP_V_START   (REG_MVOP_BASE    + 0x41)
#define REG_MVOP_CROP_H_SIZE    (REG_MVOP_BASE    + 0x42)
#define REG_MVOP_CROP_V_SIZE    (REG_MVOP_BASE    + 0x43)
