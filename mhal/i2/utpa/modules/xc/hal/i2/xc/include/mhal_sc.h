...
INTERFACE void Hal_SC_init_riu_base(MS_VIRT u32riu_base, MS_VIRT u32PMriu_base, MS_VIRT u32EXTriu_base);
...
INTERFACE void Hal_XC_SetFrameColor(void *pInstance, MS_U32 u32aRGB, MS_BOOL bYUV);
...
#define Hal_SC_HDR_CLK_Setting(args...)
...
INTERFACE E_APIXC_ReturnValue MHal_XC_Vtrack_SetAllPayloadData(void *pInstance, XC_VTRACK_PAYLOAD *vtrack_payload);
INTERFACE E_APIXC_ReturnValue MHal_XC_Vtrack_SetVtrackKey(void *pInstance, MS_U64 u64VtrackKey);
...
//Bypass mode
#define MHal_XC_Check_Bypass(args...) 0
...
#endif
INTERFACE E_APIXC_ReturnValue Hal_SC_Enable_VE_BypassPath(void *pInstance, MS_BOOL bEnable);
#define Hal_SC_MVOP_HandShake_Control(args...)
#define Hal_SC_MVOP_Gen_Timing_From_XC_Control(args...)
INTERFACE MS_BOOL Hal_SC_IsLockFromIP(void *pInstance, SCALER_WIN eWindow);
#undef INTERFACE
#endif /* MHAL_SC_H */
