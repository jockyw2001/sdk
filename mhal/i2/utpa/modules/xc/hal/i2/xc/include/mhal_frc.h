...
#define MHal_FRC_TGEN_Init(args...)
#define MHal_FRC_TGEN_Enable_LockMode(args...)
#define MHal_FRC_TGEN_Enable_Source_Select_Mode(args...)
#define MHal_FRC_TGEN_Enable_Lock_Source(args...)

#define MHal_FRC_SetYTrig(args...)

#define MHal_FRC_Enable_MiuMask(args...)
#define MHal_FRC_Disable_MiuMask(args...)
#define MHal_FRC_set_miusel(args...)
...
#define MHal_FRC_IsEnableFRC3D(args...)
...
#define Hal_XC_FRC_R2_Set_InputFrameSize(args...) 0
#define Hal_XC_FRC_R2_Set_OutputFrameSize(args...) 0
...
#define MHal_FRC_Set_TimingStable(args...)
