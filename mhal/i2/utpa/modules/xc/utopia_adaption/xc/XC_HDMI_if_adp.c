...
// MAPI_CMD_HDMIRX_HDCP22_SET_EVENT -- stHDCP22_SET_EVENT
UADP_SPT_NAMEnNXT_DEF(HDMIRX_HDCP22_SET_EVENT, 0);
// MAPI_CMD_HDMIRX_GET_HDR_INFO_FRAME -- stHDMI_GET_HDR_INFOFRAME
UADP_SPT_NAMEnNXT_DEF(HDMIRX_HDR_INFOFRAME, 0);
UADP_SPT_NAMEnNXT_DEF(HDMIRX_GET_HDR_INFOFRAME, 1);
// MAPI_CMD_HDMIRX_DATA_RTERM_CONTROL -- stHDMI_DATA_RTERM_CONTROL
UADP_SPT_NAMEnNXT_DEF(HDMIRX_DATA_RTERM_CONTROL, 0);
...
MS_U32 XC_HDMI_if_adp_Init(void)
{
    ...
    UADP_SPT_NAME1NXT(XC_HDMI_GET_3D_META_FIELD, stHDMI_GET_3D_META_FIELD, pdata, XC_HDMI_3D_META_FIELD);
...
MS_U32 XC_HDMI_if_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        case E_XC_HDMI_IF_CMD_FUNC_CAPS :
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_FUNC_CAPS, spt_XC_HDMI_FUNC_CAPS, buffer_arg, sizeof(buffer_arg));
            break;

        case E_XC_HDMI_IF_CMD_INIT:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_INITIAL_SETTING, spt_XC_HDMI_INITIAL_SETTING, buffer_arg, sizeof(buffer_arg));
            break;
        ...
        case E_XC_HDMI_IF_CMD_GET_TMDS_FREQ:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_GET_TMDS_FREQ, spt_XC_HDMI_GET_TMDS_FREQ, buffer_arg, sizeof(buffer_arg));
            break;
        ...
        case E_XC_HDMI_IF_CMD_ISHDMI_MODE:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_ISHDMI_MODE, spt_XC_HDMI_ISHDMI_MODE, buffer_arg, sizeof(buffer_arg));
            break;
        ...
        case E_XC_HDCP_IF_CMD_GETSTATUS:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDCP_GETSTATUS, spt_XC_HDCP_GETSTATUS, buffer_arg, sizeof(buffer_arg));
            break;
        ...
        case E_XC_HDMI_IF_CMD_GETINFO:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_GETINFO, spt_XC_HDMI_GETINFO, buffer_arg, sizeof(buffer_arg));
            break;

        case E_XC_HDMI_IF_CMD_GETSTATUS:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_GETSTATUS, spt_XC_HDMI_GETSTATUS, buffer_arg, sizeof(buffer_arg));
            break;

        case E_XC_HDMI_IF_CMD_READ_DDCRAM:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_XC_HDMI_READ_DDCRAM, spt_XC_HDMI_READ_DDCRAM, buffer_arg, sizeof(buffer_arg));
            break;
        ...
        case E_XC_HDMI_IF_CMD_CTRL:
            {
                ...
                if(IS_CMP_TASK())
                {
                    ...
                    CMP_CPY_FROM_USER(stHDMIRxArgs.pBuf, stCompatHDMIRxArgs.pBuf, ulDataSize);
                ...
                else
                {
                    ...
                    pData = stHDMIRxArgs.pBuf;
                    stHDMIRxArgs.pBuf = malloc(ulDataSize);
                    CPY_FROM_USER(stHDMIRxArgs.pBuf, pData, ulDataSize);
...
MS_U32 HDMIRX_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        case MAPI_CMD_HDMIRX_INITIAL:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMIRX_INITIAL_SETTING, spt_HDMIRX_INITIAL_SETTING, usbuffer_arg, sizeof(usbuffer_arg));
            break;
        ...
        case MAPI_CMD_HDMIRX_HDCP22_SET_EVENT:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMIRX_HDCP22_SET_EVENT, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            break;

        case MAPI_CMD_HDMIRX_GET_HDR_INFO_FRAME:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMIRX_GET_HDR_INFOFRAME, spt_HDMIRX_GET_HDR_INFOFRAME, usbuffer_arg, sizeof(usbuffer_arg));
            break;

        case MAPI_CMD_HDMIRX_DATA_RTERM_CONTROL:
            ulReturnValue = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_HDMIRX_DATA_RTERM_CONTROL, NULL, usbuffer_arg, sizeof(usbuffer_arg));
            break;
...
MS_U32 HDMIRX_adp_Init(FUtopiaIOctl* pIoctl)
{
    ...
    UADP_SPT_NAME0NXT(HDMIRX_HDCP22_SET_EVENT, stHDCP22_SET_EVENT);
    // MAPI_CMD_HDMIRX_GET_HDR_INFO_FRAME
    ulDataSize = sizeof(MS_U16) *HDMI_HDR_PACKET_SIZE;
    UADP_SPT_BGN(&spt_HDMIRX_HDR_INFOFRAME[0], ulDataSize);
    UADP_SPT_FIN(&spt_HDMIRX_HDR_INFOFRAME[1]);
    UADP_SPT_NAME1NXT(HDMIRX_GET_HDR_INFOFRAME, stHDMI_GET_HDR_INFOFRAME, pusHDRInfoFrame, HDMIRX_HDR_INFOFRAME);
    // MAPI_CMD_HDMIRX_DATA_RTERM_CONTROL
    UADP_SPT_NAME0NXT(HDMIRX_DATA_RTERM_CONTROL, stHDMI_DATA_RTERM_CONTROL);
