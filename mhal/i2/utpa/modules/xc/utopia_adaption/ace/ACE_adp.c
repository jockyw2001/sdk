...
MS_U32 ACE_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
...
#endif
            {
                u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_INIT, spt_ACE_INIT, NULL,0);
            }
            break;
        }

        case E_ACE_CMD_EXIT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs, NULL, spt_ACE_EXIT, NULL,0);
            break;

        case E_ACE_CMD_DMS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DMS, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETPCYUV2RGB:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETPCYUV2RGB, NULL,NULL,0);
            break;

        case E_ACE_CMD_SELECTYUVTORGBMATRIX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SELECTYUVTORGBMATRIX, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETCOLORCORRECTIONTABLE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETCOLORCORRECTIONTABLE, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETPCSRGBTABLE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETPCSRGBTABLE, NULL,NULL,0);
            break;

        case E_ACE_CMD_GETCOLORMATRIX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_GETCOLORMATRIX, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETCOLORMATRIX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETCOLORMATRIX, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETBYPASSCOLORMATRIX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETBYPASSCOLORMATRIX, spt_ACE_SETBYPASSCOLORMATRIX, NULL,0);
            break;

        case E_ACE_CMD_SETIHC:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETIHC, spt_ACE_SETIHC, NULL,0);
            break;

        case E_ACE_CMD_PATCHDTGCOLORCHECKER:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PATCHDTGCOLORCHECKER, NULL,NULL,0);
            break;

        case E_ACE_CMD_GETACEINFO:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_GETACEINFO, spt_ACE_GETACEINFO,NULL,0);
            break;

        case E_ACE_CMD_GETACEINFOEX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_GETACEINFOEX, spt_ACE_GETACEINFOEX,NULL,0);
            break;

        case E_ACE_CMD_PICSETCONTRAST:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETCONTRAST, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSETBRIGHTNESS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETBRIGHTNESS, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSETBRIGHTNESSPRECISE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETBRIGHTNESSPRECISE, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSET_PRE_Y_OFFSET:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSET_PRE_Y_OFFSET, spt_ACE_PICSET_PRE_Y_OFFSET,NULL,0);
            break;

        case E_ACE_CMD_PICGET_PRE_Y_OFFSET:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICGET_PRE_Y_OFFSET, spt_ACE_PICGET_PRE_Y_OFFSET,NULL,0);
            break;

        case E_ACE_CMD_PICSETHUE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETHUE, NULL,NULL,0);
            break;

        case E_ACE_CMD_SKIPWAITVSYNC:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SKIPWAITVSYNC, spt_ACE_SKIPWAITVSYNC,NULL,0);
            break;

        case E_ACE_CMD_PICSETSATURATION:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETSATURATION, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSETSHARPNESS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETSHARPNESS, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSETCOLORTEMP:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETCOLORTEMP, spt_ACE_PICSETCOLORTEMP,NULL,0);
            break;

        case E_ACE_CMD_PICSETCOLORTEMPEX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETCOLORTEMPEX, spt_ACE_PICSETCOLORTEMPEX,NULL,0);
            break;

        case E_ACE_CMD_PICSETPOSTCOLORTEMP_V02:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETPOSTCOLORTEMP_V02, spt_ACE_PICSETPOSTCOLORTEMP_V02,NULL,0);
            break;

        case E_ACE_CMD_SETFLESHTONE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETFLESHTONE, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETBLACKADJUST:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETBLACKADJUST, NULL,NULL,0);
            break;

        case E_ACE_CMD_SET_IHC_SRAM:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SET_IHC_SRAM, spt_ACE_SET_IHC_SRAM,NULL,0);
            break;

        case E_ACE_CMD_SET_ICC_SRAM:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SET_ICC_SRAM, spt_ACE_SET_ICC_SRAM,NULL,0);
            break;

        case E_ACE_CMD_ENABLEMWE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_ENABLEMWE, NULL,NULL,0);
            break;

        case E_ACE_CMD_MWESETMIRRORMODE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_MWESETMIRRORMODE, NULL,NULL,0);
            break;
        ...
        case E_ACE_CMD_MWESETREGTABLE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_MWESETREGTABLE, spt_ACE_MWESETREGTABLE,NULL,0);
            break;

        case E_ACE_CMD_SETMWELOADFROMPQ:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETMWELOADFROMPQ, spt_ACE_SETMWELOADFROMPQ,NULL,0);
            break;

        case E_ACE_CMD_MWESTATUS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs, NULL, spt_ACE_MWESTATUS, NULL,0);
            break;
        ...
        case E_ACE_CMD_MWEFUNCSEL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_MWEFUNCSEL, NULL,NULL,0);
            break;


        case E_ACE_CMD_MWESETDISPWIN:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_MWESETDISPWIN, NULL,NULL,0);
            break;

        case E_ACE_CMD_3DCLONEPQMAP:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_3DCLONEPQMAP, NULL,NULL,0);
            break;

        case E_ACE_CMD_DNR_BLENDING_NRTBL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_BLENDING_NRTBL, spt_ACE_DNR_BLENDING_NRTBL,NULL,0);
            break;

        case E_ACE_CMD_DNR_BLENDING_MISC:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_BLENDING_MISC, spt_ACE_DNR_BLENDING_MISC,NULL,0);
            break;

        case E_ACE_CMD_DNR_BLENDING:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_BLENDING, spt_ACE_DNR_BLENDING,NULL,0);
            break;

        case E_ACE_CMD_DNR_GET_PRECISIONSHIFT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs, NULL, spt_ACE_DNR_GET_PRECISIONSHIFT, NULL,0);
            break;

        case E_ACE_CMD_DNR_GETMOTION_WEIGHT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_GETMOTION_WEIGHT, spt_ACE_DNR_GETMOTION_WEIGHT,NULL,0);
            break;

        case E_ACE_CMD_DNR_GETLUMA_WEIGHT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_GETLUMA_WEIGHT, spt_ACE_DNR_GETLUMA_WEIGHT,NULL,0);
            break;

        case E_ACE_CMD_DNR_GETNOISE_WEIGHT:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_GETNOISE_WEIGHT, spt_ACE_DNR_GETNOISE_WEIGHT,NULL,0);
            break;

        case E_ACE_CMD_DNR_GETMOTION:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_GETMOTION, spt_ACE_DNR_GETMOTION,NULL,0);
            break;
        ...
        case E_ACE_CMD_DNR_SETPARAM:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_SETPARAM, NULL,NULL,0);
            break;

        case E_ACE_CMD_DNR_GETPARAM:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_GETPARAM, spt_ACE_DNR_GETPARAM,NULL,0);
            break;

        case E_ACE_CMD_DNR_SETNRTBL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_DNR_SETNRTBL, spt_ACE_DNR_SETNRTBL,NULL,0);
            break;
        ...
        case E_ACE_CMD_GETINFO:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs, NULL, spt_ACE_GETINFO, NULL,0);
            break;

        case E_ACE_CMD_GETSTATUS:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_GETSTATUS, spt_ACE_GETSTATUS,NULL,0);
            break;

        case E_ACE_CMD_SETDBGLEVEL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETDBGLEVEL, spt_ACE_SETDBGLEVEL,NULL,0);
            break;

        case E_ACE_CMD_COLORCORRECTIONTABLE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_COLORCORRECTIONTABLE, spt_ACE_COLORCORRECTIONTABLE,NULL,0);
            break;

        case E_ACE_CMD_SETCOLORMATRIXCONTROL:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETCOLORMATRIXCONTROL, NULL,NULL,0);
            break;

        case E_ACE_CMD_SETRBCHANNELRANGE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SETRBCHANNELRANGE, NULL,NULL,0);
            break;

        case E_ACE_CMD_PICSETPOSTCOLORTEMP:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETPOSTCOLORTEMP, spt_ACE_PICSETPOSTCOLORTEMP,NULL,0);
            break;

        case E_ACE_CMD_PICSETPOSTCOLORTEMPEX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETPOSTCOLORTEMPEX, spt_ACE_PICSETPOSTCOLORTEMPEX,NULL,0);
            break;

        case E_ACE_CMD_PICSETPOSTCOLORTEMP2:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETPOSTCOLORTEMP2, spt_ACE_PICSETPOSTCOLORTEMP2,NULL,0);
            break;

        case E_ACE_CMD_PICSETPOSTCOLORTEMP2EX:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_PICSETPOSTCOLORTEMP2EX, spt_ACE_PICSETPOSTCOLORTEMP2EX,NULL,0);
            break;

        case E_ACE_CMD_SET_POWERSTATE:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_ACE_SET_POWERSTATE, spt_ACE_SET_POWERSTATE,NULL,0);
            break;
