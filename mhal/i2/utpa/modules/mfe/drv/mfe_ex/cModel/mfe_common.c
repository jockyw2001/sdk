...
extern MS_VIRT u32MFERegOSBase;

void WriteRegMFE(MS_VIRT u32Address, MS_U16 val, MS_S8 *str1, MS_S32 num, MS_S8 *str3)
{
#if defined(WIN32)
...
void WriteRegMFE_BANK1(MS_VIRT u32Address, MS_U16 val, MS_S8 *str1, MS_S32 num, MS_S8 *str3)
{
#if defined(WIN32)
	UDMA_RIUWrite16(REG_BANK_MFE1+u32Address, val);
#else
...
void ReadRegMFE(MS_VIRT u32Address, MS_U16 *val)
{
#if defined(WIN32)
...
void ReadRegMFE_BANK1(MS_VIRT u32Address, MS_U16 *val)
{
#if defined(WIN32)
