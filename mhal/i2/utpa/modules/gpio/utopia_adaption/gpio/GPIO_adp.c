...
MS_U32 GPIO_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case MDrv_CMD_GPIO_GetStauts:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_PRIVATE_STS, spt_GPIO_PRIVATE_STS,NULL,0);
            break;
        case MDrv_CMD_GPIO_Set_High:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_SET_HIGH_PARAM, spt_GPIO_SET_HIGH_PARAM,NULL,0);
            break;
        case MDrv_CMD_GPIO_Set_Low:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_SET_LOW_PARAM, spt_GPIO_SET_LOW_PARAM,NULL,0);
            break;
        case  MDrv_CMD_GPIO_Set_Input:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_SET_INPUT_PARAM, spt_GPIO_SET_INPUT_PARAM,NULL,0);
            break;
        case MDrv_CMD_GPIO_Get_Inout:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_GET_INOUT_PARAM, spt_GPIO_GET_INOUT_PARAM,NULL,0);
            break;
        case MDrv_CMD_GPIO_Get_Level:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_GET_LEVEL_PARAM, spt_GPIO_GET_LEVEL_PARAM,NULL,0);
            break;
        case  MDrv_CMD_GPIO_Attach_Interrupt:
            u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_ATTACH_PARAM, spt_GPIO_ATTACH_PARAM,NULL,0);        
            break;;
        case MDrv_CMD_GPIO_Detach_Interrupt:
		u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_DETACH_INTERRUPT_PARAM, spt_GPIO_DETACH_INTERRUPT_PARAM,NULL,0);
            break;
        case MDrv_CMD_GPIO_En_Interrupt:
		u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_ENABLE_INTERRUPT_PARAM, spt_GPIO_ENABLE_INTERRUPT_PARAM,NULL,0);
            break;
        case MDrv_CMD_GPIO_Dis_Interrupt:
		u32Ret=UADPBypassIoctl(pInstanceTmp,u32Cmd,pArgs,spt_GPIO_DISABLE_INTERRUPT_PARAM, spt_GPIO_DISABLE_INTERRUPT_PARAM,NULL,0);
            break;
