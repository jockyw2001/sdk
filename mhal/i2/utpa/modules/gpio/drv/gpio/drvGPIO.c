...
#define GPIO_DBG_INFO(x, args...)   if (_geDbfLevel >= E_GPIO_DBGLV_INFO ) \
                                        {ULOGI(TAG_GPIO, x, ##args);}
#define GPIO_DBG_ERR(x, args...)    ULOGE(TAG_GPIO, x, ##args);
...
GPIO_DbgLv _geDbfLevel = E_GPIO_DBGLV_NONE;
