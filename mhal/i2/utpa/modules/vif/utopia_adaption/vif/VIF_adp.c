...
MS_U32 VIF_adp_Ioctl(void* pInstanceTmp, MS_U32 u32Cmd, void* const pArgs)
{
    ...
    switch(u32Cmd)
    {
        ...
        case Drv_CMD_VIF_SetClock:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, bEnable, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_Init :
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_DrvVIF_VIF_INITDATA, NULL, NULL, 0);
        break;
        ...
        case Drv_CMD_VIF_SetSoundSystem:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_VIFSoundSystem, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_SetIfFreq:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_IfFrequencyType, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_Read_CR_FOE:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, NULL, spt_VIF_CopyToUser, NULL, 0);
        break;
        ...
        case Drv_CMD_VIF_SetFreqBand :
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_FrequencyBand, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_GetInputLevelIndicator :
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, NULL, spt_VIF_CopyToUser, NULL, 0);
        break;
        case Drv_CMD_VIF_SetParameter:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_DrvVIF_VIF_SETPARA, spt_DrvVIF_VIF_SETPARA, NULL, 0);
        break;
        case Drv_CMD_VIF_ShiftClk:
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, u8Value, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_SetPowerState :
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_CopyToUser, spt_VIF_CopyToUser, NULL, 0);
        break;
        case Drv_CMD_VIF_WriteByte:
             u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_SETREGVALUE, NULL, NULL, 0);
        break;
        case Drv_CMD_VIF_ReadByte :
            u32Ret = UADPBypassIoctl(pInstanceTmp, u32Cmd, pArgs, spt_VIF_SETREGVALUE, spt_VIF_SETREGVALUE, NULL, 0);
        break;
