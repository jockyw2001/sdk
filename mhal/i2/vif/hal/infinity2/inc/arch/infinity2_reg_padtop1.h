...
typedef struct {
	...
	// h000a, bit: 0
	/* reg_rgb_16b_mode*/
	#define offset_of_padtop1_reg_rgb_16b_mode (20)
	#define mask_of_padtop1_reg_rgb_16b_mode (0x1)
	unsigned int reg_rgb_16b_mode:1;

	// h000a, bit: 1
	/* reg_rgb_24b_mode*/
	#define offset_of_padtop1_reg_rgb_24b_mode (20)
	#define mask_of_padtop1_reg_rgb_24b_mode (0x2)
	unsigned int reg_rgb_24b_mode:1;

	// h000a, bit: 3
	/* reg_sata1_led_mode*/
	#define offset_of_padtop1_reg_sata1_led_mode (20)
	#define mask_of_padtop1_reg_sata1_led_mode (0xc)
	unsigned int reg_sata1_led_mode:2;

	// h000a, bit: 5
	/* reg_sata_led_mode*/
	#define offset_of_padtop1_reg_sata_led_mode (20)
	#define mask_of_padtop1_reg_sata_led_mode (0x30)
	unsigned int reg_sata_led_mode:2;

	// h000a, bit: 6
	/* reg_sd_config*/
	#define offset_of_padtop1_reg_sd_config (20)
	#define mask_of_padtop1_reg_sd_config (0x40)
	unsigned int reg_sd_config:1;

	// h000a, bit: 7
	/* reg_sdio30_mode*/
	#define offset_of_padtop1_reg_sdio30_mode (20)
	#define mask_of_padtop1_reg_sdio30_mode (0x80)
	unsigned int reg_sdio30_mode:1;

	// h000a, bit: 9
	/* reg_sdio_mode*/
	#define offset_of_padtop1_reg_sdio_mode (20)
	#define mask_of_padtop1_reg_sdio_mode (0x300)
	unsigned int reg_sdio_mode:2;

	// h000a, bit: 10
	/* reg_sec_mspi2_mode*/
	#define offset_of_padtop1_reg_sec_mspi2_mode (20)
	#define mask_of_padtop1_reg_sec_mspi2_mode (0x400)
	unsigned int reg_sec_mspi2_mode:1;

	// h000a, bit: 11
	/* reg_snr0_in_mode*/
	#define offset_of_padtop1_reg_snr0_in_mode (20)
	#define mask_of_padtop1_reg_snr0_in_mode (0x800)
	unsigned int reg_snr0_in_mode:1;

	// h000a, bit: 12
	/* reg_snr1_in_mode*/
	#define offset_of_padtop1_reg_snr1_in_mode (20)
	#define mask_of_padtop1_reg_snr1_in_mode (0x1000)
	unsigned int reg_snr1_in_mode:1;

	// h000a, bit: 13
	/* reg_snr2_in_mode*/
	#define offset_of_padtop1_reg_snr2_in_mode (20)
	#define mask_of_padtop1_reg_snr2_in_mode (0x2000)
	unsigned int reg_snr2_in_mode:1;

	// h000a, bit: 14
	/* reg_snr3_in_mode*/
	#define offset_of_padtop1_reg_snr3_in_mode (20)
	#define mask_of_padtop1_reg_snr3_in_mode (0x4000)
	unsigned int reg_snr3_in_mode:1;
