...
typedef enum {
    CSI_HDR_MODE_NONE = 0,
    CSI_HDR_MODE_SONY_290_326, //Sony DOL
    CSI_HDR_MODE_EMBEDDED_RAW8,
    CSI_HDR_MODE_EMBEDDED_RAW10,
    CSI_HDR_MODE_EMBEDDED_RAW12,
} CSI_HDR_MODE_e;
...
//void Drv_CSISetClk(CSI_CLK_DIV_e csi_mac_div, CSI_CLK_DIV_e csi_lptx_div);
extern void Drv_CSISetClk(u32 group, CSI_CLK_e clk);
extern void Drv_CSISetLane(u16 usmipi_pad, u16 lane, u8 bon_off);
//void Drv_CSISetVC0HSMode(u16 usmipi_pad, CSI_VIRTUAL_CHANNEL_e virtual_ch_num, u16 hs_mode);
extern void Drv_CSISetLongPacket(u16 usmipi_pad, u32 ctl_cfg0_15, u32 ctl_cfg16_31, u32 ctl_cfg32_47);
extern void Drv_CSISetClkDataSkip(u16 usmipi_pad, u8 rx_clk_skip_ns, u8 rx_data_skip_ns);
void Drv_CSISetHDRMode(u16 usmipi_pad, CSI_HDR_MODE_e csi_hdr_mode, u8 bon_off);
//int Drv_CSIInit(void);
//int Drv_CSIUinit(void);
//void Drv_CSIShowInts(void);
