...
//-------------------------------------------------------------------------------------------------
//E_DRVPQ_ReturnValue MDrv_Scl_PQ_GetLibVer(const MSIF_Version **ppVersion);
...
/// @return PQ_ReturnValue
//-------------------------------------------------------------------------------------------------
PQ_ReturnValue    MDrv_Scl_PQ_GetInfo(MS_PQ_INFO *pInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool           MDrv_Scl_PQ_GetStatus(MS_PQ_Status *pStatus);
/*
DEBUG MASK:
0x01;///< Debug PQ Table
0x02;///< Debug S RULE
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool           MDrv_Scl_PQ_SetDbgLevel(u16 u16DbgSwitch);
...
//-------------------------------------------------------------------------------------------------
u16 MDrv_Scl_PQ_GetSrcType(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
PQ_INPUT_SOURCE_TYPE MDrv_Scl_PQ_GetInputSourceType(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetColorRange(PQ_WIN eWindow, bool bColorRange0_255);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_SetCSC(PQ_WIN eWindow, PQ_FOURCE_COLOR_FMT enFourceColor);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Get_MemYUVFmt(PQ_WIN eWindow, PQ_FOURCE_COLOR_FMT enFourceColor);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_LoadScalingTable(PQ_WIN eWindow,
                                  u8 eScalingType,
...
/// @return TBD
//-------------------------------------------------------------------------------------------------
PQ_DEINTERLACE_MODE MDrv_Scl_PQ_SetMemFormat(PQ_WIN eWindow,
                                                bool bMemFmt422,
                                                bool bFBL,
                                                u8 *u8BitsPerPixel);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_ReduceBW_ForOSD(PQ_WIN eWindow, bool bOSD_On);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_ReduceBW_ForPVR(PQ_WIN eWindow, bool bPVR_On);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_EnableMADIForce(PQ_WIN eWindow, bool bFullMotion);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set420upsampling(PQ_WIN eWindow, bool bFBL, bool bPreV_ScalingDown, u16 u16V_CropStart);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetFilmMode(PQ_WIN eWindow, bool bEnable);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadNRTable(PQ_WIN eWindow, PQ_3D_NR_FUNCTION_TYPE en3DNRType);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadMPEGNRTable(PQ_WIN eWindow, PQ_MPEG_NR_FUNCTION_TYPE enMPEGNRType);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadDynamicContrastTable(PQ_WIN eWindow, PQ_DYNAMIC_CONTRAST_FUNCTION_TYPE enDynamicContrastType);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadFilmModeTable(PQ_WIN eWindow, PQ_FILM_MODE_FUNCTION_TYPE enFilmModeType);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Load_ULTRACLEAR_Table(PQ_WIN eWindow, PQ_FEATURE_SWITCH_TYPE enCtrlType);
...
/// @param  bEnable                       \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetNonLinearScaling(PQ_WIN eWindow, u8 u8Level, bool bEnable);

//-------------------------------------------------------------------------------------------------
/// Check settings
/// @param  eWindow                       \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_CheckSettings(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadTable(PQ_WIN eWindow, u16 u16TabIdx, u16 u16PQIPIdx);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
u16 MDrv_Scl_PQ_GetIPNum(PQ_WIN eWindow);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
u16 MDrv_Scl_PQ_GetTableNum(PQ_WIN eWindow, u16 u16PQIPIdx);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
u16 MDrv_Scl_PQ_GetCurrentTableIndex(PQ_WIN eWindow, u16 u16PQIPIdx);

//-------------------------------------------------------------------------------------------------
/// 3D pq clone,  sub win sync with main win
/// @param bIpSync                            \b IN: do Ip sync operation
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_3DCloneforPIP(bool bIpSync);
...
/// @param  bOn                         \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_DisableFilmMode(PQ_WIN eWindow, bool bOn);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
char* MDrv_Scl_PQ_GetSrcTypeName(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_DTVInfo(PQ_WIN eWindow, MS_PQ_Dtv_Info *pstPQDTVInfo);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_MultiMediaInfo(PQ_WIN eWindow, MS_PQ_MuliMedia_Info *pstPQMMInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_SetH264_OnOff(bool bEn);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_SetMM_OnOff(bool bEn);
//-------------------------------------------------------------------------------------------------
/// Set Video Decoder information
/// @param  eWindow                        \b IN: TBD
/// @param  pstPQVDInfo                    \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_VDInfo(PQ_WIN eWindow, MS_PQ_Vd_Info* pstPQVDInfo);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_ModeInfo(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info *pstPQModeInfo);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetHDMIInfo(PQ_WIN eWindow, const MS_PQ_Hdmi_Info* const pstPQHDMIInfo);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetHDMI_PC(PQ_WIN eWindow, bool bIsTrue);
...
/// @retval TBD
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_GetHDMI_PC_Status(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_DisplayType(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, PQ_WIN ePQWin);
...
/// @param  bEnable                             \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_MADiForceMotionY(PQ_WIN eWindow, bool bEnable);
...
/// @param  bEnable                             \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_MADiForceMotionC(PQ_WIN eWindow, bool bEnable);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetRFblMode(bool bEnable,bool bFilm);

//-------------------------------------------------------------------------------------------------
/// Get RFBL mode for U4 skip field mechanism
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_GetRFblMode(MS_PQ_RFBL_INFO * stInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Get_VDSampling_Info(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, PQ_VIDEOSTANDARD_TYPE eStandard, MS_PQ_VD_Sampling_Info *pInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_IOCTL(PQ_WIN eWindow, u32 u32Flag, void *pBuf, u32 u32BufSize);
...
/// @param  bEn                                 \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_Set_MLoadEn(PQ_WIN eWindow, bool bEn);
...
//-------------------------------------------------------------------------------------------------
MS_PQ_ADC_SAMPLING_TYPE MDrv_Scl_PQ_Get_ADCSampling_Info(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info *pstPQModeInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Set3D_OnOff(bool bEn);
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_DisableUCFeature(PQ_WIN eWindow);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_GetCaps(MS_PQ_CAP_INFO *pInfo);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_SetDS_OnOFF(PQ_WIN eWindow, bool bEn);

//-------------------------------------------------------------------------------------------------
/// print out table information of each IP
/// @param  enPQWin                             \b IN: TBD
//-------------------------------------------------------------------------------------------------
void MDRV_Scl_PQ_PrintLoadTableInfo(MS_PQ_PQLOADTABLE_WIN enPQWin);
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Get_RFBL_Info( PQ_WIN eWindow);
...
/// @return bool
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_CheckHDMode( PQ_WIN eWindow );

//-------------------------------------------------------------------------------------------------
/// get Interlace SD mode
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Get_Interlace_SD_mode(PQ_WIN ePQWin);
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_GRULE_Get_Support_Status(PQ_SUPPORTED_TYPE enType);
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Update_MemFormat(void);
...
/// @return NONE
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_LOW_3dQuality(bool bEnable);

//-------------------------------------------------------------------------------------------------
/// set enhance quality, for mwe demo
/// @return NONE
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_MWE_SetEnhanceQuality(void);
//-------------------------------------------------------------------------------------------------
/// restore enhance quality, for mwe demo
/// @return NONE
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_MWE_RestoreEnhanceQuality(void);
//-------------------------------------------------------------------------------------------------
/// set enhance quality, for mwe demo
/// @return NONE
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_MWE_RestoreOffQuality(void);
//-------------------------------------------------------------------------------------------------
/// set enhance quality, for mwe demo
/// @return NONE
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_MWE_SetOffQuality(void);
//-------------------------------------------------------------------------------------------------
/// Get the V size
/// @return u16 Vertical size
//-------------------------------------------------------------------------------------------------
u16 MDrv_Scl_PQ_GetVsize(void);
//-------------------------------------------------------------------------------------------------
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_SetSelectCSC(u16 u16selection, PQ_WIN ePQWin);
...
//-------------------------------------------------------------------------------------------------
void MDrv_Scl_PQ_LoadPTPTable(PQ_WIN eWindow, PQ_PTP_FUNCTION_TYPE enPTP_Type);
...
//-------------------------------------------------------------------------------------------------
#if 0 //Ryan
bool MDrv_Scl_PQ_Set_PointToPoint(XC_SETWIN_INFO *pstXC_SetWin_Info,
                               bool bEnable,
                               PQ_WIN eWindow);
#endif
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Get_PointToPoint(PQ_WIN eWindow);
...
//-------------------------------------------------------------------------------------------------
#if 0 //Ryan
bool MDrv_Scl_PQ_Check_PointToPoint_Condition(XC_SETWIN_INFO *pstXC_SetWin_Info, PQ_WIN eWindow);
#endif
...
//-------------------------------------------------------------------------------------------------
bool MDrv_Scl_PQ_Set_DisplayType_Sub(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable);
bool MDrv_Scl_PQ_Set_DisplayType_SC2_Sub(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable);
...
bool MDrv_Scl_PQ_Set_DisplayType_SC1_Main(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable);
bool MDrv_Scl_PQ_Set_DisplayType_SC2_Main(u16 u16DisplayWidth, PQ_DISPLAY_TYPE enDisplaType, bool bSkipCommTable);


bool MDrv_Scl_PQ_GetMADiFromGrule(PQ_WIN eWindow, u16 *pu16TabIdx_MADi_Motion, u16 *pu16TabIdx_MADi);
bool MDrv_Scl_PQ_GetMemFmtInGeneral(PQ_WIN eWindow,
                                            bool bMemFmt422,
                                            u16 *pu16TabIdx_MemFormat,
                                            u16 *pu16TabIdx_444To422,
                                            u16 *pu16TabIdx_422To444
                                            );
bool MDrv_Scl_PQ_GetMADiInGeneral(PQ_WIN eWindow, u16 *pu16TabIdx_MADi_Motion, u16 *pu16TabIdx_MADi);
bool MDrv_Scl_PQ_GetMADiForRFBL(PQ_WIN eWindow, bool bFBL, u16 *pu16TabIdx_MADi_Motion, u16 *pu16TabIdx_MADi);
bool MDrv_Scl_PQ_Patch2Rto4RForFieldPackingMode(PQ_WIN eWindow, u16 u16TabIdx_MADi);
bool MDrv_Scl_PQ_GetBPPInfoFromMADi(PQ_WIN eWindow,
                                              bool bMemFmt422,
                                              u16 u16TabIdx_MADi,
...
bool MDrv_Scl_PQ_ChangeMemConfigFor3D(PQ_WIN eWindow,
                                            bool bMemFmt422,
                                            u16 *pu16TabIdx_MemFormat,
                                            u16 *pu16TabIdx_444To422,
                                            u16 *pu16TabIdx_422To444,
...
bool MDrv_Scl_PQ_ForceBPPForDynamicMemFmt(PQ_WIN eWindow, bool bMemFmt422, u8 *pu8BitsPerPixel);
bool MDrv_Scl_PQ_SetFrameNumber(PQ_WIN eWindow, u16 u16TabIdx_MADi, u8 u8FrameCount);

PQ_DISPLAY_TYPE MDrv_Scl_PQ_Get_DisplayType(void);

bool MDrv_Scl_PQ_Get_Picture(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info * pstPQModeInfo, PQ_PICTURE_TYPE enType, void *pBuf);

bool MDrv_Scl_PQ_Get_Sharpness(PQ_WIN eWindow, PQ_INPUT_SOURCE_TYPE enInputSourceType, MS_PQ_Mode_Info * pstPQModeInfo, u8 *pu8Sharpness);
