...
void MDrv_Scl_PQBin_LoadTableData(u16 u16PnlIdx, u16 u16TabIdx, u16 u16PQIPIdx, MS_PQBin_Header_Info *pPQBinHeader, u8 *pTable, u16 u16TableSize);
void MDrv_Scl_PQBin_LoadTable(u16 u16PnlIdx, u16 u16TabIdx, u16 u16PQIPIdx, MS_PQBin_Header_Info *pPQBinHeader);
...
void MDrv_Scl_PQBin_LoadTableBySrcType(u16 u16PQSrcType, u16 u16PQIPIdx, u16 u16PQPnlIdx, MS_PQBin_Header_Info *pPQBinHeader);
...
u16 MDrv_Scl_PQBin_GetGRule_LevelIndex(u16 u16PnlIdx, u16 u16GRuleType, u16 u16GRuleLvlIndex, MS_PQBin_Header_Info *pPQBinHeader);
u16 MDrv_Scl_PQBin_GetGRule_IPIndex(u16 u16GRuleType, u16 u16GRuleIPIndex, MS_PQBin_Header_Info *pPQBinHeader);
u16 MDrv_Scl_PQBin_GetGRule_TableIndex(u16 u16GRuleType, u16 u16PQSrcType, u16 u16PQ_NRIdx, u16 u16GRuleIPIndex, MS_PQBin_Header_Info *pPQBinHeader);
...
void  MDrv_Scl_PQBin_SetPanelID(u8 u8PnlID, PQ_WIN ePQWin);
...
void MDrv_Scl_PQBin_CheckTableBySrcType(u16 u16PQSrcType, u16 u16PQIPIdx, u16 u16PQPnlIdx, MS_PQBin_Header_Info * pPQBinHeader);
...
bool MDrv_Scl_PQBin_LoadPictureSetting(u16 u16PnlIdx, u16 u16TabIdx, u16 u16PQIPIdx, MS_PQBin_Header_Info *pPQBinHeader, void *pTable, u16 u16TableSize);
