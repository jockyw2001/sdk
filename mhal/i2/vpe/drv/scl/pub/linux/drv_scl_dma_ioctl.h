...
#define IOCTL_SCLDMA_CREATE_INST_CONFIG_NR                 (7)  ///< The IOCTL NR definition for IOCTL_SCLDMA_SET_LOCK_CONFIG
#define IOCTL_SCLDMA_DESTROY_INST_CONFIG_NR               (8)  ///< The IOCTL NR definition for IOCTL_SCLDMA_SET_UNLOCK_CONFIG
...
#define IOCTL_SCLDMA_INST_PROCESS_CONFIG_NR             (13)  ///< The IOCTL NR definition for IOCTL_SCLDMA_SET_LOCK_CONFIG
#define IOCTL_SCLDMA_MAX_NR                             (14)  ///< The Max IOCTL NR for scldma driver
...
*/
#define IOCTL_SCLDMA_CREATE_INST_CONFIG                _IO(IOCTL_SCLDMA_MAGIC,  IOCTL_SCLDMA_CREATE_INST_CONFIG_NR)
/**
* Setup Lock Configuration of DMA. The structure of parameter is DrvSclDmaIoLockConfig_t.
*/
#define IOCTL_SCLDMA_INST_PROCESS_CONFIG                _IO(IOCTL_SCLDMA_MAGIC,  IOCTL_SCLDMA_INST_PROCESS_CONFIG_NR)

/**
* Setup Unlock configuration of DMA. The structure of parameter is DrvSclDmaIoLockConfig_t.
*/
#define IOCTL_SCLDMA_DESTROY_INST_CONFIG              _IO(IOCTL_SCLDMA_MAGIC,  IOCTL_SCLDMA_DESTROY_INST_CONFIG_NR)
/**
