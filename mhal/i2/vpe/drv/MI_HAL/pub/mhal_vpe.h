...
typedef enum
{
    ...
    E_MHAL_VPE_INPUT_MODE_REALTIME_CAM_MODE,
...
//ISP
INTERFACE MS_BOOL MHalVpeCreateIspInstance(const MHalAllocPhyMem_t *pstAlloc,const MhalVpeIspCreate_t *pstCfg,void **pCtx);
