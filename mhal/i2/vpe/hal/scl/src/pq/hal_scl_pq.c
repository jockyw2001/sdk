...
void Hal_Scl_PQ_init_riu_base(u32 u32riu_base)
{
    Scl_PQ_RIU_BASE = u32riu_base;
}

#if (PQ_ENABLE_UNUSED_FUNC)

u8 Hal_Scl_PQ_get_sync_flag(PQ_WIN ePQWin)
{
    return 0;
}


u8 Hal_Scl_PQ_get_input_vsync_value(PQ_WIN ePQWin)
{
    return (Hal_Scl_PQ_get_sync_flag(ePQWin) & 0x04) ? 1:0;
}

u8 Hal_Scl_PQ_get_output_vsync_value(PQ_WIN ePQWin)
{
    return (Hal_Scl_PQ_get_sync_flag(ePQWin) & 0x01) ? 1 : 0;
}

u8 Hal_Scl_PQ_get_input_vsync_polarity(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_memfmt_doublebuffer(PQ_WIN ePQWin, bool bEn)
{

}
#endif

void Hal_Scl_PQ_set_sourceidx(PQ_WIN ePQWin, u16 u16Idx)
{
...
void Hal_Scl_PQ_set_mem_fmt(PQ_WIN ePQWin, u16 u16val, u16 u16Mask)
{

}

void Hal_Scl_PQ_set_mem_fmt_en(PQ_WIN ePQWin, u16 u16val, u16 u16Mask)
{

}

void Hal_Scl_PQ_set_420upSample(PQ_WIN ePQWin, u16 u16value)
{

}

void Hal_Scl_PQ_set_force_y_motion(PQ_WIN ePQWin, u16 u16value)
{

}

u8 Hal_Scl_PQ_get_force_y_motion(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_force_c_motion(PQ_WIN ePQWin, u16 u16value)
{

}

u8 Hal_Scl_PQ_get_force_c_motion(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_dipf_temporal(PQ_WIN ePQWin, u16 u16val)
{
}

u16 Hal_Scl_PQ_get_dipf_temporal(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_dipf_spatial(PQ_WIN ePQWin, u16 u16val)
{
}

u8 Hal_Scl_PQ_get_dipf_spatial(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_vsp_sram_filter(PQ_WIN ePQWin, u8 u8vale)
{

}

u8 Hal_Scl_PQ_get_vsp_sram_filter(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_dnr(PQ_WIN ePQWin, u8 u8val)
{

}

u8 Hal_Scl_PQ_get_dnr(PQ_WIN ePQWin)
{
    return 0;
}


void Hal_Scl_PQ_set_presnr(PQ_WIN ePQWin, u8 u8val)
{
}

u8 Hal_Scl_PQ_get_presnr(PQ_WIN ePQWin)
{
    return 0;
}

void Hal_Scl_PQ_set_film(PQ_WIN ePQWin, u16 u16val)
{

}

u8 Hal_Scl_PQ_get_film(PQ_WIN ePQWin)
{
    return 0;
}
#endif

void Hal_Scl_PQ_set_yc_sram(u8 enID, u8 u8sramtype, void *pData)
{
...
void Hal_Scl_PQ_set_sram_color_index_table(PQ_WIN ePQWin, u8 u8sramtype, void *pData)
{
    //ToDo

}

void Hal_Scl_PQ_set_sram_color_gain_snr_table(PQ_WIN ePQWin, u8 u8sramtype, void *pData)
{

}


void Hal_Scl_PQ_set_sram_color_gain_dnr_table(PQ_WIN ePQWin, u8 u8sramtype, void *pData)
{
...
void Hal_Scl_PQ_set_sram_icc_crd_table(PQ_WIN ePQWin, u8 u8sramtype, void *pData)
{
    u16 i;
...
void _Hal_Scl_PQ_set_sram_ihc_crd_table(PQ_WIN ePQWin, u16 *pBuf, u8 u8SRAM_Idx, u16 u16Cnt)
{
    u16 i;
...
u16 Scl_PQ_SRAM1_IHC[MAX_SRAM_SIZE];
u16 Scl_PQ_SRAM2_IHC[MAX_SRAM_SIZE];
u16 Scl_PQ_SRAM3_IHC[MAX_SRAM_SIZE];
u16 Scl_PQ_SRAM4_IHC[MAX_SRAM_SIZE];

void Hal_Scl_PQ_set_sram_ihc_crd_table(PQ_WIN ePQWin, u8 u8sramtype, void *pData)
{
    ...
    for (;u16Index < SRAM_IHC_TOTAL_COUNT ; u16Index++)
    {
        ...
        {
            Scl_PQ_SRAM1_IHC[cont1++] = u32Addr[u16Index];
        }
        else if (u16Index < SRAM3_IHC_OFFSET)
        {
            Scl_PQ_SRAM2_IHC[cont2++] = u32Addr[u16Index];
        }
        else if (u16Index < SRAM4_IHC_OFFSET)
        {
            Scl_PQ_SRAM3_IHC[cont3++] = u32Addr[u16Index];
        }
        else
        {
            Scl_PQ_SRAM4_IHC[cont4++] = u32Addr[u16Index];
        }
    }

    _Hal_Scl_PQ_set_sram_ihc_crd_table(ePQWin, &Scl_PQ_SRAM1_IHC[0], 0, SRAM1_IHC_COUNT);
    _Hal_Scl_PQ_set_sram_ihc_crd_table(ePQWin, &Scl_PQ_SRAM2_IHC[0], 1, SRAM2_IHC_COUNT);
    _Hal_Scl_PQ_set_sram_ihc_crd_table(ePQWin, &Scl_PQ_SRAM3_IHC[0], 2, SRAM3_IHC_COUNT);
    _Hal_Scl_PQ_set_sram_ihc_crd_table(ePQWin, &Scl_PQ_SRAM4_IHC[0], 3, SRAM4_IHC_COUNT);

}


#if (PQ_ENABLE_UNUSED_FUNC)
u16 Hal_Scl_PQ_get_420_cup_idx(MS_420_CUP_TYPE etype)
{
    return 0xFFFF;
}

u16 Hal_Scl_PQ_get_hnonlinear_idx(MS_HNONLINEAR_TYPE etype)
{
    return 0xFFFF;
}


u16 Hal_Scl_PQ_get_madi_idx(PQ_WIN ePQWin, MS_MADI_TYPE etype)
{
    return 0xFFFF;
}
#endif
...
u16 Hal_Scl_PQ_get_sram_size(u16 u16sramtype)
{
    u16 u16ret = 0;
...
u16 Hal_Scl_PQ_get_ip_idx(MS_PQ_IP_TYPE eType)
{
    return 0xFFFF;
}


u16 Hal_Scl_PQ_get_hsd_sampling_idx(MS_HSD_SAMPLING_TYPE eType)
{
    return 0xFFFF;
}

void Hal_Scl_PQ_OPWriteOff_Enable(bool bEna)
{

}

u16 Hal_Scl_PQ_get_adc_sampling_idx(MS_ADC_SAMPLING_TYPE eType)
{
    return 0xFFFF;

}

u16 Hal_Scl_PQ_get_rw_method(PQ_WIN ePQWin)
{
    return 0;
}
...
void Hal_Scl_PQ_set_rw_method(PQ_WIN ePQWin, u16 u16method)
{
}

bool HAL_Scl_PQ_user_mode_control(void)
{
	return FALSE;
}
...
//-------------------------------------------------------------------------------------------------
void HAL_Scl_PQ_set_SelectCSC(u16 u16selection, PQ_WIN ePQWin)
{

}

u8 Hal_Scl_PQ_get_madi_fbl_mode(bool bMemFmt422,bool bInterlace)
{
    return 0;
}

u16 Hal_Scl_PQ_get_csc_ip_idx(MS_CSC_IP_TYPE enCSC)
{
    return 0;
}

u16 Hal_Scl_PQ_get_422To444_idx(MS_422To444_TYPE etype)
{

    return 0;
}

u8 Hal_Scl_PQ_get_422To444_mode(bool bMemFmt422)
{
    return 0;
}
#endif
