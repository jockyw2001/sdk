...
#define PARSING_SCLDMA_IOCOLOR(x)       (x==E_MDRV_SCLDMA_COLOR_YUV422? "422PACK" : \
                                       ...
                                       x==E_MDRV_MDWIN_COLOR_YUV420 ? "MST420" : \
                                        x==E_MDRV_MDWIN_COLOR_YUV422 ? "YUYV422" : \
                                                                  "UNKNOWN")
...
typedef enum
{
    ...
    E_MDRV_SCLDMA_ID_MDWIN,
    E_MDRV_SCLDMA_ID_LDC,
    E_MDRV_SCLDMA_ID_ROT,
...
typedef enum
{
    ...
    E_MDRV_MDWIN_COLOR_YUV420, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV420CE, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV4206CE, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV422, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV422CE, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV4226CE, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV444, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_YUV444A, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_RGB565, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_ARGB, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_ABGR, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_RGBA, ///< color format: YUVSep420
    E_MDRV_MDWIN_COLOR_BGRA, ///< color format: YUVSep420
...
typedef enum
{
     ...
     E_MDRV_SCLDMA_MEM_FRMR = 4,  ///< memory type: IMI
     E_MDRV_SCLDMA_MEM_NUM  = 5,  ///< The max number of memory type
}MDrvSclDmaMemType_e;
typedef struct
{
...
typedef enum
{
    E_MDRV_SCL_OUTPUT_PORT0,      //
    E_MDRV_SCL_OUTPUT_PORT1,      //
    E_MDRV_SCL_OUTPUT_PORT2,      //
    E_MDRV_SCL_OUTPUT_PORT3,      //
    E_MDRV_SCL_OUTPUT_MAX,        //
}MDrvSclOutputPort_e;
...
typedef  struct
{
    u64 u64PhyAddr[3];
    u32 u32Stride[3];
} MDrvSclDmaOutputBufferConfig_t;
typedef struct
{
    MDrvSclDmaOutputBufferConfig_t stBufferInfo;
    bool bEn;
    MDrvSclDmaMemType_e   enMemType;
} MDrvSclDmaOutputPortConfig_t;
...
typedef struct
{
    MDrvSclDmaOutputPortConfig_t stCfg;
    void *pvCtx;
}MDrvSclDmaProcessConfig_t;
typedef struct
{
    u16 u16DMAcount;
    u16 u16DMAH;
...
typedef struct
{
    MDrvSclDmaIdType_e enSCLDMA_ID;
    MDrvSclDmaMemType_e   enMemType;
    bool bReadDMAMode;
    void *pvCtx;
}MDrvSclDmaGetConfig_t;
...
INTERFACE bool MDrvSclDmaInstProcess(MDrvSclDmaIdType_e enSCLDMA_ID,MDrvSclDmaProcessConfig_t *pstProcess);
INTERFACE void MDrvSclDmaReSetHw(MDrvSclDmaIdType_e enSCLDMA_ID,MDrvSclDmaClkConfig_t *stclkcfg);
...
INTERFACE void MDrvSclDmaGetDmaInformationByClient(MDrvSclDmaGetConfig_t *stGetCfg,MDrvSclDmaAttrType_t *stSendToIOCfg);
