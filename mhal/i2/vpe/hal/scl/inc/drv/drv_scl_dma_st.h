...
#define DoubleBufferStatus                  DoubleBufferDefaultSet
#define ENABLE_RING_IMI                      1
#define ENABLE_ACTIVEID_ISR                 0
#define ENABLE_CMDQ_ISR         0
...
typedef enum
{
    ...
    E_DRV_SCLDMA_4_FRM_W = 8,
    E_DRV_SCLDMA_4_FRM_R = 9,
    E_DRV_SCLDMA_3_IMI_R = 10,
...
typedef enum
{
    E_DRV_SCLDMA_MDWIN_INPUT_RGB = 0,
    E_DRV_SCLDMA_MDWIN_INPUT_YUV,
    E_DRV_SCLDMA_MDWIN_INPUT_TYPE,
}DrvSclDmaMdwinInputFormatType_e;

typedef enum
{
    E_DRV_SCLDMA_BUF_MD_RING,//I2 not support
    E_DRV_SCLDMA_BUF_MD_SINGLE,
    E_DRV_SCLDMA_BUF_MD_SWRING,//I2 not support
...
typedef enum
{
    ...
    E_DRV_MDWIN_COLOR_YUV420, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV420CE, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV4206CE, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV422, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV422CE, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV4226CE, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV444, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_YUV444A, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_RGB565, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_ARGB, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_ABGR, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_RGBA, ///< color format: YUVSep420
    E_DRV_MDWIN_COLOR_BGRA, ///< color format: YUVSep420
...
typedef enum
{
    E_DRV_SCLDMA_OUTPUT_PORT0,      //
    E_DRV_SCLDMA_OUTPUT_PORT1,      //
    E_DRV_SCLDMA_OUTPUT_PORT2,      //
    E_DRV_SCLDMA_OUTPUT_PORT3,      //
    E_DRV_SCLDMA_OUTPUT_MAX,        //
}DrvSclDmaOutputPort_e;
...
typedef  struct
{
    u64 u64PhyAddr[3];
    u32 u32Stride[3];
} DrvSclDmaOutputBufferConfig_t;
typedef struct
{
    DrvSclDmaOutputBufferConfig_t stBufferInfo;
    bool bEn;
    DrvSclDmaRwModeType_e enRWMode;
} DrvSclDmaOutputPortConfig_t;

/**
*  The Process for SCLDMA
*/
typedef struct
{
    DrvSclDmaOutputPortConfig_t stCfg;
    void *pvCtx;
}DrvSclDmaProcessConfig_t;
...
typedef struct
{
    ...
    u32 u32LineOffset_en[E_DRV_SCLDMA_CLIENT_NUM];
    u32 u32LineOffset_Y[E_DRV_SCLDMA_CLIENT_NUM];
    u32 u32Matchline[E_DRV_SCLDMA_CLIENT_NUM][2];
    bool bHFilp[E_DRV_SCLDMA_CLIENT_NUM];
    bool bVFilp[E_DRV_SCLDMA_CLIENT_NUM];
}DrvSclDmaInfoType_t;
typedef struct
{
    u16 u16DMAcount;
