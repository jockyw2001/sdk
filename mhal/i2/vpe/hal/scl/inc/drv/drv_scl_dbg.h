...
typedef enum
{
    ...
    EN_DBGMG_CTX_CONFIG  = 7,
    EN_DBGMG_VPESCL_CONFIG   = 8,
    EN_DBGMG_VPEIQ_CONFIG   = 9,
    EN_DBGMG_DRVHVSP_CONFIG     = 10,
    EN_DBGMG_DRVSCLDMA_CONFIG   = 11,
    EN_DBGMG_DRVSCLIRQ_CONFIG   = 12,
    EN_DBGMG_CMDQ_CONFIG     = 13,
    EN_DBGMG_DRVVIP_CONFIG      = 14,
    EN_DBGMG_PRIORITY_CONFIG    = 15,
    EN_DBGMG_UTILITY_CONFIG     = 16,
    EN_DBGMG_DRVSCLMGWIN_CONFIG = 17,
    EN_DBGMG_VPEISP_CONFIG   =18,
    EN_DBGMG_NUM_CONFIG         = 19,
...
typedef enum
{
    EN_DBGMG_SCLIRQLEVELSI_NORMAL     = 0x1,
    EN_DBGMG_SCLIRQLEVELSI_AFF   = 0x2,
    EN_DBGMG_SCLIRQLEVELSI_VSYNC   = 0x4,
    EN_DBGMG_SCLIRQLEVELSI_SCDONE  = 0x8,
    EN_DBGMG_SCLIRQLEVELSI_ISPDONE   = 0x10,
    EN_DBGMG_SCLIRQLEVELSI_HIST   = 0x20,
    EN_DBGMG_SCLIRQLEVELSI_MATCH  = 0x40,
    EN_DBGMG_SCLIRQLEVELSI_ELSE       = 0x80,
}EN_DBGMG_SCLIRQLEVELSI_TYPE;
typedef enum
{
...
typedef enum
{
    EN_DBGMG_CTX_INIT  = 0x1,
    EN_DBGMG_CTX_LOW  = 0x2,
    EN_DBGMG_CTX_HIGH  = 0x4,
    EN_DBGMG_CTX_ELSE = 0x8,
}EN_DBGMG_CTX_TYPE;
typedef enum
{
    EN_DBGMG_UTILITY_INIT  = 0x1,
    EN_DBGMG_UTILITY_LOW  = 0x2,
    EN_DBGMG_UTILITY_HIGH  = 0x4,
    EN_DBGMG_UTILITY_FLIP = 0x8,
}EN_DBGMG_UTILITY_TYPE;
...
extern bool gbdbgmessage[EN_DBGMG_NUM_CONFIG];
...
#define SCL_DBG_LV_DRVCMDQ()            (gbdbgmessage[EN_DBGMG_CMDQ_CONFIG])
#define SCL_DBG_LV_DRVPQ()              (gbdbgmessage[EN_DBGMG_DRVPQ_CONFIG])
#define SCL_DBG_LV_UTILITY()            (gbdbgmessage[EN_DBGMG_UTILITY_CONFIG])
#define SCL_DBG_LV_DRVSCLMGWIN()        (gbdbgmessage[EN_DBGMG_DRVSCLMGWIN_CONFIG])

#define SCL_DBG_LV_MULTI_INST_ERR       1
#define SCL_DBG_LV_CTX_CONFIG()   (gbdbgmessage[EN_DBGMG_CTX_CONFIG])
#define SCL_DBG_LV_VPESCL()    (gbdbgmessage[EN_DBGMG_VPESCL_CONFIG])
#define SCL_DBG_LV_VPEIQ()    (gbdbgmessage[EN_DBGMG_VPEIQ_CONFIG])
#define SCL_DBG_LV_VPEISP()    (gbdbgmessage[EN_DBGMG_VPEISP_CONFIG])
#define SCL_DBG_LV_MULTI_INST_LOCK_LOG  (0)

//move from Ms_Dbg.h
#define ENABLE_HVSP_UNUSED_FUNCTION     0
#define ENABLE_PNL_UNUSED_FUNCTION      0
#define ENABLE_SCLDMA_UNUSED_FUNCTION   0
#define ENABLE_VIP_UNUSED_FUNCTION      0
#define ENABLE_PQ_UNUSED_FUNCTION       0
...
({\
    ...
    else if(scldmaid == 2||scldmaid == 3||scldmaid == 4)\
    {\
