...
#define MDRV_SCLVIP_ROI_WINDOW_MAX 4
#define MDRV_SCLVIP_WDR_HIST_BUFFER 4
...
typedef enum
{
    ...
    E_MDRV_SCLVIP_SETROI_CONFIG        = 0x40000,  ///< DNR
...
typedef enum
{
    ...
    E_MDRV_SCLVIP_AIP_WDR,               ///< wdr
    E_MDRV_SCLVIP_AIP_VD,                ///< vd
    E_MDRV_SCLVIP_AIP_ARBSHP,            ///< arbshp
    E_MDRV_SCLVIP_AIP_RGBTOYUV,          ///< rgb2yuv
    E_MDRV_SCLVIP_AIP_444TO422,          ///< 4442422
    E_MDRV_SCLVIP_AIP_FORVPECFG,         ///< For Vpe Cfg
    E_MDRV_SCLVIP_AIP_FORVPEONOFF,       ///< For Vpe OnoOff
    E_MDRV_SCLVIP_AIP_FORVPEPROCESS,     ///< For Vpe OnoOff
    E_MDRV_SCLVIP_AIP_FORVPEPROCESSNE,   ///< For Vpe OnoOff
...
typedef enum
{
    ...
    E_MDRV_SCLVIP_AIP_SRAM_WDR, ///< wdr  sensor
    E_MDRV_SCLVIP_AIP_SRAM_WDR_TBL, ///< wdr 33x2 NL,33/2Sat,33x2Fmap,33x2alpha,33x2L
}MDrvSclVipAipSramType_e;
typedef enum
{
    E_MDRV_SCLVIP_ROISRC_BEFORE_WDR,      //
    E_MDRV_SCLVIP_ROISRC_AFTER_WDR,      //
    E_MDRV_SCLVIP_ROISRC_WDR,        //
    E_MDRV_SCLVIP_ROISRC_TYPE,        //
}MDrvSclVipWdrRoiSrcType_e;
typedef enum
{
    E_MDRV_SCLVIP_MASK_WDR,      //
    E_MDRV_SCLVIP_MASK_NR,      //
    E_MDRV_SCLVIP_MASK_TYPE,      //
}MDrvSclVipMaskType_e;
typedef enum
{
    E_MDRV_SCLVIP_MCNR_YCM_R  = 0x1,    ///< IP only read
    E_MDRV_SCLVIP_MCNR_YCM_W  = 0x2,    ///< IP only write
    E_MDRV_SCLVIP_MCNR_YCM_RW = 0x3,    ///< IP R/W
    E_MDRV_SCLVIP_MCNR_NON = 0x10,    ///< IP none open
}MDrvSclVipMcnrType_e;

typedef enum
{
    E_MDRV_SCLVIP_UCMCE_OFF,      //
    E_MDRV_SCLVIP_UCMCE_8,      //
    E_MDRV_SCLVIP_UCMCE_6,      //
    E_MDRV_SCLVIP_UCMCE_TYPE,      //
}MDrvSclVipUCMCEType_e;
...
typedef struct
{
    ...
    u16 u16RoiAccX[4];
    u16 u16RoiAccY[4];
}MDrvSclVipWdrRoiConfig_t;
typedef struct
{
    bool bEn;
    u8 u8WinCount;
    MDrvSclVipWdrRoiSrcType_e enPipeSrc;
    MDrvSclVipWdrRoiConfig_t stRoiCfg[MDRV_SCLVIP_ROI_WINDOW_MAX];
    u32 u32BaseAddr[MDRV_SCLVIP_ROI_WINDOW_MAX];
}MDrvSclVipWdrRoiHist_t;
typedef struct
{
    bool bOnOff;                     ///< Base Address of AIP SRAM setting
    MDrvSclVipMaskType_e enMaskType; ///< Mask type
}MDrvSclVipSetMaskOnOff_t;
typedef struct
{
    s32 s32Y[MDRV_SCLVIP_ROI_WINDOW_MAX];
    s32 s32R[MDRV_SCLVIP_ROI_WINDOW_MAX];
    s32 s32G[MDRV_SCLVIP_ROI_WINDOW_MAX];
    s32 s32B[MDRV_SCLVIP_ROI_WINDOW_MAX];
    s32 s32YCnt[MDRV_SCLVIP_ROI_WINDOW_MAX];
}MDrvSclVipWdrRoiReport_t;
typedef struct
{
    MDrvSclVipMcnrType_e enRW;
    MDrvSclVipUCMCEType_e enCeType;
    u32 u32YCMPhyAddr;
    u16 u16Width;
    u16 u16Height;
    u32  u32MemSize;
    void *pvCtx;
}MDrvSclVipIpmConfig_t;
...
typedef struct
{
    ...
    MDrvSclVipWdrRoiHist_t stRoi;               ///< WdrRoi
...
{
    u32 u32WdrMloadBuf;
    u32 u32VirWdrMloadBuf;
}MDrvSclCtxMvipGlobalSet_t;
