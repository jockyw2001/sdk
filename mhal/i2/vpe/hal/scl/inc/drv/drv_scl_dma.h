...
INTERFACE void DrvSclDmaReSetHw(DrvSclDmaIdType_e enSCLDMA_ID,DrvSclDmaClkConfig_t *stclk);
...
INTERFACE bool DrvSclDmaInstProcess(DrvSclDmaIdType_e enSCLDMA_ID,DrvSclDmaProcessConfig_t *pstProcess);
...
INTERFACE bool DrvSclDmaGetDmaInformationByClient
    (DrvSclDmaIdType_e enSCLDMA_ID,DrvSclDmaRwModeType_e enRWMode,DrvSclDmaAttrType_t *stAttr);
