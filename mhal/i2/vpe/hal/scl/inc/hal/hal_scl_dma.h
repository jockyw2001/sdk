...
INTERFACE void HalSclDmaSetMdwinInputFormat(DrvSclDmaMdwinInputFormatType_e enType);
INTERFACE void HalSclDmaSetMdwinYCSwap(bool bEn);
INTERFACE void   HalSclDmaSetSC1ToSC2HandshakeForce(bool bEn);
INTERFACE void HalSclDmaSetSC1ToSC3HandshakeForce(bool bEn);
INTERFACE void HalSclDmaSetSC4HandshakeForce(bool bEn);
...
INTERFACE void HalSclDmaReSetHw(void);
INTERFACE void HalSclDmaSetDmaOff(bool bptgen,bool bEnImi);
...
INTERFACE void HalSclDmaSetSC1DMABufferConfig(DrvSclDmaRwModeType_e enRWMode,DrvSclDmaOutputBufferConfig_t *stBufCfg,bool bEnLineOffset);
INTERFACE void   HalSclDmaSetSC2DMAEn(DrvSclDmaRwModeType_e enRWMode, bool bEn);
INTERFACE void HalSclDmaSetSC2DMABufferConfig(DrvSclDmaRwModeType_e enRWMode,DrvSclDmaOutputBufferConfig_t *stBufCfg,bool bEnLineOffset);
INTERFACE void   HalSclDmaSetSC2DMAConfig(DrvSclDmaRwConfig_t *stSCLDMACfg);
INTERFACE void HalSclDmaSetSC3DMABufferConfig(DrvSclDmaRwModeType_e enRWMode,DrvSclDmaOutputBufferConfig_t *stBufCfg,bool bEnLineOffset);
INTERFACE void HalSclDmaSetSC4MDwinBufferConfig(DrvSclDmaRwModeType_e enRWMode,DrvSclDmaOutputBufferConfig_t *stBufCfg);
INTERFACE void   HalSclDmaSetSC3DMAEn(DrvSclDmaRwModeType_e enRWMode, bool bEn);
INTERFACE void HalSclDmaSetSC4DMAEn(DrvSclDmaRwModeType_e enRWMode, bool bEn);
...
INTERFACE bool HalSclDmaSetOutputMatchline(DrvSclDmaClientType_e enClientType,u16 u16LineCnt1,u16 u16LineCnt2);
