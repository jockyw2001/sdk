...
#ifndef _HAL_CMDQ_REG_H_
#define _HAL_CMDQ_REG_H_
...
#define NUMBER_OF_CMDQ_HW         0x1
#else

#define NUMBER_OF_CMDQ_HW         0x5
#endif

typedef struct _REG32
{
    volatile u16                   L;
    volatile u16                   empty_L;
    volatile u16                   H;
    volatile u16                   empty_H;
} REG32;
...
#define CMDQ_RST_CMD_ST_PTR_TRIG      0x00040000UL       //0x03 bit:2 increament reset start
...
#define CMDQ_EN_TRIG_SAMPLE           0x00040000UL       //0x23 bit:2 enable trigger sample
...
#define TOUT_DO_NOT_JUMP              0xFF0FFFFFUL       //0x29 bit7: reg_tout_jump_cmd_en
...
#define CMDQ_SOFT_RSTZ                0x00000000UL       //0x31 bit:8
#define CMDQ_SOFT_RSTZ_BIT            0x00010000UL       //0x31 bit:8
...
#define CMDQ_READ_IDLE_DONE           0x08000000UL       //0x45 bit:11 IDLE cmdq done
...
#define CMDQ_DUMMY_WRITE_ZERO         0x00000000UL       //0x78 bit:0~7


#define CMDQ_DUMMY_REG_OFFSET              0x78
#define CMDQ_HWDUMMY_REG_OFFSET            0x76
#define CMDQ_TRIBUS_CLR_REG_OFFSET         0x54

typedef struct _REG_CMDQCtrl
{
    REG32            CMDQ_Enable;                            //0x01 & 0x00 0
    REG32            CMDQ_Trig_Mode;                         //0x03 & 0x02 4
    ...
    REG32            CMDQ_4f_4e;                             //0x4f ~ 0x4e
    REG32            CMDQ_Trig_Bus_Final_Irq;                //0x51 ~ 0x50
    REG32            CMDQ_Trig_Bus_Force_Mask;               //0x53 ~ 0x52
    REG32            CMDQ_Trig_Bus_Irq_Clr;                  //0x55 ~ 0x54
    REG32            CMDQ_75_56[16];                         //0x75 ~ 0x4e
