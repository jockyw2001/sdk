...
#define DRV_PMBR_LUT_QP             0
#define DRV_PMBR_LUT_TARGET         1
#define DRV_PMBR_LUT_LAMBDA_SCALED  2
#define DRV_PMBR_LUT_AIIDCHIST      3
#define DRV_PMBR_LUT_NUM            4

typedef union pmbr_conf
{
    enum drv_pmbr_cfg_e
    {
        DRV_PMBR_CFG_SEQ = 0,
    ...
    struct
    {
        ...
        int                 i_ctuw;     /* CTU Width */
        int                 i_ctuh;     /* CTU Height */
    } seq;
    ...
    struct
    {
        enum drv_pmbr_cfg_e i_type;     //!< MUST BE "DRV_PMBR_CFG_LUT"
        unsigned int*       p_kptr[DRV_PMBR_LUT_NUM];
        int                 i_size[DRV_PMBR_LUT_NUM];
    } lut;

    struct
    {
        enum drv_pmbr_cfg_e i_type;     //!< MUST BE "DRV_PMBR_CFG_FRM"
        int                 i_cb_qp_offset;   /* PPS Cb QP Offset */
        int                 i_cr_qp_offset;   /* PPS Cr QP Offset */
    } frm;
} pmbr_conf;
