...
#include "osalNJPD.h"
#include "drvNJPD.h"
#include "../../hal/inc/regNJPD.h"
#include "../../hal/inc/halNJPD.h"
...
MS_BOOL MDrv_NJPD_SetReadBuffer_New(MS_PHY u32BufAddr, MS_U32 u32BufSize, MS_PHY u32BufStartAddr)
{
    ...
    if(HAL_NJPD_EXT_IsEnable8G())
    {
        HAL_NJPD_EXT_SetMRCBuf0_Start_8G_0(u32MRC0_Start[eNJPDNum] & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf0_Start_8G_1((u32MRC0_Start[eNJPDNum] >> 16) & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf0_Start_8G_2(((MS_U64)u32MRC0_Start[eNJPDNum]) >> 32);
        HAL_NJPD_EXT_SetMRCBuf0_End_8G_0(u32MRC0_End[eNJPDNum] & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf0_End_8G_1((u32MRC0_End[eNJPDNum] >> 16) & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf0_End_8G_2(((MS_U64)u32MRC0_End[eNJPDNum]) >> 32);
        HAL_NJPD_EXT_SetMRCBuf1_Start_8G_0(u32MRC1_Start[eNJPDNum] & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf1_Start_8G_1((u32MRC1_Start[eNJPDNum] >> 16) & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf1_Start_8G_2(((MS_U64)u32MRC1_Start[eNJPDNum]) >> 32);
        HAL_NJPD_EXT_SetMRCBuf1_End_8G_0(u32MRC1_End[eNJPDNum] & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf1_End_8G_1((u32MRC1_End[eNJPDNum] >> 16) & 0xffffUL);
        HAL_NJPD_EXT_SetMRCBuf1_End_8G_2(((MS_U64)u32MRC1_End[eNJPDNum]) >> 32);
    }
    else
#endif
    {
