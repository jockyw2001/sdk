...
typedef enum
{
    ...
    WARP_DEV_PROC_STATE_MATRIX_VALUES_ERROR         = 0x1003,
    WARP_DEV_PROC_STATE_OP_ERROR                    = 0x1004,
    WARP_DEV_PROC_STATE_OUT_OF_MEMORY               = 0x1005,
    WARP_DEV_PROC_STATE_HW_UNAVAILABLE              = 0x1006,
    WARP_DEV_PROC_STATE_MEMORY_FAILURE              = 0x1007,
    WARP_DEV_PROC_STATE_BUSY                        = 0x1008,
    WARP_DEV_PROC_STATE_PROC_CONFIG_ERROR           = 0x1009,
    WARP_DEV_PROC_STATE_CLK_ERROR                   = 0x100a,
    WARP_DEV_PROC_STATE_DISP_MAP_CALC_ERROR        = 0x100b
