...
//-----------------------------------------------------------------------------------------------
#define DSI_REG_BASE        0x1A1A00UL
#define DSI_REG_BASE_2      0x343400UL
#define DSI_CMDQ_BASE       0x1A1B00UL
#define DSI_CMDQ_BASE_2     0x343600UL

//-----------------------------------------------------------------------------------------------

#define REG_DSI_START    0x0000         //DSI Start Register
     #define DSI_VM_CMD_START           BIT16
     #define DSI_SKEWCAL_START          BIT4
     #define DSI_SLEEPOUT_START         BIT2
     #define DSI_DSI_START              BIT0
...
#define REG_DSI_STATUS    0x0004        //DSI Status Register
    #define DSI_CONTENTION_ERR          BIT7
     #define DSI_FALSE_CTRL_ERR         BIT6
     #define DSI_ESC_SYNC_ERR           BIT5
     #define DSI_ESC_ENTRY_ERR          BIT4
     #define DSI_BUFFER_UNDERRUN        BIT1
     //Contention error
...
#define REG_DSI_INTEN    0x0008             //DSI Interrupt Enable Register
    #define DSI_SKEWCAL_DONE_INT_EN         BIT11
     #define DSI_VM_VFP_STR_INT_EN          BIT10
     #define DSI_VM_VACT_STR_INT_EN         BIT9
     #define DSI_VM_VBP_STR_INT_EN          BIT8
     #define DSI_TE_TIMEOUT_INT_EN          BIT7
     #define DSI_SLEEPOUT_DONE_INT_EN       BIT6
     #define DSI_VM_CMD_DONE_INT_EN         BIT5
     #define DSI_FRAME_DONE_INT_EN          BIT4
     #define DSI_VM_DONE_INT_EN             BIT3
     #define DSI_TE_RDY_INT_EN              BIT2
     #define DSI_CMD_DONE_INT_EN            BIT1
     #define DSI_LPRX_RD_RDY_INT_EN         BIT0
...
#define REG_DSI_INTSTA    0x000C            //DSI Interrupt Status Register
    #define DSI_DSI_BUSY                    BIT31
    #define DSI_SKEWCAL_DONE_INT_FLAG       BIT11
    #define DSI_VM_VFP_STR_INT_FLAGN        BIT10
    #define DSI_VM_VACT_STR_INT_FLAG        BIT9
    #define DSI_VM_VBP_STR_INT_FLAG         BIT8
    #define DSI_TE_TIMEOUT_INT_FLAG         BIT7
    #define DSI_SLEEPOUT_DONE_INT_FLAG      BIT6
    #define DSI_VM_CMD_DONE_INT_FLAG        BIT5
    #define DSI_FRAME_DONE_INT_FLAG         BIT4
    #define DSI_VM_DONE_INT_FLAG            BIT3
    #define DSI_TE_RDY_INT_FLAG             BIT2
    #define DSI_CMD_DONE_INT_FLAG           BIT1
    #define DSI_LPRX_RD_RDY_INT_FLAG        BIT0
...
#define REG_DSI_COM_CON     0x0010  //DSI Common Control Register
    #define DSI_DSI_DUAL_EN         BIT4
    #define DSI_DPHY_RESET          BIT2
    #define DSI_DSI_RESET           BIT0
...
#define REG_DSI_MODE_CON 0x0014                 //DSI Mode Control Register
    #define DSI_SLEEP_MODE                      BIT20
     #define DSI_C2V_SWITCH_ON                  BIT19
     #define DSI_V2C_SWITCH_ON                  BIT18
     #define DSI_MIX_MODE                       BIT17
     #define DSI_FRAME_MODE                     BIT16
     #define DSI_MODE_CON_CMD                   BITS(1:0,0)
     #define DSI_MODE_CON_VID_SYNC_PULSE        BITS(1:0,1)
     #define DSI_MODE_CON_VID_SYNC_EVENT        BITS(1:0,2)
     #define DSI_MODE_CON_BURST                 BITS(1:0,3)
     #define DSI_MODE_MASK                      BITMASK(1:0)
...
#define REG_DSI_TXRX_CON 0x0018             //DSI TX RX Control Register
    #define DSI_RGB_PKT_CNT                 BITMASK(27:24)
     #define DSI_EXT_TE_TIME_VM             BITMASK(23:20)
     #define DSI_TE_TIMEOUT_CHK_EN          BIT19
     #define DSI_TE_WITH_CMD_EN             BIT18
     #define DSI_TYPE1_BTA_SEL              BIT17
     #define DSI_HSTX_CKLP_EN               BIT16
     #define DSI_MAX_RTN_SIZE               BITMASK(15:12)
     #define DSI_TE_AUTO_SYNC               BIT11
     #define DSI_EXT_TE_EDGE_SEL            BIT10
     #define DSI_EXT_TE_EN                  BIT9
     #define DSI_TE_FREERUN                 BIT8
     #define DSI_HSTX_BLLP_EN               BIT7
     #define DSI_HSTX_DIS_EOT               BIT6
     #define DSI_LANE_NUM                   BITMASK(5:2)
     #define DSI_VC_NUM                     BITMASK(1:0)
...
#define REG_DSI_PSCON 0x001C            //DSI Pixel Stream Control Register
    #define DSI_BYTE_SWAP               BIT25
     #define DSI_RGB_SWAP               BIT24
     #define DSI_DSI_PS_SEL             BITMASK(17:16)
     #define DSI_TDSI_PS_WC             BITMASK(13:0)
...
#define REG_DSI_LFR_CON 0x0030          //DSI Low Frame Rate Control Register
    #define DSI_LFR_SKIP_NUM            BITMASK(13:8)
    #define DSI_LFR_VSE_DIS             BIT6
    #define DSI_LFR_UPDATE              BIT5
    #define DSI_LFR_EN                  BIT4
    #define DSI_LFR_TYPE                BITMASK(3:2)
    #define DSI_LFR_MODE                BITMASK(1:0)
...
#define REG_DSI_LFR_STA 0x0034          //DSI Low Frame Rate Status Register
    #define DSI_LFR_SKIP_STA            BIT8
    #define DSI_LFR_SKIP_CNT            BITMASK(5:0)
...
#define REG_DSI_HSA_WC 0x0050       //DSI Horizontal Sync Active Word Count Register
    #define DSI_HSA_WC              BITMASK(11:0)
...
#define REG_DSI_HBP_WC 0x0054       //DSI Horizontal Back Porch Word Count Register
    #define DSI_HBP_WC              BITMASK(11:0)
...
#define REG_DSI_HFP_WC 0x0058        //DSI Horizontal Front Porch Word Count Register
    #define DSI_HFP_WC               BITMASK(11:0)
...
#define REG_DSI_BLLP_WC 0x005C      //DSI Horizontal Blanking or Low Power Mode Word Count Register
    #define DSI_BLLP_WC             BITMASK(11:0)
...
#define REG_DSI_HSTX_CKLP_WC_AUTO_RESULT    0x0068  //DSI HSTX Clock Low-power Mode Automatic Calculation result
    #define DSI_HSTX_CKLP_WC_AUTO_RESULT            BITMASK(15:0)
...
#define REG_DSI_RX_DATA03    0x0074     //DSI Receive Packet Data Byte 0 ~ 3 Register
    #define DSI_RX_BYTE3                BITMASK(31:24)
    #define DSI_RX_BYTE2                BITMASK(23:16)
    #define DSI_RX_BYTE1                BITMASK(15:8)
    #define DSI_RX_BYTE0                BITMASK(7:0)

#define REG_DSI_RX_DATA47    0x0078     //DSI Receive Packet Data Byte 4 ~ 7 Register
    #define DSI_RX_BYTE7                BITMASK(31:24)
    #define DSI_RX_BYTE6                BITMASK(23:16)
    #define DSI_RX_BYTE5                BITMASK(15:8)
    #define DSI_RX_BYTE4                BITMASK(7:0)

#define REG_DSI_RX_DATA8B    0x007C     //DSI Receive Packet Data Byte 8 ~ 11 Register
    #define DSI_RX_BYTEB                BITMASK(31:24)
    #define DSI_RX_BYTEA                BITMASK(23:16)
    #define DSI_RX_BYTE9                BITMASK(15:8)
    #define DSI_RX_BYTE8                BITMASK(7:0)

#define REG_DSI_RX_DATAC    0x0080      //DSI Receive Packet Data Byte 12 ~ 15 Register
    #define DSI_RX_BYTEF                BITMASK(31:24)
    #define DSI_RX_BYTEE                BITMASK(23:16)
    #define DSI_RX_BYTED                BITMASK(15:8)
    #define DSI_RX_BYTEC                BITMASK(7:0)

#define REG_DSI_RX_RACK    0x0084       //DSI Read Data Acknowledge Register
    #define DSI_RACK_BYPASS             BIT1
    #define DSI_RACK                    BIT0
...
#define REG_DSI_RX_TRIG_STA    0x0088       //DSI Receiver Status Register
    #define DSI_RX_POINTER                  BITMASK(11:8)
    #define DSI_RX_LPDT                     BIT6
    #define DSI_DIRECTION                   BIT5
    #define DSI_RX_ULPS                     BIT4
    #define DSI_RX_TRIG_3                   BIT3
    #define DSI_RX_TRIG_2                   BIT2
    #define DSI_RX_TRIG_1                   BIT1
    #define DSI_RX_TRIG_0                   BIT0
...
#define REG_DSI_TIME_CON0    0x00A0     //DSI Timing Control 0 Register
    #define DSI_SKEWCAL_PRD             BITMASK(31:16)
    #define DSI_ULPS_WAKEUP_PRD         BITMASK(15:0)
...
#define REG_DSI_TIME_CON1    0x00A4         //DSI Timing Control 1 Register
    #define DSI_PREFETCH_EN                 BIT31
    #define DSI_PREFETCH_TIME               BITMASK(30:16)
    #define DSI_TE_TIMEOUT_PRD              BITMASK(15:0)
...
#define REG_DSI_PHY_LCPAT    0x0100         //DSI PHY Lane Clock Pattern Register
    #define DSI_LC_HSTX_CK_PAT              BITMASK(7:0)
...
#define REG_DSI_PHY_LCCON    0x0104         //DSI PHY Lane Clock Control Register
    #define DSI_LC_WAKEUP_EN                BIT2
    #define DSI_LC_ULPM_EN                  BIT1
    #define DSI_LC_HSTX_EN                  BIT0
...
#define REG_DSI_PHY_LD0CON    0x0108    //DSI PHY Lane 0 Control Register
    #define DSI_L0_RX_FILTER_EN         BIT4
    #define DSI_LX_ULPM_AS_L0           BIT3
    #define DSI_L0_WAKEUP_EN            BIT2
    #define DSI_L0_ULPM_EN              BIT1
    #define DSI_L0_RM_TRIG_EN           BIT0
...
#define REG_DSI_PHY_SYNCON    0x010C            //DSI PHY Sync Control Register
    #define DSI_HS_DB_SYNC_EN                   BIT24
    #define DSI_HS_SKEWCAL_PAT                  BITMASK(23:16)
    #define DSI_HS_SYNC_CODE2                   BITMASK(15:8)
    #define DSI_HS_SYNC_CODE                    BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON0    0x0110       //DSI PHY Timing Control 0 Register
    #define DSI_DA_HS_TRAIL                 BITMASK(31:24)
    #define DSI_DA_HS_ZERO                  BITMASK(23:16)
    #define DSI_DA_HS_PREP                  BITMASK(15:8)
    #define DSI_LPX                         BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON1    0x0114       //DSI PHY Timing Control 1 Register
    #define DSI_DA_HS_EXIT                  BITMASK(31:24)
    #define DSI_TA_GET                      BITMASK(23:16)
    #define DSI_TA_SURE                     BITMASK(15:8)
    #define DSI_TA_GO                       BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON2    0x0118       //DSI PHY Timing Control 2 Register
    #define DSI_CLK_HS_TRAIL                BITMASK(31:24)
    #define DSI_CLK_HS_ZERO                 BITMASK(23:16)
    #define DSI_DA_HS_SYNC                  BITMASK(15:8)
    #define DSI_CONT_DET                    BITMASK(7:0)
...
#define REG_DSI_PHY_TIMCON3    0x011C    //DSI PHY Timing Control 3 Register
    #define DSI_CLK_HS_EXIT                BITMASK(23:16)
    #define DSI_CLK_HS_POST                BITMASK(15:8)
    #define DSI_CLK_HS_PREP                BITMASK(7:0)
...
#define REG_DSI_VM_CMD_CON    0x0130    //DSI Video Mode Command Packet Control Register
    #define DSI_CM_DATA_1               BITMASK(31:24)
    #define DSI_CM_DATA_0               BITMASK(23:16)
    #define DSI_CM_DATA_ID              BITMASK(15:8)
    #define DSI_TS_VFP_EN               BIT5
    #define DSI_TS_VBP_EN               BIT4
    #define DSI_TS_VSA_EN               BIT3
    #define DSI_TIME_SEL                BIT2
    #define DSI_LONG_PKT                BIT1
    #define DSI_VM_CMD_EN               BIT0
...
#define REG_DSI_VM_CMD_DATA0    0x0134      //DSI Video Mode Command Packet Data Byte 0~3 Register
    #define DSI_LONG_PKT_WORD03             BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATA4    0x0138      //DSI Video Mode Command Packet Data Byte 4~7 Register
    #define DSI_LONG_PKT_WORD47             BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATA8    0x013C      //DSI Video Mode Command Packet Data Byte 8~11 Register
    #define DSI_LONG_PKT_WORD8B             BITMASK(31:0)
...
#define REG_DSI_VM_CMD_DATAC    0x0140      //DSI Video Mode Command Packet Data Byte 12~15 Register
    #define DSI_LONG_PKT_WORDCF             BITMASK(31:0)
...
#define REG_DSI_CKSM_OUT    0x0144          //DSI Checksum Output
    #define DSI_ACC_CHKSUM                  BITMASK(31:16)
    #define DSI_PKT_CHKSUM                  BITMASK(15:0)
...
#define REG_DSI_STATE_DBG0    0x0148        //DSI State Machine Debug 0
    #define DSI_DPHY_HS_TX_STATE_C          BITMASK(20:16)
    #define DSI_DPHY_CTL_STATE_C            BITMASK(8:0)
...
#define REG_DSI_STATE_DBG1    0x014C        //DSI State Machine Debug 1
    #define DSI_DPHY_ESC_STATE_0            BITMASK(31:24)
    #define DSI_DPHY_HS_TX_STATE_0          BITMASK(20:16)
    #define DSI_DPHY_CTL_STATE_0            BITMASK(14:0)
...
#define REG_DSI_STATE_DBG2    0x0150            //DSI State Machine Debug 2
    #define DSI_DPHY_TA_R2T_STATE               BITMASK(28:24)
    #define DSI_DPHY_TA_T2R_STATE               BITMASK(20:16)
    #define DSI_DPHY_RX_ESC_STATE               BITMASK(9:0)
...
#define REG_DSI_STATE_DBG3    0x0154             //DSI State Machine Debug 3
    #define DSI_DPHY_HS_TX_STATE_2               BITMASK(28:24)
    #define DSI_DPHY_CTL_STATE_2                 BITMASK(20:16)
    #define DSI_DPHY_HS_TX_STATE_1               BITMASK(12:8)
    #define DSI_DPHY_CTL_STATE_1                 BITMASK(4:0)
...
#define REG_DSI_STATE_DBG4    0x0158            //DSI State Machine Debug 4
    #define DSI_DPHY_HS_TX_STATE_3               BITMASK(12:8)
    #define DSI_DPHY_CTL_STATE_3                 BITMASK(4:0)
...
#define REG_DSI_STATE_DBG5    0x015C            //DSI State Machine Debug 5
    #define DSI_WAKEUP_STATE                    BITMASK(31:28)
    #define DSI_TIMER_BUSY                      BIT16
    #define DSI_TIMER_COUNTER                   BITMASK(15:0)
...
#define REG_DSI_STATE_DBG6    0x0160            //DSI State Machine Debug 6
    #define DSI_CMDQ_STATE                      BITMASK(22:16)
    #define DSI_CMCTL_STATE                     BITMASK(14:0)
...
#define REG_DSI_STATE_DBG7    0x0164            //DSI State Machine Debug 7
    #define DSI_VSA_PERIOD                      BIT15
    #define DSI_VBP_PERIOD                      BIT14
    #define DSI_VACT_PERIOD                     BIT13
    #define DSI_VFP_PERIOD                      BIT12
    #define DSI_VMCTL_STATE                     BITMASK(10:0)
...
#define REG_DSI_RESERVED    0x0174              //Reserved Register
    #define DSI_RESERVED                        BITMASK(31:0)
...
#define REG_DSI_BIST_PATTE_RN    0x0178         //DSI Bist Pattern Register
    #define DSI_BIST_PATTERN                    BITMASK(31:0)
    //DSI BIST test register for HW verification
#define REG_DSI_BIST_CON        0x017C          //DSI Bist Control Register

    #define DSI_BIST_TIMIING                    BITMASK(23:16)
    #define DSI_BIST_LANE_NUM                   BITMASK(11:8)
    #define DSI_SELF_PAT_MODE                   BIT6
    #define DSI_BIST_HS_FREE                    BIT4
    #define DSI_BIST_SPECIFIED_PATTERN          BIT3
    #define DSI_BIST_FIX_PATTERN                BIT2
    #define DSI_BIST_ENABLE                     BIT1
    #define DSI_BIST_MODE                       BIT0
...
#define REG_DSI_VM_CMD_DATA10        0x0180         //DSI Video Mode Command Packet Data Byte 16~19 Register
    #define DSI_VM_LONG_PKT_WORD16_19               BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA14        0x0184         //DSI Video Mode Command Packet Data Byte 20~23 Register
    #define DSI_VM_LONG_PKT_WORD20_23               BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA18        0x0188         //DSI Video Mode Command Packet Data Byte 24~27 Register
    #define DSI_VM_LONG_PKT_WORD24_27               BITMASK(31:0)
#define REG_DSI_VM_CMD_DATA1C        0x018C         //DSI Video Mode Command Packet Data Byte 28~31 Register
    #define DSI_VM_LONG_PKT_WORD28_31               BITMASK(31:0)


#define REG_DSI_CMDQ_N        0x0200                //DSI Command Queue
    #define DSI_DATA_1                              BITMASK(31:24)
    #define DSI_DATA_0                              BITMASK(23:16)
    #define DSI_DATA_ID                             BITMASK(15:8)
    #define DSI_RESV                                BITMASK(7:6)
    #define DSI_TE                                  BIT5
    #define DSI_CL                                  BIT4
    #define DSI_HS                                  BIT3
    #define DSI_BTA                                 BIT2
    #define DSI_TYPE                                BITMASK(1:0)
