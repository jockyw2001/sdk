...
//****************************************************
// MIPI_DSI Drive Chip           : INIT
// MIPI_DSI Excel CodeGen Version: 1.09
// MIPI_DSI Excel SW      Version: 1.08
// MIPI_DSI Excel update date    : 2018/6/19 16:10
//****************************************************

#ifndef _HAL_PNL_LPLL_TBL_H_
#define _HAL_PNL_LPLL_TBL_H_
...
#define MDRV_PNL_VER_INFO

#define DRV_PNL_REG(reg)      ((reg>>8)&0xFF), (reg&0xFF)
#define REG_ADDR_SIZE          2
#define REG_MASK_SIZE          1
#define REG_TABLE_END          0xFFFF

#define _PK_L_(bank, addr)     ((u16)(bank << 8) | (addr << 1))
#define _PK_H_(bank, addr)     ((u16)(bank << 8) | ((addr << 1) + 1))

#define  REG_TC_LPLL_BASE     0x3100

typedef enum
{
    PNL_TABTYPE_INIT_LPLL,
    PNL_TABTYPE_INIT_LPLL_DIV_GAIN,
    PNL_TABTYPE_NUMS,
} E_PNL_TAB_TYPE;
...
typedef enum
{
    ...
    PNL_SIGNAL_GCLK,
    PNL_SIGNAL_NUMS,
} E_PNL_POWER_SEQUENCE_SIGNAL_TYPE;

typedef struct
{
    u8           *pDacINIT_LPLLTab;
    E_PNL_TAB_TYPE   eINIT_LPLLtype;
    u8           *pDacINIT_LPLL_DIV_GAINTab;
    E_PNL_TAB_TYPE   eINIT_LPLL_DIV_GAINtype;
} PNL_TAB_INFO;

typedef enum
{
    PNL_PANEL_LVDS_1CH_1280x800,
    PNL_PANEL_720x1280_RGB888_4Lane,
    PNL_PANEL_720x1280_RGB565_4Lane,
    PNL_PANEL_720x1280_RGB666_4Lane,
    PNL_PANEL_720x1280_RGB888_2Lane,
    PNL_PANEL_720x1280_RGB565_2Lane,
    PNL_PANEL_720x1280_RGB666_2Lane,
    PNL_PANEL_NUMS,
} E_PNL_PANEL_INDEX;

extern PNL_TAB_INFO MipiDsiPanel_MainTbl[PNL_PANEL_NUMS];

typedef enum
{
    PNL_TAB_LVDS_1CH_1280x800_INIT_LPLL_ALL,
    PNL_TAB_LVDS_1CH_1280x800_INIT_LPLL_NUMS
} E_PNL_LVDS_1CH_1280x800_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_LVDS_1CH_1280x800_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_LVDS_1CH_1280x800_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_LVDS_1CH_1280x800_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB888_4Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB888_4Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB888_4Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB888_4Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB888_4Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB888_4Lane_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB565_4Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB565_4Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB565_4Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB565_4Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB565_4Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB565_4Lane_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB666_4Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB666_4Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB666_4Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB666_4Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB666_4Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB666_4Lane_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB888_2Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB888_2Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB888_2Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB888_2Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB888_2Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB888_2Lane_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB565_2Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB565_2Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB565_2Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB565_2Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB565_2Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB565_2Lane_INIT_LPLL_DIV_GAIN_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB666_2Lane_INIT_LPLL_ALL,
    PNL_TAB_720x1280_RGB666_2Lane_INIT_LPLL_NUMS
} E_PNL_720x1280_RGB666_2Lane_INIT_LPLL_TYPE;

typedef enum
{
    PNL_TAB_720x1280_RGB666_2Lane_INIT_LPLL_DIV_GAIN_ALL,
    PNL_TAB_720x1280_RGB666_2Lane_INIT_LPLL_DIV_GAIN_NUMS
} E_PNL_720x1280_RGB666_2Lane_INIT_LPLL_DIV_GAIN_TYPE;
