...
typedef struct
{
    ...
    u8 u8DimmingCtl;                 ///<  Dimming Value
    u8 u8MaxPWMVal;                  ///<  Max Dimming Value
    u8 u8MinPWMVal;                  ///<  Min Dimming Value
    ...
    */
    ...
    u8 u8SwapOdd_RG;                ///<  Swap Odd RG
    u8 u8SwapEven_RG;               ///<  Swap Even RG
    u8 u8SwapOdd_GB;                ///<  Swap Odd GB
    u8 u8SwapEven_GB;               ///<  Swap Even GB
