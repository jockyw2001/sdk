...
#define IOCTL_MMFE_MHAL_SET_PARAM           _IOWR(MAGIC_MMFE, 11, VencParamUT)
#define IOCTL_MMFE_MHAL_GET_PARAM           _IOWR(MAGIC_MMFE, 12, VencParamUT)
#define IOCTL_MMFE_MHAL_ENCODE_ONE_FRAME    _IOWR(MAGIC_MMFE, 13, MHAL_VENC_InOutBuf_t)
#define IOCTL_MMFE_MHAL_ENCODE_FRAME_DONE   _IOWR(MAGIC_MMFE, 14, MHAL_VENC_EncResult_t)
#define IOCTL_MMFE_MHAL_QUERY_BUFSIZE       _IOWR(MAGIC_MMFE, 15, MHAL_VENC_InternalBuf_t)
#define IOCTL_MMFE_MHAL_KICKOFF_CMDQ        _IO(MAGIC_MMFE, 16)
