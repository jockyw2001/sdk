...
typedef struct MfeReg_t
{
    ...
    uint  notify_size;
    void  (*notify_func)(unsigned long nBufAddr, unsigned long nNotifyOffset, unsigned long nNotifySize, unsigned short bFrameDone);
    /* Ticks for profiling */
...
#define MFE_REG_REF_NUM_TWO       1
    ...
    union
    {
        struct
        {
            ...
            ushort reg2d_s_txip_dbf_full_halt_en:1; // txip controller stop-and-go mechanism using double buffer fullness as criterion:
                                                    // 0/1: disable/enable
            ushort reg2d_s_txip_ack2fme_mode:4;     // txip2fme ack mode
                                                    // 'h0 : txip2fme_ack for double mcy buffer mode
                                                    // 'h1 : single buffer mode
        };
        ushort reg2d;
    };
    union
    {
        struct
        {
            ...
            ushort reg2e_s_txip_irfsh_mb_e1_msb:2;      // intra refresh mb end 0 MSB
            ushort reg2e_s_mdc_pic_reorder_flag:1;      // 8:     ref_pic_list_reordering_flag_l0
            ushort reg2e_s_mdc_pic_nums_idc:2;          // 9-10:  modification_of_pic_nums_idc
            ushort reg2e_s_mdc_abs_diff_or_long_term:2; // 11-12: abs_diff_pic_num_minus1 or long_term_pic_num
            ushort reg2e_s_mdc_long_term_ref_flag:1;    // 13:    long_term_reference_flag
            ushort reg2e_reserved:2;
        };
        ushort reg2e;
    };
    union
    ...
    union
    {
        struct
        {
            ...
            ushort reg3f_s_bsp_fdc_offset:6;        // bsp's fdc offset
        };
        ushort reg3f;
    };
    union
    ...
    union
    {
        struct
        {
            ushort reg90_g_capture_width_y:14;      // Capture input frame width (Luma Pels)
        };
        ushort reg90;
    };
    union
    {
        struct
        {
            ushort reg91_g_capture_width_c:14;      // Capture input frame width (Chroma Pels)
        };
        ushort reg91;
    };
    union
    ...
    union
    {
        struct
        {
            ...
            ushort reg99_dummy:9;
            ushort reg99_s_hist_burst_msb_sel:3;
        };
        ushort reg99;
    };
    union
    {
        struct
        {
            ushort reg9a_s_hist_burst_1:16;
        };
        ushort reg9a;
    };
    union
    {
        struct {
            ushort reg9b_s_hist_burst_2:16;
        };
        ushort reg9b;
    };
    union
    {
        struct
        {
            ushort reg9c_s_hist_burst_4:16;
        };
        ushort reg9c;
    };
    union
    {
        struct
        {
            ushort reg9d_s_hist_burst_8:16;
        };
        ushort reg9d;
    };
    union
    {
        struct
        {
            ushort reg9e_s_hist_burst_16:16;
        };
        ushort reg9e;
    };
    union
    {
        struct
        {
            ushort reg9f_s_hist_burst_32:8;
            ushort reg9f_s_hist_burst_msb:6;
            ushort reg9f_s_hist_sel:2;
        };
        ushort reg9f;
    };
    union
    ...
    union
    {
        struct
        {
            ushort rega2_s_whist_imi_count_burst_upper:8;
            ushort rega2_s_rhist_imi_count_burst_upper:8;
        };
        ushort rega2;
    };
    union
    {
        struct
        {
            ushort rega3_s_whist_imi_count_bubble:16;   // IMI write histogram bubble count
        };
        ushort rega3;
    };
    union
    {
        struct
        {
            ushort rega4_s_whist_imi_count_burst_lower:16;
        };
        ushort rega4;
    };
    union
    {
        struct
        {
            ushort rega5_s_rhist_imi_count_bubble:16;   // IMI read histogram bubble count
        };
        ushort rega5;
    };
    union
    {
        struct
        {
            ushort rega6_s_rhist_imi_count_burst_lower:16;
        };
        ushort rega6;
    };
    union
    {
        struct
        {
            ushort rega7_s_dump_reg_sadr_low:16;
        };
        ushort rega7;
    };
    union
    {
        struct
        {
            ushort rega8_s_dump_reg_sadr_high:12;
        };
        ushort rega8;
    };
    union
    ...
    union
    {
        struct
        {
            ushort regca_s_multislice_mby:12;       // MB height of Slice except 1st
            ushort regca_s_multislice_en:1;         // Arbitrary multi-slice enable
        };
        ushort regca;
    };
    union
    {
        struct
        {
            ushort regcb_s_multislice_1st_mby:12;   // First slice MB height
        };
        ushort regcb;
    };
    union
    {
        struct
        {
            ushort regcc_s_bsp_thd_size_low:16;     // Bitstream size threshold (Byte)
        };
        ushort regcc;
    };
    union
    {
        struct
        {
            ushort regcd_s_bsp_thd_size_high:5;     // Bitstream size threshold (Byte)
            ushort regcd_reserved:10;
            ushort regcd_s_bsp_thd_en:1;            // Bitstream size threshold enable
        };
        ushort regcd;
    };
    union
    {
        struct
        {
            ushort regce_s_bsp_thd_mbx:13;          // MB X while reaching size threshold
        };
        ushort regce;
    };
    union
    {
        struct
        {
            ushort regcf_s_bsp_thd_mby:13;          // MB Y while reaching size threshold
        };
        ushort regcf;
    };
    union
    ...
    union
    {
        struct
        {
            ...
            ushort regd1_g_jpd_hsk_frame_idx:2;
        };
        ushort regd1;
    };
    union
    ...
    union
    {
        struct
        {
            ushort regd3_g_2p_sram_read_block:1;
            ushort regd3_g_mbldr_ff_en:1;
        };
        ushort regd3;
    };
    union
...
#define MFE_REG_PLNRLDR_VU                    1
    ...
    union
    {
        struct
        {
            ushort regfd_reserved0:6;               // Giggs Check
            ushort regfd_eco:1;
        };
        ushort regfd;
    };
    union
    {
        struct
        {
            ushort regfe_s_bspobuf_wptr_fix_low:16;
        };
        ushort regfe;
    };
    union
    {
        struct
        {
            ushort regff_s_bspobuf_wptr_fix_high:13;
            ushort regff_s_bspobuf_wptr_lat:1;
        };
        ushort regff;
    };
    ///////////////////////// Bank2 ////////////////////////
    ...
    union
    {
        struct
        {
            ushort reg170_dual_row_dbfprf:10;
            ushort reg170_dual_strm_id:3;       // Stream index
            ushort reg170_dummy:1;
            ushort reg170_dual_core:1;          // 1: Dual core, 0: Single core
        };
        ushort reg170;
    };
    union
    {
        struct
        {
            ushort reg171_dual_mb_dbfprf:10;    // Dual core dbf faster than prfh mb cnt
            ushort reg171_dual_bs0_rstz:1;      // Bitstream0 software reset, 0: Reset, 1: Not reset
            ushort reg171_dual_bs1_rstz:1;      // Bitstream1 software reset, 0: Reset, 1: Not reset
            ushort reg171_dummy:4;
        };
        ushort reg171;
    };
    union
    ...
    union
    {
        struct
        {
            ushort reg17b_g_cmdq_irq_mask:8;
            ushort reg17b_g_cmdq_irq_force:8;
        };
        ushort reg17b;
    };
    union
    {
        struct
        {
            ushort reg17c_g_cmdq_irq_clr0:1;
            ushort reg17c_g_cmdq_irq_clr1:1;
            ushort reg17c_g_cmdq_irq_clr2:1;
            ushort reg17c_g_cmdq_irq_clr3:1;
            ushort reg17c_g_cmdq_irq_clr4:1;
            ushort reg17c_g_cmdq_irq_clr5:1;
            ushort reg17c_g_cmdq_irq_clr6:1;
            ushort reg17c_g_cmdq_irq_clr7:1;
        };
        ushort reg17c;
    };
    union
    {
        struct
        {
            ushort reg17d_g_cmdq_irq_cpu:8;
            ushort reg17d_g_cmdq_irq_ip:8;
        };
        ushort reg17d;
    };
    ///////////////////////// Other Bank ////////////////////////
...
#pragma pack(push)
#pragma pack(1)
typedef struct MfeDumpReg_t
{
    ushort reg42;   // bits size:lo
    uchar  reg43;   // bits size:hi
    ushort reg44;   // bspobuf write pointer (8 byte unit)
    ushort reg45;   // bspobuf write pointer (8 byte unit)
    uchar  dummy0;
    ushort regb0;   // CABAC total bin counts
    ushort regb1;   // CABAC total bin counts
    ushort regb2;   // CABAC total bin counts
    ushort regb3;   // CABAC total bin counts

    ushort regd7;   // CRC result of yuvldr to mbldr data
    ushort regd8;   // CRC result of yuvldr to mbldr data
    ushort regd9;   // CRC result of yuvldr to mbldr data
    ushort regda;   // CRC result of yuvldr to mbldr data

    ushort reg116[15];  // LUT entry histogram entry 0~14
    ushort dummy1;
    ushort reg130[32];  // Protected color weighting histogram
    ushort reg150[32];  // Texture weighting histogram

    ushort reg126;
    ushort reg127;
    ushort reg128;
    ushort reg1e;       // reg_mfe_g_irq_ip
    uchar  reg12a_hi;
    ushort reg12b;
    ushort reg129;
    uchar  reg12a_lo;
    ushort regf5;
    ushort regf6;       // reg_mfe_s_mbr_last_frm_avg_qp
} mfe6_dump_reg;
#pragma pack(pop)
