...
typedef struct Pps_t
{
    sps_t*  sps;
    int i_pps_id;
    int b_cabac_i;                      /* Selects the entropy decoding method to be applied 0:CAVLC,1:CABAC */
    int b_cabac_p;                      /* Selects the entropy decoding method to be applied 0:CAVLC,1:CABAC */
