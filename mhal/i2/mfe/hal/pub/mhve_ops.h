...
//#define MHVE_CFG_DMA_OUTPUT_BUFFER
    ...
    struct {
        ...
        unsigned char   b_entropy_coding_type_i;        // Entropy I frame: cabac/cavlc.
        unsigned char   b_entropy_coding_type_p;        // Entropy P frame: cabac/cavlc.
        ...
        unsigned char   i_disable_deblocking_idc;       // Disable deblocking idc.
          ...
          signed char   i_chroma_qp_index_offset;       // Chroma QP Index Offset
    } avc;
    struct {
        enum mhve_cfg_e i_type;
    ...
    struct {
        ...
        int             i_time_scale;
        unsigned char   b_fixed_frame_rate_flag;
    } vui;
    struct {
        enum mhve_cfg_e i_type;
