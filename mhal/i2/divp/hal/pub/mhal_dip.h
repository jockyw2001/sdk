...
#define USING_CMDQ_MULTI_WRITE    // Support CmdQ Register Multi-Write function
#define CMDQ_MULTI_WRITE_BUF_MAX        (512)
...
#define DIP_LOG(_fmt, _args...)       printk(_fmt, ## _args)
...
typedef struct
{
    ...
    MS_U8 u8TB_Field;
    MS_U8 u8DIBufIndex;
    MS_U8 u8DIWrTopIndex;
    MS_U8 u8DIWrBotIndex;
    MS_U8 u8DIRdTopIndex;
    MS_U8 u8DIRdBotIndex;
} st3DDI_DBG_INFO;

#define MAX_DEBUG_FRAME_NUM    8

typedef struct
{
    MS_U8 u8NextFrame;
    st3DDI_DBG_INFO stDebugInfo[MAX_DEBUG_FRAME_NUM];
} __attribute__ ((__packed__)) Divp_DI_DebugInfo_t;

extern Divp_DI_DebugInfo_t g_stDivpDiDebugInfo[MAX_CHANNEL_NUM];
...
INTERFACE void HAL_XC_DIP_Set2Pto1P_Mode(MS_BOOL bEnable);
INTERFACE MS_BOOL HAL_XC_DIP_Get2Pto1P_Mode(void);
...
INTERFACE void HAL_XC_DIP_DeInit(void *pstCmdQInfo, SCALER_DIP_WIN eWindow);
...
INTERFACE void HAL_XC_DIP_SetWinProperty(void *pstCmdQInfo, MS_U8 u8BufCnt, MS_U16 u16Width, MS_U16 u16LineOft, MS_U16 u16Height, MS_U32 u64OffSet, SCALER_DIP_SOURCE_TYPE eSource, MS_BOOL bPIP, MS_BOOL b2P_Enable, MS_BOOL bOutputDummyEn, SCALER_DIP_WIN eWindow);
...
INTERFACE void HAL_XC_DIP_MDWinDeInit(void *pstCmdQInfo, MS_U8 u8WinId);
...
INTERFACE void HAL_CMDQ_MultiWrite_Init(void);
INTERFACE MS_BOOL HAL_CMDQ_MultiWrite_End(void *pstCmdQInfo);
