...
typedef enum
{
    ...
    E_RES_800x600P_60Hz,
    E_RES_1280x800P_60Hz,
    E_RES_1366x768P_60Hz,
    E_RES_1680x1050P_60Hz,
    E_RES_1920x1200P_60Hz,
...
typedef enum
{
    E_DAC_DUMP_TABTYPE_INIT,
    E_DAC_DUMP_TABTYPE_INIT_GPIO,
    E_DAC_DUMP_TABTYPE_INIT_SC,
    E_DAC_DUMP_TABTYPE_INIT_MOD,
    E_DAC_DUMP_TABTYPE_INIT_HDGEN,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_8BIT,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_8BIT_Divider,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_10BIT,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_10BIT_Divider,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_12BIT,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_12BIT_Divider,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_16BIT,
    E_DAC_DUMP_TABTYPE_INIT_HDMITX_16BIT_Divider,
    E_DAC_DUMP_TABTYPE_Gamma,
    E_DAC_DUMP_TABTYPE_SC1_INIT,
    E_DAC_DUMP_TABTYPE_SC1_INIT_SC,
    E_DAC_DUMP_TABTYPE_DAC_PLL_INIT,
    E_DAC_DUMP_TABTYPE_FRAMELOCK_CLK_INIT,
    E_DAC_DUMP_TABTYPE_FRAMELOCK_SC_INIT,
    E_DAC_DUMP_TABTYPE_PNL_CLK_INIT,
    E_DAC_DUMP_TABTYPE_NUMS,
}E_DAC_DUMP_TAB_TYPE;
