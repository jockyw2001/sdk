...
typedef enum
{
    ...
    E_XC_EX_INPUT_SOURCE_NUM,           ///<44 number of the source
...
//-------------------------------------------------------------------------------------------------
/// Set Scaler Frame color
/// @param  u32aUYV             \b IN: the 4 bytes in aUYV are "a: no use,
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void    MApi_XC_EX_SetFrameColorYUV(XC_DEVICE_ID *pDeviceId, MS_U32 u32aYUV);
