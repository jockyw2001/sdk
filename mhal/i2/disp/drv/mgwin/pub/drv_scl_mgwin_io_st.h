...
/**
* The output color type of SclMgwin
*/
typedef enum
{
    E_DRV_SCLMGWIN_IO_OUT_COLOR_RGB, ///< output color: RGB
    E_DRV_SCLMGWIN_IO_OUT_COLOR_YUV, ///< output color: YUV
    E_DRV_SCLMGWIN_IO_OUT_COLOR_NUM,
} DrvSclMgwinIoOutColor_e;
...
typedef struct
{
    ...
    u32 u32Pitch;                               ///< Pitch
    DrvSclMgwinIoOutColor_e enOutColor;         ///< output color
    // VerChk_Version & VerChk_Size must be the latest 2 parameter and
    // the order can't be changed
    u32   VerChk_Size;                          ///< structure size for version checking
...
typedef struct
{
    u8 u8DbgOpt;
    u8 u8DbgLvl;
}__attribute__ ((__packed__))DrvSclMgwinIoDebugConfig_t;
///@cond
/**
...
typedef struct
{
    ...
    DrvSclMgwinIoErrType_e (*DrvSclMgwinIoSetDebugConfig)(s32 s32Handler, DrvSclMgwinIoDebugConfig_t *pstDbgCfg);
    DrvSclMgwinIoErrType_e (*DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig)(s32 s32Handler, DrvSclMgwinIoSubWinOnOffConfig_t *pstIoSubWinOnOffCfg);
