...
#define IOCTL_SCLMGWIN_SET_DEBUG_CONFIG_NR                  (9)     ///< THe IOCTL NR definition for IOCTL_SCLMGWIN_SET_DEBUG_CONFIG_NR
#define IOCTL_SCLMGWIN_SET_SUBWIN_MASKBLACK_ONOFF_CONFIG_NR (10)    ///< THe IOCTL NR definition for IOCTL_SCLMGWIN_SET_SUBWIN_MASKBLACK_ONOFF_CONFIG_NR
#define IOCTL_SCLMGWIN_MAX_NR                               (11)    ///< The Max IOCTL NR for SCLMGWIN driver
...
#define IOCTL_SCLMGWIN_SET_DEBUG_CONFIG                         _IO(IOCTL_SCLMGWIN_MAGIC,   IOCTL_SCLMGWIN_SET_DEBUG_CONFIG_NR)
#define IOCTL_SCLMGWIN_SET_SUBWIN_MASKBLACK_ONOFF_CONFIG        _IO(IOCTL_SCLMGWIN_MAGIC,   IOCTL_SCLMGWIN_SET_SUBWIN_MASKBLACK_ONOFF_CONFIG_NR)
