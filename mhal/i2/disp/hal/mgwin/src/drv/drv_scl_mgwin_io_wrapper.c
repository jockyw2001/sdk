...
u8  gMgwinbdbgmessage[EN_DBGMG_NUM_CONFIG] = {0, 0, 0, 0};
...
DrvSclMgwinOutColor_e _DrvSclMgwinIoTransOutColor(DrvSclMgwinIoOutColor_e enIoColor)
{
    DrvSclMgwinOutColor_e enOutColor;

    enOutColor = enIoColor == E_DRV_SCLMGWIN_IO_OUT_COLOR_RGB ? E_DRV_SCLMGWIN_OUT_COLOR_RGB :
                 enIoColor == E_DRV_SCLMGWIN_IO_OUT_COLOR_YUV ? E_DRV_SCLMGWIN_OUT_COLOR_YUV :
                                                                E_DRV_SCLMGWIN_OUT_COLOR_NUM;
    return enOutColor;
}
...
bool _DrvSclMgwinIoInit(void)
{
    ...
    _gstSclMgwinIoFunc.DrvSclMgwinIoSetDebugConfig                  = _DrvSclMgwinIoSetDebugConfig;
    _gstSclMgwinIoFunc.DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig   = _DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig;
...
DrvSclMgwinIoErrType_e _DrvSclMgwinIoSetSubWinFlipConfig(s32 s32Handler, DrvSclMgwinIoSubWinFlipConfig_t *pstIoSubWinFlipCfg)
{
    ...
    stSubWinFlipCfg.enOutColor  = _DrvSclMgwinIoTransOutColor(pstIoSubWinFlipCfg->enOutColor);
...
DrvSclMgwinIoErrType_e _DrvSclMgwinIoGetRegisterConfig(s32 s32Handler, DrvSclMgwinIoRegisterConfig_t *pstIoRegCfg)
{
    pstIoRegCfg->u16Val = R2BYTE(pstIoRegCfg->u32Addr);
    return E_DRV_SCLMGWIN_IO_ERR_OK;
}

DrvSclMgwinIoErrType_e _DrvSclMgwinIoSetDebugConfig(s32 s32Handler, DrvSclMgwinIoDebugConfig_t *pstIoDbgCfg)
{
    if(DrvSclMgwinSetDebugLevel(pstIoDbgCfg->u8DbgOpt, pstIoDbgCfg->u8DbgLvl))
    {
        return E_DRV_SCLMGWIN_IO_ERR_OK;
    }
    else
...
DrvSclMgwinIoErrType_e _DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig(s32 s32Handler, DrvSclMgwinIoSubWinOnOffConfig_t *pstIoSubWinOnOffCfg)
{
    DrvSclMgwinIoCtxConfig_t stCtxCfg;
    DrvSclMgwinVersionChkConfig_t stVersion;
    DrvSclMgwinSubWinOnOffConfig_t stSubWinOnOffCfg;
    ...
    if(DrvSclMgwinSetSubWinMaskBlackOnOffConfig(stCtxCfg.pCtx, &stSubWinOnOffCfg))
    {
        return E_DRV_SCLMGWIN_IO_ERR_OK;
    }
    else
...
EXPORT_SYMBOL(_DrvSclMgwinIoSetDebugConfig);
EXPORT_SYMBOL(_DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig);
