...
INTERFACE DrvSclMgwinIoErrType_e _DrvSclMgwinIoGetRegisterConfig(s32 s32Handler, DrvSclMgwinIoRegisterConfig_t *pstIoRegCfg);
INTERFACE DrvSclMgwinIoErrType_e _DrvSclMgwinIoSetDebugConfig(s32 s32Handler, DrvSclMgwinIoDebugConfig_t *pstIoDbgCfg);
INTERFACE DrvSclMgwinIoErrType_e _DrvSclMgwinIoSetSubWinMaskBlackOnOffConfig(s32 s32Handler, DrvSclMgwinIoSubWinOnOffConfig_t *pstIoSubWinOnOffCfg);
