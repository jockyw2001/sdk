...
typedef enum
{
    E_DRV_SCLMGWIN_OUT_COLOR_RGB,
    E_DRV_SCLMGWIN_OUT_COLOR_YUV,
    E_DRV_SCLMGWIN_OUT_COLOR_NUM,
}DrvSclMgwinOutColor_e;
//-------------------------------------------------------------------------------------------------
//  structure
//-------------------------------------------------------------------------------------------------
...
typedef struct
{
    ...
    DrvSclMgwinOutColor_e  enOutColor;          ///< output color
...
INTERFACE bool DrvSclMgwinSetDebugLevel(u8 u8DbgOpt, u8 u8DbgLvl);
INTERFACE bool DrvSclMgwinSetSubWinMaskBlackOnOffConfig(void *pCtx, DrvSclMgwinSubWinOnOffConfig_t *pstSubWinOnOffCfg);
