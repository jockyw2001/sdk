...
#include "../../drv/hvd_v3/drvHVD_Common.h"
...
//-------------------------------------------------------------------------------------------------
#define HVD_FW_MEM_OFFSET           FW_TASK_SIZE  //org 0x100000UL: 1M
...
#define EVD_HW_BUFFER   0x800000 //0x800000: support MFcodec, 0x200000: not support MFcodec
...
#define  _HAL_HVD_Entry()                                                       \
    ...
    {                                                                           \
        ...
        {                                                                       \
            ...
            {                                                                   \
                HVD_PRINT("[HAL HVD][%06d] Mutex taking timeout\n", __LINE__);     \
            }                                                                   \
        }                                                                       \
    } while (0)
...
//------------------------------ MIU SETTINGS ----------------------------------
#define _MaskMiuReq_MVD_RW( m )       _HVD_WriteRegBit(MIU0_REG_RQ2_MASK, m, BIT(6))
//#define _MaskMiuReq_MVD_RW_1( m )       _HVD_WriteRegBit(MIU0_REG_RQ4_MASK, m, BIT(6))
#define _MaskMiuReq_MVD_BBU_R( m )      _HVD_WriteRegBit(MIU0_REG_RQ0_MASK+1, m, BIT(2))
#define _MaskMiuReq_HVD_RW_MIF0( m )    _HVD_WriteRegBit(MIU0_REG_RQ4_MASK, m, BIT(4))
#define _MaskMiuReq_HVD_RW_MIF1( m )    _HVD_WriteRegBit(MIU0_REG_RQ4_MASK, m, BIT(5))
#define _MaskMiuReq_HVD_BBU_R( m )      _HVD_WriteRegBit(MIU0_REG_RQ4_MASK+1, m, BIT(3))

#define _MaskMiu1Req_MVD_RW( m )      _HVD_WriteRegBit(MIU1_REG_RQ2_MASK, m, BIT(6))
//#define _MaskMiu1Req_MVD_RW_1( m )      _HVD_WriteRegBit(MIU1_REG_RQ4_MASK, m, BIT(6))
#define _MaskMiu1Req_MVD_BBU_R( m )     _HVD_WriteRegBit(MIU1_REG_RQ0_MASK+1, m, BIT(2))
#define _MaskMiu1Req_HVD_RW_MIF0( m )   _HVD_WriteRegBit(MIU1_REG_RQ4_MASK, m, BIT(4))
#define _MaskMiu1Req_HVD_RW_MIF1( m )   _HVD_WriteRegBit(MIU1_REG_RQ4_MASK, m, BIT(5))
#define _MaskMiu1Req_HVD_BBU_R( m )     _HVD_WriteRegBit(MIU1_REG_RQ4_MASK+1, m, BIT(3))


#define HVD_MVD_RW_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(6)) == 0))
#define HVD_MVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(10)) == 0))
#define HVD_HVD_RW_MIF0_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(4)) == 0))
#define HVD_HVD_RW_MIF1_ON_MIU0         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(5)) == 0))
#define HVD_HVD_BBU_R_ON_MIU0           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(11)) == 0))

#define HVD_MVD_RW_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL2) & BIT(6)) == BIT(6)))
#define HVD_MVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL0) & BIT(10)) == BIT(10)))
#define HVD_HVD_RW_MIF0_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(4)) == BIT(4)))
#define HVD_HVD_RW_MIF1_ON_MIU1         (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(5)) == BIT(5)))
#define HVD_HVD_BBU_R_ON_MIU1           (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(11)) == BIT(11)))



#if SUPPORT_EVD
#define _MaskMiuReq_EVD_RW1( m )         _HVD_WriteRegBit(MIU0_REG_RQ4_MASK,   m, BIT(7))
#define _MaskMiuReq_EVD_RW2( m )         _HVD_WriteRegBit(MIU0_REG_RQ4_MASK,   m, BIT(1))
#define _MaskMiuReq_EVD_BBU_R( m )       _HVD_WriteRegBit(MIU0_REG_RQ4_MASK+1, m, BIT(2))

#define _MaskMiu1Req_EVD_RW1( m )        _HVD_WriteRegBit(MIU1_REG_RQ4_MASK,   m, BIT(7))
#define _MaskMiu1Req_EVD_RW2( m )        _HVD_WriteRegBit(MIU1_REG_RQ4_MASK,   m, BIT(1))
#define _MaskMiu1Req_EVD_BBU_R( m )      _HVD_WriteRegBit(MIU1_REG_RQ4_MASK+1, m, BIT(2))




#define HVD_EVD_RW1_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == 0))
#define HVD_EVD_RW2_ON_MIU0              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(1)) == 0))
#define HVD_EVD_BBU_R_ON_MIU0            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(10)) == 0))

#define HVD_EVD_RW1_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(7)) == BIT(7)))
#define HVD_EVD_RW2_ON_MIU1              (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(1)) == BIT(1)))
#define HVD_EVD_BBU_R_ON_MIU1            (((_HVD_Read2Byte(MIU0_REG_SEL4) & BIT(10)) == BIT(10)))
...
#ifdef VDEC3
#define HAL_HVD_EX_MAX_SUPPORT_STREAM   32
#else
...
//-------------------------------------------------------------------------------------------------
#ifdef CHIP_I2
MS_U32 VPUClockType = 576;
static MS_U32 HVDClockType = 576;
#else
MS_U32 VPUClockType = 480;
static MS_U32 HVDClockType = 384;
#endif
module_param(VPUClockType,uint,0644);
module_param(HVDClockType,uint,0644);

#if SUPPORT_EVD
static MS_U32 EVDClockType = 576;
module_param(EVDClockType,uint,0644);
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
static MS_U32 VP9ClockType = 384;
module_param(VP9ClockType,uint,0644);
#endif
...
static void HAL_EVD_EX_PowerCtrl_CLKM(MS_U32 u32Id, MS_BOOL bEnable);
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
...
typedef struct
{
    ...
    MS_U32 *pu32VPUClockType;
    MS_U32 *pu32HVDClockType;//160
#if SUPPORT_EVD
    MS_U32 *pu32EVDClockType;
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
    MS_U32 *pu32VP9ClockType;
#endif
...
static void _HVD_EX_Context_Init_HAL(void)
{
    ...
    pHVDHalContext->pu32VPUClockType = &VPUClockType;
    pHVDHalContext->pu32HVDClockType = &HVDClockType;

#if SUPPORT_EVD
    pHVDHalContext->pu32EVDClockType = &EVDClockType;
#endif
#if SUPPORT_G2VP9 && defined(VDEC3)
    pHVDHalContext->pu32VP9ClockType = &VP9ClockType;
#endif
#ifdef VDEC3
...
static MS_U32 _HVD_EX_Get_REG_NAL_RPTR_HI(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    ...
    MS_U32 u32RegNalRptrHi = HVD_REG_NAL_RPTR_HI(u32RB);
...
#endif
    {
        u32RegNalRptrHi = HVD_REG_NAL_RPTR_HI(u32RB);

    }
#ifdef VDEC3
    else if (1 == pCtrl->u32BBUId)
#else
    else if (1 == u8TaskId)
#endif
    {
        u32RegNalRptrHi = HVD_REG_NAL_RPTR_HI_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    else if (2 == u8TaskId)
#endif
    {
        if(isEVD)
            u32RegNalRptrHi = EVD_REG_NAL_RPTR_HI_BS3;
        else
            u32RegNalRptrHi = HVD_REG_NAL_RPTR_HI_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    else if (3 == u8TaskId)
#endif
    {
        if(isEVD)
            u32RegNalRptrHi = EVD_REG_NAL_RPTR_HI_BS4;
        else
            u32RegNalRptrHi = HVD_REG_NAL_RPTR_HI_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegNalRptrHi;

}


static MS_U32 _HVD_EX_Get_REG_NAL_WPTR_HI(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegNalWptrHi = HVD_REG_NAL_WPTR_HI(u32RB);
...
#endif
    {
        u32RegNalWptrHi = HVD_REG_NAL_WPTR_HI(u32RB);
...
#endif
    {
        u32RegNalWptrHi = HVD_REG_NAL_WPTR_HI_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalWptrHi = EVD_REG_NAL_WPTR_HI_BS3;
        else
            u32RegNalWptrHi = HVD_REG_NAL_WPTR_HI_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalWptrHi = EVD_REG_NAL_WPTR_HI_BS4;
        else
            u32RegNalWptrHi = HVD_REG_NAL_WPTR_HI_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegNalWptrHi;
...
static MS_U16 _HVD_EX_GetBBUReadptr(MS_U32 u32Id)
{
    ...
    else
    {
        if(_stHVDPreSet[u8Idx].bColocateBBUMode)
            ...
            u16Ret = _HVD_Read2Byte(_HVD_EX_Get_REG_NAL_RPTR_HI(u32Id));
    }

    isEVD = _HAL_EX_IS_EVD(pCtrl->InitParams.u32ModeFlag);
    if(isEVD)
    {
        HVD_EX_MSG_DBG("isEVD: %d, Task0=%d, Task1=%d, Task2=%d, Task4=%d\n",
                       isEVD, _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI_BS2(u32RB)), _HVD_Read2Byte(EVD_REG_NAL_RPTR_HI_BS3), _HVD_Read2Byte(EVD_REG_NAL_RPTR_HI_BS4));
    }
    else
    {
        HVD_EX_MSG_DBG("isEVD:%d, Task0=%d, Task1=%d, Task2=%d, Task4=%d\n",
                       isEVD, _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI_BS2(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI_BS5), _HVD_Read2Byte(HVD_REG_NAL_RPTR_HI_BS6));
...
//#if (HVD_ENABLE_MVC || (!VDEC3))
    ...
    else
    {
        if(_stHVDPreSet[u8Idx].bColocateBBUMode)
            ...
            u16Ret = _HVD_Read2Byte(_HVD_EX_Get_REG_NAL_WPTR_HI(u32Id));
...
static void _HVD_EX_ResetMainSubBBUWptr(MS_U32 u32Id)
{
    ...
    _HVD_Write2Byte(HVD_REG_NAL_RPTR_HI_BS5, 0);
    _HVD_WriteWordMask(HVD_REG_RISC_MBOX_CLR(u32RB), HVD_REG_NAL_WPTR_SYNC, HVD_REG_NAL_WPTR_SYNC);    // set bit 3
    _HVD_Write2Byte(HVD_REG_NAL_RPTR_HI_BS6, 0);
    _HVD_WriteWordMask(HVD_REG_RISC_MBOX_CLR(u32RB), HVD_REG_NAL_WPTR_SYNC, HVD_REG_NAL_WPTR_SYNC);    // set bit 3
    _HVD_Write2Byte(EVD_REG_NAL_RPTR_HI_BS3, 0);
    _HVD_WriteWordMask(HVD_REG_RISC_MBOX_CLR(u32RB), HVD_REG_NAL_WPTR_SYNC, HVD_REG_NAL_WPTR_SYNC);    // set bit 3
    _HVD_Write2Byte(EVD_REG_NAL_RPTR_HI_BS4, 0);
    _HVD_WriteWordMask(HVD_REG_RISC_MBOX_CLR(u32RB), HVD_REG_NAL_WPTR_SYNC, HVD_REG_NAL_WPTR_SYNC);    // set bit 3
...
//  #if (HVD_ENABLE_MVC || (!VDEC3))
    ...
    {
        _HVD_Write2Byte(_HVD_EX_Get_REG_NAL_WPTR_HI(u32Id), u16BBUNewWptr);
    ...
    if(isEVD)
    {
        HVD_EX_MSG_DBG("isEVD:%d, Task0=%d, Task1=%d, Task2=%d, Task3=%d\n",
                       isEVD, _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI_BS2(u32RB)), _HVD_Read2Byte(EVD_REG_NAL_WPTR_HI_BS3), _HVD_Read2Byte(EVD_REG_NAL_WPTR_HI_BS4));
    }
    else
    {
        HVD_EX_MSG_DBG("isEVD:%d, Task0=%d, Task1=%d, Task2=%d, Task3=%d\n",
                       isEVD, _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI_BS2(u32RB)), _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI_BS5), _HVD_Read2Byte(HVD_REG_NAL_WPTR_HI_BS6));
    }
...
static MS_U32 _HVD_EX_Get_REG_ES_RPTR_L(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegESRptrLow = HVD_REG_ESB_RPTR(u32RB);
...
#endif
    {
        u32RegESRptrLow = HVD_REG_ESB_RPTR(u32RB);
...
#endif
    {
        u32RegESRptrLow = HVD_REG_ESB_RPTR_L_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegESRptrLow = EVD_REG_ESB_RPTR_L_BS3;
        else
            u32RegESRptrLow = HVD_REG_ESB_RPTR_L_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegESRptrLow = EVD_REG_ESB_RPTR_L_BS4;
        else
            u32RegESRptrLow = HVD_REG_ESB_RPTR_L_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegESRptrLow;

}

static MS_U32 _HVD_EX_Get_REG_ES_RPTR_H(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegESRptrHi = HVD_REG_ESB_RPTR_H(u32RB);
...
#endif
    {
        u32RegESRptrHi = HVD_REG_ESB_RPTR_H(u32RB);
...
#endif
    {
        u32RegESRptrHi = HVD_REG_ESB_RPTR_H_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegESRptrHi = EVD_REG_ESB_RPTR_H_BS3;
        else
            u32RegESRptrHi = HVD_REG_ESB_RPTR_H_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegESRptrHi = EVD_REG_ESB_RPTR_H_BS4;
        else
            u32RegESRptrHi = HVD_REG_ESB_RPTR_H_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegESRptrHi;
...
static MS_U32 _HVD_EX_Get_NAL_TBL_ST_ADDR_L(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegNalTblAddrLo = HVD_REG_NAL_TBL_ST_ADDR_L(u32RB);
...
#endif
    {
        u32RegNalTblAddrLo = HVD_REG_NAL_TBL_ST_ADDR_L(u32RB);
...
#endif
    {
        u32RegNalTblAddrLo = HVD_REG_NAL_TBL_ST_ADDR_L_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblAddrLo = EVD_REG_NAL_TBL_ST_ADDR_L_BS3;
        else
            u32RegNalTblAddrLo = HVD_REG_NAL_TBL_ST_ADDR_L_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblAddrLo = EVD_REG_NAL_TBL_ST_ADDR_L_BS4;
        else
            u32RegNalTblAddrLo = HVD_REG_NAL_TBL_ST_ADDR_L_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegNalTblAddrLo;

}


static MS_U32 _HVD_EX_Get_NAL_TBL_ST_ADDR_H(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegNalTblAddrHi = HVD_REG_NAL_TBL_ST_ADDR_H(u32RB);
...
#endif
    {
        u32RegNalTblAddrHi = HVD_REG_NAL_TBL_ST_ADDR_H(u32RB);
...
#endif
    {
        u32RegNalTblAddrHi = HVD_REG_NAL_TBL_ST_ADDR_H_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblAddrHi = EVD_REG_NAL_TBL_ST_ADDR_H_BS3;
        else
            u32RegNalTblAddrHi = HVD_REG_NAL_TBL_ST_ADDR_H_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblAddrHi = EVD_REG_NAL_TBL_ST_ADDR_H_BS4;
        else
            u32RegNalTblAddrHi = HVD_REG_NAL_TBL_ST_ADDR_H_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegNalTblAddrHi;

}

static MS_U32 _HVD_EX_Get_NAL_TAB_LEN(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegNalTblLen = HVD_REG_NAL_TAB_LEN(u32RB);
...
#endif
    {
        u32RegNalTblLen = HVD_REG_NAL_TAB_LEN(u32RB);
...
#endif
    {
        u32RegNalTblLen = HVD_REG_NAL_TAB_LEN_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblLen = EVD_REG_NAL_TAB_LEN_BS3;
        else
            u32RegNalTblLen = HVD_REG_NAL_TAB_LEN_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegNalTblLen = EVD_REG_NAL_TAB_LEN_BS4;
        else
            u32RegNalTblLen = HVD_REG_NAL_TAB_LEN_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegNalTblLen;

}



static MS_U32 _HVD_EX_Get_ESB_ST_ADDR_L(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegEsbAddrLo = HVD_REG_ESB_ST_ADDR_L(u32RB);
...
#endif
    {
        u32RegEsbAddrLo = HVD_REG_ESB_ST_ADDR_L(u32RB);
...
#endif
    {
        u32RegEsbAddrLo =  HVD_REG_ESB_ST_ADDR_L_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbAddrLo = EVD_REG_ESB_ST_ADDR_L_BS3;
        else
            u32RegEsbAddrLo = HVD_REG_ESB_ST_ADDR_L_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbAddrLo = EVD_REG_ESB_ST_ADDR_L_BS4;
        else
            u32RegEsbAddrLo = HVD_REG_ESB_ST_ADDR_L_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegEsbAddrLo;

}


static MS_U32 _HVD_EX_Get_ESB_ST_ADDR_H(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegEsbAddrHi = HVD_REG_ESB_ST_ADDR_H(u32RB);
...
#endif
    {
        u32RegEsbAddrHi = HVD_REG_ESB_ST_ADDR_H(u32RB);
...
#endif
    {
        u32RegEsbAddrHi =  HVD_REG_ESB_ST_ADDR_H_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbAddrHi = EVD_REG_ESB_ST_ADDR_H_BS3;
        else
            u32RegEsbAddrHi = HVD_REG_ESB_ST_ADDR_H_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbAddrHi = EVD_REG_ESB_ST_ADDR_H_BS4;
        else
            u32RegEsbAddrHi = HVD_REG_ESB_ST_ADDR_H_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegEsbAddrHi;

}



static MS_U32 _HVD_EX_Get_ESB_LENGTH_L(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegEsbLenLo = HVD_REG_ESB_LENGTH_L(u32RB);
...
#endif
    {
        u32RegEsbLenLo = HVD_REG_ESB_LENGTH_L(u32RB);
...
#endif
    {
        u32RegEsbLenLo =  HVD_REG_ESB_LENGTH_L_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbLenLo = EVD_REG_ESB_LENGTH_L_BS3;
        else
            u32RegEsbLenLo = HVD_REG_ESB_LENGTH_L_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbLenLo = EVD_REG_ESB_LENGTH_L_BS4;
        else
            u32RegEsbLenLo = HVD_REG_ESB_LENGTH_L_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegEsbLenLo;

}


static MS_U32 _HVD_EX_Get_ESB_LENGTH_H(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegEsbLenHi = HVD_REG_ESB_LENGTH_H(u32RB);
...
#endif
    {
        u32RegEsbLenHi = HVD_REG_ESB_LENGTH_H(u32RB);
...
#endif
    {
        u32RegEsbLenHi =  HVD_REG_ESB_LENGTH_H_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbLenHi = EVD_REG_ESB_LENGTH_H_BS3;
        else
            u32RegEsbLenHi = HVD_REG_ESB_LENGTH_H_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegEsbLenHi = EVD_REG_ESB_LENGTH_H_BS4;
        else
            u32RegEsbLenHi = HVD_REG_ESB_LENGTH_H_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);


    return u32RegEsbLenHi;

}


static MS_U32 _HVD_EX_Get_MIF_BBU(MS_U32 u32Id)
{
//#if (HVD_ENABLE_MVC || (!VDEC3))
#if (HVD_ENABLE_MVC) || !defined(VDEC3)
    MS_U8 u8TaskId = HAL_VPU_EX_GetTaskId(u32Id);
...
//        HVD_ShareMem *pShm = (HVD_ShareMem *) HAL_HVD_EX_GetShmAddr(u32Id);
    ...
    MS_U32 u32RegMIFBBU = HVD_REG_MIF_BBU(u32RB);
...
#endif
    {
        u32RegMIFBBU = HVD_REG_MIF_BBU(u32RB);
...
#endif
    {
        u32RegMIFBBU =  HVD_REG_MIF_BBU_BS2(u32RB);
    }
#ifdef VDEC3
    else if (2 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegMIFBBU = EVD_REG_MIF_BBU_BS3;
        else
            u32RegMIFBBU = HVD_REG_MIF_BBU_BS5;
    }
#ifdef VDEC3
    else if (3 == pCtrl->u32BBUId)
#else
    ...
    {
        if(isEVD)
            u32RegMIFBBU = EVD_REG_MIF_BBU_BS4;
        else
            u32RegMIFBBU = HVD_REG_MIF_BBU_BS6;
    }
    else
        HVD_PRINT("Error bbu_id = %d , %s:%d\n", pCtrl->u32BBUId, __FUNCTION__, __LINE__);
...
static MS_U32 _HVD_EX_GetESReadPtr(MS_U32 u32Id, MS_BOOL bDbug)
{
    ...
    if (((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK) == E_HVD_INIT_INPUT_DRV) || (TRUE == bDbug))
    {
        ...
        u32Data = _HVD_Read2Byte(_HVD_EX_Get_REG_ES_RPTR_L(u32Id)) & 0xFFC0;
        u32Data >>= 6;
        u32Data |= _HVD_Read2Byte(_HVD_EX_Get_REG_ES_RPTR_H(u32Id)) << 10;
...
static void _HVD_EX_SetBufferAddr(MS_U32 u32Id)
{
    ...
    u32RB = pHVDHalContext->_stHVDStream[u8Idx].u32RegBase;
    ...
    bIsEVD = _HAL_EX_IS_EVD(pCtrl->InitParams.u32ModeFlag);
    memset(&taskInfo, 0, sizeof(VPU_EX_TaskInfo));
...
#endif
        {
            HVD_EX_MSG_ERR("ESB start addr=%lx\n", (unsigned long)u32StAddr);
    ...
    {
        _HVD_Write2Byte(_HVD_EX_Get_ESB_ST_ADDR_L(u32Id), HVD_LWORD(u32StAddr >> 3));
        _HVD_Write2Byte(_HVD_EX_Get_ESB_ST_ADDR_H(u32Id), HVD_HWORD(u32StAddr >> 3));

        _HVD_Write2Byte(_HVD_EX_Get_ESB_LENGTH_L(u32Id), HVD_LWORD(u32Length));
        _HVD_Write2Byte(_HVD_EX_Get_ESB_LENGTH_H(u32Id), HVD_HWORD(u32Length));
    }
#else
    if (0 == u8TaskId)
    {
    ...
    if (!bESBufferAlreadySet)
    {
        u16Reg = _HVD_Read2Byte(_HVD_EX_Get_MIF_BBU(u32Id));

        if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_INPUT_MASK) == E_HVD_INIT_INPUT_TSP)
        {
            if (pCtrl->u32BBUId == 0)
                u16Reg |= HVD_REG_BBU_TSP_INPUT;
            else if (pCtrl->u32BBUId == 1)
                u16Reg |= HVD_REG_BBU_TSP_INPUT_BS2;
            else if (pCtrl->u32BBUId == 2)
            {
                if(bIsEVD)
                    u16Reg |= EVD_REG_BBU_TSP_INPUT_BS3;
                else
                    u16Reg |= HVD_REG_BBU_TSP_INPUT_BS5;
            }
            else
            {
                if(bIsEVD)
                    u16Reg |= EVD_REG_BBU_TSP_INPUT_BS4;
                else
                    u16Reg |= HVD_REG_BBU_TSP_INPUT_BS6;
            }
        }
        else
        {
        ...
        {
            if(bIsEVD)
                u16Reg &= ~EVD_REG_BBU_PASER_MASK_BS3;
            else
                u16Reg &= ~HVD_REG_BBU_PASER_MASK_BS5;
        }
        else
        {
            if(bIsEVD)
                u16Reg &= ~EVD_REG_BBU_PASER_MASK_BS4;
            else
                u16Reg &= ~HVD_REG_BBU_PASER_MASK_BS6;
        }
        ...
        else if (pCtrl->u32BBUId == 2)
        {
            ...
            if (!bIsEVD)
            {
                u16Reg &= ~HVD_REG_BBU_AUTO_NAL_TAB_BS5;
            }
            else
#endif
            {
                if (bIsEVD)
                    u16Reg |= EVD_REG_BBU_AUTO_NAL_TAB_BS3;
                else
                    u16Reg |= HVD_REG_BBU_AUTO_NAL_TAB_BS5;
            }
        ...
        else
        {
            ...
            if (!bIsEVD)
            {
                u16Reg &= ~HVD_REG_BBU_AUTO_NAL_TAB_BS6;
            }
            else
#endif
            {
                if (bIsEVD)
                    u16Reg |= EVD_REG_BBU_AUTO_NAL_TAB_BS4;
                else
                    u16Reg |= HVD_REG_BBU_AUTO_NAL_TAB_BS6;
            }
        ...
        _HVD_Write2Byte(_HVD_EX_Get_MIF_BBU(u32Id), u16Reg);
    }
#else
    if (0 == u8TaskId)
    {
    ...
    if ((pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK) == E_HVD_INIT_HW_MVC)
    {
        ...
        //HVD_PRINT("**************** Buffer setting for MVC dual-BBU *************\n");
...
static MS_U32 _HVD_EX_GetESQuantity(MS_U32 u32Id)
{
    ...
    //HVD_PRINT("ES Quantity <0x%lx> W:0x%lx, R:0x%lx, Q:0x%lx.\n",u32Id,u32Wptr,u32Rptr,u32Ret);
    return u32Ret;
}

#if 0//(HVD_ENABLE_IQMEM)
...
static HVD_Return _HVD_EX_UpdateESWptr_VP8(MS_U32 u32Id, MS_U32 u32NalOffset, MS_U32 u32NalLen, MS_U32 u32NalOffset2, MS_U32 u32NalLen2)
{
    ...
    /*
    HVD_PRINT("nal2 offset=0x%x, len=0x%x\n",
...
static HVD_Frm_Information *_HVD_EX_GetNextDispFrame(MS_U32 u32Id)
{
    ...
    if (bDolbyVision)
    {
        if (bfirstTime && u16QNum < 4) // first time we need to wait 4 pic to ensure we got the correct layer type
        {
            return NULL;
        }
        else
            ...
            if (u16QNum > u16UsedFrm)
            {
                ...
                if (pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT) // Must Be
                {
                    ...
                    else
                    {
                        ...
                        if(bDolbyVision)
                        {
                            volatile HVD_Frm_Information *pPrevHvdFrm = (volatile HVD_Frm_Information*)&pShm->DispQueue[u16QPtr - 1]; //BL
                            HVD_PRINT("EL pts: %d, u16QPtr: %d, u16QNum:%d, u32PrivateData:%d\n", pHvdFrm->u32TimeStamp, u16QPtr, u16QNum, pHvdFrm->u32PrivateData);
        ...
        while (u16QNum > 0)
        {
            ...
            if (pHVDHalContext->pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT)
            {
                ...
                if((u16QPtr % 2) == 0)
                {
                    ...
                    {
                        ///HVD_PRINT("[MVC] %d is not E_HVD_DISPQ_STATUS_INIT (%ld).\n",u16QPtr+1,pHvdFrm_sub->u32Status);
                        ///HVD_PRINT("Return NULL.\n");
                        return NULL;
                    }
                }
                ...
                if (pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT) // Must Be
                {
                    ...
                    else // first get frame, we will check at least one paired in disp queue.
                    {
                        ...
                        else
                        {
                            ...
                            return (HVD_Frm_Information *)pHvdFrm_first;
                        }
                    }
                }
                u16QNum--;
            ...
            if (pHVDHalContext->_stHVDStream[u8Idx].bDispOutSide)
            {
                ...
                while (u16QNum != 0)
                {
                    ...
                    if (pHvdFrm->u32Status == E_HVD_DISPQ_STATUS_INIT) // Must Be
                    {
                        ...
                        pHvdFrm->u32Status = E_HVD_DISPQ_STATUS_VIEW;
                        HAL_HVD_EX_SetCmd(u32Id, E_HVD_CMD_UPDATE_DISPQ, pHvdFrm->u32PrivateData);
                        HVD_EX_MSG_DBG("FrameDone(%d): %d, Luma=0x%x, Chroma=0x%x, w=%d,h=%d\n", __LINE__,  u16QPtr,
                                       pHvdFrm->u32LumaAddr, pHvdFrm->u32ChromaAddr, pHvdFrm->u16Width, pHvdFrm->u16Height);
                        return (HVD_Frm_Information*)(MS_VIRT)pHvdFrm;
                    }
                    u16QNum--;
                    //go to next frame in the dispQ
...
void HAL_HVD_MIF1_MiuClientSel(MS_U8 u8MiuSel)
{
    ...
    if (u8MiuSel == E_CHIP_MIU_0)
    {
        ...
        //_HVD_WriteWordMask(MIU2_CLIENT_SELECT_GP4, 0, MIU2_CLIENT_SELECT_GP4_HVD_MIF1);
    }
    ...
    {
        _HVD_WriteWordMask(MIU0_CLIENT_SELECT_GP4, 0, MIU0_CLIENT_SELECT_GP4_HVD_MIF1);
        _HVD_WriteWordMask(MIU2_CLIENT_SELECT_GP4, MIU2_CLIENT_SELECT_GP4_HVD_MIF1, MIU2_CLIENT_SELECT_GP4_HVD_MIF1);
    }*/
...
//    MS_U32 u32StartOffset;
    ...
    if (E_HVD_INIT_HW_VP9 != (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
        ...
        if(isHVD)
        {
            ...
            {
                HVD_EX_MSG_INF("HVD power on\n");
#ifdef CONFIG_MSTAR_CLKM
                HAL_HVD_EX_PowerCtrl_CLKM(u32Id, TRUE);
#else
    ...
    if (isEVD)
    {
        ...
        {
            HVD_EX_MSG_INF("EVD power on\n");
#ifdef CONFIG_MSTAR_CLKM
            HAL_EVD_EX_PowerCtrl_CLKM(u32Id, TRUE);
#else
    ...
    if ((!HAL_VPU_EX_HVDInUsed()) )
    {
        ...
        HVD_EX_MSG_INF("HVD_REG_RESET_SWRST done\n");
...
#if defined(CHIP_K6)
        _HVD_WriteWordMask(HVD_REG_RESET, HVD_REG_RESET_MIU_128 , HVD_REG_RESET_MIU_128);
        _HVD_WriteWordMask(HVD_REG_RESET, HVD_REG_RESET_MIU1_128 , HVD_REG_RESET_MIU1_128 );
        _HVD_WriteWordMask(HVD_REG_RESET, 0 , HVD_REG_RESET_MIU_256 );
        _HVD_WriteWordMask(HVD_REG_RESET, 0 , HVD_REG_RESET_MIU1_256);
#elif defined(CHIP_I2)
        ...
        //BWA
        _HVD_Write2Byte(HVD_REG_BWA_CLK, ((_HVD_Read2Byte(HVD_REG_BWA_CLK)) & ((~HVD_REG_CLK_HVD_SW_OV_EN & ~HVD_REG_CLK_HVD_IDB_SW_OV_EN))));
    ...
    {
#ifdef VDEC3
        if (!HAL_VPU_EX_EVDInUsed() && !HAL_VPU_EX_HVDInUsed())
#endif
...
#endif
            {
                _HVD_WriteWordMask(EVD_BBU23_SETTING, REG_TSP2EVD_EN_BS3, REG_TSP2EVD_EN_BS3);
            }
            else
            {
#ifdef VDEC3
...
#else
                if (u8TaskId > 3)
                    HVD_PRINT("Error u8TaskId = %d , %s:%d\n", u8TaskId, __FUNCTION__, __LINE__);
#endif

                _HVD_WriteWordMask(EVD_BBU23_SETTING, REG_TSP2EVD_EN_BS4, REG_TSP2EVD_EN_BS4);
            }
        }
        goto RESET;
    }
...
RESET:
    ...
    if (isEVD)
    {
        ...
        {
#if defined(CHIP_K6)
            HVD_EX_MSG_INF("EVD miu 128 bits\n");
            ...
            HVD_EX_MSG_INF("EVD BBU 128 bits\n");
...
#elif defined(CHIP_I2)
            HVD_EX_MSG_INF("EVD miu 256 bits\n");
            _HVD_Write2Byte(EVD_REG_RESET, (_HVD_Read2Byte(EVD_REG_RESET) & ~EVD_REG_RESET_MIU0_128 & ~EVD_REG_RESET_MIU1_128));
            _HVD_Write2Byte(EVD_REG_RESET, (_HVD_Read2Byte(EVD_REG_RESET) | EVD_REG_RESET_MIU0_256 | EVD_REG_RESET_MIU1_256));
            HVD_EX_MSG_INF("EVD BBU 256 bits\n");
            _HVD_Write2Byte(EVD_BBU_MIU_SETTING, (_HVD_Read2Byte(EVD_BBU_MIU_SETTING) & ~REG_BBU_MIU_128));
            _HVD_Write2Byte(EVD_BBU_MIU_SETTING, (_HVD_Read2Byte(EVD_BBU_MIU_SETTING) | REG_BBU_MIU_256));
            _HVD_Write2Byte(REG_CLK_EVD, (_HVD_Read2Byte(REG_CLK_EVD) & ~REG_CLK_EVD_SW_OV_EN & ~REG_CLK_EVD_PPU_SW_OV_EN));//set 0 firmware
#endif
    ...
    if (!HAL_VPU_EX_HVDInUsed())
    {
        ...
        HVD_EX_MSG_INF("HVD_REG_RESET_SWRST reset done!!!\n");
    }
...
#ifdef CONFIG_MSTAR_CLKM
        HAL_HVD_EX_PowerCtrl_CLKM(u32Id, FALSE);
#else
...
static void HAL_VP8_PowerCtrl(MS_BOOL bEnable)
{
    if (bEnable)
    {
        ...
        switch (*(pHVDHalContext->pu32HVDClockType))
        {
            case 384:
            {
...
void HAL_HVD_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    switch (*(pHVDHalContext->pu32HVDClockType))
    {
		case 576:
		{
			_HVD_WriteWordMask(REG_TOP_HVD,     TOP_CKG_HVD_576MHZ,     TOP_CKG_HVD_CLK_MASK);
			_HVD_WriteWordMask(REG_TOP_HVD_IDB, TOP_CKG_HVD_IDB_576MHZ, TOP_CKG_HVD_IDB_CLK_MASK);
			break;
		}
        case 432:
        {
...
//    *(pHVDHalContext->pu32VPUClockType) = (MS_U32) pCtrl->InitParams.u16DecoderClock;
//    *(pHVDHalContext->pu32HVDClockType) = (MS_U32) pCtrl->InitParams.u16DecoderClock;
    // Create mutex
    //_HAL_HVD_MutexCreate();
...
#endif
{
    ...
    pShm->u32CPUClock = *(pHVDHalContext->pu32VPUClockType);
    pShm->u32UserCCIdxWrtPtr = 0xFFFFFFFF;
    pShm->DispFrmInfo.u32TimeStamp = 0xFFFFFFFF;
    //Chip info
#if defined(CHIP_K6)
    pShm->u16ChipID = E_MSTAR_CHIP_K6;
    pShm->u16ChipECONum = pCtrl->InitParams.u16ChipECONum;
#elif defined(CHIP_I2)
    pShm->u16ChipID = E_MSTAR_CHIP_K6;   //E_MSTAR_CHIP_I2;
    #ifdef CHIP_I2_FPGA
    pShm->u16ChipECONum = 0xFF;
    #else
    pShm->u16ChipECONum = pCtrl->InitParams.u16ChipECONum;
    #endif
#endif
    ...
    if (pHVDHalContext->pHVDPreCtrl_Hal[u8Idx]->bEnableForceStartNonISlice)
    {
    ...
    // disable AVC fluidplay temporarily
    if (E_HVD_INIT_HW_HEVC == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK)
            || E_HVD_INIT_HW_AVC == (pCtrl->InitParams.u32ModeFlag & E_HVD_INIT_HW_MASK))
    {
...
HVD_Return HAL_HVD_EX_SetData(MS_U32 u32Id, HVD_SetData u32type, MS_VIRT u32Data)
{
    ...
    switch (u32type)
    {
        ...
        case E_HVD_SDATA_NDS_AVC_FAST_FLUSH:
        {
            pShm->bFastFlush = (MS_BOOL)u32Data;
            break;
        }
        case E_HVD_SDATA_PLAYBACK_INTERVAL_START_PTS:
        {
            pShm->u32PlayIntvlStartPts = u32Data;
            break;
        }
        case E_HVD_SDATA_PLAYBACK_INTERVAL_END_PTS:
        {
            pShm->u32PlayIntvlEndPts = u32Data;
            break;
        }
        // SRAM
        ...
        {
            MS_U8 u8DVLevel = u32Data & 0x00ff;
            MS_U8 u8DVProfile = (u32Data >> 8) & 0x00ff;

            pShm->u8DVLevelFromDriverAPI = u8DVLevel;
            pShm->u8DVProfileFromDriverAPI = u8DVProfile;
        }
        ...
        case E_HVD_SDATA_DISPQ_STATUS_VIEW:
        {
            ...
            {
                //HVD_PRINT("DispFrame DqPtr: %d\n", u32Data);
                pShm->DispQueue[u32Data].u32Status = E_HVD_DISPQ_STATUS_VIEW;
            }
            break;
        }
        case E_HVD_SDATA_DISPQ_ADD_REF:
        {
            if (pHVDHalContext->_stHVDStream[u8Idx].bDispOutSide)
            {
                if (bMVC || (bDolbyVision && !pShm->bSingleLayer))
                {
                    if (pHVDHalContext->_stHVDStream[u8Idx].u32RefData == 0xFFFF)
                    {
                        pHVDHalContext->_stHVDStream[u8Idx].u32RefData = u32Data;
                    }
                    else
                    {
                        HAL_HVD_EX_SetCmd(u32Id, E_HVD_CMD_ADD_REF_DISPQ, (u32Data << 16) | pHVDHalContext->_stHVDStream[u8Idx].u32RefData);
                        pHVDHalContext->_stHVDStream[u8Idx].u32RefData = 0xFFFF;
                    }
                }
                else
                {
                    HAL_HVD_EX_SetCmd(u32Id, E_HVD_CMD_ADD_REF_DISPQ, u32Data);
                }
            }
            break;
        }
        ...
        case E_HVD_SDATA_TRICK_SMOOTH_SCAN:
        {
            HVD_EX_DEF_TrickSmoothScan *stTrickSmoothScan = (HVD_EX_DEF_TrickSmoothScan *)u32Data;
            VPU_EX_TrickSmoothScan stVpuStrickSmoothScan;
            stVpuStrickSmoothScan.bEnable = stTrickSmoothScan->bEnable;
            stVpuStrickSmoothScan.eDispSpeed = (VPU_EX_DispSpeed)stTrickSmoothScan->eDispSpeed;
            HAL_VPU_EX_TrickSmoothScan(u32Id, &stVpuStrickSmoothScan);
            stTrickSmoothScan->eSmoothScanMode = (HVD_EX_DEF_SmoothScanMode)stVpuStrickSmoothScan.eSmoothScanMode;
            break;
        }
        default:
            break;
...
MS_S64 HAL_HVD_EX_GetData_EX(MS_U32 u32Id, HVD_GetData eType)
{
    ...
    switch (eType)
    {
        case E_HVD_GDATA_PTS_STC_DIFF:
            ...
            break;
        case E_HVD_GDATA_TS_SEAMLESS_TARGET_PTS:
            s64Ret = (MS_S64)(pShm->u64SeamlessTargetPTS);  //33bit PTS is compatible in S64
            break;
        default:
            break;
    }
...
MS_VIRT HAL_HVD_EX_GetData(MS_U32 u32Id, HVD_GetData eType)
{
    ...
    if(pShm == NULL)
    {
        HVD_PRINT("########## VDEC patch for Debug ###########\n");
        return 0x0;
    }
    ...
    switch (eType)
    {
        ...
        case E_HVD_GDATA_EXTEND_DISP_INFO_ADDR:
        {
            u32Ret = (MS_VIRT) (&pShm->ExtendDispInfo);
            break;
        }
        ...
        case E_HVD_GDATA_TS_SEAMLESS_STATUS:
            ...
            break;
        case E_HVD_GDATA_TS_SEAMLESS_TARGET_POC:
            u32Ret = pShm->u32SeamlessTargetPOC;
            break;
        ...
        case E_HVD_GDATA_SEQ_CHANGE_INFO:
            ...
            break;
        case E_HVD_GDATA_GET_NOT_SUPPORT_INFO:
            u32Ret = pShm->u32NotSupportInfo;
            break;
        case E_HVD_GDATA_GET_MIN_TSP_DATA_SIZE:
            u32Ret = pShm->u32CurMinTspDataSize;
            break;
        case E_HVD_GDATA_CREATETASK_TIME:
            u32Ret = (MS_U32)pShm->u32TaskTime;
            break;
        case E_HVD_GDATA_PLAY_TIME:
            u32Ret = (MS_U32)pShm->u32PlayCmdTime;
            break;
        case E_HVD_GDATA_RECEIVEDATA_TIME:
            u32Ret = (MS_U32)pShm->u32MVDParserWriteTime;
            break;
        case E_HVD_GDATA_SEQHEADERFOUND_TIME:
            u32Ret = (MS_U32)pShm->u32SEQHeaderTime;
            break;
        case E_HVD_GDATA_DECODEFIRSTI_TIME:
            u32Ret = (MS_U32)pShm->u32Decode_I_Time;
            break;
        case E_HVD_GDATA_PUSHFIRSTI_TIME:
            u32Ret = (MS_U32)pShm->u32Push_I_Time;
            break;
        case E_HVD_GDATA_FIRSTVSYNC_TIME:
            u32Ret = (MS_U32)pShm->u32ReceiveVsyncTime;
            break;
        case E_HVD_GDATA_FIRSTFRAMEDISP_TIME:
            u32Ret = (MS_U32)pShm->u32DisplayOneFrameTime;
            break;
        case E_HVD_GDATA_IFRAMECOUNT:
            u32Ret = (MS_U32)pShm->u32IFrameNum;
            break;
        case E_HVD_GDATA_PFRAMECOUNT:
            u32Ret = (MS_U32)pShm->u32PFrameNum;
            break;
        case E_HVD_GDATA_BFRAMECOUNT:
            u32Ret = (MS_U32)pShm->u32BFrameNum;
            break;
        case E_HVD_GDATA_VSYNCCOUNT:
            u32Ret = (MS_U32)pShm->u32VsyncCnt;
            break;
        case E_HVD_GDATA_FRAMEBUFFER_NUM:
            u32Ret = (MS_U32)pShm->u8FrameBufNum;
            break;
        ...
        case E_HVD_GDATA_HVD_DECODE_SIMPLE_INFO:
            ...
            HAL_HVD_EX_FlushMemory();
            u32Ret = (MS_VIRT) (&_stSimpleFrm[u8Idx]);
            break;
        default:
            break;
    }
...
MS_U32 HAL_HVD_EX_Get_DV_Support_Profiles(void)
{
...
DV_Stream_Level HAL_HVD_EX_Get_DV_Support_Highest_Level(DV_Stream_Profile pDV_Stream_Profile)
{
    switch (pDV_Stream_Profile)
    {
        ...
        case E_DV_STREAM_PROFILE_ID_DVHE_DER:
            return E_DV_STREAM_LEVEL_ID_UHD48;// level 8
...
void HAL_HVD_EX_Dump_FW_Status(MS_U32 u32Id)
{
    ...
    if (u32UartCtrl & E_HVD_UART_CTRL_DBG)
    {
        ...
        HVD_PRINT("\tSystime=%u, FWVersionID=0x%x, FwState=0x%x, ErrCode=0x%x, ProgCnt=0x%x\n",
                  HVD_GetSysTime_ms(), pShm->u32FWVersionID, pShm->u32FwState, (MS_U32) pShm->u16ErrCode, HAL_VPU_EX_GetProgCnt());

        HVD_PRINT("\tTime: DispSTC=%u, DispT=%u, DecT=%u, CurrentPts=%u, Last Cmd=0x%x, Arg=0x%x, Rdy1=0x%x, Rdy2=0x%x\n",
        ...
        HVD_PRINT("\tFlag: InitDone=%d, SpsChange=%d, IsIFrmFound=%d, 1stFrmRdy=%d, SyncStart=%d, SyncReach=%d\n",
                  pShm->bInitDone, pShm->bSpsChange, pShm->bIsIFrmFound,
                  pShm->bIs1stFrameRdy, pShm->bIsSyncStart, pShm->bIsSyncReach);

        HVD_PRINT("\tQueue: BBUQNumb=%u, DecQNumb=%d, DispQNumb=%d, ESR=%u, ESRfromFW=%u, ESW=%u, ESLevel=%u\n",
        ...
        HVD_PRINT("\tCounter: DecodeCnt=%u, DispCnt=%u, DataErrCnt=%u, DecErrCnt=%u, SkipCnt=%u, DropCnt=%u, idle=%u, MainLoopCnt=%u, VsyncCnt=%u\n",
...
MS_U32 HAL_HVD_EX_GetDVSupportProfiles(void)
{
    ...
    return E_DV_STREAM_PROFILE_ID_DVAV_PER | E_DV_STREAM_PROFILE_ID_DVHE_DER | E_DV_STREAM_PROFILE_ID_DVHE_DTR | E_DV_STREAM_PROFILE_ID_DVHE_STN | E_DV_STREAM_PROFILE_ID_DVHE_DTH;
#else
    return E_DV_STREAM_PROFILE_ID_UNSUPPORTED;
#endif
}
...
{
#if 1
    // Doesn't support any DV profile
    return E_DV_STREAM_LEVEL_ID_UNSUPPORTED;
#else
...
//            HVD_PRINT("Q2[%d]: %ld\n", u16QPtr, pShm->DispQueue[u16QPtr].u32Status);
    ...
    //HVD_PRINT("dispQnum = %ld, pShm->u16DispQNumb = %d\n", u32DispQNum, pShm->u16DispQNumb);
    return u32DispQNum;
#else
...
static void HAL_EVD_EX_PowerCtrl(MS_U32 u32Id, MS_BOOL bEnable)
{
    ...
    switch (*(pHVDHalContext->pu32EVDClockType))
    {
        case 576:
        {
#ifdef CHIP_I2
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU, TOP_CKG_EVD_PPU_PLL_BUF, TOP_CKG_EVD_PPU_MASK);
            _HVD_WriteWordMask(REG_TOP_CKG_EVD, TOP_CKG_EVD_PPU_PLL_BUF, TOP_CKG_EVD_MASK);
#else
            _HVD_WriteWordMask(REG_TOP_CKG_EVD_PPU, TOP_CKG_EVD_PPU_PLL_BUF, TOP_CKG_EVD_PPU_MASK);
...
#endif /* CONFIG_MSTAR_SRAMPD */
#endif /* _DISABLE_CLK_CTL */
    return;
}
...
#endif
    {
        _HVD_Write2Byte(EVD_BBU23_SETTING, (_HVD_Read2Byte(EVD_BBU23_SETTING) & ~REG_TSP2EVD_EN_BS3));  //0: tsp2hvd, coz EVD & HVD use the same MVD parser for bbu3-DTV mode
    }
    else
    {
#ifdef VDEC3
        ...
        if (u8TaskId > 3)
            HVD_PRINT("Error u8TaskId = %d , %s:%d\n", u8TaskId, __FUNCTION__, __LINE__);
#endif
        _HVD_Write2Byte(EVD_BBU23_SETTING, (_HVD_Read2Byte(EVD_BBU23_SETTING) & ~REG_TSP2EVD_EN_BS4));  //0: tsp2hvd, coz EVD & HVD use the same MVD parser for bbu4-DTV mode
    }
    return;
}
...
#ifdef CONFIG_MSTAR_CLKM
        HAL_EVD_EX_PowerCtrl_CLKM(u32Id, FALSE);
#else
...
static void HAL_VP9_EX_PowerCtrl(MS_BOOL bEnable)
{
    ...
    switch (*(pHVDHalContext->pu32VP9ClockType))
    {
        case 432:
        {
...
void HAL_HVD_EX_SetNalTblAddr(MS_U32 u32Id)
{
    ...
    {
        _HVD_Write2Byte(_HVD_EX_Get_NAL_TBL_ST_ADDR_L(u32Id), (MS_U16) (u32StAddr >> 3));
        _HVD_Write2Byte(_HVD_EX_Get_NAL_TBL_ST_ADDR_H(u32Id), (MS_U16) (u32StAddr >> 19));
        // -1 is for NAL_TAB_LEN counts from zero.
        _HVD_Write2Byte(_HVD_EX_Get_NAL_TAB_LEN(u32Id), (MS_U16) (pHVDHalContext->_stHVDStream[u8Idx].u32BBUEntryNum - 1));
    }
#else
    if (0 == u8TaskId)
    {
...
MS_U32 HAL_HVD_EX_GetEVDHWBuffer(void)
{
    return  EVD_HW_BUFFER;
}

void HAL_HVD_GetIPBV(MS_U32 u32Id, void* pCounter)
{
    HVD_EX_MDBCounter* temp = (HVD_EX_MDBCounter*)pCounter;
    temp->u32ICounter = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_IFRAMECOUNT);
    temp->u32PCounter = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_PFRAMECOUNT);
    temp->u32BCounter = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_BFRAMECOUNT);
    temp->u32VCounter = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_VSYNCCOUNT);
}

void HAL_HVD_GetPerf(MS_U32 u32Id, void* pPerf)
{
    HVD_EX_MDBPerformance* temp = (HVD_EX_MDBPerformance*)pPerf;
    temp->u32CreateTask = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_CREATETASK_TIME);
    temp->u32Play = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_PLAY_TIME);
    temp->u32ReceiveData = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_RECEIVEDATA_TIME);
    temp->u32SeqHeadFound = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_SEQHEADERFOUND_TIME);
    temp->u32FirstIDecode = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_DECODEFIRSTI_TIME);
    temp->u32FirstFramePush = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_PUSHFIRSTI_TIME);
    temp->u32FirstVsync = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_FIRSTVSYNC_TIME);
    temp->u32FirstFrameDisp = HAL_HVD_EX_GetData(u32Id, E_HVD_GDATA_FIRSTFRAMEDISP_TIME);
}

#else

MS_VIRT HAL_HVD_EX_GetVpuShmAddr(MS_U8 u8Idx, MS_PHY pVPUCodecAddr)
{
    MS_PHY u32PhyAddr = 0x0;
    ...
    u32PhyAddr = pVPUCodecAddr + (u8Idx * HVD_FW_MEM_OFFSET) + HVD_SHARE_MEM_ST_OFFSET;
