...
#define TOP_CKG_HVD_576MHZ                BITS(4:2, 4)
...
#define TOP_CKG_HVD_IDB_576MHZ              BITS(2:0, 4)
...
#define MIU0_RQ_REG_HVD_BASE            (0x210600)      //bank: 0x3106-->(0xfd200000+0x2106*2)
#define MIU0_RQ_REG_HVD_BASE2          	(0x210200)      //bank: 0x3102-->(0xfd200000+0x2102*2)
...
#ifdef CHIP_I2
#define MIU0_REG_RQ0_MASK                 (MIU0_RQ_REG_HVD_BASE+(( 0x0003)<<1))
#define MIU0_REG_RQ1_MASK                 (MIU0_RQ_REG_HVD_BASE+(( 0x0023)<<1))
#define MIU0_REG_RQ2_MASK                 (MIU0_RQ_REG_HVD_BASE+(( 0x0043)<<1))
#define MIU0_REG_RQ3_MASK                 (MIU0_RQ_REG_HVD_BASE+(( 0x0063)<<1))
#define MIU0_REG_RQ4_MASK                 (MIU0_RQ_REG_HVD_BASE2+(( 0x0003)<<1))
#define MIU0_REG_RQ5_MASK                 (MIU0_RQ_REG_HVD_BASE2+(( 0x0023)<<1))
#else
