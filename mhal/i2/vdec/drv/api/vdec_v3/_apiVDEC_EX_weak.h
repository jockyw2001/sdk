...
__vdec_if MS_BOOL MDrv_MVD_SetCodecInfo(MS_U32 u32Id, MVD_CodecType u8CodecType, MVD_SrcMode u8BSProviderMode, MS_U8 bDisablePESParsing) __vdec_weak;
...
__vdec_if void MDrv_MVD_RstIFrameDec(MS_U32 u32Id, MVD_CodecType eCodecType, MS_BOOL bShareBBU) __vdec_weak;
...
__vdec_if void MDrv_MVD_GetErrInfo(MS_U32 u32Id, MVD_ErrCode *errCode, MVD_ErrStatus *errStatus, MS_U32*) __vdec_weak;
...
__vdec_if MS_BOOL MDrv_MVD_Set_Playback_Interval(MS_U32 u32Id, MS_U32 u32StartPts, MS_U32 u32EndPts) __vdec_weak;

__vdec_if void MDrv_MVD_RegSetBase(MS_VIRT u32RegBaseAddr) __vdec_weak;
__vdec_if MS_BOOL MDrv_MVD_Init(MS_U32 u32Id, MVD_CodecType eCodecType, MS_BOOL bShareBBU) __vdec_weak;
__vdec_if MS_BOOL MDrv_MVD_Exit(MS_U32 u32Id) __vdec_weak;
__vdec_if E_MVD_Result MDrv_MVD_Rst(MS_U32 u32Id, MVD_CodecType eCodecType, MS_BOOL bShareBBU) __vdec_weak;
...
__vdec_if MS_VIRT MDrv_MVD_GetESReadPtr(MS_U32 u32Id) __vdec_weak;
__vdec_if MS_VIRT MDrv_MVD_GetESWritePtr(MS_U32 u32Id) __vdec_weak;
...
__vdec_if E_MVD_Result MDrv_MVD_SetDynScalingParam(MS_U32 u32Id, MS_PHY u32StAddr, MS_SIZE u32Size) __vdec_weak;
...
__vdec_if MS_BOOL MDrv_MVD_AddRef(MS_U32 u32Id, MS_U8 u8FrmIdx) __vdec_weak;
...
__vdec_if E_MVD_Result MDrv_MVD_REE_GetVsyncExtShm(MS_U32 u32Id, MS_VIRT* u32SHMAddr, MS_VIRT* u32VsyncExtShmOffset) __vdec_weak;
__vdec_if E_MVD_Result MDrv_MVD_DisablePBFrameMode(MS_U32 u32Id, MS_BOOL bEn) __vdec_weak;
...
__vdec_if void MDrv_HVD_EX_SetOSRegBase(MS_VIRT u32RegBaseAddr) __vdec_weak;
#ifdef VDEC3
__vdec_if HVD_EX_Result MDrv_HVD_EX_Init(MS_U32 u32Id, HVD_EX_MemCfg *mem, HVD_EX_InitSettings *InitParam, MS_BOOL bFWdecideFB, MS_BOOL bShareBBU, HVD_EX_Original_Stream eStream) __vdec_weak;
#else
...
__vdec_if HVD_EX_Result MDrv_HVD_EX_DecodeIFrame(MS_U32 u32Id, MS_PHY u32SrcSt, MS_U32 u32SrcSize) __vdec_weak;
...
__vdec_if MS_VIRT MDrv_HVD_EX_GetESWritePtr(MS_U32 u32Id) __vdec_weak;
__vdec_if MS_VIRT MDrv_HVD_EX_GetESReadPtr(MS_U32 u32Id) __vdec_weak;
...
__vdec_if MS_VIRT MDrv_HVD_EX_GetUserData_Packet(MS_U32 u32Id, MS_U32 u32Idx , MS_U32* u32Size) __vdec_weak;
__vdec_if HVD_EX_Result MDrv_HVD_EX_GenPattern(MS_U32 u32Id, HVD_EX_PatternType eType, MS_VIRT u32VAddr, MS_U32 *u32Size) __vdec_weak;
__vdec_if MS_U32 MDrv_HVD_EX_GetPatternInfo(MS_U32 u32Id, HVD_EX_PatternInfo eType) __vdec_weak;
__vdec_if MS_U64 MDrv_HVD_EX_GetDynamicScalingInfo(MS_U32 u32Id, HVD_EX_DynamicScalingInfo eType) __vdec_weak;

__vdec_if MS_VIRT MDrv_HVD_EX_GetData(MS_U32 u32Id, HVD_EX_GDataType eType) __vdec_weak;
...
__vdec_if HVD_EX_Result MDrv_HVD_EX_SetARChangeMode(MS_U32 u32Id, MS_U32 u32ARChangeMode) __vdec_weak;
#endif
