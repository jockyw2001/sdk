...
static void _VDEC_MapStatus(VDEC_EX_Status* pExStatus, VDEC_Status* pStatus)
{
    ...
    {
        case E_VDEC_EX_STAGE_STOP:
            pStatus->eStage = E_VDEC_STAGE_STOP;
            break;
        case E_VDEC_EX_STAGE_INIT:
            pStatus->eStage = E_VDEC_STAGE_INIT;
            break;
        case E_VDEC_EX_STAGE_PLAY:
            pStatus->eStage = E_VDEC_STAGE_PLAY;
            break;
        case E_VDEC_EX_STAGE_PAUSE:
            pStatus->eStage = E_VDEC_STAGE_PAUSE;
            break;
        default:
            pStatus->eStage = E_VDEC_STAGE_STOP;
            break;
...
MS_BOOL MApi_VDEC_GetStatus(VDEC_Status *pStatus)
{
    ...
    memset(&stExStatus, 0, sizeof(VDEC_EX_Status));
...
void VDEC_TestCC(MS_U32 eFlag, void *param)
{
    ...
    //VPRINTF("testCb eFlag=0x%lx, param=%ld\n", eFlag, *(MS_U32*)param);
    ...
    if ((E_VDEC_EVENT_USER_DATA_FOUND & eFlag) == E_VDEC_EVENT_USER_DATA_FOUND)
    {
        ...
        while (MApi_VDEC_IsCCAvailable())
        {
            if (E_VDEC_OK == MApi_VDEC_GetCCInfo((void*)&ccInfo, sizeof(VDEC_CC_Info)))
            {
                ...
                {
                    VPRINTF("ccInfo: ");
                    VPRINTF("%02d, ", ccInfo.u16TempRef);
                    VPRINTF("%d, ", ccInfo.u8PicStructure);
                    VPRINTF("%d, ", ccInfo.u8TopFieldFirst);
                    VPRINTF("0x%lx, ", ccInfo.u32UserDataBuf);
                    VPRINTF("%ld, ", ccInfo.u32UserDataSize);
                    VPRINTF("%ld\n", ccInfo.u32Pts);
                }
...
static VDEC_EX_SrcMode _VDEC_MapSrcMode(VDEC_SrcMode eSrcMode)
{
    ...
    switch (eSrcMode)
    {
        ...
        case E_VDEC_SRC_MODE_FILE_DUAL_ES:
            ...
            break;
        default:
            VDEC_INFO(VPRINTF("input eSrcMode 0x%x out of range!\n", eSrcMode));
            eExSrcMode = E_VDEC_EX_SRC_MODE_DTV;
            break;
    }
    return eExSrcMode;
...
static VDEC_EX_User_Cmd _VDEC_MapUserCmd(VDEC_User_Cmd eUserCmd)
{
    ...
    switch (eUserCmd)
    {
        case VDEC_USER_CMD_SET_CONTROL_BASE             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_CONTROL_BASE;
            break;
        case VDEC_USER_CMD_REPEAT_LAST_FIELD            :
            eEXUserCmd = E_VDEC_EX_USER_CMD_REPEAT_LAST_FIELD;
            break;
        case VDEC_USER_CMD_AVSYNC_REPEAT_TH             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVSYNC_REPEAT_TH;
            break;
        case VDEC_USER_CMD_DISP_ONE_FIELD               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DISP_ONE_FIELD;
            break;
        case VDEC_USER_CMD_FD_MASK_DELAY_COUNT          :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FD_MASK_DELAY_COUNT;
            break;
        case VDEC_USER_CMD_FRC_OUTPUT                   :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FRC_OUTPUT;
            break;
        case VDEC_USER_CMD_FRC_DROP_TYPE                :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FRC_DROP_TYPE;
            break;
        case VDEC_USER_CMD_FAST_DISPLAY                 :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FAST_DISPLAY;
            break;
        case VDEC_USER_CMD_IGNORE_ERR_REF               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_IGNORE_ERR_REF;
            break;
        case VDEC_USER_CMD_FORCE_FOLLOW_DTV_SPEC        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FORCE_FOLLOW_DTV_SPEC;
            break;
        case VDEC_USER_CMD_AVC_MIN_FRM_GAP              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_MIN_FRM_GAP;
            break;
        case VDEC_USER_CMD_DISABLE_SEQ_CHG              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_SEQ_CHG;
            break;
        case VDEC_USER_CMD_AVC_DISABLE_ANTI_VDEAD       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_DISABLE_ANTI_VDEAD;
            break;
        case VDEC_USER_CMD_DTV_RESET_MVD_PARSER         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DTV_RESET_MVD_PARSER;
            break;
        case VDEC_USER_CMD_PVR_FLUSH_FRAME_BUFFER       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_PVR_FLUSH_FRAME_BUFFER;
            break;
        case VDEC_USER_CMD_SET_DTV_USER_DATA_MODE       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DTV_USER_DATA_MODE;
            break;
        case VDEC_USER_CMD_SET_SINGLE_TASK_MODE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_SINGLE_TASK_MODE;
            break;
        case VDEC_USER_CMD_FORCE_INTERLACE_MODE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FORCE_INTERLACE_MODE;
            break;
        case VDEC_USER_CMD_RELEASE_FD_MASK              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_RELEASE_FD_MASK;
            break;
        case VDEC_USER_CMD_SET_DECODE_MODE              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DECODE_MODE;
            break;
        case VDEC_USER_CMD_SHOW_DECODE_ORDER            :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SHOW_DECODE_ORDER;
            break;
        case VDEC_USER_CMD_SUPPORT_AVC_TO_MVC           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SUPPORT_AVC_TO_MVC;
            break;
        case VDEC_USER_CMD_3DLR_VIEW_EXCHANGE           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_3DLR_VIEW_EXCHANGE;
            break;
        case VDEC_USER_CMD_FORCE_AUTO_MUTE              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FORCE_AUTO_MUTE;
            break;
        case VDEC_USER_CMD_SET_VSIZE_ALIGN              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_VSIZE_ALIGN;
            break;
        case VDEC_USER_CMD_AVC_DISP_IGNORE_CROP         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_DISP_IGNORE_CROP;
            break;
        case VDEC_USER_CMD_SET_DISP_FINISH_MODE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DISP_FINISH_MODE;
            break;
        case VDEC_USER_CMD_SET_AVSYNC_MODE              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_AVSYNC_MODE;
            break;
        case VDEC_USER_CMD_SET_CC608_INFO_ENHANCE_MODE  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_CC608_INFO_ENHANCE_MODE;
            break;
        case VDEC_USER_CMD_PUSH_DISPQ_WITH_REF_NUM      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_PUSH_DISPQ_WITH_REF_NUM;
            break;
        case VDEC_USER_CMD_SET_IDCT_MODE                :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_IDCT_MODE;
            break;
        case VDEC_USER_CMD_SHOW_FIRST_FRAME_DIRECT      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SHOW_FIRST_FRAME_DIRECT;
            break;
        case VDEC_USER_CMD_SET_XC_LOW_DELAY_PARA        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_XC_LOW_DELAY_PARA;
            break;
        case VDEC_USER_CMD_AVC_SUPPORT_REF_NUM_OVER_MAX_DPB_SIZE  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_SUPPORT_REF_NUM_OVER_MAX_DPB_SIZE;
            break;
        case VDEC_USER_CMD_FRAMEBUFFER_AUTO_MODE        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FRAMEBUFFER_AUTO_MODE;
            break;
        case VDEC_USER_CMD_AUTO_DROP_DISPLAY_QUEUE      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AUTO_DROP_DISPLAY_QUEUE;
            break;
        case VDEC_USER_CMD_SET_PTS_US_MODE              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_PTS_US_MODE;
            break;
        case VDEC_USER_CMD_FORCE_PROGRESSIVE_MODE       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FORCE_PROGRESSIVE_MODE;
            break;
        case VDEC_USER_CMD_AVC_NEW_SLOW_MOTION          :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AVC_NEW_SLOW_MOTION;
            break;
        case VDEC_USER_CMD_AUTO_EXHAUST_ES_MODE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AUTO_EXHAUST_ES_MODE;
            break;
        case VDEC_USER_CMD_MVC_BBU2_PUSH_PACKET         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_MVC_BBU2_PUSH_PACKET;
            break;
        case VDEC_USER_CMD_MVC_BBU2_FIRE_DECCMD         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_MVC_BBU2_FIRE_DECCMD;
            break;
        case VDEC_USER_CMD_RETURN_INVALID_AFD           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_RETURN_INVALID_AFD;
            break;
        case VDEC_USER_CMD_USE_CPB_REMOVAL_DEALY        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_USE_CPB_REMOVAL_DEALY;
            break;
        case VDEC_USER_CMD_SET_DV_XC_SHM_ADDR           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_DV_XC_SHM_ADDR ;
            break;
        case VDEC_USER_CMD_SET_ENABLE_HDR               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_ENABLE_HDR ;
            break;
        case VDEC_USER_CMD_DISABLE_PBFRAME_MODE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_PBFRAME_MODE;
            break;
        case VDEC_USER_CMD_SET_SLOW_SYNC                :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_SLOW_SYNC;
            break;
        case VDEC_USER_CMD_FRC_ONLY_SHOW_TOP_FIELD      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FRC_ONLY_SHOW_TOP_FIELD;
            break;
        case VDEC_USER_CMD_DISABLE_ES_FULL_STOP         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_ES_FULL_STOP;
            break;
        case VDEC_USER_CMD_SET_FRAMEBUFF2               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_FRAMEBUFF2;
            break;
        case VDEC_USER_CMD_SET_TRICKPLAY_2X_MODE        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_TRICKPLAY_2X_MODE;
            break;
        case VDEC_USER_CMD_PUSI_CONTROL                 :
            eEXUserCmd = E_VDEC_EX_USER_CMD_PUSI_CONTROL;
            break;
        case VDEC_USER_CMD_DISABLE_FDMASK               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DISABLE_FDMASK;
            break;
        case VDEC_USER_CMD_MPEG4_CAL_FRAMERATE          :
            eEXUserCmd = E_VDEC_EX_USER_CMD_MPEG4_CAL_FRAMERATE;
            break;

            //Group2:Get Control command
        case VDEC_USER_CMD_GET_CONTROL_BASE             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_CONTROL_BASE;
            break;
        case VDEC_USER_CMD_GET_CHROMA_TYPE              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_CHROMA_TYPE;
            break;
        case VDEC_USER_CMD_GET_REAL_FRAMERATE           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_REAL_FRAMERATE;
            break;
        case VDEC_USER_CMD_GET_COLOR_MATRIX             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_COLOR_MATRIX;
            break;
        case VDEC_USER_CMD_GET_DYNSCALE_ENABLED         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_DYNSCALE_ENABLED;
            break;
        case VDEC_USER_CMD_GET_ORI_INTERLACE_MODE       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_ORI_INTERLACE_MODE;
            break;
        case VDEC_USER_CMD_GET_FPA_SEI                  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_FPA_SEI;
            break;
        case VDEC_USER_CMD_GET_U64PTS                   :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_U64PTS;
            break;
            //case VDEC_USER_CMD_GET_FB_USAGE_MEM             : eEXUserCmd = E_VDEC_EX_USER_CMD_GET_FB_USAGE_MEM; break;
        case VDEC_USER_CMD_GET_FW_STATUS_FLAG           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_FW_STATUS_FLAG;
            break;
        case VDEC_USER_CMD_GET_DS_BUF_MIU_SEL           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_DS_BUF_MIU_SEL;
            break;
        case VDEC_USER_CMD_GET_PRE_PAS_U64PTS           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_PRE_PAS_U64PTS;
            break;
        case VDEC_USER_CMD_GET_SEQ_CHANGE_INFO          :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_SEQ_CHANGE_INFO;
            break;

        case VDEC_USER_CMD_GET_MVC_SUB_FRAME_DISP_INFO  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_MVC_SUB_FRAME_DISP_INFO;
            break;
        case VDEC_USER_CMD_GET_MVC_BBU2_DECQ_VACANCY    :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_MVC_BBU2_DECQ_VACANCY;
            break;
        case VDEC_USER_CMD_GET_MVC_ES2_READ_PTR         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_MVC_ES2_READ_PTR;
            break;
        case VDEC_USER_CMD_GET_MVC_ES2_WRITE_PTR        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_MVC_ES2_WRITE_PTR;
            break;
        case VDEC_USER_CMD_GET_ES_QUANTITY              :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_ES_QUANTITY;
            break;
        case VDEC_USER_CMD_GET_ES2_QUANTITY             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_ES2_QUANTITY;
            break;
        case VDEC_USER_CMD_DROP_ERR_FRAME               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DROP_ERR_FRAME;
            break;
        case VDEC_USER_CMD_GET_FLUSH_PATTEN_ENTRY_NUM   :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_FLUSH_PATTEN_ENTRY_NUM ;
            break;
        case VDEC_USER_CMD_SET_MIN_TSP_DATA_SIZE        :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_MIN_TSP_DATA_SIZE;
            break;

            //Group3:System Preset Control command======================
            //Group3-1:Common system Preset Control command
        case VDEC_USER_CMD_SYSTEM_PRESET_CONTROL_BASE   :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_CONTROL_BASE;
            break;
        case VDEC_USER_CMD_SYSTEM_PRESET_VPU_CLOCK      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_VPU_CLOCK;
            break;

            //Group3-2:HVD System Preset Control command
        case VDEC_USER_CMD_SYSTEM_PRESET_HVD_BASE       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_HVD_BASE;
            break;
        case VDEC_USER_CMD_SYSTEM_PRESET_HVD_CLOCK      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_HVD_CLOCK;
            break;
        case VDEC_USER_CMD_GET_XC_LOW_DELAY_INT_STATE   :
            eEXUserCmd = E_VDEC_EX_USER_CMD_GET_XC_LOW_DELAY_INT_STATE;
            break;

            //Group3-3:MVD System Preset Control command
        case VDEC_USER_CMD_SYSTEM_PRESET_MVD_BASE       :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_MVD_BASE;
            break;
        case VDEC_USER_CMD_SYSTEM_PRESET_MVD_CLOCK      :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SYSTEM_PRESET_MVD_CLOCK;
            break;
        case VDEC_USER_CMD_VPU_SECURITY_MODE            :
            eEXUserCmd = E_VDEC_EX_USER_CMD_VPU_SECURITY_MODE;
            break;

            //Group3-4:Preset Control command=============================
        case VDEC_USER_CMD_PRESET_CONTROL_BASE          :
            eEXUserCmd = E_VDEC_EX_USER_CMD_PRESET_CONTROL_BASE;
            break;
        case VDEC_USER_CMD_HVD_ONE_PENDING_BUFFER_MODE  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_HVD_ONE_PENDING_BUFFER_MODE;
            break;
        case VDEC_USER_CMD_MVD_HWBUFFER_REMAPPING_MODE  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_MVD_HWBUFFER_REMAPPING_MODE;
            break;
        case VDEC_USER_CMD_FRAMERATE_HANDLING           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FRAMERATE_HANDLING;
            break;
        case VDEC_USER_CMD_SET_SHAREMEMORY_BASE         :
            eEXUserCmd = E_VDEC_EX_USER_CMD_SET_SHAREMEMORY_BASE;
            break;
        case VDEC_USER_CMD_HVD_COL_BBU_MODE             :
            eEXUserCmd = E_VDEC_EX_USER_CMD_HVD_COL_BBU_MODE;
            break;
        case VDEC_USER_CMD_HVD_IAPGN_BUF_SHARE_BW_MODE  :
            eEXUserCmd = E_VDEC_EX_USER_CMD_HVD_IAPGN_BUF_SHARE_BW_MODE;
            break;
        case VDEC_USER_CMD_DTV_DEBUG_MODE               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_DTV_DEBUG_MODE;
            break;
        case VDEC_USER_CMD_HVD_TS_IN_BBU_MODE           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_HVD_TS_IN_BBU_MODE;
            break;
        case VDEC_USER_CMD_AUTO_ARRANGE_FRAMEBUFFER_USAGE           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_AUTO_ARRANGE_FRAMEBUFFER_USAGE;
            break;
        case VDEC_USER_CMD_THUMBNAIL_MODE               :
            eEXUserCmd = E_VDEC_EX_USER_CMD_THUMBNAIL_MODE;
            break;
        case VDEC_USER_CMD_FORCE_8BIT_DEC_MODE           :
            eEXUserCmd = E_VDEC_EX_USER_CMD_FORCE_8BIT_DEC_MODE;
            break;
        case VDEC_USER_CMD_CAL_FRAMERATE                :
            eEXUserCmd = E_VDEC_EX_USER_CMD_CAL_FRAMERATE;
            break;
...
_init_ret:
    ...
    if (E_VDEC_EX_OK == eEXRetVal)
    {
        //VPRINTF("%s: Update _vdecInitParam\n", __FUNCTION__);
...
VDEC_Result MApi_VDEC_GetCCInfo(void *pInfo, MS_U32 u32Size)
{
    ...
    {
        VDEC_INFO(VPRINTF("%s err: wrong pInfo\n", __FUNCTION__));
...
VDEC_Result MApi_VDEC_GetDispInfo(VDEC_DispInfo *pDispinfo)
{
    ...
    {
        VDEC_INFO(VPRINTF("%s err: null input\n", __FUNCTION__));
        eRetVal = E_VDEC_RET_INVALID_PARAM;
    }
    return eRetVal;
}
...
VDEC_Result MApi_VDEC_GetDecFrameInfo(VDEC_FrameInfo* pFrmInfo)
{
    ...
    if (!pFrmInfo)
    {
        VDEC_INFO(VPRINTF("%s err: null pFrmInfo\n", __FUNCTION__));
        return E_VDEC_RET_INVALID_PARAM;
    }
...
VDEC_Result MApi_VDEC_GetExtDispInfo(VDEC_ExtDispInfo *pExtDispinfo)
{
    ...
    if (!pExtDispinfo)
    {
        VDEC_INFO(VPRINTF("%s err: null pExtDispinfo\n", __FUNCTION__));
        return E_VDEC_RET_INVALID_PARAM;
    }
...
VDEC_Result MApi_VDEC_GetDecTimeCode(VDEC_TimeCode* pTimeCode)
{
    ...
    if (!pTimeCode)
    {
        VDEC_INFO(VPRINTF("%s err: null pTimeCode\n", __FUNCTION__));
        return E_VDEC_RET_INVALID_PARAM;
    }
...
{
    VPRINTF("VDEC Warn: MDrv_VDEC_GenPattern() will be removed. please use new API:MApi_VDEC_GenPattern()\n ");
...
/*
VDEC_Result MApi_VDEC_SetFrmBuff2(MS_VIRT u32FrmBuffAddr, MS_U32 u32FrmBuffSize)
{
    VDEC_Result eRetVal  = E_VDEC_FAIL;
    VDEC_EX_Result eEXRetVal = E_VDEC_EX_FAIL;
    eEXRetVal = MApi_VDEC_EX_SetFrmBuff2(&stStreamId, u32FrmBuffAddr, u32FrmBuffSize);
    eRetVal = _VDEC_MapResult(eEXRetVal);
