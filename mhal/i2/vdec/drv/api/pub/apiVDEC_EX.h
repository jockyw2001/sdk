...
#define VDEC_EX_DEFAULT_DBG_MSG_LEVEL  E_VDEC_EX_DBG_LEVEL_ERR
...
#define VDEC_CAP_HDR VDEC_CAP_VP9_HDR
#define VDEC_CAP_CAL_FRAMERATE
#endif
#endif
...
/// error code enumerator
    typedef enum
    {
        ...
        E_VDEC_EX_HVD_ERR_CODE_HDR_WRONG_DISP_PATH,
        // AVC
        ...
        E_VDEC_EX_HVD_ERR_CODE_AVC_ERROR_CONCEAL,
        E_VDEC_EX_HVD_ERR_CODE_AVC_ERROR_NAL,
        // AVS
        ...
        // HEVC
        E_VDEC_EX_HVD_ERR_CODE_HEVC_BASE = (0x5000 | E_VDEC_EX_HVD_ERR_CODE_BASE),
        E_VDEC_EX_HVD_ERR_CODE_HEVC_SPS_BROKEN,           // SPS is not valid
        E_VDEC_EX_HVD_ERR_CODE_HEVC_SPS_NOT_IN_SPEC,
        E_VDEC_EX_HVD_ERR_CODE_HEVC_SPS_NOT_ENOUGH_FRM,   // DPB size at specified level is smaller than the specified number of reference frames. This is not allowed
        E_VDEC_EX_HVD_ERR_CODE_HEVC_PPS_BROKEN,           // PPS is not valid
        E_VDEC_EX_HVD_ERR_CODE_HEVC_VPS_BROKEN,           // VPS is not valid
        E_VDEC_EX_HVD_ERR_CODE_HEVC_REF_LIST,
        E_VDEC_EX_HVD_ERR_CODE_HEVC_NO_REF,
        E_VDEC_EX_HVD_ERR_CODE_HEVC_RES,                  // out of supported resolution
        E_VDEC_EX_HVD_ERR_CODE_HEVC_ERROR_CONCEAL,
        E_VDEC_EX_HVD_ERR_CODE_HEVC_ERROR_NAL,
...
//VDEC user command id
    typedef enum
    {
        ...
        E_VDEC_EX_USER_CMD_DISABLE_FDMASK,              // Param: 1(Disable), 0(Enable)
        E_VDEC_EX_USER_CMD_SET_MULTI_SPEED_ENCODE,
        E_VDEC_EX_USER_CMD_SET_DISP_WIN_ID,
        E_VDEC_EX_USER_CMD_SET_PLAYBACK_INTERVAL,
        E_VDEC_EX_USER_CMD_SET_AR_CHANGE_MODE,
        E_VDEC_EX_USER_CMD_SET_FW_DEBUG_LEVEL,          // Param: bit0(VDEC_FW_DBG_LV_ERROR), bit1(VDEC_FW_DBG_LV_FLOW), bit2(VDEC_FW_DBG_LV_DEBUG), bit3(VDEC_FW_DBG_LV_TRACE)
        E_VDEC_EX_USER_CMD_SUPPORT_MULTI_ULTRA_RES,
        E_VDEC_EX_USER_CMD_SET_TRICK_SMOOTH_SCAN,           // Param: VDEC_EX_TrickSmoothScan
        E_VDEC_EX_USER_CMD_SET_WIN_INIT,
        ...
        E_VDEC_EX_USER_CMD_AVSYNC_ON,
        E_VDEC_EX_USER_CMD_SET_BLOCK_DISPLAY,
        E_VDEC_EX_USER_CMD_ENABLE_ES_BUFF_MALLOC,
        E_VDEC_EX_USER_CMD_DISABLE_DEBLOCKING,
        E_VDEC_EX_USER_CMD_PLAY,
        E_VDEC_EX_USER_CMD_PUSH_DECQ,
        E_VDEC_EX_USER_CMD_FIRE_DEC,
        E_VDEC_EX_USER_CMD_RELEASE_FRAME,
        E_VDEC_EX_USER_CMD_EXIT,
#endif
        ...
        E_VDEC_EX_USER_CMD_GET_FILE_END_PATTERN,
        E_VDEC_EX_USER_CMD_GET_HDR_INFO,

#ifdef _USE_MDRV_VDEC_
        E_VDEC_EX_USER_CMD_GET_FRAME_CNT,
        E_VDEC_EX_USER_CMD_GET_ERR_CNT,
        E_VDEC_EX_USER_CMD_GET_DROP_CNT,
        E_VDEC_EX_USER_CMD_GET_SKIP_CNT,
        E_VDEC_EX_USER_CMD_GET_ERR_CODE,
        E_VDEC_EX_USER_CMD_GET_DECQ_VACANCY,
        E_VDEC_EX_USER_CMD_GET_ES_BUFF,
        E_VDEC_EX_USER_CMD_GET_NEXT_DISP_FRAME,
        E_VDEC_EX_USER_CMD_GET_ACTIVE_CODEC_TYPE,
        E_VDEC_EX_USER_CMD_GET_ES_READ_PTR,
        E_VDEC_EX_USER_CMD_GET_ES_WRITE_PTR,
        E_VDEC_EX_USER_CMD_GET_DISP_INFO,
#endif
        ...
        E_VDEC_EX_USER_CMD_DRIVER_MCU_MODE,
...
/// DecodeMode for f/w tasks
    ...
    typedef enum
    {
        ...
        E_VDEC_EX_CODEC_PROFILE_AVS_BROADCASTING, // 26
        ...
        E_VDEC_EX_CODEC_PROFILE_AVS2_MAIN_PIC,    // 34
        E_VDEC_EX_CODEC_PROFILE_AVS2_MAIN,
        E_VDEC_EX_CODEC_PROFILE_AVS2_MAIN10,      // 36
    ...
    typedef enum
    {
        ...
        E_VDEC_EX_CODEC_LEVEL_AVS2_8_2_60, // 4096x2034@60p
...
#define VDEC_CAP_FRAME_INFO_EXT_V7_1
...
#define API_HWCAP_VERSION 1
    ...
    typedef struct DLL_PACKED
    {
        ...
        VDEC_EX_CodecType eCodecType;
        /// Input
        MS_U16  u16EnableMfcodec;			// TRUE(1): enable, FALSE(0): disable
        /// Input
        MS_U16  u16FrmNum;
        /// Input
        MS_U16  u16Width;
...
/// Capture display frame
/// @ingroup VDEC_Display_Q_Control
/// @param pHwMemInfo \b IN/OUT : specify the fparameter
/// @return VDEC_EX_Result
//-------------------------------------------------------------------------------------------------
    VDEC_EX_Result  MApi_VDEC_EX_GetHwMemSize(VDEC_EX_HW_MEM_CFG *pHwMemCfg);
