...
//sylvia: compared to K6NVR, this seems to be a fault-modification
#if !defined(SUPPORT_X_MODEL_FEATURE) && !defined(STELLAR) && !defined(MSOS_TYPE_LINUX_KERNEL)
    switch (u32CodecType)
    {
...
#if defined(CHIP_K6LITE) || defined(CHIP_K6) || defined(CHIP_K7U) || defined(CHIP_K5TN) || defined(CHIP_I2)
