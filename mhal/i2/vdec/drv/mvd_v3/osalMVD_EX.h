...
MS_BOOL OSAL_MVD_IntDisable(MS_U8 u8Idx);
MS_BOOL OSAL_MVD_IntEnable(MS_U8 u8Idx);
MS_BOOL OSAL_MVD_IsrAttach(MS_U8 u8Idx, void* pfnIsr);
MS_BOOL OSAL_MVD_IsrDetach(MS_U8 u8Idx);
#else
