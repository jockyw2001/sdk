...
#define HVD_INIT_HW_HEVC_DV                         BITS(3:0, 9)   ///< HW: HEVC_DOLBY 0x1001
#define HVD_INIT_HW_AVS2                            BITS(3:0,10)   ///< HW: AVS2 0x1010
...
//-----------------------------------------------------------------------------
    typedef enum
    {
        ...
        E_HVD_EX_ISR_DEC_CMA_ACTION = BIT(7),         ///< HVD handle CMA action
        ...
        E_HVD_EX_ISR_DEC_USE_EVD_HICODEC = BIT(16),   ///< HVD USE_EVD_HICODEC to decode.
        E_HVD_EX_ISR_DEC_USE_EVD_LITE = BIT(17),      ///< HVD USE_EVD_LITE to decode.
    } HVD_EX_IsrEvent;
...
//-----------------------------------------------------------------------------
    typedef enum
    {
        ...
        E_HVD_EX_GDATA_TYPE_SEQ_CHANGE_INFO,
        E_HVD_EX_GDATA_TYPE_GET_NOT_SUPPORT_INFO,
        E_HVD_EX_GDATA_TYPE_GET_MIN_TSP_DATA_SIZE,
...
//-----------------------------------------------------------------------------
    typedef enum
    {
        ...
        E_HVD_EX_ERRCODE_RES_NOT_SUPPORT,
        E_HVD_EX_ERRCODE_DIVX_PLUS_UNSUPPORTED,
        E_HVD_EX_ERRCODE_HDR_WRONG_DISP_PATH,
        ...
        E_HVD_EX_ERRCODE_AVC_ERROR_CONCEAL,
        E_HVD_EX_ERRCODE_AVC_ERROR_NAL,
        ...
        // HEVC
        E_HVD_EX_ERRCODE_HEVC_BASE = (0x5000),
        E_HVD_EX_ERRCODE_HEVC_SPS_BROKEN,           // SPS is not valid
        E_HVD_EX_ERRCODE_HEVC_SPS_NOT_IN_SPEC,
        E_HVD_EX_ERRCODE_HEVC_SPS_NOT_ENOUGH_FRM,   // DPB size at specified level is smaller than the specified number of reference frames. This is not allowed
        E_HVD_EX_ERRCODE_HEVC_PPS_BROKEN,           // PPS is not valid
        E_HVD_EX_ERRCODE_HEVC_VPS_BROKEN,           // VPS is not valid
        E_HVD_EX_ERRCODE_HEVC_REF_LIST,
        E_HVD_EX_ERRCODE_HEVC_NO_REF,
        E_HVD_EX_ERRCODE_HEVC_RES,                  // out of supported resolution
        E_HVD_EX_ERRCODE_HEVC_ERROR_CONCEAL,
        E_HVD_EX_ERRCODE_HEVC_ERROR_NAL,
    } HVD_EX_ErrorCode;
...
// VDEC SEQ change info, must match VDEC_SpsChangeInfo in fwHVD_if.h
    typedef enum
    {
        E_HVD_SEQ_CHANGE_NONE              = 0,         ///< unknown sps change info
        E_HVD_SEQ_CHANGE_FIRST_TIME        = BIT(0),    ///< seq change due to first sequence
        E_HVD_SEQ_CHANGE_RESOLUTION        = BIT(1),    ///< seq chagne due to resolution
        E_HVD_SEQ_CHANGE_PICTURE_TYPE      = BIT(2),    ///< seq chagne due to picture type
        E_HVD_SEQ_CHANGE_ASPECT_RATIO      = BIT(3),    ///< seq chagne due to aspect ratio
        E_HVD_SEQ_CHANGE_FRAME_RATE        = BIT(4),    ///< seq chagne due to frame rate
        E_HVD_SEQ_CHANGE_HDR_INFO          = BIT(5),    ///< seq chagne due to HDR info
    } HVD_SeqChangeInfo;
    ...
    typedef enum
    {
        E_HVD_EX_INPUT_TSP_0 = 0,
        E_HVD_EX_INPUT_TSP_1,
        E_HVD_EX_INPUT_TSP_2,
        E_HVD_EX_INPUT_TSP_3,
        E_HVD_EX_INPUT_TSP_NONE = 0xFF,
    } HVD_EX_INPUT_TSP;
...
//set VDEC Feature
    typedef enum
    {
        E_HVD_EX_FEATURE_DEFAULT = 0,
        E_HVD_EX_FEATURE_FORCE_MAIN_PROFILE = BIT(0),           // BIT0=1: HEVC Only support Main profile decode
        E_HVD_EX_FEATURE_DISABLE_TEMPORAL_SCALABILITY = BIT(1), // BIT1=0: Default; BIT1=1: do not support temporal scalibity
        E_HVD_EX_FEATURE_DISABLE_SUB_SAMPLE = BIT(2),           // BIT2=0: Default; BIT2=1: do not enable sub sample
    } HVD_EX_Feature;
...
/// input source select enumerator
    ...
    {
        ///DTV mode
        E_HVD_EX_SRC_MODE_DTV = 0,
        ///TS file mode
        E_HVD_EX_SRC_MODE_TS_FILE,
        ///generic file mode
        E_HVD_EX_SRC_MODE_FILE,
        /// TS file and dual ES buffer mode
        E_HVD_EX_SRC_MODE_TS_FILE_DUAL_ES,
        ///generic file and dual ES buffer mode
        E_HVD_EX_SRC_MODE_FILE_DUAL_ES,
    } HVD_EX_SrcMode;
...
/// codec type enumerator
    typedef enum
    {
        ...
        E_HVD_EX_CODEC_TYPE_NONE = 0,
        ///MPEG 1/2
        E_HVD_EX_CODEC_TYPE_MPEG2,
        ///H263 (short video header)
        E_HVD_EX_CODEC_TYPE_H263,
        ///MPEG4 (default)
        E_HVD_EX_CODEC_TYPE_MPEG4,
        ///MPEG4 (Divx311)
        E_HVD_EX_CODEC_TYPE_DIVX311,
        ///MPEG4 (Divx412)
        E_HVD_EX_CODEC_TYPE_DIVX412,
        ///FLV
        E_HVD_EX_CODEC_TYPE_FLV,
        ///VC1 advanced profile (VC1)
        E_HVD_EX_CODEC_TYPE_VC1_ADV,
        ///VC1 main profile (RCV)
        E_HVD_EX_CODEC_TYPE_VC1_MAIN,
        ///Real Video version 8
        E_HVD_EX_CODEC_TYPE_RV8,
        ///Real Video version 9 and 10
        E_HVD_EX_CODEC_TYPE_RV9,
        ///H264
        E_HVD_EX_CODEC_TYPE_H264,
        ///AVS
        E_HVD_EX_CODEC_TYPE_AVS,
        ///MJPEG
        E_HVD_EX_CODEC_TYPE_MJPEG,
        ///MVC
        E_HVD_EX_CODEC_TYPE_MVC,
        ///VP8
        E_HVD_EX_CODEC_TYPE_VP8,
        ///HEVC
        E_HVD_EX_CODEC_TYPE_HEVC,
        ///VP9
        E_HVD_EX_CODEC_TYPE_VP9,
        ///HEVC_DV
        E_HVD_EX_CODEC_TYPE_HEVC_DV,
        E_HVD_EX_CODEC_TYPE_NUM
    } HVD_EX_CodecType;

    typedef enum
    {
        E_HVD_EX_CMA_ALLOCATION_NONE = 0,
        E_HVD_EX_CMA_ALLOCATION_WAITING,
        E_HVD_EX_CMA_ALLOCATION_DONE,
        E_HVD_EX_CMA_ALLOCATION_FAILED,
    } HVD_EX_CMA_Allocation_Status;

    typedef enum
    {
        E_HVD_EX_CMA_RELEASE_NONE = 0,
        E_HVD_EX_CMA_RELEASE_WAITING,
        E_HVD_EX_CMA_RELEASE_DONE,
    } HVD_EX_CMA_Release_Status;

    typedef enum
    {
        E_HVD_EX_GET_DV_SUPPORT_PROFILE = 0,
        E_HVD_EX_GET_DV_SUPPORT_LEVEL,
        E_HVD_EX_SET_DV_INFO,//set profile and level
    } HVD_EX_DV_CMD_TYPE;

    typedef enum
    {
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_NONE       = 0,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_CBP        = 66,   //constraint_set1_flag is equal to 1
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_BP         = 66,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_XP         = 88,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_MP         = 77,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_HiP        = 100,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_Hi10P      = 110,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_Hi422P     = 122,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_Hi444P     = 144,
        E_HVD_EX_MPEG4_AVC_PROFILE_IDC_NOTSUPPORT = 0xFF
    } HVD_EX_MPEG4_AVC_PROFILE_IDC;

    typedef enum
    {
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_NONE       = 0x00000000,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_CBP        = 0x00000001,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_BP         = 0x00000002,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_XP         = 0x00000004,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_MP         = 0x00000008,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_HiP        = 0x00000010,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_Hi10P      = 0x00000020,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_Hi422P     = 0x00000040,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_Hi444P     = 0x00000080,
        E_HVD_EX_MPEG4_AVC_PROFILE_BIT_NOTSUPPORT = 0xFFFFFFFF
    } HVD_EX_MPEG4_AVC_PROFILE_BIT;

    typedef enum
    {
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_NONE         = 0,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L1           = 10,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L1b          = 10,     //constraint_set3_flag is equal to 1
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L1_1         = 11,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L1_2         = 12,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L1_3         = 13,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L2           = 20,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L2_1         = 21,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L2_2         = 22,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L3           = 30,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L3_1         = 31,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L3_2         = 32,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L4           = 40,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L4_1         = 41,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L4_2         = 42,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L5           = 50,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_L5_1         = 51,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC_NOTSUPPORT   = 0xFF,
    } HVD_EX_MPEG4_AVC_PROFILE_LEVEL_IDC;

    typedef enum
    {
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_NONE         = 0x00000000,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L1           = 0x00000001,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L1b          = 0x00000002,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L1_1         = 0x00000004,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L1_2         = 0x00000008,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L1_3         = 0x00000010,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L2           = 0x00000020,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L2_1         = 0x00000040,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L2_2         = 0x00000080,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L3           = 0x00000100,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L3_1         = 0x00000200,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L3_2         = 0x00000400,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L4           = 0x00000800,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L4_1         = 0x00001000,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L4_2         = 0x00002000,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L5           = 0x00004000,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_L5_1         = 0x00008000,
        E_HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT_NOTSUPPORT   = 0xFFFFFFFF
    } HVD_EX_MPEG4_AVC_PROFILE_LEVEL_BIT;

    typedef enum
    {
        E_HVD_EX_MPEGH_HEVC_PROFILE_IDC_MP            = 1,
        E_HVD_EX_MPEGH_HEVC_PROFILE_IDC_MP10          = 2,
        E_HVD_EX_MPEGH_HEVC_PROFILE_IDC_MP_STILL      = 3
    } HVD_EX_MPEGH_HEVC_PROFILE_IDC;

    typedef enum
    {
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L1      = 30, // 1.0 * 30 = 30
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L2      = 60, // 2.0 * 30 = 60
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L2_1    = 63, // 2.1 * 30 = 63
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L3      = 90, // 3.0 * 30 = 90
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L3_1    = 93, // 3.1 * 30 = 93
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L4      = 120, // 4.0 * 30 = 120
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L4_1    = 123, // 4.1 * 30 = 123
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L5      = 150, // 5.0 * 30 = 150
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L5_1    = 153, // 5.1 * 30 = 153
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L5_2    = 156, // 5.2 * 30 = 156
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L6      = 180, // 6.0 * 30 = 180
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L6_1    = 183, // 6.1 * 30 = 183
        E_HVD_EX_MPEGH_HEVC_LEVEL_IDC_L6_2    = 186  // 6.2 * 30 = 186
    } HVD_EX_MPEGH_HEVC_LEVEL_IDC;

    typedef enum
    {
        E_HVD_EX_MPEGH_HEVC_PROFILE_BIT_NONE          = 0x00000000,
        E_HVD_EX_MPEGH_HEVC_PROFILE_BIT_MP            = 0x00000001,
        E_HVD_EX_MPEGH_HEVC_PROFILE_BIT_MP10          = 0x00000002,
        E_HVD_EX_MPEGH_HEVC_PROFILE_BIT_MP_STILL      = 0x00000004,
        E_HVD_EX_MPEGH_HEVC_PROFILE_BIT_NOTSUPPORT    = 0xFFFFFFFF
    } HVD_EX_MPEGH_HEVC_PROFILE_BIT;

    typedef enum
    {
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_NONE       = 0x00000000,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L1         = 0x00000001,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L2         = 0x00000002,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L2_1       = 0x00000004,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L3         = 0x00000008,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L3_1       = 0x00000010,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L4         = 0x00000020,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L4_1       = 0x00000040,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L5         = 0x00000080,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L5_1       = 0x00000100,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L5_2       = 0x00000200,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L6         = 0x00000400,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L6_1       = 0x00000800,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_L6_2       = 0x00001000,
        E_HVD_EX_MPEGH_HEVC_LEVEL_BIT_NOTSUPPORT = 0xFFFFFFFF
    } HVD_EX_MPEGH_HEVC_LEVEL_BIT;

    typedef enum
    {
        E_HVD_EX_ORIGINAL_MAIN_STREAM = 0,
        E_HVD_EX_ORIGINAL_SUB_STREAM,
        E_HVD_EX_ORIGINAL_N_STREAM,
    } HVD_EX_Original_Stream;

    typedef enum
    {
        HVD_EX_CUSTOMER_DEFAULT = 0,
        HVD_EX_CUSTOMER_ENABLE_NDS = BIT(0),  // 1: Run NDS code flow
    } HVD_EX_Customer_Mode;

/// VDEC smooth scan
    typedef enum
    {
        /// smooth scan is disabled
        E_HVD_EX_SMOOTH_SCAN_NONE = 0,
        /// smooth scan by hw
        E_HVD_EX_SMOOTH_SCAN_HW,
        /// smooth scan by vdec plus
        E_HVD_EX_SMOOTH_SCAN_VDEC_PLUS,
        /// smooth scan is unsupport
        E_HVD_EX_SMOOTH_SCAN_UNSUPPORT,
    } HVD_EX_SmoothScanMode;
...
//-----------------------------------------------------------------------------
/// @brief \b Struct \b Name: HVD_EX_ExtendDispInfo
/// @brief \b Struct \b Description:  Store the HVD driver information
//-----------------------------------------------------------------------------
    typedef struct
    {
        MS_U32 u32EncodedFormatProfileBit;
        MS_U32 u32EncodedFormatProfileLevelBit;
        MS_U8  u8BitsPerComponent;
    } HVD_EX_ExtendDispInfo;     //  bytes
...
//-----------------------------------------------------------------------------
    typedef struct
    {
        ...
        MS_VIRT  u32FWBinaryVAddr;                //!<  virtual address of input FW binary in DRAM
        ...
        MS_VIRT u32VLCBinaryVAddr;///< VLC table binary data buffer start address
        ...
        MS_VIRT  u32DrvProcessBufVAddr;       //!< the virtual memory start address of driver process buffer
...
#ifdef VDEC3
        MS_PHY  u32TotalBitstreamBufAddr;
...
//-----------------------------------------------------------------------------
    typedef struct
    {
        ...
        MS_PHY u32Staddr2;      ///< Packet offset from bitstream buffer base address. unit: byte.
        ...
        MS_U8  u8Version;       ///< Packet version 0 means u32Offset is the offset of ES buffer
...
//-----------------------------------------------------------------------------
    typedef struct
    {
        ...
        MS_PHY u32LumaAddr_2bit;                 ///< The start offset of luma data. Unit: byte.
        MS_PHY u32ChromaAddr_2bit;               ///< The start offset of chroma data. Unit: byte.
        ...
        // Other
        MS_U8  u8ComplexityLevel; // from 1~5, smaller number means smaller complexity
        MS_U8  u8TileMode;
        MS_U8  u8Reserve[2];
        ...
        //Subsample(currently 1/2 width and 1/2 height)
...
//-----------------------------------------------------------------------------
    typedef struct
    {
        ...
        MS_PHY u32DataBuf;            // User_Data data buffer address
    ...
    } HVD_EX_ContentLightLevelInfoSEI;

    typedef struct
    {
        MS_PHY  u32DSBufAddr;       // Buffer Address
        MS_U32  u32DSBufSize;       // Buffer Size
    } HVD_EX_ExternalDSBuf;

    typedef struct
    {
        HVD_EX_Codec eCodecType;
        MS_VIRT  u32DataVAddr;
        MS_U32  u32MemUsageSize;
        MS_U16  u16DataSize;
        MS_BOOL bForce8BitMode;
    } HVD_EX_FbMemUsage_Param;
    ...
    } HVD_EX_VdecPlus_Info;

    typedef struct
    {
        HVD_EX_DispSpeed eDispSpeed;//in/out
        HVD_EX_SmoothScanMode eSmoothScanMode;//out
        MS_BOOL bEnable;//inout
    } HVD_EX_TrickSmoothScan;
...
//-------------------------------------------------------------------------------------------------
    ...
    HVD_EX_Result MDrv_HVD_EX_GetHDRMeta22bytes(MS_U32 u32Id, MS_U16 HDRMDMIU, MS_PHY u32MetaAddr, MS_U16 u16HDRVer, MS_U32 *u32FirstMetaAddr,
            MS_U32 *u32SecondMetaAddr, MS_U8 *u32FirstMetaEnable, MS_U8 *u32SecondMetaEnable,
    ...
    HVD_EX_Result  MDrv_HVD_EX_GenPattern(MS_U32 u32Id, HVD_EX_PatternType eType, MS_VIRT u32VAddr, MS_U32 *u32Size);
    ...
    HVD_EX_Result MDrv_HVD_EX_SetARChangeMode(MS_U32 u32Id, MS_U32 bMode);
