...
//  Local Defines
//-------------------------------------------------------------------------------------------------
#define DISABLE_MJPEG_VPU_CONTROL
...
{
    #ifndef DISABLE_MJPEG_VPU_CONTROL
...
MS_BOOL MDrv_MJPEG_IsFirmwareReady(void)
{
    ...
    #endif //DISABLE_MJPEG_VPU_CONTROL
    return TRUE;
}
...
static MS_BOOL MDrv_MJPEG_SetVPUCmd(MS_U32 u32Id, MS_U32 u32Cmd)
{
    ...
    return bResult;
    #else //DISABLE_MJPEG_VPU_CONTROL
    return TRUE;
    #endif //DISABLE_MJPEG_VPU_CONTROL
}
...
MS_BOOL MDrv_MJPEG_IsDisableVpuControl(void)
{
    #ifdef DISABLE_MJPEG_VPU_CONTROL
    return TRUE;
    #else
    return FALSE;
    #endif
...
#ifdef VDEC3
    bRet = HAL_VPU_EX_TaskCreate(u32Id, &stVpuInitPara, FWInfo.bFWdecideFB, 0);
    // MIU info sould be set after HAL_VPU_EX_TaskCreate()
    MDrv_MJPEG_SetMIUInfo(u32Id, MIUAllocation);
#else
    bRet = HAL_VPU_EX_TaskCreate(u32Id, &stVpuInitPara);
#endif
    UNUSED(bRet);
