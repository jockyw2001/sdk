...
static JPE_IOC_RET_STATUS_e _SetConf(JpeOpsCB_t* pJpeOpsIn, JpeCfg_t* pJpeCfgIn)
{
    ...
    pJpeHalHandle->nWidth = _ALIGN_(4 , pJpeCfgIn->nCropW);
    pJpeHalHandle->nHeight = _ALIGN_(4 , pJpeCfgIn->nCropH);
    pJpeHalHandle->nPitchWidth = pJpeCfgIn->nWidth;
    ...
    /* Set output buffer */
    pJpeHalOutBufCfg->nHeaderLen         = pJpeCfgIn->nHeaderLen;
    ...
    pJpeHalOutBufCfg->nPartialNotifySize = pJpeCfgIn->nPartialNotifySize;
    pJpeHalOutBufCfg->nPartialOffset[0]  = 0;
    pJpeHalOutBufCfg->nPartialOffset[1]  = 0;
    pJpeHalOutBufCfg->notifyFunc         = pJpeCfgIn->notifyFunc;
...
static JPE_IOC_RET_STATUS_e _GetConf(JpeOpsCB_t* pJpeOpsCB, JpeCfg_t* pJpeCfgOut)
{
    ...
    pJpeCfgOut->nPartialNotifySize = pJpeHalHandle->tJpeHalOutBufCfg.nPartialNotifySize;
    pJpeCfgOut->notifyFunc = pJpeHalHandle->tJpeHalOutBufCfg.notifyFunc;
