#ifndef __MHAL_JPE_H__
#define __MHAL_JPE_H__
...
//------------------------------------------------------------------------------
/// @brief Get JPE encode status
/// @param[in] hDev: Device handle.
/// @param[out] pstParam: Pointer to encode information.
/// @return MHAL_ErrCode_e
//------------------------------------------------------------------------------
