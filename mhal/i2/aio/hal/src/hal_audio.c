...
#define DMA_RESET_REFINE    ( 1 )
#define DMA_RESET_DELAY_US  ( 1 )
...
BOOL _HalAudDmaGetRdInt(AudDmaChn_e eDmaChannel, BOOL *bUnderrun, BOOL *bEmpty, BOOL *bLocalEmpty)
{
    AudRegBank_e eBank;
    U8 nAddr;
    U16 nConfigValue = 0;
    ...
    if ( ( nConfigValue & AUD_DMA_RD_EMPTY_INT_MASK ) == 0 )
    {
        *bEmpty = TRUE;
    }
    else
    ...
    if ( ( nConfigValue & AUD_DMA_RD_UNDERRUN_INT_MASK ) == 0 )
    {
        *bUnderrun = TRUE;
    }
    else
    ...
    if ( ( nConfigValue & AUD_DMA_RD_LOCALBUF_EMPTY_INT_MASK ) == 0 )
    {
        *bLocalEmpty = TRUE;
    }
    else
...
BOOL _HalAudDmaGetWrInt(AudDmaChn_e eDmaChannel, BOOL *bOverrun, BOOL *bFull, BOOL *bLocalFull)
{
    U8 nAddr;
    AudRegBank_e eBank;
    U16 nConfigValue = 0;
    ...
    if ( ( nConfigValue & AUD_DMA_WR_FULL_INT_MASK ) == 0 )
    {
        *bFull = TRUE;
    }
    else
    ...
    if ( ( nConfigValue & AUD_DMA_WR_OVERRUN_INT_MASK ) == 0 )
    {
        *bOverrun = TRUE;
    }
    else
    ...
    if ( ( nConfigValue & AUD_DMA_WR_LOCALBUF_FULL_INT_MASK ) == 0 )
    {
        *bLocalFull = TRUE;
    }
    else
...
BOOL HalAudDmaGetInt(AudDmaChn_e eDmaChannel, BOOL *bDatatrigger, BOOL *bDataboundary, BOOL *bLocalData)
{
    BOOL ret;

    if (eDmaChannel <= AUD_DMA_WRITER5)
        ret = _HalAudDmaGetWrInt(eDmaChannel, bDatatrigger, bDataboundary, bLocalData);
    else
        ret = _HalAudDmaGetRdInt(eDmaChannel, bDatatrigger, bDataboundary, bLocalData);
...
U32 HalAudDmaGetLevelCnt(AudDmaChn_e eDmaChannel)
{
    ...
    if(eDmaChannel < AUD_DMA_READER1)//dma writer
    {
        ...
        if(nCount==10)
        {
            printk(KERN_ERR"Writer - Get level count timeout !!!\n");
        }
    ...
    else//dma reader
    {
        ...
        if(nCount==10)
        {
            printk(KERN_ERR"Reader - Get level count timeout !!!\n");
        }
        _AudWriteReg(eBank,nAddr0,AUD_DMA_RD_LEVEL_MASK,0);
    }
#endif
...
// For resolve ADC init noise ( the noise appears 2 secs after init )
#if 1 // ---analog depop : power on---
    _AudWriteRegByte(0x3111dc, 0xff, 0xf0);
    _AudWriteRegByte(0x3111dd, 0xff, 0x3f);
    _AudWriteRegByte(0x3111de, 0xff, 0x00);
    _AudWriteRegByte(0x3111df, 0xff, 0x00);
    _AudWriteRegByte(0x3111e6, 0xff, 0x01);
    _AudWriteRegByte(0x3111e7, 0xff, 0x00);
    _AudWriteRegByte(0x3111e8, 0xff, 0x00);
    _AudWriteRegByte(0x3111e9, 0xff, 0x80);
    //_AudWriteRegByte(0x3111e2, 0xff, 0x01);
    _AudWriteRegByte(0x3111e3, 0xff, 0x00);
    _AudWriteRegByte(0x3111e0, 0xff, 0x30);
    _AudWriteRegByte(0x3111e1, 0xff, 0x10);
    _AudWriteRegByte(0x3111ea, 0xff, 0x08);
    _AudWriteRegByte(0x3111eb, 0xff, 0x00);
    _AudWriteRegByte(0x3111ee, 0xff, 0x00);
    _AudWriteRegByte(0x3111ef, 0xff, 0x00);
    _AudWriteRegByte(0x3111ec, 0xff, 0x00);
    _AudWriteRegByte(0x3111ed, 0xff, 0x00);

    _AudWriteRegByte(0x3111de, 0xff, 0x00);
    _AudWriteRegByte(0x3111df, 0xff, 0x78);
    _AudWriteRegByte(0x3111ea, 0xff, 0x08);
    _AudWriteRegByte(0x3111eb, 0xff, 0x00);
    _AudWriteRegByte(0x3111ee, 0xff, 0x81);
    _AudWriteRegByte(0x3111ef, 0xff, 0x10);
    _AudWriteRegByte(0x3111ec, 0xff, 0x28);
    _AudWriteRegByte(0x3111ed, 0xff, 0x00);

    // delay 1 ms
    mdelay(1); // mdelay busy waiting
    ...
    _AudWriteRegByte(0x3111E9, 0xff, 0x00);
    _AudWriteRegByte(0x3111EC, 0xff, 0x28);
    _AudWriteRegByte(0x3111ED, 0xff, 0x08);
    _AudWriteRegByte(0x3111EE, 0xff, 0x01);
    _AudWriteRegByte(0x3111EF, 0xff, 0x10);
    ...
    _AudWriteRegByte(0x3111ee, 0xff, 0x01);
    _AudWriteRegByte(0x3111ef, 0xff, 0x13);
