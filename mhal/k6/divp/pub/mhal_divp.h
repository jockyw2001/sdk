...
/// @return MHAL_ErrCode_e
//------------------------------------------------------------------------------
MS_S32 MHAL_DIVP_CaptureTiming(void* pCtx, MHAL_DIVP_CaptureInfo_t* pstCaptureInfo,
                                                                                 MHAL_CMDQ_CmdqInterface_t* pstCmdInf);
...
MS_S32 MHAL_DIVP_ProcessDramData(void* pCtx, MHAL_DIVP_InputInfo_t* pstDivpInputInfo,
                             MHAL_DIVP_OutPutInfo_t* pstDivpOutputInfo, MHAL_CMDQ_CmdqInterface_t* pstCmdInf);
...
/// @param[in] pstCmdInf: a group of function pointer for controlling HW register. These functions
///    will deside write/read regster with RIU or Command queue.
/// @return MHAL_ErrCode_e
//------------------------------------------------------------------------------
