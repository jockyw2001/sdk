...
typedef enum
{
    ...
    E_MHAL_DISP_CSC_MATRIX_BT601_TO_BT709,       /* I2 not support: change color space from BT.601 to BT.709 */
    E_MHAL_DISP_CSC_MATRIX_BT709_TO_BT601,       /* I2 not support: change color space from BT.709 to BT.601 */
...
{
    MHAL_DISP_PixelFormat_e  ePixelFormat;
